//! Iam_api service for Gcp provider
//!
//! This module handles all iam_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Iam_api service handler
...
impl<'a> Iam_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "workload_identity_pool" => {
                self.plan_workload_identity_pool(current_state, desired_input)
                    .await
            }
            ...
            "provider" => self.plan_provider(current_state, desired_input).await,
            ...
            "subject" => self.plan_subject(current_state, desired_input).await,
            ...
            "scim_tenant" => self.plan_scim_tenant(current_state, desired_input).await,
            "iam_policie" => self.plan_iam_policie(current_state, desired_input).await,
            "managed_identitie" => {
                self.plan_managed_identitie(current_state, desired_input)
                    .await
            }
            "permission" => self.plan_permission(current_state, desired_input).await,
            "workforce_pool" => self.plan_workforce_pool(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "scim_tenant" => self.create_scim_tenant(input).await,
            "iam_policie" => self.create_iam_policie(input).await,
            "managed_identitie" => self.create_managed_identitie(input).await,
            "permission" => self.create_permission(input).await,
            "workforce_pool" => self.create_workforce_pool(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "scim_tenant" => self.read_scim_tenant(id).await,
            "iam_policie" => self.read_iam_policie(id).await,
            "managed_identitie" => self.read_managed_identitie(id).await,
            "permission" => self.read_permission(id).await,
            "workforce_pool" => self.read_workforce_pool(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "scim_tenant" => self.update_scim_tenant(id, input).await,
            "iam_policie" => self.update_iam_policie(id, input).await,
            "managed_identitie" => self.update_managed_identitie(id, input).await,
            "permission" => self.update_permission(id, input).await,
            "workforce_pool" => self.update_workforce_pool(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "scim_tenant" => self.delete_scim_tenant(id).await,
            "iam_policie" => self.delete_iam_policie(id).await,
            "managed_identitie" => self.delete_managed_identitie(id).await,
            "permission" => self.delete_permission(id).await,
            "workforce_pool" => self.delete_workforce_pool(id).await,
    ...
    // ------------------------------------------------------------------------
    // Workload_identity_pool resource operations
    // ------------------------------------------------------------------------

    /// Plan changes to a workload_identity_pool resource
    async fn plan_workload_identity_pool(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Create a new workload_identity_pool resource
    async fn create_workload_identity_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a workload_identity_pool resource
    async fn read_workload_identity_pool(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a workload_identity_pool resource
    ...
    /// Delete a workload_identity_pool resource
    async fn delete_workload_identity_pool(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_provider(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a provider resource
    async fn read_provider(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a provider resource
    async fn update_provider(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn create_subject(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a subject resource
    async fn read_subject(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a subject resource
    async fn update_subject(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a subject resource
    async fn delete_subject(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_scim_tenant(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a scim_tenant resource
    async fn read_scim_tenant(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a scim_tenant resource
    async fn update_scim_tenant(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a scim_tenant resource
    async fn delete_scim_tenant(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_iam_policie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a iam_policie resource
    async fn read_iam_policie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a iam_policie resource
    async fn update_iam_policie(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a iam_policie resource
    async fn delete_iam_policie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }

    // ------------------------------------------------------------------------
    // Managed_identitie resource operations
    // ------------------------------------------------------------------------

    /// Plan changes to a managed_identitie resource
    async fn plan_managed_identitie(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Create a new managed_identitie resource
    async fn create_managed_identitie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a managed_identitie resource
    async fn read_managed_identitie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a managed_identitie resource
    async fn update_managed_identitie(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    /// Delete a managed_identitie resource
    async fn delete_managed_identitie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_workforce_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a workforce_pool resource
    async fn read_workforce_pool(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_workforce_pool(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
