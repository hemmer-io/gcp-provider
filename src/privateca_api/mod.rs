...
impl<'a> Privateca_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "certificate_authoritie" => {
                self.plan_certificate_authoritie(current_state, desired_input)
                    .await
            }
            "certificate" => self.plan_certificate(current_state, desired_input).await,
            "certificate_template" => {
                self.plan_certificate_template(current_state, desired_input)
                    .await
            }
            "ca_pool" => self.plan_ca_pool(current_state, desired_input).await,
            "certificate_revocation_list" => {
                self.plan_certificate_revocation_list(current_state, desired_input)
                    .await
            }
            ...
            "location" => self.plan_location(current_state, desired_input).await,
            "reusable_config" => {
                self.plan_reusable_config(current_state, desired_input)
                    .await
            }
            "certificate_revocation_list" => {
                self.plan_certificate_revocation_list(current_state, desired_input)
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "certificate_authoritie" => self.create_certificate_authoritie(input).await,
            "certificate" => self.create_certificate(input).await,
            "certificate_template" => self.create_certificate_template(input).await,
            "ca_pool" => self.create_ca_pool(input).await,
            "certificate_revocation_list" => self.create_certificate_revocation_list(input).await,
            "location" => self.create_location(input).await,
            "certificate_authoritie" => self.create_certificate_authoritie(input).await,
            "location" => self.create_location(input).await,
            "reusable_config" => self.create_reusable_config(input).await,
            "certificate_revocation_list" => self.create_certificate_revocation_list(input).await,
            "operation" => self.create_operation(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "certificate_authoritie" => self.read_certificate_authoritie(id).await,
            "certificate" => self.read_certificate(id).await,
            "certificate_template" => self.read_certificate_template(id).await,
            "ca_pool" => self.read_ca_pool(id).await,
            "certificate_revocation_list" => self.read_certificate_revocation_list(id).await,
            "location" => self.read_location(id).await,
            "certificate_authoritie" => self.read_certificate_authoritie(id).await,
            "location" => self.read_location(id).await,
            "reusable_config" => self.read_reusable_config(id).await,
            "certificate_revocation_list" => self.read_certificate_revocation_list(id).await,
            "operation" => self.read_operation(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "certificate_authoritie" => self.update_certificate_authoritie(id, input).await,
            "certificate" => self.update_certificate(id, input).await,
            "certificate_template" => self.update_certificate_template(id, input).await,
            "ca_pool" => self.update_ca_pool(id, input).await,
            "certificate_revocation_list" => {
            ...
            "certificate_authoritie" => self.update_certificate_authoritie(id, input).await,
            "location" => self.update_location(id, input).await,
            "reusable_config" => self.update_reusable_config(id, input).await,
            "certificate_revocation_list" => {
                self.update_certificate_revocation_list(id, input).await
            }
            "operation" => self.update_operation(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "certificate_authoritie" => self.delete_certificate_authoritie(id).await,
            "certificate" => self.delete_certificate(id).await,
            "certificate_template" => self.delete_certificate_template(id).await,
            "ca_pool" => self.delete_ca_pool(id).await,
            "certificate_revocation_list" => self.delete_certificate_revocation_list(id).await,
            "location" => self.delete_location(id).await,
            "certificate_authoritie" => self.delete_certificate_authoritie(id).await,
            "location" => self.delete_location(id).await,
            "reusable_config" => self.delete_reusable_config(id).await,
            "certificate_revocation_list" => self.delete_certificate_revocation_list(id).await,
            "operation" => self.delete_operation(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    async fn create_certificate_authoritie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a certificate_authoritie resource
    async fn read_certificate_authoritie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_certificate_authoritie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_certificate_template(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a certificate_template resource
    async fn read_certificate_template(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_certificate_template(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_ca_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a ca_pool resource
    async fn read_ca_pool(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a ca_pool resource
    async fn update_ca_pool(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a ca_pool resource
    async fn delete_ca_pool(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_certificate_revocation_list(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_certificate_revocation_list(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_reusable_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a reusable_config resource
    async fn read_reusable_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_reusable_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
