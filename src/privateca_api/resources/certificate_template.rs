...
impl<'a> Certificate_template<'a> {
    ...
    pub async fn create(&self, name: Option<String>, update_time: Option<String>, predefined_values: Option<String>, create_time: Option<String>, description: Option<String>, identity_constraints: Option<String>, labels: Option<HashMap<String, String>>, passthrough_extensions: Option<String>, maximum_lifetime: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, update_time: Option<String>, predefined_values: Option<String>, create_time: Option<String>, description: Option<String>, identity_constraints: Option<String>, labels: Option<HashMap<String, String>>, passthrough_extensions: Option<String>, maximum_lifetime: Option<String>) -> Result<()> {
