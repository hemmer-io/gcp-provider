...
impl<'a> Youtubereporting_apiService<'a> {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "report_type" => self.create_report_type(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "report_type" => self.read_report_type(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "report_type" => self.update_report_type(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "report_type" => self.delete_report_type(id).await,
    ...
    async fn create_report_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a report_type resource
    async fn read_report_type(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a report_type resource
    async fn update_report_type(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a report_type resource
    async fn delete_report_type(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
