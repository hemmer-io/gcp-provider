...
impl<'a> Artifactregistry_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "apt_artifact" => self.plan_apt_artifact(current_state, desired_input).await,
            "kfp_artifact" => self.plan_kfp_artifact(current_state, desired_input).await,
            "tag" => self.plan_tag(current_state, desired_input).await,
            "maven_artifact" => self.plan_maven_artifact(current_state, desired_input).await,
            ...
            "go_module" => self.plan_go_module(current_state, desired_input).await,
            "generic_artifact" => {
                self.plan_generic_artifact(current_state, desired_input)
                    .await
            }
            "yum_artifact" => self.plan_yum_artifact(current_state, desired_input).await,
            "python_package" => self.plan_python_package(current_state, desired_input).await,
            "googet_artifact" => {
                self.plan_googet_artifact(current_state, desired_input)
                    .await
            }
            "file" => self.plan_file(current_state, desired_input).await,
            "npm_package" => self.plan_npm_package(current_state, desired_input).await,
            "docker_image" => self.plan_docker_image(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "artifactregistry_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "apt_artifact" => self.create_apt_artifact(input).await,
            "kfp_artifact" => self.create_kfp_artifact(input).await,
            "tag" => self.create_tag(input).await,
            "maven_artifact" => self.create_maven_artifact(input).await,
            ...
            "go_module" => self.create_go_module(input).await,
            "generic_artifact" => self.create_generic_artifact(input).await,
            "yum_artifact" => self.create_yum_artifact(input).await,
            "python_package" => self.create_python_package(input).await,
            "googet_artifact" => self.create_googet_artifact(input).await,
            "file" => self.create_file(input).await,
            "npm_package" => self.create_npm_package(input).await,
            "docker_image" => self.create_docker_image(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "apt_artifact" => self.read_apt_artifact(id).await,
            "kfp_artifact" => self.read_kfp_artifact(id).await,
            "tag" => self.read_tag(id).await,
            "maven_artifact" => self.read_maven_artifact(id).await,
            "rule" => self.read_rule(id).await,
            "operation" => self.read_operation(id).await,
            "repositorie" => self.read_repositorie(id).await,
            "go_module" => self.read_go_module(id).await,
            "generic_artifact" => self.read_generic_artifact(id).await,
            "yum_artifact" => self.read_yum_artifact(id).await,
            "python_package" => self.read_python_package(id).await,
            "googet_artifact" => self.read_googet_artifact(id).await,
            "file" => self.read_file(id).await,
            "npm_package" => self.read_npm_package(id).await,
            "docker_image" => self.read_docker_image(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "apt_artifact" => self.update_apt_artifact(id, input).await,
            "kfp_artifact" => self.update_kfp_artifact(id, input).await,
            "tag" => self.update_tag(id, input).await,
            "maven_artifact" => self.update_maven_artifact(id, input).await,
            ...
            "go_module" => self.update_go_module(id, input).await,
            "generic_artifact" => self.update_generic_artifact(id, input).await,
            "yum_artifact" => self.update_yum_artifact(id, input).await,
            "python_package" => self.update_python_package(id, input).await,
            "googet_artifact" => self.update_googet_artifact(id, input).await,
            "file" => self.update_file(id, input).await,
            "npm_package" => self.update_npm_package(id, input).await,
            "docker_image" => self.update_docker_image(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "apt_artifact" => self.delete_apt_artifact(id).await,
            "kfp_artifact" => self.delete_kfp_artifact(id).await,
            "tag" => self.delete_tag(id).await,
            "maven_artifact" => self.delete_maven_artifact(id).await,
            "rule" => self.delete_rule(id).await,
            "operation" => self.delete_operation(id).await,
            "repositorie" => self.delete_repositorie(id).await,
            "go_module" => self.delete_go_module(id).await,
            "generic_artifact" => self.delete_generic_artifact(id).await,
            "yum_artifact" => self.delete_yum_artifact(id).await,
            "python_package" => self.delete_python_package(id).await,
            "googet_artifact" => self.delete_googet_artifact(id).await,
            "file" => self.delete_file(id).await,
            "npm_package" => self.delete_npm_package(id).await,
            "docker_image" => self.delete_docker_image(id).await,
    ...
    async fn create_apt_artifact(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a apt_artifact resource
    async fn read_apt_artifact(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a apt_artifact resource
    async fn update_apt_artifact(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a apt_artifact resource
    async fn delete_apt_artifact(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_kfp_artifact(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a kfp_artifact resource
    async fn read_kfp_artifact(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a kfp_artifact resource
    async fn update_kfp_artifact(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a kfp_artifact resource
    async fn delete_kfp_artifact(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_maven_artifact(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a maven_artifact resource
    async fn read_maven_artifact(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_maven_artifact(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_go_module(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a go_module resource
    async fn read_go_module(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a go_module resource
    async fn update_go_module(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a go_module resource
    async fn delete_go_module(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_generic_artifact(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a generic_artifact resource
    async fn read_generic_artifact(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_generic_artifact(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_yum_artifact(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a yum_artifact resource
    async fn read_yum_artifact(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a yum_artifact resource
    async fn update_yum_artifact(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a yum_artifact resource
    async fn delete_yum_artifact(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_python_package(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a python_package resource
    async fn read_python_package(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_python_package(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_googet_artifact(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a googet_artifact resource
    async fn read_googet_artifact(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_googet_artifact(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_npm_package(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a npm_package resource
    async fn read_npm_package(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a npm_package resource
    async fn update_npm_package(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a npm_package resource
    async fn delete_npm_package(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_docker_image(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a docker_image resource
    async fn read_docker_image(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a docker_image resource
    async fn update_docker_image(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a docker_image resource
    async fn delete_docker_image(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
