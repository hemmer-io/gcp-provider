...
impl<'a> Bigqueryreservation_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "reservation_group" => {
                self.plan_reservation_group(current_state, desired_input)
                    .await
            }
            ...
            "capacity_commitment" => {
                self.plan_capacity_commitment(current_state, desired_input)
                    .await
            }
            "reservation_grant" => {
                self.plan_reservation_grant(current_state, desired_input)
                    .await
            }
            "operation" => self.plan_operation(current_state, desired_input).await,
            "reservation" => self.plan_reservation(current_state, desired_input).await,
            "slot_pool" => self.plan_slot_pool(current_state, desired_input).await,
            "location" => self.plan_location(current_state, desired_input).await,
            "assignment" => self.plan_assignment(current_state, desired_input).await,
            "reservation" => self.plan_reservation(current_state, desired_input).await,
            "location" => self.plan_location(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "bigqueryreservation_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "reservation_group" => self.create_reservation_group(input).await,
            "reservation" => self.create_reservation(input).await,
            "assignment" => self.create_assignment(input).await,
            "capacity_commitment" => self.create_capacity_commitment(input).await,
            "reservation_grant" => self.create_reservation_grant(input).await,
            "operation" => self.create_operation(input).await,
            "reservation" => self.create_reservation(input).await,
            "slot_pool" => self.create_slot_pool(input).await,
            "location" => self.create_location(input).await,
            "assignment" => self.create_assignment(input).await,
            "reservation" => self.create_reservation(input).await,
            "location" => self.create_location(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "reservation_group" => self.read_reservation_group(id).await,
            "reservation" => self.read_reservation(id).await,
            "assignment" => self.read_assignment(id).await,
            "capacity_commitment" => self.read_capacity_commitment(id).await,
            "reservation_grant" => self.read_reservation_grant(id).await,
            "operation" => self.read_operation(id).await,
            "reservation" => self.read_reservation(id).await,
            "slot_pool" => self.read_slot_pool(id).await,
            "location" => self.read_location(id).await,
            "assignment" => self.read_assignment(id).await,
            "reservation" => self.read_reservation(id).await,
            "location" => self.read_location(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "reservation_group" => self.update_reservation_group(id, input).await,
            "reservation" => self.update_reservation(id, input).await,
            "assignment" => self.update_assignment(id, input).await,
            "capacity_commitment" => self.update_capacity_commitment(id, input).await,
            "reservation_grant" => self.update_reservation_grant(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "reservation" => self.update_reservation(id, input).await,
            "slot_pool" => self.update_slot_pool(id, input).await,
            "location" => self.update_location(id, input).await,
            "assignment" => self.update_assignment(id, input).await,
            "reservation" => self.update_reservation(id, input).await,
            "location" => self.update_location(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "reservation_group" => self.delete_reservation_group(id).await,
            "reservation" => self.delete_reservation(id).await,
            "assignment" => self.delete_assignment(id).await,
            "capacity_commitment" => self.delete_capacity_commitment(id).await,
            "reservation_grant" => self.delete_reservation_grant(id).await,
            "operation" => self.delete_operation(id).await,
            "reservation" => self.delete_reservation(id).await,
            "slot_pool" => self.delete_slot_pool(id).await,
            "location" => self.delete_location(id).await,
            "assignment" => self.delete_assignment(id).await,
            "reservation" => self.delete_reservation(id).await,
            "location" => self.delete_location(id).await,
    ...
    async fn create_reservation_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a reservation_group resource
    async fn read_reservation_group(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_reservation_group(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_capacity_commitment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a capacity_commitment resource
    async fn read_capacity_commitment(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_capacity_commitment(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_reservation_grant(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a reservation_grant resource
    async fn read_reservation_grant(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_reservation_grant(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_slot_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a slot_pool resource
    async fn read_slot_pool(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a slot_pool resource
    async fn update_slot_pool(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a slot_pool resource
    async fn delete_slot_pool(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
