...
impl<'a> Reservation_grant<'a> {
    ...
    pub async fn create(&self, name: Option<String>, state: Option<String>, grantee: Option<String>, job_type: Option<String>, reservation: Option<String>, parent: String) -> Result<String> {
