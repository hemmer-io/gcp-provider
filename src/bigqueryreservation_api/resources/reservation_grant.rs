...
impl<'a> Reservation_grant<'a> {
    ...
    pub async fn create(&self, grantee: Option<String>, job_type: Option<String>, name: Option<String>, state: Option<String>, reservation: Option<String>, parent: String) -> Result<String> {
