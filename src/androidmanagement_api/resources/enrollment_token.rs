...
impl<'a> Enrollment_token<'a> {
    ...
    pub async fn create(&self, name: Option<String>, expiration_timestamp: Option<String>, one_time_only: Option<bool>, allow_personal_usage: Option<String>, policy_name: Option<String>, qr_code: Option<String>, user: Option<String>, value: Option<String>, duration: Option<String>, additional_data: Option<String>, parent: String) -> Result<String> {
