...
impl<'a> Grounding_config<'a> {
    ...
    pub async fn create(&self, grounding_spec: Option<String>, answer_candidate: Option<String>, facts: Option<Vec<String>>, user_labels: Option<HashMap<String, String>>, grounding_config: String) -> Result<String> {
