...
impl<'a> Grounding_config<'a> {
    ...
    pub async fn create(&self, user_labels: Option<HashMap<String, String>>, facts: Option<Vec<String>>, answer_candidate: Option<String>, grounding_spec: Option<String>, grounding_config: String) -> Result<String> {
