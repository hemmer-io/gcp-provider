...
impl<'a> Sample_query_set<'a> {
    ...
    pub async fn create(&self, description: Option<String>, display_name: Option<String>, create_time: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, display_name: Option<String>, create_time: Option<String>, name: Option<String>) -> Result<()> {
