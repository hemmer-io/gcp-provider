...
impl<'a> Sample_query_set<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, name: Option<String>, description: Option<String>, create_time: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, display_name: Option<String>, name: Option<String>, description: Option<String>, create_time: Option<String>) -> Result<()> {
