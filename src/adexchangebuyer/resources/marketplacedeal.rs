...
impl<'a> Marketplacedeal<'a> {
    ...
    pub async fn create(&self, deals: Option<Vec<String>>, update_action: Option<String>, proposal_revision_number: Option<String>, proposal_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, deals: Option<Vec<String>>, update_action: Option<String>, proposal_revision_number: Option<String>) -> Result<()> {
