...
impl<'a> Marketplaceprivateauction<'a> {
    ...
    pub async fn create(&self, note: Option<String>, external_deal_id: Option<String>, update_action: Option<String>, proposal_revision_number: Option<String>, private_auction_id: String) -> Result<String> {
