...
impl<'a> Retail_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "attributes_config" => {
                self.plan_attributes_config(current_state, desired_input).await
            }
            "control" => {
            ...
            "placement" => {
                self.plan_placement(current_state, desired_input).await
            }
            "project" => {
            ...
            "completion_data" => {
                self.plan_completion_data(current_state, desired_input).await
            }
            "generative_question" => {
                self.plan_generative_question(current_state, desired_input).await
            }
            "serving_config" => {
                self.plan_serving_config(current_state, desired_input).await
            }
            ...
            "merchant_center_account_link" => {
                self.plan_merchant_center_account_link(current_state, desired_input).await
            }
            "product" => {
                self.plan_product(current_state, desired_input).await
            }
            ...
            "retail_project" => {
                self.plan_retail_project(current_state, desired_input).await
            }
            "attributes_config" => {
                self.plan_attributes_config(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "attributes_config" => {
                self.create_attributes_config(input).await
            }
            "control" => {
            ...
            "placement" => {
                self.create_placement(input).await
            }
            "project" => {
            ...
            "completion_data" => {
                self.create_completion_data(input).await
            }
            "generative_question" => {
                self.create_generative_question(input).await
            }
            "serving_config" => {
                self.create_serving_config(input).await
            }
            ...
            "merchant_center_account_link" => {
                self.create_merchant_center_account_link(input).await
            }
            "product" => {
                self.create_product(input).await
            }
            ...
            "retail_project" => {
                self.create_retail_project(input).await
            }
            "attributes_config" => {
                self.create_attributes_config(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "attributes_config" => {
                self.read_attributes_config(id).await
            }
            "control" => {
            ...
            "completion_data" => {
                self.read_completion_data(id).await
            }
            "generative_question" => {
                self.read_generative_question(id).await
            }
            "serving_config" => {
                self.read_serving_config(id).await
            }
            ...
            "merchant_center_account_link" => {
                self.read_merchant_center_account_link(id).await
            }
            "product" => {
                self.read_product(id).await
            }
            ...
            "retail_project" => {
                self.read_retail_project(id).await
            }
            "attributes_config" => {
                self.read_attributes_config(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "attributes_config" => {
                self.update_attributes_config(id, input).await
            }
            "control" => {
            ...
            "placement" => {
                self.update_placement(id, input).await
            }
            "project" => {
            ...
            "completion_data" => {
                self.update_completion_data(id, input).await
            }
            "generative_question" => {
                self.update_generative_question(id, input).await
            }
            "serving_config" => {
                self.update_serving_config(id, input).await
            }
            ...
            "retail_project" => {
                self.update_retail_project(id, input).await
            }
            "attributes_config" => {
                self.update_attributes_config(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "attributes_config" => {
                self.delete_attributes_config(id).await
            }
            "control" => {
            ...
            "placement" => {
                self.delete_placement(id).await
            }
            "project" => {
            ...
            "completion_data" => {
                self.delete_completion_data(id).await
            }
            "generative_question" => {
                self.delete_generative_question(id).await
            }
            "serving_config" => {
                self.delete_serving_config(id).await
            }
            ...
            "merchant_center_account_link" => {
                self.delete_merchant_center_account_link(id).await
            }
            "product" => {
                self.delete_product(id).await
            }
            ...
            "retail_project" => {
                self.delete_retail_project(id).await
            }
            "attributes_config" => {
                self.delete_attributes_config(id).await
            }
    ...
    async fn create_attributes_config(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_attributes_config(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_attributes_config(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_completion_data(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_completion_data(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_generative_question(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_generative_question(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_generative_question(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_merchant_center_account_link(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_retail_project(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_retail_project(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
