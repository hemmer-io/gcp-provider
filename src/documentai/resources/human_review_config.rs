...
impl<'a> Human_review_config<'a> {
    ...
    pub async fn create(&self, document_schema: Option<String>, inline_document: Option<String>, enable_schema_validation: Option<bool>, priority: Option<String>, human_review_config: String) -> Result<String> {
