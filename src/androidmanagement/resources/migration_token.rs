...
impl<'a> Migration_token<'a> {
    ...
    pub async fn create(&self, value: Option<String>, policy: Option<String>, name: Option<String>, user_id: Option<String>, create_time: Option<String>, additional_data: Option<String>, expire_time: Option<String>, device: Option<String>, device_id: Option<String>, management_mode: Option<String>, ttl: Option<String>, parent: String) -> Result<String> {
