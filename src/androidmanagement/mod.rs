//! Androidmanagement Service
//!
//! Auto-generated service module for androidmanagement

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for androidmanagement
pub struct AndroidmanagementService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> AndroidmanagementService<'a> {
