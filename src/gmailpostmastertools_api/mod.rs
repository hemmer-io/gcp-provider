...
impl<'a> Gmailpostmastertools_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "traffic_stat" => self.plan_traffic_stat(current_state, desired_input).await,
            "domain" => self.plan_domain(current_state, desired_input).await,
            "traffic_stat" => self.plan_traffic_stat(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gmailpostmastertools_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "traffic_stat" => self.create_traffic_stat(input).await,
            "domain" => self.create_domain(input).await,
            "traffic_stat" => self.create_traffic_stat(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "traffic_stat" => self.read_traffic_stat(id).await,
            "domain" => self.read_domain(id).await,
            "traffic_stat" => self.read_traffic_stat(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "traffic_stat" => self.update_traffic_stat(id, input).await,
            "domain" => self.update_domain(id, input).await,
            "traffic_stat" => self.update_traffic_stat(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "traffic_stat" => self.delete_traffic_stat(id).await,
            "domain" => self.delete_domain(id).await,
            "traffic_stat" => self.delete_traffic_stat(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    async fn create_traffic_stat(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a traffic_stat resource
    async fn read_traffic_stat(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a traffic_stat resource
    async fn update_traffic_stat(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a traffic_stat resource
    async fn delete_traffic_stat(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
