...
impl<'a> Cloudbuild_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "github_enterprise_config" => {
                self.plan_github_enterprise_config(current_state, desired_input)
                    .await
            }
            "bitbucket_server_config" => {
                self.plan_bitbucket_server_config(current_state, desired_input)
                    .await
            }
            "location" => self.plan_location(current_state, desired_input).await,
            "connected_repositorie" => {
                self.plan_connected_repositorie(current_state, desired_input)
                    .await
            }
            "git_lab_config" => self.plan_git_lab_config(current_state, desired_input).await,
            "trigger" => self.plan_trigger(current_state, desired_input).await,
            "github_dot_com_webhook" => {
                self.plan_github_dot_com_webhook(current_state, desired_input)
                    .await
            }
            ...
            "cloudbuild" => self.plan_cloudbuild(current_state, desired_input).await,
            "worker_pool" => self.plan_worker_pool(current_state, desired_input).await,
            "operation" => self.plan_operation(current_state, desired_input).await,
            "location" => self.plan_location(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "github_enterprise_config" => self.create_github_enterprise_config(input).await,
            "bitbucket_server_config" => self.create_bitbucket_server_config(input).await,
            "location" => self.create_location(input).await,
            "connected_repositorie" => self.create_connected_repositorie(input).await,
            "git_lab_config" => self.create_git_lab_config(input).await,
            "trigger" => self.create_trigger(input).await,
            "github_dot_com_webhook" => self.create_github_dot_com_webhook(input).await,
            "operation" => self.create_operation(input).await,
            "build" => self.create_build(input).await,
            "repo" => self.create_repo(input).await,
            "cloudbuild" => self.create_cloudbuild(input).await,
            "worker_pool" => self.create_worker_pool(input).await,
            "operation" => self.create_operation(input).await,
            "location" => self.create_location(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "github_enterprise_config" => self.read_github_enterprise_config(id).await,
            "bitbucket_server_config" => self.read_bitbucket_server_config(id).await,
            "location" => self.read_location(id).await,
            "connected_repositorie" => self.read_connected_repositorie(id).await,
            "git_lab_config" => self.read_git_lab_config(id).await,
            "trigger" => self.read_trigger(id).await,
            "github_dot_com_webhook" => self.read_github_dot_com_webhook(id).await,
            "operation" => self.read_operation(id).await,
            "build" => self.read_build(id).await,
            "repo" => self.read_repo(id).await,
            "cloudbuild" => self.read_cloudbuild(id).await,
            "worker_pool" => self.read_worker_pool(id).await,
            "operation" => self.read_operation(id).await,
            "location" => self.read_location(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "github_enterprise_config" => self.update_github_enterprise_config(id, input).await,
            "bitbucket_server_config" => self.update_bitbucket_server_config(id, input).await,
            "location" => self.update_location(id, input).await,
            "connected_repositorie" => self.update_connected_repositorie(id, input).await,
            "git_lab_config" => self.update_git_lab_config(id, input).await,
            "trigger" => self.update_trigger(id, input).await,
            "github_dot_com_webhook" => self.update_github_dot_com_webhook(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "build" => self.update_build(id, input).await,
            "repo" => self.update_repo(id, input).await,
            "cloudbuild" => self.update_cloudbuild(id, input).await,
            "worker_pool" => self.update_worker_pool(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "location" => self.update_location(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "github_enterprise_config" => self.delete_github_enterprise_config(id).await,
            "bitbucket_server_config" => self.delete_bitbucket_server_config(id).await,
            "location" => self.delete_location(id).await,
            "connected_repositorie" => self.delete_connected_repositorie(id).await,
            "git_lab_config" => self.delete_git_lab_config(id).await,
            "trigger" => self.delete_trigger(id).await,
            "github_dot_com_webhook" => self.delete_github_dot_com_webhook(id).await,
            "operation" => self.delete_operation(id).await,
            "build" => self.delete_build(id).await,
            "repo" => self.delete_repo(id).await,
            "cloudbuild" => self.delete_cloudbuild(id).await,
            "worker_pool" => self.delete_worker_pool(id).await,
            "operation" => self.delete_operation(id).await,
            "location" => self.delete_location(id).await,
    ...
    async fn read_github_enterprise_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_github_enterprise_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_bitbucket_server_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a bitbucket_server_config resource
    async fn read_bitbucket_server_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_bitbucket_server_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_connected_repositorie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a connected_repositorie resource
    async fn read_connected_repositorie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_connected_repositorie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_git_lab_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a git_lab_config resource
    async fn read_git_lab_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_git_lab_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_github_dot_com_webhook(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a github_dot_com_webhook resource
    async fn read_github_dot_com_webhook(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_github_dot_com_webhook(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_cloudbuild(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a cloudbuild resource
    async fn read_cloudbuild(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a cloudbuild resource
    async fn update_cloudbuild(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a cloudbuild resource
    async fn delete_cloudbuild(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
