...
impl<'a> Assigned_inventory_source<'a> {
    ...
    pub async fn create(&self, name: Option<String>, assigned_inventory_source_id: Option<String>, inventory_source_id: Option<String>, inventory_source_group_id: String) -> Result<String> {
