...
impl<'a> Assigned_location<'a> {
    ...
    pub async fn create(&self, targeting_option_id: Option<String>, name: Option<String>, assigned_location_id: Option<String>, advertiser_id: String, location_list_id: String) -> Result<String> {
