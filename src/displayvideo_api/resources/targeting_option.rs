...
impl<'a> Targeting_option<'a> {
    ...
    pub async fn create(&self, poi_search_terms: Option<String>, advertiser_id: Option<String>, geo_region_search_terms: Option<String>, page_size: Option<i64>, business_chain_search_terms: Option<String>, page_token: Option<String>, targeting_type: String) -> Result<String> {
