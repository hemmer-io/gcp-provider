...
impl<'a> Sdfdownloadtask<'a> {
    ...
    pub async fn create(&self, inventory_source_filter: Option<String>, partner_id: Option<String>, version: Option<String>, advertiser_id: Option<String>, id_filter: Option<String>, parent_entity_filter: Option<String>) -> Result<String> {
