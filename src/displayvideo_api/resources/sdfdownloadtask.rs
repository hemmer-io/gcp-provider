...
impl<'a> Sdfdownloadtask<'a> {
    ...
    pub async fn create(&self, parent_entity_filter: Option<String>, id_filter: Option<String>, version: Option<String>, inventory_source_filter: Option<String>, advertiser_id: Option<String>, partner_id: Option<String>) -> Result<String> {
