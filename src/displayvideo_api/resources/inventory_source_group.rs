...
impl<'a> Inventory_source_group<'a> {
    ...
    pub async fn create(&self, inventory_source_group_id: Option<String>, display_name: Option<String>, name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, inventory_source_group_id: Option<String>, display_name: Option<String>, name: Option<String>) -> Result<()> {
