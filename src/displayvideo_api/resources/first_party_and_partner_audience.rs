...
impl<'a> First_party_and_partner_audience<'a> {
    ...
    pub async fn create(&self, first_party_and_partner_audience_id: Option<String>, active_display_audience_size: Option<String>, description: Option<String>, gmail_audience_size: Option<String>, audience_source: Option<String>, audience_type: Option<String>, first_party_and_partner_audience_type: Option<String>, display_desktop_audience_size: Option<String>, membership_duration_days: Option<String>, display_mobile_app_audience_size: Option<String>, youtube_audience_size: Option<String>, mobile_device_id_list: Option<String>, display_name: Option<String>, display_audience_size: Option<String>, contact_info_list: Option<String>, display_mobile_web_audience_size: Option<String>, app_id: Option<String>, name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, first_party_and_partner_audience_id: Option<String>, active_display_audience_size: Option<String>, description: Option<String>, gmail_audience_size: Option<String>, audience_source: Option<String>, audience_type: Option<String>, first_party_and_partner_audience_type: Option<String>, display_desktop_audience_size: Option<String>, membership_duration_days: Option<String>, display_mobile_app_audience_size: Option<String>, youtube_audience_size: Option<String>, mobile_device_id_list: Option<String>, display_name: Option<String>, display_audience_size: Option<String>, contact_info_list: Option<String>, display_mobile_web_audience_size: Option<String>, app_id: Option<String>, name: Option<String>) -> Result<()> {
