...
impl<'a> Manual_trigger<'a> {
    ...
    pub async fn create(&self, trigger_id: Option<String>, display_name: Option<String>, name: Option<String>, state: Option<String>, activation_duration_minutes: Option<String>, latest_activation_time: Option<String>, advertiser_id: Option<String>, advertiser_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, trigger_id: Option<String>, display_name: Option<String>, name: Option<String>, state: Option<String>, activation_duration_minutes: Option<String>, latest_activation_time: Option<String>, advertiser_id: Option<String>) -> Result<()> {
