...
impl<'a> Manual_trigger<'a> {
    ...
    pub async fn create(&self, advertiser_id: Option<String>, name: Option<String>, activation_duration_minutes: Option<String>, state: Option<String>, latest_activation_time: Option<String>, trigger_id: Option<String>, display_name: Option<String>, advertiser_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, advertiser_id: Option<String>, name: Option<String>, activation_duration_minutes: Option<String>, state: Option<String>, latest_activation_time: Option<String>, trigger_id: Option<String>, display_name: Option<String>) -> Result<()> {
