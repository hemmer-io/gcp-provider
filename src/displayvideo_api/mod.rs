...
impl<'a> Displayvideo_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "sdfdownloadtask" => {
                self.plan_sdfdownloadtask(current_state, desired_input).await
            }
            "guaranteed_order" => {
                self.plan_guaranteed_order(current_state, desired_input).await
            }
            "assigned_targeting_option" => {
                self.plan_assigned_targeting_option(current_state, desired_input).await
            }
            "inventory_source_group" => {
                self.plan_inventory_source_group(current_state, desired_input).await
            }
            "user" => {
            ...
            "targeting_option" => {
                self.plan_targeting_option(current_state, desired_input).await
            }
            "partner" => {
                self.plan_partner(current_state, desired_input).await
            }
            "location_list" => {
                self.plan_location_list(current_state, desired_input).await
            }
            "first_and_third_party_audience" => {
                self.plan_first_and_third_party_audience(current_state, desired_input).await
            }
            "manual_trigger" => {
                self.plan_manual_trigger(current_state, desired_input).await
            }
            "google_audience" => {
                self.plan_google_audience(current_state, desired_input).await
            }
            "custom_bidding_algorithm" => {
                self.plan_custom_bidding_algorithm(current_state, desired_input).await
            }
            "campaign" => {
            ...
            "custom_list" => {
                self.plan_custom_list(current_state, desired_input).await
            }
            "invoice" => {
                self.plan_invoice(current_state, desired_input).await
            }
            "floodlight_group" => {
                self.plan_floodlight_group(current_state, desired_input).await
            }
            "insertion_order" => {
                self.plan_insertion_order(current_state, desired_input).await
            }
            "asset" => {
            ...
            "negative_keyword" => {
                self.plan_negative_keyword(current_state, desired_input).await
            }
            "assigned_inventory_source" => {
                self.plan_assigned_inventory_source(current_state, desired_input).await
            }
            "advertiser" => {
                self.plan_advertiser(current_state, desired_input).await
            }
            "negative_keyword_list" => {
                self.plan_negative_keyword_list(current_state, desired_input).await
            }
            "script" => {
                self.plan_script(current_state, desired_input).await
            }
            "combined_audience" => {
                self.plan_combined_audience(current_state, desired_input).await
            }
            "inventory_source" => {
                self.plan_inventory_source(current_state, desired_input).await
            }
            "channel" => {
                self.plan_channel(current_state, desired_input).await
            }
            "assigned_location" => {
                self.plan_assigned_location(current_state, desired_input).await
            }
            "operation" => {
                self.plan_operation(current_state, desired_input).await
            }
            ...
            "youtube_ad_group" => {
                self.plan_youtube_ad_group(current_state, desired_input).await
            }
            "targeting_option" => {
                self.plan_targeting_option(current_state, desired_input).await
            }
            "youtube_ad_group_ad" => {
                self.plan_youtube_ad_group_ad(current_state, desired_input).await
            }
            "user" => {
                self.plan_user(current_state, desired_input).await
            }
            ...
            "floodlight_activitie" => {
                self.plan_floodlight_activitie(current_state, desired_input).await
            }
            "assigned_location" => {
                self.plan_assigned_location(current_state, desired_input).await
            }
            ...
            "youtube_asset_association" => {
                self.plan_youtube_asset_association(current_state, desired_input).await
            }
            "insertion_order" => {
                self.plan_insertion_order(current_state, desired_input).await
            }
            ...
            "first_party_and_partner_audience" => {
                self.plan_first_party_and_partner_audience(current_state, desired_input).await
            }
            "google_audience" => {
                self.plan_google_audience(current_state, desired_input).await
            }
            ...
            "ad_group" => {
                self.plan_ad_group(current_state, desired_input).await
            }
            "negative_keyword_list" => {
                self.plan_negative_keyword_list(current_state, desired_input).await
            }
            ...
            "ad_asset" => {
                self.plan_ad_asset(current_state, desired_input).await
            }
            "inventory_source_group" => {
                self.plan_inventory_source_group(current_state, desired_input).await
            }
            ...
            "ad_group_ad" => {
                self.plan_ad_group_ad(current_state, desired_input).await
            }
            "assigned_location" => {
                self.plan_assigned_location(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "sdfdownloadtask" => {
                self.create_sdfdownloadtask(input).await
            }
            "guaranteed_order" => {
                self.create_guaranteed_order(input).await
            }
            "assigned_targeting_option" => {
                self.create_assigned_targeting_option(input).await
            }
            "inventory_source_group" => {
                self.create_inventory_source_group(input).await
            }
            "user" => {
            ...
            "targeting_option" => {
                self.create_targeting_option(input).await
            }
            "partner" => {
                self.create_partner(input).await
            }
            "location_list" => {
                self.create_location_list(input).await
            }
            "first_and_third_party_audience" => {
                self.create_first_and_third_party_audience(input).await
            }
            "manual_trigger" => {
                self.create_manual_trigger(input).await
            }
            "google_audience" => {
                self.create_google_audience(input).await
            }
            "custom_bidding_algorithm" => {
                self.create_custom_bidding_algorithm(input).await
            }
            "campaign" => {
            ...
            "custom_list" => {
                self.create_custom_list(input).await
            }
            "invoice" => {
                self.create_invoice(input).await
            }
            "floodlight_group" => {
                self.create_floodlight_group(input).await
            }
            "insertion_order" => {
                self.create_insertion_order(input).await
            }
            "asset" => {
            ...
            "negative_keyword" => {
                self.create_negative_keyword(input).await
            }
            "assigned_inventory_source" => {
                self.create_assigned_inventory_source(input).await
            }
            "advertiser" => {
                self.create_advertiser(input).await
            }
            "negative_keyword_list" => {
                self.create_negative_keyword_list(input).await
            }
            "script" => {
                self.create_script(input).await
            }
            "combined_audience" => {
                self.create_combined_audience(input).await
            }
            "inventory_source" => {
                self.create_inventory_source(input).await
            }
            "channel" => {
                self.create_channel(input).await
            }
            "assigned_location" => {
                self.create_assigned_location(input).await
            }
            "operation" => {
                self.create_operation(input).await
            }
            ...
            "youtube_ad_group" => {
                self.create_youtube_ad_group(input).await
            }
            "targeting_option" => {
                self.create_targeting_option(input).await
            }
            "youtube_ad_group_ad" => {
                self.create_youtube_ad_group_ad(input).await
            }
            "user" => {
                self.create_user(input).await
            }
            ...
            "floodlight_activitie" => {
                self.create_floodlight_activitie(input).await
            }
            "assigned_location" => {
                self.create_assigned_location(input).await
            }
            ...
            "youtube_asset_association" => {
                self.create_youtube_asset_association(input).await
            }
            "insertion_order" => {
                self.create_insertion_order(input).await
            }
            ...
            "ad_group" => {
                self.create_ad_group(input).await
            }
            "negative_keyword_list" => {
                self.create_negative_keyword_list(input).await
            }
            ...
            "ad_asset" => {
                self.create_ad_asset(input).await
            }
            "inventory_source_group" => {
                self.create_inventory_source_group(input).await
            }
            ...
            "ad_group_ad" => {
                self.create_ad_group_ad(input).await
            }
            "assigned_location" => {
                self.create_assigned_location(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "sdfdownloadtask" => {
                self.read_sdfdownloadtask(id).await
            }
            "guaranteed_order" => {
                self.read_guaranteed_order(id).await
            }
            "assigned_targeting_option" => {
                self.read_assigned_targeting_option(id).await
            }
            "inventory_source_group" => {
                self.read_inventory_source_group(id).await
            }
            "user" => {
            ...
            "targeting_option" => {
                self.read_targeting_option(id).await
            }
            "partner" => {
                self.read_partner(id).await
            }
            "location_list" => {
                self.read_location_list(id).await
            }
            "first_and_third_party_audience" => {
                self.read_first_and_third_party_audience(id).await
            }
            "manual_trigger" => {
                self.read_manual_trigger(id).await
            }
            "google_audience" => {
                self.read_google_audience(id).await
            }
            "custom_bidding_algorithm" => {
                self.read_custom_bidding_algorithm(id).await
            }
            "campaign" => {
            ...
            "custom_list" => {
                self.read_custom_list(id).await
            }
            "invoice" => {
                self.read_invoice(id).await
            }
            "floodlight_group" => {
                self.read_floodlight_group(id).await
            }
            "insertion_order" => {
                self.read_insertion_order(id).await
            }
            "asset" => {
            ...
            "negative_keyword" => {
                self.read_negative_keyword(id).await
            }
            "assigned_inventory_source" => {
                self.read_assigned_inventory_source(id).await
            }
            "advertiser" => {
                self.read_advertiser(id).await
            }
            "negative_keyword_list" => {
                self.read_negative_keyword_list(id).await
            }
            "script" => {
                self.read_script(id).await
            }
            "combined_audience" => {
                self.read_combined_audience(id).await
            }
            "inventory_source" => {
                self.read_inventory_source(id).await
            }
            "channel" => {
                self.read_channel(id).await
            }
            "assigned_location" => {
                self.read_assigned_location(id).await
            }
            "operation" => {
                self.read_operation(id).await
            }
            ...
            "youtube_ad_group" => {
                self.read_youtube_ad_group(id).await
            }
            "targeting_option" => {
                self.read_targeting_option(id).await
            }
            "youtube_ad_group_ad" => {
                self.read_youtube_ad_group_ad(id).await
            }
            "user" => {
                self.read_user(id).await
            }
            ...
            "floodlight_activitie" => {
                self.read_floodlight_activitie(id).await
            }
            "assigned_location" => {
                self.read_assigned_location(id).await
            }
            ...
            "youtube_asset_association" => {
                self.read_youtube_asset_association(id).await
            }
            "insertion_order" => {
                self.read_insertion_order(id).await
            }
            ...
            "ad_group_ad" => {
                self.read_ad_group_ad(id).await
            }
            "assigned_location" => {
                self.read_assigned_location(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "sdfdownloadtask" => {
                self.update_sdfdownloadtask(id, input).await
            }
            "guaranteed_order" => {
                self.update_guaranteed_order(id, input).await
            }
            "assigned_targeting_option" => {
                self.update_assigned_targeting_option(id, input).await
            }
            "inventory_source_group" => {
                self.update_inventory_source_group(id, input).await
            }
            "user" => {
            ...
            "targeting_option" => {
                self.update_targeting_option(id, input).await
            }
            "partner" => {
                self.update_partner(id, input).await
            }
            "location_list" => {
                self.update_location_list(id, input).await
            }
            "first_and_third_party_audience" => {
                self.update_first_and_third_party_audience(id, input).await
            }
            "manual_trigger" => {
                self.update_manual_trigger(id, input).await
            }
            "google_audience" => {
                self.update_google_audience(id, input).await
            }
            "custom_bidding_algorithm" => {
                self.update_custom_bidding_algorithm(id, input).await
            }
            "campaign" => {
            ...
            "custom_list" => {
                self.update_custom_list(id, input).await
            }
            "invoice" => {
                self.update_invoice(id, input).await
            }
            "floodlight_group" => {
                self.update_floodlight_group(id, input).await
            }
            "insertion_order" => {
                self.update_insertion_order(id, input).await
            }
            "asset" => {
            ...
            "negative_keyword" => {
                self.update_negative_keyword(id, input).await
            }
            "assigned_inventory_source" => {
                self.update_assigned_inventory_source(id, input).await
            }
            "advertiser" => {
                self.update_advertiser(id, input).await
            }
            "negative_keyword_list" => {
                self.update_negative_keyword_list(id, input).await
            }
            "script" => {
                self.update_script(id, input).await
            }
            "combined_audience" => {
                self.update_combined_audience(id, input).await
            }
            "inventory_source" => {
                self.update_inventory_source(id, input).await
            }
            "channel" => {
                self.update_channel(id, input).await
            }
            "assigned_location" => {
                self.update_assigned_location(id, input).await
            }
            "operation" => {
                self.update_operation(id, input).await
            }
            ...
            "youtube_ad_group" => {
                self.update_youtube_ad_group(id, input).await
            }
            "targeting_option" => {
                self.update_targeting_option(id, input).await
            }
            "youtube_ad_group_ad" => {
                self.update_youtube_ad_group_ad(id, input).await
            }
            "user" => {
                self.update_user(id, input).await
            }
            ...
            "floodlight_activitie" => {
                self.update_floodlight_activitie(id, input).await
            }
            "assigned_location" => {
                self.update_assigned_location(id, input).await
            }
            ...
            "youtube_asset_association" => {
                self.update_youtube_asset_association(id, input).await
            }
            "insertion_order" => {
                self.update_insertion_order(id, input).await
            }
            ...
            "first_party_and_partner_audience" => {
                self.update_first_party_and_partner_audience(id, input).await
            }
            "google_audience" => {
                self.update_google_audience(id, input).await
            }
            ...
            "ad_group" => {
                self.update_ad_group(id, input).await
            }
            "negative_keyword_list" => {
                self.update_negative_keyword_list(id, input).await
            }
            ...
            "ad_asset" => {
                self.update_ad_asset(id, input).await
            }
            "inventory_source_group" => {
                self.update_inventory_source_group(id, input).await
            }
            ...
            "ad_group_ad" => {
                self.update_ad_group_ad(id, input).await
            }
            "assigned_location" => {
                self.update_assigned_location(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "sdfdownloadtask" => {
                self.delete_sdfdownloadtask(id).await
            }
            "guaranteed_order" => {
                self.delete_guaranteed_order(id).await
            }
            "assigned_targeting_option" => {
                self.delete_assigned_targeting_option(id).await
            }
            "inventory_source_group" => {
                self.delete_inventory_source_group(id).await
            }
            "user" => {
            ...
            "targeting_option" => {
                self.delete_targeting_option(id).await
            }
            "partner" => {
                self.delete_partner(id).await
            }
            "location_list" => {
                self.delete_location_list(id).await
            }
            "first_and_third_party_audience" => {
                self.delete_first_and_third_party_audience(id).await
            }
            "manual_trigger" => {
                self.delete_manual_trigger(id).await
            }
            "google_audience" => {
                self.delete_google_audience(id).await
            }
            "custom_bidding_algorithm" => {
                self.delete_custom_bidding_algorithm(id).await
            }
            "campaign" => {
            ...
            "custom_list" => {
                self.delete_custom_list(id).await
            }
            "invoice" => {
                self.delete_invoice(id).await
            }
            "floodlight_group" => {
                self.delete_floodlight_group(id).await
            }
            "insertion_order" => {
                self.delete_insertion_order(id).await
            }
            "asset" => {
            ...
            "negative_keyword" => {
                self.delete_negative_keyword(id).await
            }
            "assigned_inventory_source" => {
                self.delete_assigned_inventory_source(id).await
            }
            "advertiser" => {
                self.delete_advertiser(id).await
            }
            "negative_keyword_list" => {
                self.delete_negative_keyword_list(id).await
            }
            "script" => {
                self.delete_script(id).await
            }
            "combined_audience" => {
                self.delete_combined_audience(id).await
            }
            "inventory_source" => {
                self.delete_inventory_source(id).await
            }
            "channel" => {
                self.delete_channel(id).await
            }
            "assigned_location" => {
                self.delete_assigned_location(id).await
            }
            "operation" => {
                self.delete_operation(id).await
            }
            ...
            "youtube_ad_group" => {
                self.delete_youtube_ad_group(id).await
            }
            "targeting_option" => {
                self.delete_targeting_option(id).await
            }
            "youtube_ad_group_ad" => {
                self.delete_youtube_ad_group_ad(id).await
            }
            "user" => {
                self.delete_user(id).await
            }
            ...
            "floodlight_activitie" => {
                self.delete_floodlight_activitie(id).await
            }
            "assigned_location" => {
                self.delete_assigned_location(id).await
            }
            ...
            "youtube_asset_association" => {
                self.delete_youtube_asset_association(id).await
            }
            "insertion_order" => {
                self.delete_insertion_order(id).await
            }
            ...
            "ad_group_ad" => {
                self.delete_ad_group_ad(id).await
            }
            "assigned_location" => {
                self.delete_assigned_location(id).await
            }
    ...
    async fn create_sdfdownloadtask(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_sdfdownloadtask(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_guaranteed_order(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_guaranteed_order(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_guaranteed_order(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_assigned_targeting_option(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_assigned_targeting_option(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_inventory_source_group(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_inventory_source_group(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_inventory_source_group(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_targeting_option(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_targeting_option(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_targeting_option(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_first_and_third_party_audience(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_first_and_third_party_audience(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_manual_trigger(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_manual_trigger(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_google_audience(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_google_audience(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_custom_bidding_algorithm(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_custom_bidding_algorithm(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_floodlight_group(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_floodlight_group(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_floodlight_group(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_insertion_order(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_insertion_order(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_negative_keyword(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_negative_keyword(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_assigned_inventory_source(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_assigned_inventory_source(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_negative_keyword_list(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_combined_audience(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_combined_audience(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_combined_audience(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_inventory_source(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_inventory_source(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_assigned_location(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_assigned_location(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_assigned_location(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_youtube_ad_group(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_youtube_ad_group(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_youtube_ad_group(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_youtube_ad_group_ad(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_youtube_ad_group_ad(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_youtube_ad_group_ad(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_floodlight_activitie(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_floodlight_activitie(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_floodlight_activitie(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_youtube_asset_association(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_youtube_asset_association(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_first_party_and_partner_audience(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_first_party_and_partner_audience(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
