...
impl<'a> Publicca_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "external_account_key" => {
                self.plan_external_account_key(current_state, desired_input).await
            }
            "external_account_key" => {
                self.plan_external_account_key(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "external_account_key" => {
                self.create_external_account_key(input).await
            }
            "external_account_key" => {
                self.create_external_account_key(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "external_account_key" => {
                self.read_external_account_key(id).await
            }
            "external_account_key" => {
                self.read_external_account_key(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "external_account_key" => {
                self.update_external_account_key(id, input).await
            }
            "external_account_key" => {
                self.update_external_account_key(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "external_account_key" => {
                self.delete_external_account_key(id).await
            }
            "external_account_key" => {
                self.delete_external_account_key(id).await
            }
    ...
    async fn read_external_account_key(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_external_account_key(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
