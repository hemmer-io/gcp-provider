...
impl<'a> Accessproposal<'a> {
    ...
    pub async fn create(&self, role: Option<Vec<String>>, view: Option<String>, action: Option<String>, send_notification: Option<bool>, proposal_id: String, file_id: String) -> Result<String> {
