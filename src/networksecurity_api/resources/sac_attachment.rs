...
impl<'a> Sac_attachment<'a> {
    ...
    pub async fn create(&self, ncc_gateway: Option<String>, country: Option<String>, state: Option<String>, name: Option<String>, sac_realm: Option<String>, update_time: Option<String>, labels: Option<HashMap<String, String>>, create_time: Option<String>, symantec_options: Option<String>, time_zone: Option<String>, parent: String) -> Result<String> {
