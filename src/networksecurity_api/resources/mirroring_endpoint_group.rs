...
impl<'a> Mirroring_endpoint_group<'a> {
    ...
    pub async fn create(&self, mirroring_deployment_group: Option<String>, associations: Option<Vec<String>>, reconciling: Option<bool>, state: Option<String>, type: Option<String>, update_time: Option<String>, connected_deployment_groups: Option<Vec<String>>, create_time: Option<String>, labels: Option<HashMap<String, String>>, name: Option<String>, description: Option<String>, parent: String) -> Result<String> {
