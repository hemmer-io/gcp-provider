...
impl<'a> Firewall_endpoint<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, description: Option<String>, associated_networks: Option<Vec<String>>, associations: Option<Vec<String>>, endpoint_settings: Option<String>, billing_project_id: Option<String>, labels: Option<HashMap<String, String>>, reconciling: Option<bool>, name: Option<String>, satisfies_pzi: Option<bool>, state: Option<String>, update_time: Option<String>, satisfies_pzs: Option<bool>, parent: String) -> Result<String> {
