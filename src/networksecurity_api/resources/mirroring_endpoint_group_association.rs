...
impl<'a> Mirroring_endpoint_group_association<'a> {
    ...
    pub async fn create(&self, reconciling: Option<bool>, locations: Option<Vec<String>>, create_time: Option<String>, network: Option<String>, mirroring_endpoint_group: Option<String>, labels: Option<HashMap<String, String>>, name: Option<String>, state: Option<String>, locations_details: Option<Vec<String>>, update_time: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, reconciling: Option<bool>, locations: Option<Vec<String>>, create_time: Option<String>, network: Option<String>, mirroring_endpoint_group: Option<String>, labels: Option<HashMap<String, String>>, name: Option<String>, state: Option<String>, locations_details: Option<Vec<String>>, update_time: Option<String>) -> Result<()> {
