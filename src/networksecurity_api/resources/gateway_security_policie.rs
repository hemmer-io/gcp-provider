...
impl<'a> Gateway_security_policie<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, description: Option<String>, name: Option<String>, tls_inspection_policy: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, create_time: Option<String>, description: Option<String>, name: Option<String>, tls_inspection_policy: Option<String>, update_time: Option<String>) -> Result<()> {
