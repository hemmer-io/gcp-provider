...
impl<'a> Reservation_grant<'a> {
    ...
    pub async fn create(&self, name: Option<String>, reservation: Option<String>, state: Option<String>, job_type: Option<String>, grantee: Option<String>, parent: String) -> Result<String> {
