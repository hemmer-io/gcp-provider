...
//!
//! Auto-generated service module for storagetransfer

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for storagetransfer
pub struct StoragetransferService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> StoragetransferService<'a> {
