...
impl<'a> Member<'a> {
    ...
    pub async fn create(&self, name: Option<String>, state: Option<String>, member: Option<String>, delete_time: Option<String>, create_time: Option<String>, group_member: Option<String>, role: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, state: Option<String>, member: Option<String>, delete_time: Option<String>, create_time: Option<String>, group_member: Option<String>, role: Option<String>) -> Result<()> {
