...
impl<'a> Custom_emoji<'a> {
    ...
    pub async fn create(&self, name: Option<String>, payload: Option<String>, emoji_name: Option<String>, temporary_image_uri: Option<String>, uid: Option<String>) -> Result<String> {
