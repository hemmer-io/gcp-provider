...
impl<'a> Space<'a> {
    ...
    pub async fn create(&self, space_history_state: Option<String>, type: Option<String>, import_mode_expire_time: Option<String>, admin_installed: Option<bool>, last_active_time: Option<String>, membership_count: Option<String>, permission_settings: Option<String>, space_details: Option<String>, space_type: Option<String>, predefined_permission_settings: Option<String>, threaded: Option<bool>, create_time: Option<String>, single_user_bot_dm: Option<bool>, display_name: Option<String>, space_threading_state: Option<String>, access_settings: Option<String>, space_uri: Option<String>, import_mode: Option<bool>, name: Option<String>, customer: Option<String>, external_user_allowed: Option<bool>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, space_history_state: Option<String>, type: Option<String>, import_mode_expire_time: Option<String>, admin_installed: Option<bool>, last_active_time: Option<String>, membership_count: Option<String>, permission_settings: Option<String>, space_details: Option<String>, space_type: Option<String>, predefined_permission_settings: Option<String>, threaded: Option<bool>, create_time: Option<String>, single_user_bot_dm: Option<bool>, display_name: Option<String>, space_threading_state: Option<String>, access_settings: Option<String>, space_uri: Option<String>, import_mode: Option<bool>, name: Option<String>, customer: Option<String>, external_user_allowed: Option<bool>) -> Result<()> {
