...
impl<'a> Message<'a> {
    ...
    pub async fn create(&self, formatted_text: Option<String>, thread: Option<String>, client_assigned_message_id: Option<String>, matched_url: Option<String>, attachment: Option<Vec<String>>, cards: Option<Vec<String>>, text: Option<String>, argument_text: Option<String>, thread_reply: Option<bool>, sender: Option<String>, deletion_metadata: Option<String>, attached_gifs: Option<Vec<String>>, last_update_time: Option<String>, annotations: Option<Vec<String>>, accessory_widgets: Option<Vec<String>>, emoji_reaction_summaries: Option<Vec<String>>, action_response: Option<String>, name: Option<String>, quoted_message_metadata: Option<String>, slash_command: Option<String>, delete_time: Option<String>, private_message_viewer: Option<String>, space: Option<String>, cards_v2: Option<Vec<String>>, create_time: Option<String>, fallback_text: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, formatted_text: Option<String>, thread: Option<String>, client_assigned_message_id: Option<String>, matched_url: Option<String>, attachment: Option<Vec<String>>, cards: Option<Vec<String>>, text: Option<String>, argument_text: Option<String>, thread_reply: Option<bool>, sender: Option<String>, deletion_metadata: Option<String>, attached_gifs: Option<Vec<String>>, last_update_time: Option<String>, annotations: Option<Vec<String>>, accessory_widgets: Option<Vec<String>>, emoji_reaction_summaries: Option<Vec<String>>, action_response: Option<String>, name: Option<String>, quoted_message_metadata: Option<String>, slash_command: Option<String>, delete_time: Option<String>, private_message_viewer: Option<String>, space: Option<String>, cards_v2: Option<Vec<String>>, create_time: Option<String>, fallback_text: Option<String>) -> Result<()> {
