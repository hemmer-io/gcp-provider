...
impl<'a> Message<'a> {
    ...
    pub async fn create(&self, last_update_time: Option<String>, quoted_message_metadata: Option<String>, space: Option<String>, formatted_text: Option<String>, annotations: Option<Vec<String>>, matched_url: Option<String>, name: Option<String>, sender: Option<String>, text: Option<String>, client_assigned_message_id: Option<String>, attachment: Option<Vec<String>>, delete_time: Option<String>, private_message_viewer: Option<String>, thread: Option<String>, thread_reply: Option<bool>, argument_text: Option<String>, action_response: Option<String>, deletion_metadata: Option<String>, fallback_text: Option<String>, emoji_reaction_summaries: Option<Vec<String>>, slash_command: Option<String>, accessory_widgets: Option<Vec<String>>, cards: Option<Vec<String>>, attached_gifs: Option<Vec<String>>, create_time: Option<String>, cards_v2: Option<Vec<String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, last_update_time: Option<String>, quoted_message_metadata: Option<String>, space: Option<String>, formatted_text: Option<String>, annotations: Option<Vec<String>>, matched_url: Option<String>, name: Option<String>, sender: Option<String>, text: Option<String>, client_assigned_message_id: Option<String>, attachment: Option<Vec<String>>, delete_time: Option<String>, private_message_viewer: Option<String>, thread: Option<String>, thread_reply: Option<bool>, argument_text: Option<String>, action_response: Option<String>, deletion_metadata: Option<String>, fallback_text: Option<String>, emoji_reaction_summaries: Option<Vec<String>>, slash_command: Option<String>, accessory_widgets: Option<Vec<String>>, cards: Option<Vec<String>>, attached_gifs: Option<Vec<String>>, create_time: Option<String>, cards_v2: Option<Vec<String>>) -> Result<()> {
