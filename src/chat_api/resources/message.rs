...
impl<'a> Message<'a> {
    ...
    pub async fn create(&self, cards_v2: Option<Vec<String>>, delete_time: Option<String>, emoji_reaction_summaries: Option<Vec<String>>, last_update_time: Option<String>, thread_reply: Option<bool>, cards: Option<Vec<String>>, accessory_widgets: Option<Vec<String>>, attachment: Option<Vec<String>>, deletion_metadata: Option<String>, sender: Option<String>, slash_command: Option<String>, name: Option<String>, action_response: Option<String>, space: Option<String>, text: Option<String>, thread: Option<String>, client_assigned_message_id: Option<String>, create_time: Option<String>, annotations: Option<Vec<String>>, formatted_text: Option<String>, private_message_viewer: Option<String>, argument_text: Option<String>, attached_gifs: Option<Vec<String>>, fallback_text: Option<String>, matched_url: Option<String>, quoted_message_metadata: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, cards_v2: Option<Vec<String>>, delete_time: Option<String>, emoji_reaction_summaries: Option<Vec<String>>, last_update_time: Option<String>, thread_reply: Option<bool>, cards: Option<Vec<String>>, accessory_widgets: Option<Vec<String>>, attachment: Option<Vec<String>>, deletion_metadata: Option<String>, sender: Option<String>, slash_command: Option<String>, name: Option<String>, action_response: Option<String>, space: Option<String>, text: Option<String>, thread: Option<String>, client_assigned_message_id: Option<String>, create_time: Option<String>, annotations: Option<Vec<String>>, formatted_text: Option<String>, private_message_viewer: Option<String>, argument_text: Option<String>, attached_gifs: Option<Vec<String>>, fallback_text: Option<String>, matched_url: Option<String>, quoted_message_metadata: Option<String>) -> Result<()> {
