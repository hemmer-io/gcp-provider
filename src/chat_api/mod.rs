...
impl<'a> Chat_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "reaction" => {
                self.plan_reaction(current_state, desired_input).await
            }
            "member" => {
            ...
            "space_notification_setting" => {
                self.plan_space_notification_setting(current_state, desired_input).await
            }
            "thread" => {
            ...
            "custom_emoji" => {
                self.plan_custom_emoji(current_state, desired_input).await
            }
            "space_event" => {
                self.plan_space_event(current_state, desired_input).await
            }
            "media" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "reaction" => {
                self.create_reaction(input).await
            }
            "member" => {
            ...
            "space_notification_setting" => {
                self.create_space_notification_setting(input).await
            }
            "thread" => {
            ...
            "custom_emoji" => {
                self.create_custom_emoji(input).await
            }
            "space_event" => {
                self.create_space_event(input).await
            }
            "media" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "space_notification_setting" => {
                self.read_space_notification_setting(id).await
            }
            "thread" => {
            ...
            "custom_emoji" => {
                self.read_custom_emoji(id).await
            }
            "space_event" => {
                self.read_space_event(id).await
            }
            "media" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "reaction" => {
                self.update_reaction(id, input).await
            }
            "member" => {
            ...
            "space_notification_setting" => {
                self.update_space_notification_setting(id, input).await
            }
            "thread" => {
            ...
            "custom_emoji" => {
                self.update_custom_emoji(id, input).await
            }
            "space_event" => {
                self.update_space_event(id, input).await
            }
            "media" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "space_notification_setting" => {
                self.delete_space_notification_setting(id).await
            }
            "thread" => {
            ...
            "custom_emoji" => {
                self.delete_custom_emoji(id).await
            }
            "space_event" => {
                self.delete_space_event(id).await
            }
            "media" => {
    ...
    async fn read_space_notification_setting(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_space_notification_setting(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
