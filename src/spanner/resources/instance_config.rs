...
impl<'a> Instance_config<'a> {
    ...
    pub async fn create(&self, instance_config_id: Option<String>, validate_only: Option<bool>, instance_config: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, instance_config_id: Option<String>, validate_only: Option<bool>, instance_config: Option<String>) -> Result<()> {
