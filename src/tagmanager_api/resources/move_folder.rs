...
impl<'a> Move_folder<'a> {
    ...
    pub async fn update(&self, id: &str, account_id: Option<String>, folder_id: Option<String>, container_id: Option<String>, fingerprint: Option<String>, name: Option<String>) -> Result<()> {
