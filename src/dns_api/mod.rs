...
impl<'a> Dns_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "response_policy_rule" => {
                self.plan_response_policy_rule(current_state, desired_input).await
            }
            "managed_zone_operation" => {
                self.plan_managed_zone_operation(current_state, desired_input).await
            }
            "policie" => {
                self.plan_policie(current_state, desired_input).await
            }
            "response_policie" => {
                self.plan_response_policie(current_state, desired_input).await
            }
            "resource_record_set" => {
                self.plan_resource_record_set(current_state, desired_input).await
            }
            "managed_zone" => {
                self.plan_managed_zone(current_state, desired_input).await
            }
            "dns_key" => {
                self.plan_dns_key(current_state, desired_input).await
            }
            "managed_zone_operation" => {
                self.plan_managed_zone_operation(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "response_policy_rule" => {
                self.create_response_policy_rule(input).await
            }
            "managed_zone_operation" => {
                self.create_managed_zone_operation(input).await
            }
            "policie" => {
                self.create_policie(input).await
            }
            "response_policie" => {
                self.create_response_policie(input).await
            }
            "resource_record_set" => {
                self.create_resource_record_set(input).await
            }
            "managed_zone" => {
                self.create_managed_zone(input).await
            }
            "dns_key" => {
                self.create_dns_key(input).await
            }
            "managed_zone_operation" => {
                self.create_managed_zone_operation(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "response_policy_rule" => {
                self.read_response_policy_rule(id).await
            }
            "managed_zone_operation" => {
                self.read_managed_zone_operation(id).await
            }
            "policie" => {
                self.read_policie(id).await
            }
            "response_policie" => {
                self.read_response_policie(id).await
            }
            "resource_record_set" => {
                self.read_resource_record_set(id).await
            }
            "managed_zone" => {
                self.read_managed_zone(id).await
            }
            "dns_key" => {
                self.read_dns_key(id).await
            }
            "managed_zone_operation" => {
                self.read_managed_zone_operation(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "response_policy_rule" => {
                self.update_response_policy_rule(id, input).await
            }
            "managed_zone_operation" => {
                self.update_managed_zone_operation(id, input).await
            }
            "policie" => {
                self.update_policie(id, input).await
            }
            "response_policie" => {
                self.update_response_policie(id, input).await
            }
            "resource_record_set" => {
                self.update_resource_record_set(id, input).await
            }
            "managed_zone" => {
                self.update_managed_zone(id, input).await
            }
            "dns_key" => {
                self.update_dns_key(id, input).await
            }
            "managed_zone_operation" => {
                self.update_managed_zone_operation(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "response_policy_rule" => {
                self.delete_response_policy_rule(id).await
            }
            "managed_zone_operation" => {
                self.delete_managed_zone_operation(id).await
            }
            "policie" => {
                self.delete_policie(id).await
            }
            "response_policie" => {
                self.delete_response_policie(id).await
            }
            "resource_record_set" => {
                self.delete_resource_record_set(id).await
            }
            "managed_zone" => {
                self.delete_managed_zone(id).await
            }
            "dns_key" => {
                self.delete_dns_key(id).await
            }
            "managed_zone_operation" => {
                self.delete_managed_zone_operation(id).await
            }
    ...
    async fn create_response_policy_rule(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_response_policy_rule(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_response_policy_rule(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_managed_zone_operation(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_managed_zone_operation(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_managed_zone_operation(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_response_policie(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_response_policie(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_response_policie(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_resource_record_set(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_resource_record_set(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_resource_record_set(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
