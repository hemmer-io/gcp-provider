...
impl<'a> Connection_profile<'a> {
    ...
    pub async fn create(&self, update_time: Option<String>, create_time: Option<String>, name: Option<String>, gcs_profile: Option<String>, display_name: Option<String>, forward_ssh_connectivity: Option<String>, labels: Option<HashMap<String, String>>, mysql_profile: Option<String>, no_connectivity: Option<String>, private_connectivity: Option<String>, oracle_profile: Option<String>, static_service_ip_connectivity: Option<String>, parent: String) -> Result<String> {
