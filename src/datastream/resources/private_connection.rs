...
impl<'a> Private_connection<'a> {
    ...
    pub async fn create(&self, state: Option<String>, labels: Option<HashMap<String, String>>, create_time: Option<String>, vpc_peering_config: Option<String>, name: Option<String>, display_name: Option<String>, error: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
