...
impl<'a> Translate_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "detection" => self.plan_detection(current_state, desired_input).await,
            "language" => self.plan_language(current_state, desired_input).await,
            "translation" => self.plan_translation(current_state, desired_input).await,
            "model" => self.plan_model(current_state, desired_input).await,
            "project" => self.plan_project(current_state, desired_input).await,
            "glossarie" => self.plan_glossarie(current_state, desired_input).await,
            "glossary_entrie" => {
                self.plan_glossary_entrie(current_state, desired_input)
                    .await
            }
            "location" => self.plan_location(current_state, desired_input).await,
            "operation" => self.plan_operation(current_state, desired_input).await,
            ...
            "adaptive_mt_dataset" => {
                self.plan_adaptive_mt_dataset(current_state, desired_input)
                    .await
            }
            "adaptive_mt_file" => {
                self.plan_adaptive_mt_file(current_state, desired_input)
                    .await
            }
            "adaptive_mt_sentence" => {
                self.plan_adaptive_mt_sentence(current_state, desired_input)
                    .await
            }
            "dataset" => self.plan_dataset(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "translate_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "detection" => self.create_detection(input).await,
            "language" => self.create_language(input).await,
            "translation" => self.create_translation(input).await,
            "model" => self.create_model(input).await,
            "project" => self.create_project(input).await,
            "glossarie" => self.create_glossarie(input).await,
            "glossary_entrie" => self.create_glossary_entrie(input).await,
            "location" => self.create_location(input).await,
            "operation" => self.create_operation(input).await,
            "example" => self.create_example(input).await,
            "adaptive_mt_dataset" => self.create_adaptive_mt_dataset(input).await,
            "adaptive_mt_file" => self.create_adaptive_mt_file(input).await,
            "adaptive_mt_sentence" => self.create_adaptive_mt_sentence(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "detection" => self.read_detection(id).await,
            "language" => self.read_language(id).await,
            "translation" => self.read_translation(id).await,
            "model" => self.read_model(id).await,
            "project" => self.read_project(id).await,
            "glossarie" => self.read_glossarie(id).await,
            "glossary_entrie" => self.read_glossary_entrie(id).await,
            "location" => self.read_location(id).await,
            "operation" => self.read_operation(id).await,
            "example" => self.read_example(id).await,
            "adaptive_mt_dataset" => self.read_adaptive_mt_dataset(id).await,
            "adaptive_mt_file" => self.read_adaptive_mt_file(id).await,
            "adaptive_mt_sentence" => self.read_adaptive_mt_sentence(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "detection" => self.update_detection(id, input).await,
            "language" => self.update_language(id, input).await,
            "translation" => self.update_translation(id, input).await,
            "model" => self.update_model(id, input).await,
            "project" => self.update_project(id, input).await,
            "glossarie" => self.update_glossarie(id, input).await,
            "glossary_entrie" => self.update_glossary_entrie(id, input).await,
            "location" => self.update_location(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "example" => self.update_example(id, input).await,
            "adaptive_mt_dataset" => self.update_adaptive_mt_dataset(id, input).await,
            "adaptive_mt_file" => self.update_adaptive_mt_file(id, input).await,
            "adaptive_mt_sentence" => self.update_adaptive_mt_sentence(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "detection" => self.delete_detection(id).await,
            "language" => self.delete_language(id).await,
            "translation" => self.delete_translation(id).await,
            "model" => self.delete_model(id).await,
            "project" => self.delete_project(id).await,
            "glossarie" => self.delete_glossarie(id).await,
            "glossary_entrie" => self.delete_glossary_entrie(id).await,
            "location" => self.delete_location(id).await,
            "operation" => self.delete_operation(id).await,
            "example" => self.delete_example(id).await,
            "adaptive_mt_dataset" => self.delete_adaptive_mt_dataset(id).await,
            "adaptive_mt_file" => self.delete_adaptive_mt_file(id).await,
            "adaptive_mt_sentence" => self.delete_adaptive_mt_sentence(id).await,
    ...
    async fn create_detection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a detection resource
    async fn read_detection(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a detection resource
    async fn update_detection(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a detection resource
    async fn delete_detection(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_language(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a language resource
    async fn read_language(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a language resource
    async fn update_language(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a language resource
    async fn delete_language(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_translation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a translation resource
    async fn read_translation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a translation resource
    async fn update_translation(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a translation resource
    async fn delete_translation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_glossary_entrie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a glossary_entrie resource
    async fn read_glossary_entrie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_glossary_entrie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_adaptive_mt_dataset(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a adaptive_mt_dataset resource
    async fn read_adaptive_mt_dataset(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_adaptive_mt_dataset(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_adaptive_mt_file(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a adaptive_mt_file resource
    async fn read_adaptive_mt_file(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_adaptive_mt_file(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_adaptive_mt_sentence(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a adaptive_mt_sentence resource
    async fn read_adaptive_mt_sentence(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_adaptive_mt_sentence(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
