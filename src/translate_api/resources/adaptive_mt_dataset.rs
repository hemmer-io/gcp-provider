...
impl<'a> Adaptive_mt_dataset<'a> {
    ...
    pub async fn create(&self, name: Option<String>, update_time: Option<String>, source_language_code: Option<String>, target_language_code: Option<String>, create_time: Option<String>, example_count: Option<i64>, display_name: Option<String>, parent: String) -> Result<String> {
