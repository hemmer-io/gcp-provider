...
impl<'a> Scan<'a> {
    ...
    pub async fn create(&self, local_scan_path: Option<String>, scm_metadata: Option<String>, cli_version: Option<String>, cli_analysis: Option<String>, parent: String) -> Result<String> {
