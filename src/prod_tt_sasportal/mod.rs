//! Prod_tt_sasportal Service
//!
//! Auto-generated service module for prod_tt_sasportal

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for prod_tt_sasportal
pub struct Prod_tt_sasportalService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> Prod_tt_sasportalService<'a> {
