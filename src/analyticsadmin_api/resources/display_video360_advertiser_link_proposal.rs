...
impl<'a> Display_video360_advertiser_link_proposal<'a> {
    ...
    pub async fn create(&self, cost_data_sharing_enabled: Option<bool>, validation_email: Option<String>, ads_personalization_enabled: Option<bool>, name: Option<String>, link_proposal_status_details: Option<String>, advertiser_id: Option<String>, advertiser_display_name: Option<String>, campaign_data_sharing_enabled: Option<bool>, parent: String) -> Result<String> {
