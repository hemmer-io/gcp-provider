...
impl<'a> Sk_ad_network_conversion_value_schema<'a> {
    ...
    pub async fn create(&self, name: Option<String>, postback_window_three: Option<String>, postback_window_two: Option<String>, postback_window_one: Option<String>, apply_conversion_values: Option<bool>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, postback_window_three: Option<String>, postback_window_two: Option<String>, postback_window_one: Option<String>, apply_conversion_values: Option<bool>) -> Result<()> {
