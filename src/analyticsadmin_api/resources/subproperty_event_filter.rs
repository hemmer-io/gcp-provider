...
impl<'a> Subproperty_event_filter<'a> {
    ...
    pub async fn create(&self, filter_clauses: Option<Vec<String>>, apply_to_property: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, filter_clauses: Option<Vec<String>>, apply_to_property: Option<String>, name: Option<String>) -> Result<()> {
