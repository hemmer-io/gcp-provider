...
impl<'a> Subproperty_event_filter<'a> {
    ...
    pub async fn create(&self, name: Option<String>, apply_to_property: Option<String>, filter_clauses: Option<Vec<String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, apply_to_property: Option<String>, filter_clauses: Option<Vec<String>>) -> Result<()> {
