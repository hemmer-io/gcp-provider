...
impl<'a> Access_binding<'a> {
    ...
    pub async fn create(&self, name: Option<String>, roles: Option<Vec<String>>, user: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, roles: Option<Vec<String>>, user: Option<String>) -> Result<()> {
