...
impl<'a> Analyticsadmin_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "reporting_data_annotation" => {
                self.plan_reporting_data_annotation(current_state, desired_input).await
            }
            "measurement_protocol_secret" => {
                self.plan_measurement_protocol_secret(current_state, desired_input).await
            }
            "audience" => {
            ...
            "subproperty_sync_config" => {
                self.plan_subproperty_sync_config(current_state, desired_input).await
            }
            "search_ads360_link" => {
                self.plan_search_ads360_link(current_state, desired_input).await
            }
            "display_video360_advertiser_link_proposal" => {
                self.plan_display_video360_advertiser_link_proposal(current_state, desired_input).await
            }
            "account" => {
                self.plan_account(current_state, desired_input).await
            }
            "calculated_metric" => {
                self.plan_calculated_metric(current_state, desired_input).await
            }
            "access_binding" => {
                self.plan_access_binding(current_state, desired_input).await
            }
            "ad_sense_link" => {
                self.plan_ad_sense_link(current_state, desired_input).await
            }
            "subproperty_event_filter" => {
                self.plan_subproperty_event_filter(current_state, desired_input).await
            }
            "display_video360_advertiser_link" => {
                self.plan_display_video360_advertiser_link(current_state, desired_input).await
            }
            "custom_dimension" => {
                self.plan_custom_dimension(current_state, desired_input).await
            }
            "rollup_property_source_link" => {
                self.plan_rollup_property_source_link(current_state, desired_input).await
            }
            "channel_group" => {
                self.plan_channel_group(current_state, desired_input).await
            }
            "expanded_data_set" => {
                self.plan_expanded_data_set(current_state, desired_input).await
            }
            "key_event" => {
                self.plan_key_event(current_state, desired_input).await
            }
            "custom_metric" => {
                self.plan_custom_metric(current_state, desired_input).await
            }
            "event_edit_rule" => {
                self.plan_event_edit_rule(current_state, desired_input).await
            }
            "event_create_rule" => {
                self.plan_event_create_rule(current_state, desired_input).await
            }
            "sk_ad_network_conversion_value_schema" => {
                self.plan_sk_ad_network_conversion_value_schema(current_state, desired_input).await
            }
            "big_query_link" => {
                self.plan_big_query_link(current_state, desired_input).await
            }
            "google_ads_link" => {
                self.plan_google_ads_link(current_state, desired_input).await
            }
            "account_summarie" => {
                self.plan_account_summarie(current_state, desired_input).await
            }
            "firebase_link" => {
                self.plan_firebase_link(current_state, desired_input).await
            }
            "conversion_event" => {
                self.plan_conversion_event(current_state, desired_input).await
            }
            "data_stream" => {
                self.plan_data_stream(current_state, desired_input).await
            }
            "measurement_protocol_secret" => {
                self.plan_measurement_protocol_secret(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "reporting_data_annotation" => {
                self.create_reporting_data_annotation(input).await
            }
            "measurement_protocol_secret" => {
                self.create_measurement_protocol_secret(input).await
            }
            "audience" => {
            ...
            "subproperty_sync_config" => {
                self.create_subproperty_sync_config(input).await
            }
            "search_ads360_link" => {
                self.create_search_ads360_link(input).await
            }
            "display_video360_advertiser_link_proposal" => {
                self.create_display_video360_advertiser_link_proposal(input).await
            }
            "account" => {
                self.create_account(input).await
            }
            "calculated_metric" => {
                self.create_calculated_metric(input).await
            }
            "access_binding" => {
                self.create_access_binding(input).await
            }
            "ad_sense_link" => {
                self.create_ad_sense_link(input).await
            }
            "subproperty_event_filter" => {
                self.create_subproperty_event_filter(input).await
            }
            "display_video360_advertiser_link" => {
            ...
            "rollup_property_source_link" => {
                self.create_rollup_property_source_link(input).await
            }
            "channel_group" => {
                self.create_channel_group(input).await
            }
            "expanded_data_set" => {
                self.create_expanded_data_set(input).await
            }
            "key_event" => {
                self.create_key_event(input).await
            }
            "custom_metric" => {
                self.create_custom_metric(input).await
            }
            "event_edit_rule" => {
                self.create_event_edit_rule(input).await
            }
            "event_create_rule" => {
                self.create_event_create_rule(input).await
            }
            "sk_ad_network_conversion_value_schema" => {
                self.create_sk_ad_network_conversion_value_schema(input).await
            }
            "big_query_link" => {
                self.create_big_query_link(input).await
            }
            "google_ads_link" => {
                self.create_google_ads_link(input).await
            }
            "account_summarie" => {
                self.create_account_summarie(input).await
            }
            "firebase_link" => {
                self.create_firebase_link(input).await
            }
            "conversion_event" => {
                self.create_conversion_event(input).await
            }
            "data_stream" => {
                self.create_data_stream(input).await
            }
            "measurement_protocol_secret" => {
                self.create_measurement_protocol_secret(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "reporting_data_annotation" => {
                self.read_reporting_data_annotation(id).await
            }
            "measurement_protocol_secret" => {
                self.read_measurement_protocol_secret(id).await
            }
            "audience" => {
            ...
            "subproperty_sync_config" => {
                self.read_subproperty_sync_config(id).await
            }
            "search_ads360_link" => {
                self.read_search_ads360_link(id).await
            }
            "display_video360_advertiser_link_proposal" => {
                self.read_display_video360_advertiser_link_proposal(id).await
            }
            "account" => {
                self.read_account(id).await
            }
            "calculated_metric" => {
                self.read_calculated_metric(id).await
            }
            "access_binding" => {
                self.read_access_binding(id).await
            }
            "ad_sense_link" => {
                self.read_ad_sense_link(id).await
            }
            "subproperty_event_filter" => {
                self.read_subproperty_event_filter(id).await
            }
            "display_video360_advertiser_link" => {
            ...
            "rollup_property_source_link" => {
                self.read_rollup_property_source_link(id).await
            }
            "channel_group" => {
                self.read_channel_group(id).await
            }
            "expanded_data_set" => {
                self.read_expanded_data_set(id).await
            }
            "key_event" => {
                self.read_key_event(id).await
            }
            "custom_metric" => {
                self.read_custom_metric(id).await
            }
            "event_edit_rule" => {
                self.read_event_edit_rule(id).await
            }
            "event_create_rule" => {
                self.read_event_create_rule(id).await
            }
            "sk_ad_network_conversion_value_schema" => {
                self.read_sk_ad_network_conversion_value_schema(id).await
            }
            "big_query_link" => {
                self.read_big_query_link(id).await
            }
            "google_ads_link" => {
                self.read_google_ads_link(id).await
            }
            "account_summarie" => {
                self.read_account_summarie(id).await
            }
            "firebase_link" => {
                self.read_firebase_link(id).await
            }
            "conversion_event" => {
                self.read_conversion_event(id).await
            }
            "data_stream" => {
                self.read_data_stream(id).await
            }
            "measurement_protocol_secret" => {
                self.read_measurement_protocol_secret(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "reporting_data_annotation" => {
                self.update_reporting_data_annotation(id, input).await
            }
            "measurement_protocol_secret" => {
            ...
            "subproperty_sync_config" => {
                self.update_subproperty_sync_config(id, input).await
            }
            "search_ads360_link" => {
                self.update_search_ads360_link(id, input).await
            }
            "display_video360_advertiser_link_proposal" => {
                self.update_display_video360_advertiser_link_proposal(id, input).await
            }
            "account" => {
                self.update_account(id, input).await
            }
            "calculated_metric" => {
                self.update_calculated_metric(id, input).await
            }
            "access_binding" => {
                self.update_access_binding(id, input).await
            }
            "ad_sense_link" => {
                self.update_ad_sense_link(id, input).await
            }
            "subproperty_event_filter" => {
                self.update_subproperty_event_filter(id, input).await
            }
            "display_video360_advertiser_link" => {
                self.update_display_video360_advertiser_link(id, input).await
            }
            "custom_dimension" => {
            ...
            "channel_group" => {
                self.update_channel_group(id, input).await
            }
            "expanded_data_set" => {
                self.update_expanded_data_set(id, input).await
            }
            "key_event" => {
                self.update_key_event(id, input).await
            }
            "custom_metric" => {
                self.update_custom_metric(id, input).await
            }
            "event_edit_rule" => {
                self.update_event_edit_rule(id, input).await
            }
            "event_create_rule" => {
                self.update_event_create_rule(id, input).await
            }
            "sk_ad_network_conversion_value_schema" => {
                self.update_sk_ad_network_conversion_value_schema(id, input).await
            }
            "big_query_link" => {
                self.update_big_query_link(id, input).await
            }
            "google_ads_link" => {
                self.update_google_ads_link(id, input).await
            }
            "account_summarie" => {
                self.update_account_summarie(id, input).await
            }
            "firebase_link" => {
                self.update_firebase_link(id, input).await
            }
            "conversion_event" => {
                self.update_conversion_event(id, input).await
            }
            "data_stream" => {
                self.update_data_stream(id, input).await
            }
            "measurement_protocol_secret" => {
                self.update_measurement_protocol_secret(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "reporting_data_annotation" => {
                self.delete_reporting_data_annotation(id).await
            }
            "measurement_protocol_secret" => {
                self.delete_measurement_protocol_secret(id).await
            }
            "audience" => {
            ...
            "subproperty_sync_config" => {
                self.delete_subproperty_sync_config(id).await
            }
            "search_ads360_link" => {
                self.delete_search_ads360_link(id).await
            }
            "display_video360_advertiser_link_proposal" => {
                self.delete_display_video360_advertiser_link_proposal(id).await
            }
            "account" => {
                self.delete_account(id).await
            }
            "calculated_metric" => {
                self.delete_calculated_metric(id).await
            }
            "access_binding" => {
                self.delete_access_binding(id).await
            }
            "ad_sense_link" => {
                self.delete_ad_sense_link(id).await
            }
            "subproperty_event_filter" => {
                self.delete_subproperty_event_filter(id).await
            }
            "display_video360_advertiser_link" => {
            ...
            "rollup_property_source_link" => {
                self.delete_rollup_property_source_link(id).await
            }
            "channel_group" => {
                self.delete_channel_group(id).await
            }
            "expanded_data_set" => {
                self.delete_expanded_data_set(id).await
            }
            "key_event" => {
                self.delete_key_event(id).await
            }
            "custom_metric" => {
                self.delete_custom_metric(id).await
            }
            "event_edit_rule" => {
                self.delete_event_edit_rule(id).await
            }
            "event_create_rule" => {
                self.delete_event_create_rule(id).await
            }
            "sk_ad_network_conversion_value_schema" => {
                self.delete_sk_ad_network_conversion_value_schema(id).await
            }
            "big_query_link" => {
                self.delete_big_query_link(id).await
            }
            "google_ads_link" => {
                self.delete_google_ads_link(id).await
            }
            "account_summarie" => {
                self.delete_account_summarie(id).await
            }
            "firebase_link" => {
                self.delete_firebase_link(id).await
            }
            "conversion_event" => {
                self.delete_conversion_event(id).await
            }
            "data_stream" => {
                self.delete_data_stream(id).await
            }
            "measurement_protocol_secret" => {
                self.delete_measurement_protocol_secret(id).await
            }
    ...
    async fn read_reporting_data_annotation(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_reporting_data_annotation(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_measurement_protocol_secret(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_subproperty_sync_config(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_subproperty_sync_config(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_subproperty_sync_config(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_search_ads360_link(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_calculated_metric(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_subproperty_event_filter(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_display_video360_advertiser_link(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_rollup_property_source_link(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_expanded_data_set(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_event_create_rule(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_sk_ad_network_conversion_value_schema(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_conversion_event(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
