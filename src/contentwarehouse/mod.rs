//! Contentwarehouse Service
//!
//! Auto-generated service module for contentwarehouse

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for contentwarehouse
pub struct ContentwarehouseService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> ContentwarehouseService<'a> {
