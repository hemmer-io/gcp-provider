...
impl<'a> Synonym_set<'a> {
    ...
    pub async fn create(&self, context: Option<String>, name: Option<String>, synonyms: Option<Vec<String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, context: Option<String>, name: Option<String>, synonyms: Option<Vec<String>>) -> Result<()> {
