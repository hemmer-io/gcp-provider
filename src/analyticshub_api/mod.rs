...
impl<'a> Analyticshub_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "query_template" => {
                self.plan_query_template(current_state, desired_input).await
            }
            "data_exchange" => {
                self.plan_data_exchange(current_state, desired_input).await
            }
            "listing" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "query_template" => {
                self.create_query_template(input).await
            }
            "data_exchange" => {
                self.create_data_exchange(input).await
            }
            "listing" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "query_template" => {
                self.read_query_template(id).await
            }
            "data_exchange" => {
                self.read_data_exchange(id).await
            }
            "listing" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "query_template" => {
                self.update_query_template(id, input).await
            }
            "data_exchange" => {
                self.update_data_exchange(id, input).await
            }
            "listing" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "query_template" => {
                self.delete_query_template(id).await
            }
            "data_exchange" => {
                self.delete_data_exchange(id).await
            }
            "listing" => {
