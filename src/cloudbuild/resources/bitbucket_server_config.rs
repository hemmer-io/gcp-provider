...
impl<'a> Bitbucket_server_config<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, peered_network_ip_range: Option<String>, ssl_ca: Option<String>, webhook_key: Option<String>, api_key: Option<String>, username: Option<String>, name: Option<String>, secrets: Option<String>, connected_repositories: Option<Vec<String>>, host_uri: Option<String>, peered_network: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, create_time: Option<String>, peered_network_ip_range: Option<String>, ssl_ca: Option<String>, webhook_key: Option<String>, api_key: Option<String>, username: Option<String>, name: Option<String>, secrets: Option<String>, connected_repositories: Option<Vec<String>>, host_uri: Option<String>, peered_network: Option<String>) -> Result<()> {
