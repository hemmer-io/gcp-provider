...
impl<'a> Managed_short_link<'a> {
    ...
    pub async fn create(&self, sdk_version: Option<String>, suffix: Option<String>, name: Option<String>, dynamic_link_info: Option<String>, long_dynamic_link: Option<String>) -> Result<String> {
