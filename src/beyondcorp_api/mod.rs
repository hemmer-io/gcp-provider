...
impl<'a> Beyondcorp_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "security_gateway" => {
                self.plan_security_gateway(current_state, desired_input).await
            }
            "app_connector" => {
                self.plan_app_connector(current_state, desired_input).await
            }
            "app_gateway" => {
                self.plan_app_gateway(current_state, desired_input).await
            }
            "application" => {
            ...
            "app_connection" => {
                self.plan_app_connection(current_state, desired_input).await
            }
            "connector" => {
            ...
            "partner_tenant" => {
                self.plan_partner_tenant(current_state, desired_input).await
            }
            "subscription" => {
            ...
            "application_domain" => {
                self.plan_application_domain(current_state, desired_input).await
            }
            "security_gateway" => {
                self.plan_security_gateway(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "security_gateway" => {
                self.create_security_gateway(input).await
            }
            "app_connector" => {
                self.create_app_connector(input).await
            }
            "app_gateway" => {
                self.create_app_gateway(input).await
            }
            "application" => {
            ...
            "app_connection" => {
                self.create_app_connection(input).await
            }
            "connector" => {
            ...
            "partner_tenant" => {
                self.create_partner_tenant(input).await
            }
            "subscription" => {
            ...
            "application_domain" => {
                self.create_application_domain(input).await
            }
            "security_gateway" => {
                self.create_security_gateway(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "security_gateway" => {
                self.read_security_gateway(id).await
            }
            "app_connector" => {
                self.read_app_connector(id).await
            }
            "app_gateway" => {
                self.read_app_gateway(id).await
            }
            "application" => {
            ...
            "app_connection" => {
                self.read_app_connection(id).await
            }
            "connector" => {
            ...
            "partner_tenant" => {
                self.read_partner_tenant(id).await
            }
            "subscription" => {
            ...
            "application_domain" => {
                self.read_application_domain(id).await
            }
            "security_gateway" => {
                self.read_security_gateway(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "security_gateway" => {
                self.update_security_gateway(id, input).await
            }
            "app_connector" => {
                self.update_app_connector(id, input).await
            }
            "app_gateway" => {
                self.update_app_gateway(id, input).await
            }
            "application" => {
            ...
            "app_connection" => {
                self.update_app_connection(id, input).await
            }
            "connector" => {
            ...
            "partner_tenant" => {
                self.update_partner_tenant(id, input).await
            }
            "subscription" => {
            ...
            "application_domain" => {
                self.update_application_domain(id, input).await
            }
            "security_gateway" => {
                self.update_security_gateway(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "security_gateway" => {
                self.delete_security_gateway(id).await
            }
            "app_connector" => {
                self.delete_app_connector(id).await
            }
            "app_gateway" => {
                self.delete_app_gateway(id).await
            }
            "application" => {
            ...
            "app_connection" => {
                self.delete_app_connection(id).await
            }
            "connector" => {
            ...
            "partner_tenant" => {
                self.delete_partner_tenant(id).await
            }
            "subscription" => {
            ...
            "application_domain" => {
                self.delete_application_domain(id).await
            }
            "security_gateway" => {
                self.delete_security_gateway(id).await
            }
    ...
    async fn create_security_gateway(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn read_security_gateway(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_security_gateway(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_partner_tenant(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_partner_tenant(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_application_domain(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
