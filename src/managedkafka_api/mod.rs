...
impl<'a> Managedkafka_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "connect_cluster" => {
                self.plan_connect_cluster(current_state, desired_input)
                    .await
            }
            "config" => self.plan_config(current_state, desired_input).await,
            "consumer_group" => self.plan_consumer_group(current_state, desired_input).await,
            ...
            "schema_registrie" => {
                self.plan_schema_registrie(current_state, desired_input)
                    .await
            }
            "type_" => self.plan_type_(current_state, desired_input).await,
            "compatibility" => self.plan_compatibility(current_state, desired_input).await,
            "referencedby" => self.plan_referencedby(current_state, desired_input).await,
            ...
            "mode" => self.plan_mode(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "managedkafka_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "connect_cluster" => self.create_connect_cluster(input).await,
            "config" => self.create_config(input).await,
            "consumer_group" => self.create_consumer_group(input).await,
            "location" => self.create_location(input).await,
            "version" => self.create_version(input).await,
            "subject" => self.create_subject(input).await,
            "schema_registrie" => self.create_schema_registrie(input).await,
            "type_" => self.create_type_(input).await,
            "compatibility" => self.create_compatibility(input).await,
            "referencedby" => self.create_referencedby(input).await,
            ...
            "mode" => self.create_mode(input).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "connect_cluster" => self.update_connect_cluster(id, input).await,
            "config" => self.update_config(id, input).await,
            "consumer_group" => self.update_consumer_group(id, input).await,
            ...
            "schema_registrie" => self.update_schema_registrie(id, input).await,
            "type_" => self.update_type_(id, input).await,
            "compatibility" => self.update_compatibility(id, input).await,
            "referencedby" => self.update_referencedby(id, input).await,
            ...
            "mode" => self.update_mode(id, input).await,
    ...
    async fn create_connect_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a connect_cluster resource
    async fn read_connect_cluster(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_connect_cluster(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_consumer_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a consumer_group resource
    async fn read_consumer_group(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_consumer_group(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_schema_registrie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a schema_registrie resource
    async fn read_schema_registrie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_schema_registrie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_compatibility(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a compatibility resource
    async fn read_compatibility(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a compatibility resource
    async fn update_compatibility(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a compatibility resource
    async fn delete_compatibility(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_referencedby(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a referencedby resource
    async fn read_referencedby(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a referencedby resource
    async fn update_referencedby(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a referencedby resource
    async fn delete_referencedby(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_mode(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a mode resource
    async fn read_mode(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a mode resource
    async fn update_mode(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a mode resource
    async fn delete_mode(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
