...
impl<'a> Policy_orchestrator<'a> {
    ...
    pub async fn create(&self, description: Option<String>, state: Option<String>, orchestrated_resource: Option<String>, action: Option<String>, create_time: Option<String>, labels: Option<HashMap<String, String>>, name: Option<String>, orchestration_scope: Option<String>, orchestration_state: Option<String>, reconciling: Option<bool>, update_time: Option<String>, etag: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, state: Option<String>, orchestrated_resource: Option<String>, action: Option<String>, create_time: Option<String>, labels: Option<HashMap<String, String>>, name: Option<String>, orchestration_scope: Option<String>, orchestration_state: Option<String>, reconciling: Option<bool>, update_time: Option<String>, etag: Option<String>) -> Result<()> {
