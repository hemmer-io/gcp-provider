...
impl<'a> Content_categorie<'a> {
    ...
    pub async fn create(&self, account_id: Option<String>, name: Option<String>, id: Option<String>, kind: Option<String>, profile_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, account_id: Option<String>, name: Option<String>, id: Option<String>, kind: Option<String>) -> Result<()> {
