...
impl<'a> Advertiser_group<'a> {
    ...
    pub async fn create(&self, id: Option<String>, name: Option<String>, kind: Option<String>, account_id: Option<String>, profile_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, id: Option<String>, name: Option<String>, kind: Option<String>, account_id: Option<String>) -> Result<()> {
