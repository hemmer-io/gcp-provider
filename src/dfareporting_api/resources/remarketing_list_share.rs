...
impl<'a> Remarketing_list_share<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, kind: Option<String>, shared_advertiser_ids: Option<Vec<String>>, remarketing_list_id: Option<String>, shared_account_ids: Option<Vec<String>>) -> Result<()> {
