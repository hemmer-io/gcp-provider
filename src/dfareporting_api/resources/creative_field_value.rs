...
impl<'a> Creative_field_value<'a> {
    ...
    pub async fn create(&self, value: Option<String>, id: Option<String>, kind: Option<String>, creative_field_id: String, profile_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, value: Option<String>, id: Option<String>, kind: Option<String>) -> Result<()> {
