...
impl<'a> Billing_assignment<'a> {
    ...
    pub async fn create(&self, advertiser_id: Option<String>, account_id: Option<String>, campaign_id: Option<String>, kind: Option<String>, subaccount_id: Option<String>, profile_id: String, billing_profile_id: String) -> Result<String> {
