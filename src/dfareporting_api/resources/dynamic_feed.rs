...
impl<'a> Dynamic_feed<'a> {
    ...
    pub async fn create(&self, dynamic_profile_id: Option<String>, dynamic_feed: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, dynamic_profile_id: Option<String>, dynamic_feed: Option<String>) -> Result<()> {
