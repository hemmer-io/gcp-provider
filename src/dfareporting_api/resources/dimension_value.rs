...
impl<'a> Dimension_value<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, start_date: Option<String>, end_date: Option<String>, dimension_name: Option<String>, filters: Option<Vec<String>>, profile_id: String) -> Result<String> {
