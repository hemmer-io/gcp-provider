...
impl<'a> Dimension_value<'a> {
    ...
    pub async fn create(&self, start_date: Option<String>, filters: Option<Vec<String>>, end_date: Option<String>, dimension_name: Option<String>, kind: Option<String>, profile_id: String) -> Result<String> {
