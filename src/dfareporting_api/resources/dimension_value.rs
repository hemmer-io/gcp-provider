...
impl<'a> Dimension_value<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, dimension_name: Option<String>, start_date: Option<String>, filters: Option<Vec<String>>, end_date: Option<String>, profile_id: String) -> Result<String> {
