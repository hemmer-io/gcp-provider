...
impl<'a> Placement_strategie<'a> {
    ...
    pub async fn create(&self, account_id: Option<String>, id: Option<String>, kind: Option<String>, name: Option<String>, profile_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, account_id: Option<String>, id: Option<String>, kind: Option<String>, name: Option<String>) -> Result<()> {
