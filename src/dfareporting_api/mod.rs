//! Dfareporting_api Service
//!
//! Auto-generated service module for dfareporting_api

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for dfareporting_api
pub struct Dfareporting_apiService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> Dfareporting_apiService<'a> {
