...
impl<'a> Feedback_message<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, image: Option<String>, body: Option<String>, operator_feedback_metadata: Option<String>, requester_feedback_metadata: Option<String>, name: Option<String>, parent: String) -> Result<String> {
