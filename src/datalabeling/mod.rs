//! Datalabeling Service
//!
//! Auto-generated service module for datalabeling

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for datalabeling
pub struct DatalabelingService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> DatalabelingService<'a> {
