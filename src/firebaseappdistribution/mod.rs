//! Firebaseappdistribution Service
//!
//! Auto-generated service module for firebaseappdistribution

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for firebaseappdistribution
pub struct FirebaseappdistributionService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> FirebaseappdistributionService<'a> {
