...
impl<'a> Games_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "metagame" => self.plan_metagame(current_state, desired_input).await,
            "event" => self.plan_event(current_state, desired_input).await,
            "score" => self.plan_score(current_state, desired_input).await,
            "recall" => self.plan_recall(current_state, desired_input).await,
            ...
            "achievement_definition" => {
                self.plan_achievement_definition(current_state, desired_input)
                    .await
            }
            "accesstoken" => self.plan_accesstoken(current_state, desired_input).await,
            "stat" => self.plan_stat(current_state, desired_input).await,
            "leaderboard" => self.plan_leaderboard(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "metagame" => self.create_metagame(input).await,
            "event" => self.create_event(input).await,
            "score" => self.create_score(input).await,
            "recall" => self.create_recall(input).await,
            "player" => self.create_player(input).await,
            "application" => self.create_application(input).await,
            "achievement_definition" => self.create_achievement_definition(input).await,
            "accesstoken" => self.create_accesstoken(input).await,
            "stat" => self.create_stat(input).await,
            "leaderboard" => self.create_leaderboard(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "metagame" => self.read_metagame(id).await,
            "event" => self.read_event(id).await,
            "score" => self.read_score(id).await,
            "recall" => self.read_recall(id).await,
            "player" => self.read_player(id).await,
            "application" => self.read_application(id).await,
            "achievement_definition" => self.read_achievement_definition(id).await,
            "accesstoken" => self.read_accesstoken(id).await,
            "stat" => self.read_stat(id).await,
            "leaderboard" => self.read_leaderboard(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "metagame" => self.update_metagame(id, input).await,
            "event" => self.update_event(id, input).await,
            "score" => self.update_score(id, input).await,
            "recall" => self.update_recall(id, input).await,
            "player" => self.update_player(id, input).await,
            "application" => self.update_application(id, input).await,
            "achievement_definition" => self.update_achievement_definition(id, input).await,
            "accesstoken" => self.update_accesstoken(id, input).await,
            "stat" => self.update_stat(id, input).await,
            "leaderboard" => self.update_leaderboard(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "metagame" => self.delete_metagame(id).await,
            "event" => self.delete_event(id).await,
            "score" => self.delete_score(id).await,
            "recall" => self.delete_recall(id).await,
            "player" => self.delete_player(id).await,
            "application" => self.delete_application(id).await,
            "achievement_definition" => self.delete_achievement_definition(id).await,
            "accesstoken" => self.delete_accesstoken(id).await,
            "stat" => self.delete_stat(id).await,
            "leaderboard" => self.delete_leaderboard(id).await,
    ...
    async fn create_metagame(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a metagame resource
    async fn read_metagame(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a metagame resource
    async fn update_metagame(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a metagame resource
    async fn delete_metagame(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_recall(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a recall resource
    async fn read_recall(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a recall resource
    async fn update_recall(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a recall resource
    async fn delete_recall(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_achievement_definition(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a achievement_definition resource
    async fn read_achievement_definition(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_achievement_definition(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_accesstoken(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a accesstoken resource
    async fn read_accesstoken(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a accesstoken resource
    async fn update_accesstoken(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a accesstoken resource
    async fn delete_accesstoken(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_leaderboard(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a leaderboard resource
    async fn read_leaderboard(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a leaderboard resource
    async fn update_leaderboard(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a leaderboard resource
    async fn delete_leaderboard(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
