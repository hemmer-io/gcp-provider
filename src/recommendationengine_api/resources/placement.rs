...
impl<'a> Placement<'a> {
    ...
    pub async fn create(&self, dry_run: Option<bool>, user_event: Option<String>, page_token: Option<String>, params: Option<HashMap<String, String>>, labels: Option<HashMap<String, String>>, page_size: Option<i64>, filter: Option<String>, name: String) -> Result<String> {
