...
impl GcpProvider {
    ...
    pub fn firebasedataconnect_api(
        &self,
    ) -> firebasedataconnect_api::Firebasedataconnect_apiService<'_> {
    ...
    pub fn contactcenteraiplatform_api(
        &self,
    ) -> contactcenteraiplatform_api::Contactcenteraiplatform_apiService<'_> {
    ...
    pub fn resource_named_service(
        &self,
    ) -> resource_named_service::Resource_named_serviceService<'_> {
    ...
    pub fn playdeveloperreporting_api(
        &self,
    ) -> playdeveloperreporting_api::Playdeveloperreporting_apiService<'_> {
    ...
    pub fn mybusinessbusinessinformation_api(
        &self,
    ) -> mybusinessbusinessinformation_api::Mybusinessbusinessinformation_apiService<'_> {
    ...
    pub fn paymentsresellersubscription_api(
        &self,
    ) -> paymentsresellersubscription_api::Paymentsresellersubscription_apiService<'_> {
    ...
    pub fn bigquerydatapolicy_api(
        &self,
    ) -> bigquerydatapolicy_api::Bigquerydatapolicy_apiService<'_> {
    ...
    pub fn businessprofileperformance_api(
        &self,
    ) -> businessprofileperformance_api::Businessprofileperformance_apiService<'_> {
    ...
    pub fn bigqueryconnection_api(
        &self,
    ) -> bigqueryconnection_api::Bigqueryconnection_apiService<'_> {
    ...
    pub fn adexperiencereport_api(
        &self,
    ) -> adexperiencereport_api::Adexperiencereport_apiService<'_> {
    ...
    pub fn gamesconfiguration_api(
        &self,
    ) -> gamesconfiguration_api::Gamesconfiguration_apiService<'_> {
    ...
    pub fn cloudlocationfinder_api(
        &self,
    ) -> cloudlocationfinder_api::Cloudlocationfinder_apiService<'_> {
    ...
    pub fn serviceconsumermanagement_api(
        &self,
    ) -> serviceconsumermanagement_api::Serviceconsumermanagement_apiService<'_> {
    ...
    pub fn readerrevenuesubscriptionlinking_api(
        &self,
    ) -> readerrevenuesubscriptionlinking_api::Readerrevenuesubscriptionlinking_apiService<'_> {
    ...
    pub fn replicapoolupdater_api(
        &self,
    ) -> replicapoolupdater_api::Replicapoolupdater_apiService<'_> {
    ...
    pub fn acceleratedmobilepageurl_api(
        &self,
    ) -> acceleratedmobilepageurl_api::Acceleratedmobilepageurl_apiService<'_> {
        acceleratedmobilepageurl_api::Acceleratedmobilepageurl_apiService::new(self)
    }
    /// Get advisorynotifications_api service handler
    pub fn advisorynotifications_api(
        &self,
    ) -> advisorynotifications_api::Advisorynotifications_apiService<'_> {
        advisorynotifications_api::Advisorynotifications_apiService::new(self)
    }
    /// Get mybusinessbusinesscalls_api service handler
    pub fn mybusinessbusinesscalls_api(
        &self,
    ) -> mybusinessbusinesscalls_api::Mybusinessbusinesscalls_apiService<'_> {
    ...
    pub fn storagebatchoperations_api(
        &self,
    ) -> storagebatchoperations_api::Storagebatchoperations_apiService<'_> {
        storagebatchoperations_api::Storagebatchoperations_apiService::new(self)
    }
    /// Get mybusinessnotifications_api service handler
    pub fn mybusinessnotifications_api(
        &self,
    ) -> mybusinessnotifications_api::Mybusinessnotifications_apiService<'_> {
    ...
    pub fn firebasedynamiclinks_api(
        &self,
    ) -> firebasedynamiclinks_api::Firebasedynamiclinks_apiService<'_> {
    ...
    pub fn recommendationengine_api(
        &self,
    ) -> recommendationengine_api::Recommendationengine_apiService<'_> {
    ...
    pub fn mybusinessplaceactions_api(
        &self,
    ) -> mybusinessplaceactions_api::Mybusinessplaceactions_apiService<'_> {
    ...
    pub fn networkconnectivity_api(
        &self,
    ) -> networkconnectivity_api::Networkconnectivity_apiService<'_> {
    ...
    pub fn cloudcommerceprocurement_api(
        &self,
    ) -> cloudcommerceprocurement_api::Cloudcommerceprocurement_apiService<'_> {
    ...
    pub fn repeated_any_query_error(
        &self,
    ) -> repeated_any_query_error::Repeated_any_query_errorService<'_> {
    ...
    pub fn mybusinessverifications_api(
        &self,
    ) -> mybusinessverifications_api::Mybusinessverifications_apiService<'_> {
    ...
    pub fn securesourcemanager_api(
        &self,
    ) -> securesourcemanager_api::Securesourcemanager_apiService<'_> {
    ...
    pub fn binaryauthorization_api(
        &self,
    ) -> binaryauthorization_api::Binaryauthorization_apiService<'_> {
    ...
    pub fn abusiveexperiencereport_api(
        &self,
    ) -> abusiveexperiencereport_api::Abusiveexperiencereport_apiService<'_> {
        abusiveexperiencereport_api::Abusiveexperiencereport_apiService::new(self)
    }
    /// Get certificatemanager_api service handler
    pub fn certificatemanager_api(
        &self,
    ) -> certificatemanager_api::Certificatemanager_apiService<'_> {
    ...
    pub fn cloudresourcemanager_api(
        &self,
    ) -> cloudresourcemanager_api::Cloudresourcemanager_apiService<'_> {
    ...
    pub fn gmailpostmastertools_api(
        &self,
    ) -> gmailpostmastertools_api::Gmailpostmastertools_apiService<'_> {
    ...
    pub fn marketingplatformadmin_api(
        &self,
    ) -> marketingplatformadmin_api::Marketingplatformadmin_apiService<'_> {
    ...
    pub fn firebaseremoteconfig_api(
        &self,
    ) -> firebaseremoteconfig_api::Firebaseremoteconfig_apiService<'_> {
    ...
    pub fn authorizedbuyersmarketplace_api(
        &self,
    ) -> authorizedbuyersmarketplace_api::Authorizedbuyersmarketplace_apiService<'_> {
    ...
    pub fn bigquerydatatransfer_api(
        &self,
    ) -> bigquerydatatransfer_api::Bigquerydatatransfer_apiService<'_> {
    ...
    pub fn blockchainnodeengine_api(
        &self,
    ) -> blockchainnodeengine_api::Blockchainnodeengine_apiService<'_> {
    ...
    pub fn firebaseappdistribution_api(
        &self,
    ) -> firebaseappdistribution_api::Firebaseappdistribution_apiService<'_> {
    ...
    pub fn clouderrorreporting_api(
        &self,
    ) -> clouderrorreporting_api::Clouderrorreporting_apiService<'_> {
    ...
    pub fn recaptchaenterprise_api(
        &self,
    ) -> recaptchaenterprise_api::Recaptchaenterprise_apiService<'_> {
    ...
    pub fn analyticsreporting_api(
        &self,
    ) -> analyticsreporting_api::Analyticsreporting_apiService<'_> {
    ...
    pub fn rapidmigrationassessment_api(
        &self,
    ) -> rapidmigrationassessment_api::Rapidmigrationassessment_apiService<'_> {
    ...
    pub fn accesscontextmanager_api(
        &self,
    ) -> accesscontextmanager_api::Accesscontextmanager_apiService<'_> {
        accesscontextmanager_api::Accesscontextmanager_apiService::new(self)
    }
    /// Get smartdevicemanagement_api service handler
    pub fn smartdevicemanagement_api(
        &self,
    ) -> smartdevicemanagement_api::Smartdevicemanagement_apiService<'_> {
    ...
    pub fn doubleclickbidmanager_api(
        &self,
    ) -> doubleclickbidmanager_api::Doubleclickbidmanager_apiService<'_> {
    ...
    pub fn androiddeviceprovisioning_api(
        &self,
    ) -> androiddeviceprovisioning_api::Androiddeviceprovisioning_apiService<'_> {
    ...
    pub fn workflowexecutions_api(
        &self,
    ) -> workflowexecutions_api::Workflowexecutions_apiService<'_> {
    ...
    pub fn firebaseapphosting_api(
        &self,
    ) -> firebaseapphosting_api::Firebaseapphosting_apiService<'_> {
    ...
    pub fn cloudprivatecatalogproducer_api(
        &self,
    ) -> cloudprivatecatalogproducer_api::Cloudprivatecatalogproducer_apiService<'_> {
    ...
    pub fn cloudcontrolspartner_api(
        &self,
    ) -> cloudcontrolspartner_api::Cloudcontrolspartner_apiService<'_> {
    ...
    pub fn remotebuildexecution_api(
        &self,
    ) -> remotebuildexecution_api::Remotebuildexecution_apiService<'_> {
    ...
    pub fn cloudprivatecatalog_api(
        &self,
    ) -> cloudprivatecatalog_api::Cloudprivatecatalog_apiService<'_> {
    ...
    pub fn contactcenterinsights_api(
        &self,
    ) -> contactcenterinsights_api::Contactcenterinsights_apiService<'_> {
    ...
    pub fn websecurityscanner_api(
        &self,
    ) -> websecurityscanner_api::Websecurityscanner_apiService<'_> {
    ...
    pub fn policytroubleshooter_api(
        &self,
    ) -> policytroubleshooter_api::Policytroubleshooter_apiService<'_> {
    ...
    pub fn bigqueryreservation_api(
        &self,
    ) -> bigqueryreservation_api::Bigqueryreservation_apiService<'_> {
    ...
    pub fn mybusinessaccountmanagement_api(
        &self,
    ) -> mybusinessaccountmanagement_api::Mybusinessaccountmanagement_apiService<'_> {
...
impl ProviderExecutor for GcpProvider {
    ...
    async fn plan(
        ...
        match service_name {
            ...
            "youtubereporting_api" => {
                self.youtubereporting_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "ondemandscanning_api" => {
                self.ondemandscanning_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "chromepolicy_api" => {
                self.chromepolicy_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "localservices_api" => {
                self.localservices_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "adexchangebuyer2_api" => {
                self.adexchangebuyer2_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "tracing_api" => {
            ...
            "androidenterprise_api" => {
                self.androidenterprise_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudprofiler_api" => {
                self.cloudprofiler_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "contactcenteraiplatform_api" => {
                self.contactcenteraiplatform_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "workflows_api" => {
            ...
            "networkmanagement_api" => {
                self.networkmanagement_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "resource_named_service" => {
                self.resource_named_service()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "discovery_api" => {
            ...
            "playdeveloperreporting_api" => {
                self.playdeveloperreporting_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "mybusinessbusinessinformation_api" => {
                self.mybusinessbusinessinformation_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "logging_api" => {
            ...
            "commentanalyzer_api" => {
                self.commentanalyzer_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "paymentsresellersubscription_api" => {
                self.paymentsresellersubscription_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "dataportability_api" => {
                self.dataportability_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "partners_api" => {
            ...
            "contentwarehouse_api" => {
                self.contentwarehouse_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "bigquerydatapolicy_api" => {
                self.bigquerydatapolicy_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "domainsrdap_api" => {
                self.domainsrdap_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "discoveryengine_api" => {
                self.discoveryengine_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "apigeeregistry_api" => {
                self.apigeeregistry_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "keep_api" => {
            ...
            "businessprofileperformance_api" => {
                self.businessprofileperformance_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "displayvideo_api" => {
                self.displayvideo_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "sql_api" => {
            ...
            "vmwareengine_api" => {
                self.vmwareengine_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "kmsinventory_api" => {
                self.kmsinventory_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "forms_api" => {
            ...
            "networkservices_api" => {
                self.networkservices_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "digitalassetlinks_api" => {
                self.digitalassetlinks_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "datapipelines_api" => {
                self.datapipelines_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "translate_api" => {
            ...
            "streetviewpublish_api" => {
                self.streetviewpublish_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "verifiedaccess_api" => {
                self.verifiedaccess_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "notebooks_api" => {
            ...
            "servicebroker_api" => {
                self.servicebroker_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudscheduler_api" => {
                self.cloudscheduler_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "adexperiencereport_api" => {
                self.adexperiencereport_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "osconfig_api" => {
            ...
            "fusiontables_api" => {
                self.fusiontables_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "runtimeconfig_api" => {
                self.runtimeconfig_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudasset_api" => {
            ...
            "manufacturers_api" => {
                self.manufacturers_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "playmoviespartner_api" => {
                self.playmoviespartner_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "texttospeech_api" => {
                self.texttospeech_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "securityposture_api" => {
                self.securityposture_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "gamesconfiguration_api" => {
                self.gamesconfiguration_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "firebase_api" => {
            ...
            "managedidentities_api" => {
                self.managedidentities_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "firebaserules_api" => {
                self.firebaserules_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "fcmdata_api" => {
            ...
            "essentialcontacts_api" => {
                self.essentialcontacts_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudlocationfinder_api" => {
                self.cloudlocationfinder_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "workspaceevents_api" => {
                self.workspaceevents_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "identitytoolkit_api" => {
                self.identitytoolkit_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "checks_api" => {
            ...
            "androidmanagement_api" => {
                self.androidmanagement_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "baremetalsolution_api" => {
                self.baremetalsolution_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "serviceconsumermanagement_api" => {
                self.serviceconsumermanagement_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "surveys_api" => {
            ...
            "areainsights_api" => {
                self.areainsights_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "readerrevenuesubscriptionlinking_api" => {
                self.readerrevenuesubscriptionlinking_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "analyticshub_api" => {
                self.analyticshub_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "replicapoolupdater_api" => {
                self.replicapoolupdater_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "playcustomapp_api" => {
                self.playcustomapp_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "searchads360_api" => {
                self.searchads360_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudsearch_api" => {
                self.cloudsearch_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "oauth2_api" => {
            ...
            "alertcenter_api" => {
                self.alertcenter_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "workloadmanager_api" => {
                self.workloadmanager_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "spectrum_api" => {
            ...
            "acceleratedmobilepageurl_api" => {
                self.acceleratedmobilepageurl_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "advisorynotifications_api" => {
                self.advisorynotifications_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "mybusinessbusinesscalls_api" => {
                self.mybusinessbusinesscalls_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "datalineage_api" => {
                self.datalineage_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "sasportal_api" => {
            ...
            "servicenetworking_api" => {
                self.servicenetworking_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "storagebatchoperations_api" => {
                self.storagebatchoperations_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "mybusinessnotifications_api" => {
                self.mybusinessnotifications_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "orgpolicy_api" => {
            ...
            "assuredworkloads_api" => {
                self.assuredworkloads_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "versionhistory_api" => {
                self.versionhistory_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "firebasedynamiclinks_api" => {
                self.firebasedynamiclinks_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "people_api" => {
            ...
            "recommendationengine_api" => {
                self.recommendationengine_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "storagetransfer_api" => {
                self.storagetransfer_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "mybusinessplaceactions_api" => {
                self.mybusinessplaceactions_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudchannel_api" => {
                self.cloudchannel_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "bigquery_api" => {
            ...
            "serviceusage_api" => {
                self.serviceusage_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "plusdomains_api" => {
                self.plusdomains_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "prod_tt_sasportal_api" => {
                self.prod_tt_sasportal_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "sqladmin_api" => {
            ...
            "recommender_api" => {
                self.recommender_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudcommerceprocurement_api" => {
                self.cloudcommerceprocurement_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "servicedirectory_api" => {
                self.servicedirectory_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "fcm_api" => {
            ...
            "cloudidentity_api" => {
                self.cloudidentity_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "repeated_any_query_error" => {
                self.repeated_any_query_error()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "adexchangeseller_api" => {
                self.adexchangeseller_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "mybusinessverifications_api" => {
                self.mybusinessverifications_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "config_api" => {
            ...
            "videointelligence_api" => {
                self.videointelligence_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "vmmigration_api" => {
                self.vmmigration_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "webrisk_api" => {
            ...
            "playintegrity_api" => {
                self.playintegrity_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "securitycenter_api" => {
                self.securitycenter_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "binaryauthorization_api" => {
                self.binaryauthorization_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudbuild_api" => {
            ...
            "abusiveexperiencereport_api" => {
                self.abusiveexperiencereport_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "certificatemanager_api" => {
                self.certificatemanager_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "datamanager_api" => {
                self.datamanager_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "reseller_api" => {
            ...
            "cloudresourcemanager_api" => {
                self.cloudresourcemanager_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "gamesmanagement_api" => {
                self.gamesmanagement_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudbilling_api" => {
                self.cloudbilling_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "compute_api" => {
            ...
            "gmailpostmastertools_api" => {
                self.gmailpostmastertools_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "datacatalog_api" => {
                self.datacatalog_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "policyanalyzer_api" => {
                self.policyanalyzer_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "marketingplatformadmin_api" => {
                self.marketingplatformadmin_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "datalabeling_api" => {
                self.datalabeling_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "integrations_api" => {
            ...
            "authorizedbuyersmarketplace_api" => {
                self.authorizedbuyersmarketplace_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "script_api" => {
            ...
            "bigquerydatatransfer_api" => {
                self.bigquerydatatransfer_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "playgrouping_api" => {
                self.playgrouping_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "blockchainnodeengine_api" => {
                self.blockchainnodeengine_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "artifactregistry_api" => {
                self.artifactregistry_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "merchantapi_api" => {
                self.merchantapi_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "firebaseappdistribution_api" => {
                self.firebaseappdistribution_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "developerconnect_api" => {
                self.developerconnect_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "factchecktools_api" => {
                self.factchecktools_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "http_body" => {
            ...
            "datamigration_api" => {
                self.datamigration_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "chromemanagement_api" => {
                self.chromemanagement_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "containeranalysis_api" => {
                self.containeranalysis_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "clouderrorreporting_api" => {
                self.clouderrorreporting_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "chromewebstore_api" => {
                self.chromewebstore_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "webfonts_api" => {
            ...
            "walletobjects_api" => {
                self.walletobjects_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "recaptchaenterprise_api" => {
                self.recaptchaenterprise_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "dlp_api" => {
            ...
            "workstations_api" => {
                self.workstations_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudsupport_api" => {
                self.cloudsupport_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "webmasters_api" => {
            ...
            "rapidmigrationassessment_api" => {
                self.rapidmigrationassessment_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "gmail_api" => {
            ...
            "adexchangebuyer_api" => {
                self.adexchangebuyer_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "serviceuser_api" => {
                self.serviceuser_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudfunctions_api" => {
                self.cloudfunctions_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "kgsearch_api" => {
            ...
            "accesscontextmanager_api" => {
                self.accesscontextmanager_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "smartdevicemanagement_api" => {
                self.smartdevicemanagement_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "any" => {
            ...
            "doubleclickbidmanager_api" => {
                self.doubleclickbidmanager_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "playablelocations_api" => {
                self.playablelocations_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "test_api" => {
            ...
            "androiddeviceprovisioning_api" => {
                self.androiddeviceprovisioning_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "beyondcorp_api" => {
            ...
            "parallelstore_api" => {
                self.parallelstore_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "customsearch_api" => {
                self.customsearch_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "workflowexecutions_api" => {
                self.workflowexecutions_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "trafficdirector_api" => {
                self.trafficdirector_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "adsenseplatform_api" => {
                self.adsenseplatform_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "dataform_api" => {
            ...
            "libraryagent_api" => {
                self.libraryagent_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "firebaseapphosting_api" => {
                self.firebaseapphosting_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "searchconsole_api" => {
                self.searchconsole_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "ids_api" => {
            ...
            "cloudprivatecatalogproducer_api" => {
                self.cloudprivatecatalogproducer_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "clouddebugger_api" => {
                self.clouddebugger_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "groupssettings_api" => {
                self.groupssettings_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "chromeuxreport_api" => {
                self.chromeuxreport_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "appengine_api" => {
            ...
            "servicecontrol_api" => {
                self.servicecontrol_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudcontrolspartner_api" => {
                self.cloudcontrolspartner_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "genomics_api" => {
            ...
            "policysimulator_api" => {
                self.policysimulator_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "mybusinessqanda_api" => {
                self.mybusinessqanda_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "adsensehost_api" => {
                self.adsensehost_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "remotebuildexecution_api" => {
                self.remotebuildexecution_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "iap_api" => {
            ...
            "dfareporting_api" => {
                self.dfareporting_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "managedkafka_api" => {
                self.managedkafka_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "servicemanagement_api" => {
                self.servicemanagement_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "apigee_api" => {
            ...
            "contactcenterinsights_api" => {
                self.contactcenterinsights_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "toolresults_api" => {
                self.toolresults_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "websecurityscanner_api" => {
                self.websecurityscanner_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "deploymentmanager_api" => {
                self.deploymentmanager_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "pubsub_api" => {
            ...
            "groupsmigration_api" => {
                self.groupsmigration_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "policytroubleshooter_api" => {
                self.policytroubleshooter_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "dialogflow_api" => {
            ...
            "migrationcenter_api" => {
                self.migrationcenter_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "addressvalidation_api" => {
                self.addressvalidation_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "doubleclicksearch_api" => {
                self.doubleclicksearch_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "drivelabels_api" => {
                self.drivelabels_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "cloudshell_api" => {
            ...
            "bigqueryreservation_api" => {
                self.bigqueryreservation_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "pagespeedonline_api" => {
                self.pagespeedonline_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "games_api" => {
            ...
            "billingbudgets_api" => {
                self.billingbudgets_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "replicapool_api" => {
                self.replicapool_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "area120tables_api" => {
                self.area120tables_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "accessapproval_api" => {
                self.accessapproval_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "firebasestorage_api" => {
                self.firebasestorage_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "licensing_api" => {
            ...
            "mybusinessaccountmanagement_api" => {
                self.mybusinessaccountmanagement_api()
                    .plan_resource(resource_name, current_state, desired_input)
                    .await
            }
            "dataproc_api" => {
    ...
    async fn create(&self, resource_type: &str, input: ResourceInput) -> Result<ResourceOutput> {
        ...
        match service_name {
            ...
            "plus_api" => self.plus_api().create_resource(resource_name, input).await,
            "firebasedataconnect_api" => {
                self.firebasedataconnect_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "dns_api" => self.dns_api().create_resource(resource_name, input).await,
            "file_api" => self.file_api().create_resource(resource_name, input).await,
            "youtubereporting_api" => {
                self.youtubereporting_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "keep_api" => self.keep_api().create_resource(resource_name, input).await,
            "gkebackup_api" => {
                self.gkebackup_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "jobs_api" => self.jobs_api().create_resource(resource_name, input).await,
            "datastore_api" => {
                self.datastore_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "sql_api" => self.sql_api().create_resource(resource_name, input).await,
            "vectortile_api" => {
                self.vectortile_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "forms_api" => self.forms_api().create_resource(resource_name, input).await,
            "ml_api" => self.ml_api().create_resource(resource_name, input).await,
            "apihub_api" => {
                self.apihub_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "json_body" => self.json_body().create_resource(resource_name, input).await,
            "batch_api" => self.batch_api().create_resource(resource_name, input).await,
            "alertcenter_api" => {
                self.alertcenter_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "vault_api" => self.vault_api().create_resource(resource_name, input).await,
            "tpu_api" => self.tpu_api().create_resource(resource_name, input).await,
            "sheets_api" => {
                self.sheets_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "chat_api" => self.chat_api().create_resource(resource_name, input).await,
            "recommendationengine_api" => {
                self.recommendationengine_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "run_api" => self.run_api().create_resource(resource_name, input).await,
            "drive_api" => self.drive_api().create_resource(resource_name, input).await,
            "pubsublite_api" => {
                self.pubsublite_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "fcm_api" => self.fcm_api().create_resource(resource_name, input).await,
            "cloudidentity_api" => {
                self.cloudidentity_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "redis_api" => self.redis_api().create_resource(resource_name, input).await,
            "videointelligence_api" => {
                self.videointelligence_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "iam_api" => self.iam_api().create_resource(resource_name, input).await,
            "poly_api" => self.poly_api().create_resource(resource_name, input).await,
            "indexing_api" => {
                self.indexing_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "solar_api" => self.solar_api().create_resource(resource_name, input).await,
            "civicinfo_api" => {
                self.civicinfo_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "books_api" => self.books_api().create_resource(resource_name, input).await,
            "firebaseremoteconfig_api" => {
                self.firebaseremoteconfig_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "docs_api" => self.docs_api().create_resource(resource_name, input).await,
            "authorizedbuyersmarketplace_api" => {
                self.authorizedbuyersmarketplace_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "http_body" => self.http_body().create_resource(resource_name, input).await,
            "datamigration_api" => {
                self.datamigration_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "dlp_api" => self.dlp_api().create_resource(resource_name, input).await,
            "workstations_api" => {
                self.workstations_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "apim_api" => self.apim_api().create_resource(resource_name, input).await,
            "analyticsreporting_api" => {
                self.analyticsreporting_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "gmail_api" => self.gmail_api().create_resource(resource_name, input).await,
            "adexchangebuyer_api" => {
                self.adexchangebuyer_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "any" => self.any().create_resource(resource_name, input).await,
            "healthcare_api" => {
                self.healthcare_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "admin_api" => self.admin_api().create_resource(resource_name, input).await,
            "gkeonprem_api" => {
                self.gkeonprem_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "test_api" => self.test_api().create_resource(resource_name, input).await,
            "androiddeviceprovisioning_api" => {
                self.androiddeviceprovisioning_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "tasks_api" => self.tasks_api().create_resource(resource_name, input).await,
            "libraryagent_api" => {
                self.libraryagent_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "ids_api" => self.ids_api().create_resource(resource_name, input).await,
            "sts_api" => self.sts_api().create_resource(resource_name, input).await,
            "cloudprivatecatalogproducer_api" => {
                self.cloudprivatecatalogproducer_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "meet_api" => self.meet_api().create_resource(resource_name, input).await,
            "admob_api" => self.admob_api().create_resource(resource_name, input).await,
            "airquality_api" => {
                self.airquality_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "iap_api" => self.iap_api().create_resource(resource_name, input).await,
            "spanner_api" => {
                self.spanner_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "css_api" => self.css_api().create_resource(resource_name, input).await,
            "groupsmigration_api" => {
                self.groupsmigration_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "games_api" => self.games_api().create_resource(resource_name, input).await,
            "urlshortener_api" => {
                self.urlshortener_api()
                    .create_resource(resource_name, input)
                    .await
            ...
            "blogger_3" => self.blogger_3().create_resource(resource_name, input).await,
            "analyticsadmin_api" => {
                self.analyticsadmin_api()
                    .create_resource(resource_name, input)
                    .await
    ...
    async fn read(&self, resource_type: &str, id: &str) -> Result<ResourceOutput> {
        ...
        match service_name {
            "publicca_api" => self.publicca_api().read_resource(resource_name, id).await,
            "plus_api" => self.plus_api().read_resource(resource_name, id).await,
            "firebasedataconnect_api" => {
                self.firebasedataconnect_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "privateca_api" => self.privateca_api().read_resource(resource_name, id).await,
            "networksecurity_api" => {
                self.networksecurity_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "apigateway_api" => self.apigateway_api().read_resource(resource_name, id).await,
            "firebasehosting_api" => {
                self.firebasehosting_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "dns_api" => self.dns_api().read_resource(resource_name, id).await,
            "file_api" => self.file_api().read_resource(resource_name, id).await,
            "youtubereporting_api" => {
                self.youtubereporting_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "tracing_api" => self.tracing_api().read_resource(resource_name, id).await,
            "androidenterprise_api" => {
                self.androidenterprise_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "workflows_api" => self.workflows_api().read_resource(resource_name, id).await,
            "networkmanagement_api" => {
                self.networkmanagement_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "discovery_api" => self.discovery_api().read_resource(resource_name, id).await,
            "playdeveloperreporting_api" => {
                self.playdeveloperreporting_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "logging_api" => self.logging_api().read_resource(resource_name, id).await,
            "metastore_api" => self.metastore_api().read_resource(resource_name, id).await,
            "biglake_api" => self.biglake_api().read_resource(resource_name, id).await,
            "apikeys_api" => self.apikeys_api().read_resource(resource_name, id).await,
            "commentanalyzer_api" => {
                self.commentanalyzer_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "partners_api" => self.partners_api().read_resource(resource_name, id).await,
            "firebaseappcheck_api" => {
                self.firebaseappcheck_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "cloudtrace_api" => self.cloudtrace_api().read_resource(resource_name, id).await,
            "contentwarehouse_api" => {
                self.contentwarehouse_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "keep_api" => self.keep_api().read_resource(resource_name, id).await,
            "gkebackup_api" => self.gkebackup_api().read_resource(resource_name, id).await,
            "eventarc_api" => self.eventarc_api().read_resource(resource_name, id).await,
            "driveactivity_api" => {
                self.driveactivity_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "jobs_api" => self.jobs_api().read_resource(resource_name, id).await,
            "datastore_api" => self.datastore_api().read_resource(resource_name, id).await,
            "businessprofileperformance_api" => {
                self.businessprofileperformance_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "sql_api" => self.sql_api().read_resource(resource_name, id).await,
            "vectortile_api" => self.vectortile_api().read_resource(resource_name, id).await,
            "testing_api" => self.testing_api().read_resource(resource_name, id).await,
            "vmwareengine_api" => {
                self.vmwareengine_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "forms_api" => self.forms_api().read_resource(resource_name, id).await,
            "ml_api" => self.ml_api().read_resource(resource_name, id).await,
            "apihub_api" => self.apihub_api().read_resource(resource_name, id).await,
            "oslogin_api" => self.oslogin_api().read_resource(resource_name, id).await,
            "bigqueryconnection_api" => {
                self.bigqueryconnection_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "documentai_api" => self.documentai_api().read_resource(resource_name, id).await,
            "networkservices_api" => {
                self.networkservices_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "translate_api" => self.translate_api().read_resource(resource_name, id).await,
            "streetviewpublish_api" => {
                self.streetviewpublish_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "notebooks_api" => self.notebooks_api().read_resource(resource_name, id).await,
            "servicebroker_api" => {
                self.servicebroker_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "osconfig_api" => self.osconfig_api().read_resource(resource_name, id).await,
            "mirror_api" => self.mirror_api().read_resource(resource_name, id).await,
            "fusiontables_api" => {
                self.fusiontables_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "cloudasset_api" => self.cloudasset_api().read_resource(resource_name, id).await,
            "adsense_api" => self.adsense_api().read_resource(resource_name, id).await,
            "manufacturers_api" => {
                self.manufacturers_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "firebase_api" => self.firebase_api().read_resource(resource_name, id).await,
            "youtubeanalytics_api" => {
                self.youtubeanalytics_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "mediaupload" => self.mediaupload().read_resource(resource_name, id).await,
            "analytics_api" => self.analytics_api().read_resource(resource_name, id).await,
            "apphub_api" => self.apphub_api().read_resource(resource_name, id).await,
            "vision_api" => self.vision_api().read_resource(resource_name, id).await,
            "managedidentities_api" => {
                self.managedidentities_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "fcmdata_api" => self.fcmdata_api().read_resource(resource_name, id).await,
            "essentialcontacts_api" => {
                self.essentialcontacts_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "checks_api" => self.checks_api().read_resource(resource_name, id).await,
            "androidmanagement_api" => {
                self.androidmanagement_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "surveys_api" => self.surveys_api().read_resource(resource_name, id).await,
            "areainsights_api" => {
                self.areainsights_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "oauth2_api" => self.oauth2_api().read_resource(resource_name, id).await,
            "androidpublisher_api" => {
                self.androidpublisher_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "json_body" => self.json_body().read_resource(resource_name, id).await,
            "batch_api" => self.batch_api().read_resource(resource_name, id).await,
            "alertcenter_api" => {
                self.alertcenter_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "spectrum_api" => self.spectrum_api().read_resource(resource_name, id).await,
            "acceleratedmobilepageurl_api" => {
                self.acceleratedmobilepageurl_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "sasportal_api" => self.sasportal_api().read_resource(resource_name, id).await,
            "servicenetworking_api" => {
                self.servicenetworking_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "orgpolicy_api" => self.orgpolicy_api().read_resource(resource_name, id).await,
            "backupdr_api" => self.backupdr_api().read_resource(resource_name, id).await,
            "storage_api" => self.storage_api().read_resource(resource_name, id).await,
            "gameservices_api" => {
                self.gameservices_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "vault_api" => self.vault_api().read_resource(resource_name, id).await,
            "tpu_api" => self.tpu_api().read_resource(resource_name, id).await,
            "sheets_api" => self.sheets_api().read_resource(resource_name, id).await,
            "analyticsdata_api" => {
                self.analyticsdata_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "alloydb_api" => self.alloydb_api().read_resource(resource_name, id).await,
            "assuredworkloads_api" => {
                self.assuredworkloads_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "people_api" => self.people_api().read_resource(resource_name, id).await,
            "consumersurveys_api" => {
                self.consumersurveys_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "language_api" => self.language_api().read_resource(resource_name, id).await,
            "chat_api" => self.chat_api().read_resource(resource_name, id).await,
            "recommendationengine_api" => {
                self.recommendationengine_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "bigquery_api" => self.bigquery_api().read_resource(resource_name, id).await,
            "ideahub_api" => self.ideahub_api().read_resource(resource_name, id).await,
            "sourcerepo_api" => self.sourcerepo_api().read_resource(resource_name, id).await,
            "firestore_api" => self.firestore_api().read_resource(resource_name, id).await,
            "serviceusage_api" => {
                self.serviceusage_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "sqladmin_api" => self.sqladmin_api().read_resource(resource_name, id).await,
            "resourcesettings_api" => {
                self.resourcesettings_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "pollen_api" => self.pollen_api().read_resource(resource_name, id).await,
            "content_api" => self.content_api().read_resource(resource_name, id).await,
            "appsactivity_api" => {
                self.appsactivity_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "dataflow_api" => self.dataflow_api().read_resource(resource_name, id).await,
            "classroom_api" => self.classroom_api().read_resource(resource_name, id).await,
            "networkconnectivity_api" => {
                self.networkconnectivity_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "tagmanager_api" => self.tagmanager_api().read_resource(resource_name, id).await,
            "run_api" => self.run_api().read_resource(resource_name, id).await,
            "drive_api" => self.drive_api().read_resource(resource_name, id).await,
            "pubsublite_api" => self.pubsublite_api().read_resource(resource_name, id).await,
            "lifesciences_api" => {
                self.lifesciences_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "calendar_api" => self.calendar_api().read_resource(resource_name, id).await,
            "iamcredentials_api" => {
                self.iamcredentials_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "datastream_api" => self.datastream_api().read_resource(resource_name, id).await,
            "datafusion_api" => self.datafusion_api().read_resource(resource_name, id).await,
            "observability_api" => {
                self.observability_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "fcm_api" => self.fcm_api().read_resource(resource_name, id).await,
            "cloudidentity_api" => {
                self.cloudidentity_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "config_api" => self.config_api().read_resource(resource_name, id).await,
            "redis_api" => self.redis_api().read_resource(resource_name, id).await,
            "videointelligence_api" => {
                self.videointelligence_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "webrisk_api" => self.webrisk_api().read_resource(resource_name, id).await,
            "domains_api" => self.domains_api().read_resource(resource_name, id).await,
            "cloudtasks_api" => self.cloudtasks_api().read_resource(resource_name, id).await,
            "cloudkms_api" => self.cloudkms_api().read_resource(resource_name, id).await,
            "securesourcemanager_api" => {
                self.securesourcemanager_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "iam_api" => self.iam_api().read_resource(resource_name, id).await,
            "poly_api" => self.poly_api().read_resource(resource_name, id).await,
            "indexing_api" => self.indexing_api().read_resource(resource_name, id).await,
            "firebasedatabase_api" => {
                self.firebasedatabase_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "gkehub_api" => self.gkehub_api().read_resource(resource_name, id).await,
            "playintegrity_api" => {
                self.playintegrity_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "cloudbuild_api" => self.cloudbuild_api().read_resource(resource_name, id).await,
            "parametermanager_api" => {
                self.parametermanager_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "slides_api" => self.slides_api().read_resource(resource_name, id).await,
            "siteverification_api" => {
                self.siteverification_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "solar_api" => self.solar_api().read_resource(resource_name, id).await,
            "civicinfo_api" => self.civicinfo_api().read_resource(resource_name, id).await,
            "saasservicemgmt_api" => {
                self.saasservicemgmt_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "acmedns_api" => self.acmedns_api().read_resource(resource_name, id).await,
            "aiplatform_api" => self.aiplatform_api().read_resource(resource_name, id).await,
            "cloudiot_api" => self.cloudiot_api().read_resource(resource_name, id).await,
            "abusiveexperiencereport_api" => {
                self.abusiveexperiencereport_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "reseller_api" => self.reseller_api().read_resource(resource_name, id).await,
            "cloudresourcemanager_api" => {
                self.cloudresourcemanager_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "compute_api" => self.compute_api().read_resource(resource_name, id).await,
            "gmailpostmastertools_api" => {
                self.gmailpostmastertools_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "books_api" => self.books_api().read_resource(resource_name, id).await,
            "firebaseremoteconfig_api" => {
                self.firebaseremoteconfig_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "looker_api" => self.looker_api().read_resource(resource_name, id).await,
            "docs_api" => self.docs_api().read_resource(resource_name, id).await,
            "authorizedbuyersmarketplace_api" => {
                self.authorizedbuyersmarketplace_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "script_api" => self.script_api().read_resource(resource_name, id).await,
            "homegraph_api" => self.homegraph_api().read_resource(resource_name, id).await,
            "bigquerydatatransfer_api" => {
                self.bigquerydatatransfer_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "http_body" => self.http_body().read_resource(resource_name, id).await,
            "datamigration_api" => {
                self.datamigration_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "webfonts_api" => self.webfonts_api().read_resource(resource_name, id).await,
            "secretmanager_api" => {
                self.secretmanager_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "youtube_api" => self.youtube_api().read_resource(resource_name, id).await,
            "dataplex_api" => self.dataplex_api().read_resource(resource_name, id).await,
            "walletobjects_api" => {
                self.walletobjects_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "dlp_api" => self.dlp_api().read_resource(resource_name, id).await,
            "workstations_api" => {
                self.workstations_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "webmasters_api" => self.webmasters_api().read_resource(resource_name, id).await,
            "qpxexpress_api" => self.qpxexpress_api().read_resource(resource_name, id).await,
            "apim_api" => self.apim_api().read_resource(resource_name, id).await,
            "analyticsreporting_api" => {
                self.analyticsreporting_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "connectors_api" => self.connectors_api().read_resource(resource_name, id).await,
            "blogger_api" => self.blogger_api().read_resource(resource_name, id).await,
            "rapidmigrationassessment_api" => {
                self.rapidmigrationassessment_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "gmail_api" => self.gmail_api().read_resource(resource_name, id).await,
            "adexchangebuyer_api" => {
                self.adexchangebuyer_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "kgsearch_api" => self.kgsearch_api().read_resource(resource_name, id).await,
            "accesscontextmanager_api" => {
                self.accesscontextmanager_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "any" => self.any().read_resource(resource_name, id).await,
            "healthcare_api" => self.healthcare_api().read_resource(resource_name, id).await,
            "composer_api" => self.composer_api().read_resource(resource_name, id).await,
            "monitoring_api" => self.monitoring_api().read_resource(resource_name, id).await,
            "speech_api" => self.speech_api().read_resource(resource_name, id).await,
            "container_api" => self.container_api().read_resource(resource_name, id).await,
            "mybusinesslodging_api" => {
                self.mybusinesslodging_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "admin_api" => self.admin_api().read_resource(resource_name, id).await,
            "gkeonprem_api" => self.gkeonprem_api().read_resource(resource_name, id).await,
            "doubleclickbidmanager_api" => {
                self.doubleclickbidmanager_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "test_api" => self.test_api().read_resource(resource_name, id).await,
            "androiddeviceprovisioning_api" => {
                self.androiddeviceprovisioning_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "beyondcorp_api" => self.beyondcorp_api().read_resource(resource_name, id).await,
            "parallelstore_api" => {
                self.parallelstore_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "dataform_api" => self.dataform_api().read_resource(resource_name, id).await,
            "oracledatabase_api" => {
                self.oracledatabase_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "tasks_api" => self.tasks_api().read_resource(resource_name, id).await,
            "libraryagent_api" => {
                self.libraryagent_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "ids_api" => self.ids_api().read_resource(resource_name, id).await,
            "sts_api" => self.sts_api().read_resource(resource_name, id).await,
            "cloudprivatecatalogproducer_api" => {
                self.cloudprivatecatalogproducer_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "appengine_api" => self.appengine_api().read_resource(resource_name, id).await,
            "servicecontrol_api" => {
                self.servicecontrol_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "genomics_api" => self.genomics_api().read_resource(resource_name, id).await,
            "places_api" => self.places_api().read_resource(resource_name, id).await,
            "netapp_api" => self.netapp_api().read_resource(resource_name, id).await,
            "proximitybeacon_api" => {
                self.proximitybeacon_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "meet_api" => self.meet_api().read_resource(resource_name, id).await,
            "admob_api" => self.admob_api().read_resource(resource_name, id).await,
            "airquality_api" => self.airquality_api().read_resource(resource_name, id).await,
            "policysimulator_api" => {
                self.policysimulator_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "iap_api" => self.iap_api().read_resource(resource_name, id).await,
            "spanner_api" => self.spanner_api().read_resource(resource_name, id).await,
            "clouddeploy_api" => {
                self.clouddeploy_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "vpcaccess_api" => self.vpcaccess_api().read_resource(resource_name, id).await,
            "dfareporting_api" => {
                self.dfareporting_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "apigee_api" => self.apigee_api().read_resource(resource_name, id).await,
            "cloudprivatecatalog_api" => {
                self.cloudprivatecatalog_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "retail_api" => self.retail_api().read_resource(resource_name, id).await,
            "contactcenterinsights_api" => {
                self.contactcenterinsights_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "pubsub_api" => self.pubsub_api().read_resource(resource_name, id).await,
            "appstate_api" => self.appstate_api().read_resource(resource_name, id).await,
            "realtimebidding_api" => {
                self.realtimebidding_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "firebaseml_api" => self.firebaseml_api().read_resource(resource_name, id).await,
            "bigtableadmin_api" => {
                self.bigtableadmin_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "css_api" => self.css_api().read_resource(resource_name, id).await,
            "groupsmigration_api" => {
                self.groupsmigration_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "dialogflow_api" => self.dialogflow_api().read_resource(resource_name, id).await,
            "migrationcenter_api" => {
                self.migrationcenter_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "cloudshell_api" => self.cloudshell_api().read_resource(resource_name, id).await,
            "memcache_api" => self.memcache_api().read_resource(resource_name, id).await,
            "safebrowsing_api" => {
                self.safebrowsing_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "transcoder_api" => self.transcoder_api().read_resource(resource_name, id).await,
            "bigqueryreservation_api" => {
                self.bigqueryreservation_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "games_api" => self.games_api().read_resource(resource_name, id).await,
            "urlshortener_api" => {
                self.urlshortener_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "fitness_api" => self.fitness_api().read_resource(resource_name, id).await,
            "billingbudgets_api" => {
                self.billingbudgets_api()
                    .read_resource(resource_name, id)
                    .await
            ...
            "licensing_api" => self.licensing_api().read_resource(resource_name, id).await,
            "mybusinessaccountmanagement_api" => {
                self.mybusinessaccountmanagement_api()
                    .read_resource(resource_name, id)
                    .await
            }
            "dataproc_api" => self.dataproc_api().read_resource(resource_name, id).await,
            "blogger_3" => self.blogger_3().read_resource(resource_name, id).await,
            "analyticsadmin_api" => {
                self.analyticsadmin_api()
                    .read_resource(resource_name, id)
                    .await
    ...
    async fn update(
        ...
        match service_name {
            ...
            "any" => self.any().update_resource(resource_name, id, input).await,
            "healthcare_api" => {
                self.healthcare_api()
                    .update_resource(resource_name, id, input)
                    .await
    ...
    async fn delete(&self, resource_type: &str, id: &str) -> Result<()> {
        ...
        match service_name {
            "publicca_api" => self.publicca_api().delete_resource(resource_name, id).await,
            "plus_api" => self.plus_api().delete_resource(resource_name, id).await,
            "firebasedataconnect_api" => {
                self.firebasedataconnect_api()
            ...
            "dns_api" => self.dns_api().delete_resource(resource_name, id).await,
            "file_api" => self.file_api().delete_resource(resource_name, id).await,
            "youtubereporting_api" => {
                self.youtubereporting_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "tracing_api" => self.tracing_api().delete_resource(resource_name, id).await,
            "androidenterprise_api" => {
                self.androidenterprise_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "logging_api" => self.logging_api().delete_resource(resource_name, id).await,
            "metastore_api" => {
                self.metastore_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "biglake_api" => self.biglake_api().delete_resource(resource_name, id).await,
            "apikeys_api" => self.apikeys_api().delete_resource(resource_name, id).await,
            "commentanalyzer_api" => {
                self.commentanalyzer_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "partners_api" => self.partners_api().delete_resource(resource_name, id).await,
            "firebaseappcheck_api" => {
                self.firebaseappcheck_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "keep_api" => self.keep_api().delete_resource(resource_name, id).await,
            "gkebackup_api" => {
                self.gkebackup_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "eventarc_api" => self.eventarc_api().delete_resource(resource_name, id).await,
            "driveactivity_api" => {
                self.driveactivity_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "jobs_api" => self.jobs_api().delete_resource(resource_name, id).await,
            "datastore_api" => {
                self.datastore_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "sql_api" => self.sql_api().delete_resource(resource_name, id).await,
            "vectortile_api" => {
                self.vectortile_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "testing_api" => self.testing_api().delete_resource(resource_name, id).await,
            "vmwareengine_api" => {
                self.vmwareengine_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "forms_api" => self.forms_api().delete_resource(resource_name, id).await,
            "ml_api" => self.ml_api().delete_resource(resource_name, id).await,
            "apihub_api" => self.apihub_api().delete_resource(resource_name, id).await,
            "oslogin_api" => self.oslogin_api().delete_resource(resource_name, id).await,
            "bigqueryconnection_api" => {
                self.bigqueryconnection_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "osconfig_api" => self.osconfig_api().delete_resource(resource_name, id).await,
            "mirror_api" => self.mirror_api().delete_resource(resource_name, id).await,
            "fusiontables_api" => {
                self.fusiontables_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "adsense_api" => self.adsense_api().delete_resource(resource_name, id).await,
            "manufacturers_api" => {
                self.manufacturers_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "firebase_api" => self.firebase_api().delete_resource(resource_name, id).await,
            "youtubeanalytics_api" => {
                self.youtubeanalytics_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "mediaupload" => self.mediaupload().delete_resource(resource_name, id).await,
            "analytics_api" => {
                self.analytics_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "apphub_api" => self.apphub_api().delete_resource(resource_name, id).await,
            "vision_api" => self.vision_api().delete_resource(resource_name, id).await,
            "managedidentities_api" => {
                self.managedidentities_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "fcmdata_api" => self.fcmdata_api().delete_resource(resource_name, id).await,
            "essentialcontacts_api" => {
                self.essentialcontacts_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "checks_api" => self.checks_api().delete_resource(resource_name, id).await,
            "androidmanagement_api" => {
                self.androidmanagement_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "surveys_api" => self.surveys_api().delete_resource(resource_name, id).await,
            "areainsights_api" => {
                self.areainsights_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "oauth2_api" => self.oauth2_api().delete_resource(resource_name, id).await,
            "androidpublisher_api" => {
                self.androidpublisher_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "json_body" => self.json_body().delete_resource(resource_name, id).await,
            "batch_api" => self.batch_api().delete_resource(resource_name, id).await,
            "alertcenter_api" => {
                self.alertcenter_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "spectrum_api" => self.spectrum_api().delete_resource(resource_name, id).await,
            "acceleratedmobilepageurl_api" => {
                self.acceleratedmobilepageurl_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "backupdr_api" => self.backupdr_api().delete_resource(resource_name, id).await,
            "storage_api" => self.storage_api().delete_resource(resource_name, id).await,
            "gameservices_api" => {
                self.gameservices_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "vault_api" => self.vault_api().delete_resource(resource_name, id).await,
            "tpu_api" => self.tpu_api().delete_resource(resource_name, id).await,
            "sheets_api" => self.sheets_api().delete_resource(resource_name, id).await,
            "analyticsdata_api" => {
                self.analyticsdata_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "alloydb_api" => self.alloydb_api().delete_resource(resource_name, id).await,
            "assuredworkloads_api" => {
                self.assuredworkloads_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "people_api" => self.people_api().delete_resource(resource_name, id).await,
            "consumersurveys_api" => {
                self.consumersurveys_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "language_api" => self.language_api().delete_resource(resource_name, id).await,
            "chat_api" => self.chat_api().delete_resource(resource_name, id).await,
            "recommendationengine_api" => {
                self.recommendationengine_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "bigquery_api" => self.bigquery_api().delete_resource(resource_name, id).await,
            "ideahub_api" => self.ideahub_api().delete_resource(resource_name, id).await,
            "sourcerepo_api" => {
                self.sourcerepo_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "sqladmin_api" => self.sqladmin_api().delete_resource(resource_name, id).await,
            "resourcesettings_api" => {
                self.resourcesettings_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "pollen_api" => self.pollen_api().delete_resource(resource_name, id).await,
            "content_api" => self.content_api().delete_resource(resource_name, id).await,
            "appsactivity_api" => {
                self.appsactivity_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "dataflow_api" => self.dataflow_api().delete_resource(resource_name, id).await,
            "classroom_api" => {
                self.classroom_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "run_api" => self.run_api().delete_resource(resource_name, id).await,
            "drive_api" => self.drive_api().delete_resource(resource_name, id).await,
            "pubsublite_api" => {
                self.pubsublite_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "calendar_api" => self.calendar_api().delete_resource(resource_name, id).await,
            "iamcredentials_api" => {
                self.iamcredentials_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "fcm_api" => self.fcm_api().delete_resource(resource_name, id).await,
            "cloudidentity_api" => {
                self.cloudidentity_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "config_api" => self.config_api().delete_resource(resource_name, id).await,
            "redis_api" => self.redis_api().delete_resource(resource_name, id).await,
            "videointelligence_api" => {
                self.videointelligence_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "webrisk_api" => self.webrisk_api().delete_resource(resource_name, id).await,
            "domains_api" => self.domains_api().delete_resource(resource_name, id).await,
            "cloudtasks_api" => {
                self.cloudtasks_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "cloudkms_api" => self.cloudkms_api().delete_resource(resource_name, id).await,
            "securesourcemanager_api" => {
                self.securesourcemanager_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "iam_api" => self.iam_api().delete_resource(resource_name, id).await,
            "poly_api" => self.poly_api().delete_resource(resource_name, id).await,
            "indexing_api" => self.indexing_api().delete_resource(resource_name, id).await,
            "firebasedatabase_api" => {
                self.firebasedatabase_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "gkehub_api" => self.gkehub_api().delete_resource(resource_name, id).await,
            "playintegrity_api" => {
                self.playintegrity_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "slides_api" => self.slides_api().delete_resource(resource_name, id).await,
            "siteverification_api" => {
                self.siteverification_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "solar_api" => self.solar_api().delete_resource(resource_name, id).await,
            "civicinfo_api" => {
                self.civicinfo_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "acmedns_api" => self.acmedns_api().delete_resource(resource_name, id).await,
            "aiplatform_api" => {
                self.aiplatform_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "cloudiot_api" => self.cloudiot_api().delete_resource(resource_name, id).await,
            "abusiveexperiencereport_api" => {
                self.abusiveexperiencereport_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "reseller_api" => self.reseller_api().delete_resource(resource_name, id).await,
            "cloudresourcemanager_api" => {
                self.cloudresourcemanager_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "compute_api" => self.compute_api().delete_resource(resource_name, id).await,
            "gmailpostmastertools_api" => {
                self.gmailpostmastertools_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "books_api" => self.books_api().delete_resource(resource_name, id).await,
            "firebaseremoteconfig_api" => {
                self.firebaseremoteconfig_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "looker_api" => self.looker_api().delete_resource(resource_name, id).await,
            "docs_api" => self.docs_api().delete_resource(resource_name, id).await,
            "authorizedbuyersmarketplace_api" => {
                self.authorizedbuyersmarketplace_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "script_api" => self.script_api().delete_resource(resource_name, id).await,
            "homegraph_api" => {
                self.homegraph_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "http_body" => self.http_body().delete_resource(resource_name, id).await,
            "datamigration_api" => {
                self.datamigration_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "webfonts_api" => self.webfonts_api().delete_resource(resource_name, id).await,
            "secretmanager_api" => {
                self.secretmanager_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "youtube_api" => self.youtube_api().delete_resource(resource_name, id).await,
            "dataplex_api" => self.dataplex_api().delete_resource(resource_name, id).await,
            "walletobjects_api" => {
                self.walletobjects_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "dlp_api" => self.dlp_api().delete_resource(resource_name, id).await,
            "workstations_api" => {
                self.workstations_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "apim_api" => self.apim_api().delete_resource(resource_name, id).await,
            "analyticsreporting_api" => {
                self.analyticsreporting_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "blogger_api" => self.blogger_api().delete_resource(resource_name, id).await,
            "rapidmigrationassessment_api" => {
                self.rapidmigrationassessment_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "gmail_api" => self.gmail_api().delete_resource(resource_name, id).await,
            "adexchangebuyer_api" => {
                self.adexchangebuyer_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "kgsearch_api" => self.kgsearch_api().delete_resource(resource_name, id).await,
            "accesscontextmanager_api" => {
                self.accesscontextmanager_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "any" => self.any().delete_resource(resource_name, id).await,
            "healthcare_api" => {
                self.healthcare_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "composer_api" => self.composer_api().delete_resource(resource_name, id).await,
            "monitoring_api" => {
                self.monitoring_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "speech_api" => self.speech_api().delete_resource(resource_name, id).await,
            "container_api" => {
                self.container_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "admin_api" => self.admin_api().delete_resource(resource_name, id).await,
            "gkeonprem_api" => {
                self.gkeonprem_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "test_api" => self.test_api().delete_resource(resource_name, id).await,
            "androiddeviceprovisioning_api" => {
                self.androiddeviceprovisioning_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "dataform_api" => self.dataform_api().delete_resource(resource_name, id).await,
            "oracledatabase_api" => {
                self.oracledatabase_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "tasks_api" => self.tasks_api().delete_resource(resource_name, id).await,
            "libraryagent_api" => {
                self.libraryagent_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "ids_api" => self.ids_api().delete_resource(resource_name, id).await,
            "sts_api" => self.sts_api().delete_resource(resource_name, id).await,
            "cloudprivatecatalogproducer_api" => {
                self.cloudprivatecatalogproducer_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "genomics_api" => self.genomics_api().delete_resource(resource_name, id).await,
            "places_api" => self.places_api().delete_resource(resource_name, id).await,
            "netapp_api" => self.netapp_api().delete_resource(resource_name, id).await,
            "proximitybeacon_api" => {
                self.proximitybeacon_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "meet_api" => self.meet_api().delete_resource(resource_name, id).await,
            "admob_api" => self.admob_api().delete_resource(resource_name, id).await,
            "airquality_api" => {
                self.airquality_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "iap_api" => self.iap_api().delete_resource(resource_name, id).await,
            "spanner_api" => self.spanner_api().delete_resource(resource_name, id).await,
            "clouddeploy_api" => {
                self.clouddeploy_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "apigee_api" => self.apigee_api().delete_resource(resource_name, id).await,
            "cloudprivatecatalog_api" => {
                self.cloudprivatecatalog_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "retail_api" => self.retail_api().delete_resource(resource_name, id).await,
            "contactcenterinsights_api" => {
                self.contactcenterinsights_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "pubsub_api" => self.pubsub_api().delete_resource(resource_name, id).await,
            "appstate_api" => self.appstate_api().delete_resource(resource_name, id).await,
            "realtimebidding_api" => {
                self.realtimebidding_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "css_api" => self.css_api().delete_resource(resource_name, id).await,
            "groupsmigration_api" => {
                self.groupsmigration_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "memcache_api" => self.memcache_api().delete_resource(resource_name, id).await,
            "safebrowsing_api" => {
                self.safebrowsing_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "games_api" => self.games_api().delete_resource(resource_name, id).await,
            "urlshortener_api" => {
                self.urlshortener_api()
                    .delete_resource(resource_name, id)
                    .await
            }
            "fitness_api" => self.fitness_api().delete_resource(resource_name, id).await,
            "billingbudgets_api" => {
                self.billingbudgets_api()
                    .delete_resource(resource_name, id)
                    .await
            ...
            "dataproc_api" => self.dataproc_api().delete_resource(resource_name, id).await,
            "blogger_3" => self.blogger_3().delete_resource(resource_name, id).await,
            "analyticsadmin_api" => {
                self.analyticsadmin_api()
                    .delete_resource(resource_name, id)
                    .await
