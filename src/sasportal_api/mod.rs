//! Sasportal_api service for Gcp provider
//!
//! This module handles all sasportal_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Sasportal_api service handler
