...
impl<'a> Data_attribute_binding<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, display_name: Option<String>, labels: Option<HashMap<String, String>>, uid: Option<String>, attributes: Option<Vec<String>>, paths: Option<Vec<String>>, name: Option<String>, resource: Option<String>, update_time: Option<String>, etag: Option<String>, description: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, create_time: Option<String>, display_name: Option<String>, labels: Option<HashMap<String, String>>, uid: Option<String>, attributes: Option<Vec<String>>, paths: Option<Vec<String>>, name: Option<String>, resource: Option<String>, update_time: Option<String>, etag: Option<String>, description: Option<String>) -> Result<()> {
