...
impl<'a> Spanner_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "instance_partition_operation" => {
                self.plan_instance_partition_operation(current_state, desired_input)
                    .await
            }
            ...
            "database_role" => self.plan_database_role(current_state, desired_input).await,
            "instance_config_operation" => {
                self.plan_instance_config_operation(current_state, desired_input)
                    .await
            }
            "scan" => self.plan_scan(current_state, desired_input).await,
            "backup_operation" => {
                self.plan_backup_operation(current_state, desired_input)
                    .await
            }
            "instance_partition" => {
                self.plan_instance_partition(current_state, desired_input)
                    .await
            }
            "instance_config" => {
                self.plan_instance_config(current_state, desired_input)
                    .await
            }
            "database_operation" => {
                self.plan_database_operation(current_state, desired_input)
                    .await
            }
            "instance" => self.plan_instance(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "spanner_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "instance_partition_operation" => self.create_instance_partition_operation(input).await,
            ...
            "database_role" => self.create_database_role(input).await,
            "instance_config_operation" => self.create_instance_config_operation(input).await,
            "scan" => self.create_scan(input).await,
            "backup_operation" => self.create_backup_operation(input).await,
            "instance_partition" => self.create_instance_partition(input).await,
            "instance_config" => self.create_instance_config(input).await,
            "database_operation" => self.create_database_operation(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "instance_partition_operation" => self.read_instance_partition_operation(id).await,
            ...
            "database_role" => self.read_database_role(id).await,
            "instance_config_operation" => self.read_instance_config_operation(id).await,
            "scan" => self.read_scan(id).await,
            "backup_operation" => self.read_backup_operation(id).await,
            "instance_partition" => self.read_instance_partition(id).await,
            "instance_config" => self.read_instance_config(id).await,
            "database_operation" => self.read_database_operation(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "database_role" => self.update_database_role(id, input).await,
            "instance_config_operation" => self.update_instance_config_operation(id, input).await,
            "scan" => self.update_scan(id, input).await,
            "backup_operation" => self.update_backup_operation(id, input).await,
            "instance_partition" => self.update_instance_partition(id, input).await,
            "instance_config" => self.update_instance_config(id, input).await,
            "database_operation" => self.update_database_operation(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "instance_partition_operation" => self.delete_instance_partition_operation(id).await,
            ...
            "database_role" => self.delete_database_role(id).await,
            "instance_config_operation" => self.delete_instance_config_operation(id).await,
            "scan" => self.delete_scan(id).await,
            "backup_operation" => self.delete_backup_operation(id).await,
            "instance_partition" => self.delete_instance_partition(id).await,
            "instance_config" => self.delete_instance_config(id).await,
            "database_operation" => self.delete_database_operation(id).await,
    ...
    async fn read_instance_partition_operation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_instance_partition_operation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_database_role(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a database_role resource
    async fn read_database_role(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a database_role resource
    async fn update_database_role(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a database_role resource
    async fn delete_database_role(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_instance_config_operation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_instance_config_operation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_backup_operation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a backup_operation resource
    async fn read_backup_operation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_backup_operation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_instance_partition(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a instance_partition resource
    async fn read_instance_partition(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_instance_partition(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_instance_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a instance_config resource
    async fn read_instance_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_instance_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_database_operation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a database_operation resource
    async fn read_database_operation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_database_operation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
