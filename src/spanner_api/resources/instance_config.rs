...
impl<'a> Instance_config<'a> {
    ...
    pub async fn create(&self, validate_only: Option<bool>, instance_config: Option<String>, instance_config_id: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, validate_only: Option<bool>, instance_config: Option<String>, instance_config_id: Option<String>) -> Result<()> {
