...
impl<'a> Forms_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "form" => {
                self.plan_form(current_state, desired_input).await
            }
            "response" => {
                self.plan_response(current_state, desired_input).await
            }
            "watche" => {
                self.plan_watche(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "form" => {
                self.create_form(input).await
            }
            "response" => {
                self.create_response(input).await
            }
            "watche" => {
                self.create_watche(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "forms_api",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "form" => {
                self.read_form(id).await
            }
            "response" => {
                self.read_response(id).await
            }
            "watche" => {
                self.read_watche(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "forms_api",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "form" => {
                self.update_form(id, input).await
            }
            "response" => {
                self.update_response(id, input).await
            }
            "watche" => {
                self.update_watche(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "forms_api",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "form" => {
                self.delete_form(id).await
            }
            "response" => {
                self.delete_response(id).await
            }
            "watche" => {
                self.delete_watche(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "forms_api",
