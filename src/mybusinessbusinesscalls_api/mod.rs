...
impl<'a> Mybusinessbusinesscalls_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "businesscallsinsight" => {
                self.plan_businesscallsinsight(current_state, desired_input).await
            }
            "location" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "businesscallsinsight" => {
                self.create_businesscallsinsight(input).await
            }
            "location" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "businesscallsinsight" => {
                self.read_businesscallsinsight(id).await
            }
            "location" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "businesscallsinsight" => {
                self.update_businesscallsinsight(id, input).await
            }
            "location" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "businesscallsinsight" => {
                self.delete_businesscallsinsight(id).await
            }
            "location" => {
    ...
    async fn create_businesscallsinsight(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn read_businesscallsinsight(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_businesscallsinsight(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
