...
impl<'a> Rubric<'a> {
    ...
    pub async fn create(&self, course_id: Option<String>, id: Option<String>, source_spreadsheet_id: Option<String>, update_time: Option<String>, criteria: Option<Vec<String>>, creation_time: Option<String>, course_work_id: Option<String>, course_id: String, course_work_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, course_id: Option<String>, id: Option<String>, source_spreadsheet_id: Option<String>, update_time: Option<String>, criteria: Option<Vec<String>>, creation_time: Option<String>, course_work_id: Option<String>) -> Result<()> {
