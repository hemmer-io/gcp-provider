...
impl<'a> Product_certification<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, brand: Option<String>, issues: Option<Vec<String>>, name: Option<String>, certification: Option<Vec<String>>, product_code: Option<Vec<String>>, title: Option<String>, product_type: Option<Vec<String>>, destination_statuses: Option<Vec<String>>, country_code: Option<Vec<String>>, mpn: Option<Vec<String>>) -> Result<()> {
