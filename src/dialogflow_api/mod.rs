...
impl<'a> Dialogflow_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "security_setting" => {
                self.plan_security_setting(current_state, desired_input).await
            }
            "location" => {
            ...
            "changelog" => {
                self.plan_changelog(current_state, desired_input).await
            }
            "flow" => {
            ...
            "continuous_test_result" => {
                self.plan_continuous_test_result(current_state, desired_input).await
            }
            "version" => {
            ...
            "playbook" => {
                self.plan_playbook(current_state, desired_input).await
            }
            "page" => {
            ...
            "transition_route_group" => {
                self.plan_transition_route_group(current_state, desired_input).await
            }
            "generator" => {
                self.plan_generator(current_state, desired_input).await
            }
            "message" => {
                self.plan_message(current_state, desired_input).await
            }
            "stateless_suggestion" => {
                self.plan_stateless_suggestion(current_state, desired_input).await
            }
            "knowledge_base" => {
                self.plan_knowledge_base(current_state, desired_input).await
            }
            "project" => {
            ...
            "suggestion" => {
                self.plan_suggestion(current_state, desired_input).await
            }
            "context" => {
            ...
            "answer_record" => {
                self.plan_answer_record(current_state, desired_input).await
            }
            "operation" => {
                self.plan_operation(current_state, desired_input).await
            }
            ...
            "sip_trunk" => {
                self.plan_sip_trunk(current_state, desired_input).await
            }
            "location" => {
                self.plan_location(current_state, desired_input).await
            }
            ...
            "conversation_profile" => {
                self.plan_conversation_profile(current_state, desired_input).await
            }
            "evaluation" => {
            ...
            "conversation_dataset" => {
                self.plan_conversation_dataset(current_state, desired_input).await
            }
            "generator" => {
                self.plan_generator(current_state, desired_input).await
            }
            ...
            "conversation_model" => {
                self.plan_conversation_model(current_state, desired_input).await
            }
            "sip_trunk" => {
                self.plan_sip_trunk(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "security_setting" => {
                self.create_security_setting(input).await
            }
            "location" => {
            ...
            "changelog" => {
                self.create_changelog(input).await
            }
            "flow" => {
            ...
            "continuous_test_result" => {
                self.create_continuous_test_result(input).await
            }
            "version" => {
            ...
            "playbook" => {
                self.create_playbook(input).await
            }
            "page" => {
            ...
            "transition_route_group" => {
                self.create_transition_route_group(input).await
            }
            "generator" => {
                self.create_generator(input).await
            }
            "message" => {
                self.create_message(input).await
            }
            "stateless_suggestion" => {
                self.create_stateless_suggestion(input).await
            }
            "knowledge_base" => {
                self.create_knowledge_base(input).await
            }
            "project" => {
            ...
            "suggestion" => {
                self.create_suggestion(input).await
            }
            "context" => {
            ...
            "answer_record" => {
                self.create_answer_record(input).await
            }
            "operation" => {
                self.create_operation(input).await
            }
            ...
            "sip_trunk" => {
                self.create_sip_trunk(input).await
            }
            "location" => {
                self.create_location(input).await
            }
            ...
            "conversation_profile" => {
                self.create_conversation_profile(input).await
            }
            "evaluation" => {
            ...
            "conversation_dataset" => {
                self.create_conversation_dataset(input).await
            }
            "generator" => {
                self.create_generator(input).await
            }
            ...
            "conversation_model" => {
                self.create_conversation_model(input).await
            }
            "sip_trunk" => {
                self.create_sip_trunk(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "security_setting" => {
                self.read_security_setting(id).await
            }
            "location" => {
            ...
            "continuous_test_result" => {
                self.read_continuous_test_result(id).await
            }
            "version" => {
            ...
            "transition_route_group" => {
                self.read_transition_route_group(id).await
            }
            "generator" => {
                self.read_generator(id).await
            }
            "message" => {
                self.read_message(id).await
            }
            "stateless_suggestion" => {
                self.read_stateless_suggestion(id).await
            }
            "knowledge_base" => {
                self.read_knowledge_base(id).await
            }
            "project" => {
            ...
            "answer_record" => {
                self.read_answer_record(id).await
            }
            "operation" => {
                self.read_operation(id).await
            }
            ...
            "conversation_profile" => {
                self.read_conversation_profile(id).await
            }
            "evaluation" => {
            ...
            "conversation_dataset" => {
                self.read_conversation_dataset(id).await
            }
            "generator" => {
                self.read_generator(id).await
            }
            ...
            "conversation_model" => {
                self.read_conversation_model(id).await
            }
            "sip_trunk" => {
                self.read_sip_trunk(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "security_setting" => {
                self.update_security_setting(id, input).await
            }
            "location" => {
            ...
            "changelog" => {
                self.update_changelog(id, input).await
            }
            "flow" => {
            ...
            "continuous_test_result" => {
                self.update_continuous_test_result(id, input).await
            }
            "version" => {
            ...
            "playbook" => {
                self.update_playbook(id, input).await
            }
            "page" => {
            ...
            "transition_route_group" => {
                self.update_transition_route_group(id, input).await
            }
            "generator" => {
                self.update_generator(id, input).await
            }
            "message" => {
                self.update_message(id, input).await
            }
            "stateless_suggestion" => {
                self.update_stateless_suggestion(id, input).await
            }
            "knowledge_base" => {
                self.update_knowledge_base(id, input).await
            }
            "project" => {
            ...
            "suggestion" => {
                self.update_suggestion(id, input).await
            }
            "context" => {
            ...
            "answer_record" => {
                self.update_answer_record(id, input).await
            }
            "operation" => {
                self.update_operation(id, input).await
            }
            ...
            "sip_trunk" => {
                self.update_sip_trunk(id, input).await
            }
            "location" => {
                self.update_location(id, input).await
            }
            ...
            "conversation_profile" => {
                self.update_conversation_profile(id, input).await
            }
            "evaluation" => {
            ...
            "conversation_dataset" => {
                self.update_conversation_dataset(id, input).await
            }
            "generator" => {
                self.update_generator(id, input).await
            }
            ...
            "conversation_model" => {
                self.update_conversation_model(id, input).await
            }
            "sip_trunk" => {
                self.update_sip_trunk(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "security_setting" => {
                self.delete_security_setting(id).await
            }
            "location" => {
            ...
            "changelog" => {
                self.delete_changelog(id).await
            }
            "flow" => {
            ...
            "continuous_test_result" => {
                self.delete_continuous_test_result(id).await
            }
            "version" => {
            ...
            "transition_route_group" => {
                self.delete_transition_route_group(id).await
            }
            "generator" => {
                self.delete_generator(id).await
            }
            "message" => {
                self.delete_message(id).await
            }
            "stateless_suggestion" => {
                self.delete_stateless_suggestion(id).await
            }
            "knowledge_base" => {
            ...
            "suggestion" => {
                self.delete_suggestion(id).await
            }
            "context" => {
            ...
            "answer_record" => {
                self.delete_answer_record(id).await
            }
            "operation" => {
                self.delete_operation(id).await
            }
            ...
            "sip_trunk" => {
                self.delete_sip_trunk(id).await
            }
            "location" => {
                self.delete_location(id).await
            }
            ...
            "conversation_profile" => {
                self.delete_conversation_profile(id).await
            }
            "evaluation" => {
            ...
            "conversation_dataset" => {
                self.delete_conversation_dataset(id).await
            }
            "generator" => {
                self.delete_generator(id).await
            }
            ...
            "conversation_model" => {
                self.delete_conversation_model(id).await
            }
            "sip_trunk" => {
                self.delete_sip_trunk(id).await
            }
    ...
    async fn create_security_setting(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_security_setting(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_continuous_test_result(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_continuous_test_result(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_continuous_test_result(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_transition_route_group(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_stateless_suggestion(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_stateless_suggestion(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_stateless_suggestion(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_conversation_profile(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_conversation_dataset(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_conversation_model(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
