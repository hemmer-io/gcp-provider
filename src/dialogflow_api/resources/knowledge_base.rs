...
impl<'a> Knowledge_base<'a> {
    ...
    pub async fn create(&self, language_code: Option<String>, display_name: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, language_code: Option<String>, display_name: Option<String>, name: Option<String>) -> Result<()> {
