...
impl<'a> Transition_route_group<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, name: Option<String>, transition_routes: Option<Vec<String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, display_name: Option<String>, name: Option<String>, transition_routes: Option<Vec<String>>) -> Result<()> {
