...
impl<'a> Conversation_model<'a> {
    ...
    pub async fn create(&self, satisfies_pzi: Option<bool>, display_name: Option<String>, datasets: Option<Vec<String>>, name: Option<String>, smart_reply_model_metadata: Option<String>, state: Option<String>, article_suggestion_model_metadata: Option<String>, create_time: Option<String>, satisfies_pzs: Option<bool>, language_code: Option<String>, parent: String) -> Result<String> {
