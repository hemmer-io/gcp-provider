...
impl<'a> Stateless_suggestion<'a> {
    ...
    pub async fn create(&self, security_settings: Option<String>, context_references: Option<HashMap<String, String>>, generator: Option<String>, generator_name: Option<String>, conversation_context: Option<String>, trigger_events: Option<Vec<String>>, parent: String) -> Result<String> {
