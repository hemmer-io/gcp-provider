...
impl<'a> Message<'a> {
    ...
    pub async fn create(&self, matched_url: Option<String>, last_update_time: Option<String>, sender: Option<String>, create_time: Option<String>, argument_text: Option<String>, cards_v2: Option<Vec<String>>, deletion_metadata: Option<String>, delete_time: Option<String>, accessory_widgets: Option<Vec<String>>, annotations: Option<Vec<String>>, slash_command: Option<String>, cards: Option<Vec<String>>, text: Option<String>, private_message_viewer: Option<String>, emoji_reaction_summaries: Option<Vec<String>>, formatted_text: Option<String>, thread: Option<String>, attachment: Option<Vec<String>>, thread_reply: Option<bool>, name: Option<String>, space: Option<String>, quoted_message_metadata: Option<String>, fallback_text: Option<String>, client_assigned_message_id: Option<String>, action_response: Option<String>, attached_gifs: Option<Vec<String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, matched_url: Option<String>, last_update_time: Option<String>, sender: Option<String>, create_time: Option<String>, argument_text: Option<String>, cards_v2: Option<Vec<String>>, deletion_metadata: Option<String>, delete_time: Option<String>, accessory_widgets: Option<Vec<String>>, annotations: Option<Vec<String>>, slash_command: Option<String>, cards: Option<Vec<String>>, text: Option<String>, private_message_viewer: Option<String>, emoji_reaction_summaries: Option<Vec<String>>, formatted_text: Option<String>, thread: Option<String>, attachment: Option<Vec<String>>, thread_reply: Option<bool>, name: Option<String>, space: Option<String>, quoted_message_metadata: Option<String>, fallback_text: Option<String>, client_assigned_message_id: Option<String>, action_response: Option<String>, attached_gifs: Option<Vec<String>>) -> Result<()> {
