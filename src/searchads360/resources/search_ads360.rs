...
impl<'a> Search_ads360<'a> {
    ...
    pub async fn create(&self, return_total_results_count: Option<bool>, summary_row_setting: Option<String>, page_size: Option<i64>, query: Option<String>, validate_only: Option<bool>, page_token: Option<String>, customer_id: String) -> Result<String> {
