//! Policyanalyzer_api service for Gcp provider
//!
//! This module handles all policyanalyzer_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Policyanalyzer_api service handler
pub struct Policyanalyzer_apiService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> Policyanalyzer_apiService<'a> {
