...
impl<'a> Git_repository_link<'a> {
    ...
    pub async fn create(&self, git_proxy_uri: Option<String>, uid: Option<String>, name: Option<String>, etag: Option<String>, delete_time: Option<String>, labels: Option<HashMap<String, String>>, annotations: Option<HashMap<String, String>>, create_time: Option<String>, update_time: Option<String>, webhook_id: Option<String>, clone_uri: Option<String>, reconciling: Option<bool>, parent: String) -> Result<String> {
