//! Securesourcemanager Service
//!
//! Auto-generated service module for securesourcemanager

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for securesourcemanager
pub struct SecuresourcemanagerService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> SecuresourcemanagerService<'a> {
