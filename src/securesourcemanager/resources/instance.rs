...
impl<'a> Instance<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, private_config: Option<String>, state_note: Option<String>, host_config: Option<String>, update_time: Option<String>, state: Option<String>, workforce_identity_federation_config: Option<String>, labels: Option<HashMap<String, String>>, kms_key: Option<String>, name: Option<String>, parent: String) -> Result<String> {
