...
impl<'a> Conversation_dataset<'a> {
    ...
    pub async fn create(&self, satisfies_pzi: Option<bool>, input_config: Option<String>, display_name: Option<String>, conversation_info: Option<String>, name: Option<String>, satisfies_pzs: Option<bool>, create_time: Option<String>, description: Option<String>, conversation_count: Option<String>, parent: String) -> Result<String> {
