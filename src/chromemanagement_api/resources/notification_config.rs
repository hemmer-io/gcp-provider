...
impl<'a> Notification_config<'a> {
    ...
    pub async fn create(&self, filter: Option<String>, customer: Option<String>, google_cloud_pubsub_topic: Option<String>, name: Option<String>, parent: String) -> Result<String> {
