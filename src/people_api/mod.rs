...
impl<'a> People_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "other_contact" => self.plan_other_contact(current_state, desired_input).await,
            "people" => self.plan_people(current_state, desired_input).await,
            "contact_group" => self.plan_contact_group(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "other_contact" => self.create_other_contact(input).await,
            "people" => self.create_people(input).await,
            "contact_group" => self.create_contact_group(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "other_contact" => self.read_other_contact(id).await,
            "people" => self.read_people(id).await,
            "contact_group" => self.read_contact_group(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "other_contact" => self.update_other_contact(id, input).await,
            "people" => self.update_people(id, input).await,
            "contact_group" => self.update_contact_group(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "other_contact" => self.delete_other_contact(id).await,
            "people" => self.delete_people(id).await,
            "contact_group" => self.delete_contact_group(id).await,
    ...
    async fn create_other_contact(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a other_contact resource
    async fn read_other_contact(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a other_contact resource
    async fn update_other_contact(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a other_contact resource
    async fn delete_other_contact(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_contact_group(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a contact_group resource
    async fn read_contact_group(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a contact_group resource
    async fn update_contact_group(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a contact_group resource
    async fn delete_contact_group(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
