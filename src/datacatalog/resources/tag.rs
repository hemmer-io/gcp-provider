...
impl<'a> Tag<'a> {
    ...
    pub async fn create(&self, column: Option<String>, fields: Option<HashMap<String, String>>, template: Option<String>, template_display_name: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, column: Option<String>, fields: Option<HashMap<String, String>>, template: Option<String>, template_display_name: Option<String>, name: Option<String>) -> Result<()> {
