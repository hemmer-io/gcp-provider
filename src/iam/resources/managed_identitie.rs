...
impl<'a> Managed_identitie<'a> {
    ...
    pub async fn create(&self, state: Option<String>, name: Option<String>, description: Option<String>, expire_time: Option<String>, disabled: Option<bool>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, state: Option<String>, name: Option<String>, description: Option<String>, expire_time: Option<String>, disabled: Option<bool>) -> Result<()> {
