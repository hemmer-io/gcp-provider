...
impl<'a> Dataportability_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "archive_job" => self.plan_archive_job(current_state, desired_input).await,
            "portability_archive" => {
                self.plan_portability_archive(current_state, desired_input)
                    .await
            }
            "access_type" => self.plan_access_type(current_state, desired_input).await,
            "access_type" => self.plan_access_type(current_state, desired_input).await,
            "archive_job" => self.plan_archive_job(current_state, desired_input).await,
            "authorization" => self.plan_authorization(current_state, desired_input).await,
            "portability_archive" => {
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "dataportability_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "archive_job" => self.create_archive_job(input).await,
            "portability_archive" => self.create_portability_archive(input).await,
            "access_type" => self.create_access_type(input).await,
            "access_type" => self.create_access_type(input).await,
            "archive_job" => self.create_archive_job(input).await,
            "authorization" => self.create_authorization(input).await,
            "portability_archive" => self.create_portability_archive(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "archive_job" => self.read_archive_job(id).await,
            "portability_archive" => self.read_portability_archive(id).await,
            "access_type" => self.read_access_type(id).await,
            "access_type" => self.read_access_type(id).await,
            "archive_job" => self.read_archive_job(id).await,
            "authorization" => self.read_authorization(id).await,
            "portability_archive" => self.read_portability_archive(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "archive_job" => self.update_archive_job(id, input).await,
            "portability_archive" => self.update_portability_archive(id, input).await,
            "access_type" => self.update_access_type(id, input).await,
            "access_type" => self.update_access_type(id, input).await,
            "archive_job" => self.update_archive_job(id, input).await,
            "authorization" => self.update_authorization(id, input).await,
            "portability_archive" => self.update_portability_archive(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "archive_job" => self.delete_archive_job(id).await,
            "portability_archive" => self.delete_portability_archive(id).await,
            "access_type" => self.delete_access_type(id).await,
            "access_type" => self.delete_access_type(id).await,
            "archive_job" => self.delete_archive_job(id).await,
            "authorization" => self.delete_authorization(id).await,
            "portability_archive" => self.delete_portability_archive(id).await,
    ...
    async fn create_archive_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a archive_job resource
    async fn read_archive_job(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a archive_job resource
    async fn update_archive_job(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a archive_job resource
    async fn delete_archive_job(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_portability_archive(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a portability_archive resource
    async fn read_portability_archive(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_portability_archive(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_access_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a access_type resource
    async fn read_access_type(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a access_type resource
    async fn update_access_type(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a access_type resource
    async fn delete_access_type(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
