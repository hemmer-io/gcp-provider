...
impl<'a> Regional_endpoint<'a> {
    ...
    pub async fn create(&self, labels: Option<HashMap<String, String>>, target_google_api: Option<String>, ip_address: Option<String>, name: Option<String>, address: Option<String>, create_time: Option<String>, access_type: Option<String>, network: Option<String>, psc_forwarding_rule: Option<String>, description: Option<String>, subnetwork: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
