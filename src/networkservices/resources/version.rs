...
impl<'a> Version<'a> {
    ...
    pub async fn create(&self, image_digest: Option<String>, plugin_config_data: Option<String>, plugin_config_digest: Option<String>, name: Option<String>, create_time: Option<String>, description: Option<String>, plugin_config_uri: Option<String>, image_uri: Option<String>, update_time: Option<String>, labels: Option<HashMap<String, String>>, parent: String) -> Result<String> {
