...
impl<'a> Lb_traffic_extension<'a> {
    ...
    pub async fn create(&self, load_balancing_scheme: Option<String>, metadata: Option<HashMap<String, String>>, labels: Option<HashMap<String, String>>, create_time: Option<String>, forwarding_rules: Option<Vec<String>>, extension_chains: Option<Vec<String>>, update_time: Option<String>, name: Option<String>, description: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, load_balancing_scheme: Option<String>, metadata: Option<HashMap<String, String>>, labels: Option<HashMap<String, String>>, create_time: Option<String>, forwarding_rules: Option<Vec<String>>, extension_chains: Option<Vec<String>>, update_time: Option<String>, name: Option<String>, description: Option<String>) -> Result<()> {
