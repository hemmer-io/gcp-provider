...
//!
//! Auto-generated service module for networkservices

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for networkservices
pub struct NetworkservicesService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> NetworkservicesService<'a> {
