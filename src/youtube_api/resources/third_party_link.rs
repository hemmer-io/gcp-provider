...
impl<'a> Third_party_link<'a> {
    ...
    pub async fn create(&self, etag: Option<String>, kind: Option<String>, linking_token: Option<String>, snippet: Option<String>, status: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, etag: Option<String>, kind: Option<String>, linking_token: Option<String>, snippet: Option<String>, status: Option<String>) -> Result<()> {
