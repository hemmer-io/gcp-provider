...
impl<'a> Abuse_report<'a> {
    ...
    pub async fn create(&self, abuse_types: Option<Vec<String>>, subject: Option<String>, related_entities: Option<Vec<String>>, description: Option<String>) -> Result<String> {
