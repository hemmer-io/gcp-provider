...
impl<'a> Playlist_image<'a> {
    ...
    pub async fn create(&self, id: Option<String>, kind: Option<String>, snippet: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, id: Option<String>, kind: Option<String>, snippet: Option<String>) -> Result<()> {
