...
impl<'a> Playlist_image<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, id: Option<String>, snippet: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, kind: Option<String>, id: Option<String>, snippet: Option<String>) -> Result<()> {
