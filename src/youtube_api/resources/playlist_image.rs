...
impl<'a> Playlist_image<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, snippet: Option<String>, id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, kind: Option<String>, snippet: Option<String>, id: Option<String>) -> Result<()> {
