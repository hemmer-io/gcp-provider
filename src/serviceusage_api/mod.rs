...
impl<'a> Serviceusage_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "admin_override" => {
                self.plan_admin_override(current_state, desired_input).await
            }
            "service" => {
                self.plan_service(current_state, desired_input).await
            }
            ...
            "consumer_override" => {
                self.plan_consumer_override(current_state, desired_input).await
            }
            "limit" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "admin_override" => {
                self.create_admin_override(input).await
            }
            "service" => {
                self.create_service(input).await
            }
            ...
            "consumer_override" => {
                self.create_consumer_override(input).await
            }
            "limit" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "admin_override" => {
                self.read_admin_override(id).await
            }
            "service" => {
                self.read_service(id).await
            }
            ...
            "consumer_override" => {
                self.read_consumer_override(id).await
            }
            "limit" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "admin_override" => {
                self.update_admin_override(id, input).await
            }
            "service" => {
                self.update_service(id, input).await
            }
            ...
            "consumer_override" => {
                self.update_consumer_override(id, input).await
            }
            "limit" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "admin_override" => {
                self.delete_admin_override(id).await
            }
            "service" => {
                self.delete_service(id).await
            }
            ...
            "consumer_override" => {
                self.delete_consumer_override(id).await
            }
            "limit" => {
    ...
    async fn read_consumer_override(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
