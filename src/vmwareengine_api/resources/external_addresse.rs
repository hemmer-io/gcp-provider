...
impl<'a> External_addresse<'a> {
    ...
    pub async fn create(&self, external_ip: Option<String>, description: Option<String>, create_time: Option<String>, internal_ip: Option<String>, uid: Option<String>, name: Option<String>, update_time: Option<String>, state: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, external_ip: Option<String>, description: Option<String>, create_time: Option<String>, internal_ip: Option<String>, uid: Option<String>, name: Option<String>, update_time: Option<String>, state: Option<String>) -> Result<()> {
