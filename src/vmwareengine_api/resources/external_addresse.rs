...
impl<'a> External_addresse<'a> {
    ...
    pub async fn create(&self, state: Option<String>, external_ip: Option<String>, create_time: Option<String>, internal_ip: Option<String>, description: Option<String>, uid: Option<String>, update_time: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, state: Option<String>, external_ip: Option<String>, create_time: Option<String>, internal_ip: Option<String>, description: Option<String>, uid: Option<String>, update_time: Option<String>, name: Option<String>) -> Result<()> {
