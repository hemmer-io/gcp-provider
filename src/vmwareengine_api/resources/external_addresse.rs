...
impl<'a> External_addresse<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, external_ip: Option<String>, internal_ip: Option<String>, name: Option<String>, description: Option<String>, state: Option<String>, uid: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, create_time: Option<String>, external_ip: Option<String>, internal_ip: Option<String>, name: Option<String>, description: Option<String>, state: Option<String>, uid: Option<String>, update_time: Option<String>) -> Result<()> {
