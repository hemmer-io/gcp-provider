...
impl<'a> External_addresse<'a> {
    ...
    pub async fn create(&self, description: Option<String>, create_time: Option<String>, update_time: Option<String>, external_ip: Option<String>, name: Option<String>, state: Option<String>, internal_ip: Option<String>, uid: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, create_time: Option<String>, update_time: Option<String>, external_ip: Option<String>, name: Option<String>, state: Option<String>, internal_ip: Option<String>, uid: Option<String>) -> Result<()> {
