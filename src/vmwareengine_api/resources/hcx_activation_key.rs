...
impl<'a> Hcx_activation_key<'a> {
    ...
    pub async fn create(&self, name: Option<String>, state: Option<String>, create_time: Option<String>, activation_key: Option<String>, uid: Option<String>, parent: String) -> Result<String> {
