...
impl<'a> Private_connection<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, state: Option<String>, type: Option<String>, name: Option<String>, peering_id: Option<String>, routing_mode: Option<String>, peering_state: Option<String>, description: Option<String>, vmware_engine_network_canonical: Option<String>, service_network: Option<String>, uid: Option<String>, vmware_engine_network: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
