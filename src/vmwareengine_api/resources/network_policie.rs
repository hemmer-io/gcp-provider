...
impl<'a> Network_policie<'a> {
    ...
    pub async fn create(&self, description: Option<String>, create_time: Option<String>, external_ip: Option<String>, vmware_engine_network: Option<String>, vmware_engine_network_canonical: Option<String>, edge_services_cidr: Option<String>, internet_access: Option<String>, name: Option<String>, uid: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
