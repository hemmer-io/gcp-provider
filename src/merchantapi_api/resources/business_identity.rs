...
impl<'a> Business_identity<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, black_owned: Option<String>, small_business: Option<String>, veteran_owned: Option<String>, women_owned: Option<String>, name: Option<String>, promotions_consent: Option<String>, latino_owned: Option<String>) -> Result<()> {
