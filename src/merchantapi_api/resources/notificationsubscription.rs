...
impl<'a> Notificationsubscription<'a> {
    ...
    pub async fn create(&self, target_account: Option<String>, name: Option<String>, all_managed_accounts: Option<bool>, call_back_uri: Option<String>, registered_event: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, target_account: Option<String>, name: Option<String>, all_managed_accounts: Option<bool>, call_back_uri: Option<String>, registered_event: Option<String>) -> Result<()> {
