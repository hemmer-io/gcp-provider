...
impl<'a> Regional_inventorie<'a> {
    ...
    pub async fn create(&self, region: Option<String>, name: Option<String>, account: Option<String>, regional_inventory_attributes: Option<String>, parent: String) -> Result<String> {
