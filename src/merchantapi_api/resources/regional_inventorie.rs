...
impl<'a> Regional_inventorie<'a> {
    ...
    pub async fn create(&self, account: Option<String>, regional_inventory_attributes: Option<String>, region: Option<String>, name: Option<String>, parent: String) -> Result<String> {
