...
impl<'a> Product_input<'a> {
    ...
    pub async fn create(&self, custom_attributes: Option<Vec<String>>, offer_id: Option<String>, feed_label: Option<String>, product: Option<String>, attributes: Option<String>, content_language: Option<String>, version_number: Option<String>, channel: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, custom_attributes: Option<Vec<String>>, offer_id: Option<String>, feed_label: Option<String>, product: Option<String>, attributes: Option<String>, content_language: Option<String>, version_number: Option<String>, channel: Option<String>, name: Option<String>) -> Result<()> {
