...
impl<'a> Product_input<'a> {
    ...
    pub async fn create(&self, channel: Option<String>, version_number: Option<String>, feed_label: Option<String>, custom_attributes: Option<Vec<String>>, content_language: Option<String>, name: Option<String>, offer_id: Option<String>, product: Option<String>, attributes: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, channel: Option<String>, version_number: Option<String>, feed_label: Option<String>, custom_attributes: Option<Vec<String>>, content_language: Option<String>, name: Option<String>, offer_id: Option<String>, product: Option<String>, attributes: Option<String>) -> Result<()> {
