...
impl<'a> Automatic_improvement<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, shipping_improvements: Option<String>, image_improvements: Option<String>, name: Option<String>, item_updates: Option<String>) -> Result<()> {
