...
impl<'a> Product_review<'a> {
    ...
    pub async fn create(&self, custom_attributes: Option<Vec<String>>, name: Option<String>, product_review_status: Option<String>, data_source: Option<String>, product_review_attributes: Option<String>, product_review_id: Option<String>, parent: String) -> Result<String> {
