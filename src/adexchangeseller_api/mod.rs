...
impl<'a> Adexchangeseller_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "saved" => self.plan_saved(current_state, desired_input).await,
            "preferreddeal" => self.plan_preferreddeal(current_state, desired_input).await,
            "urlchannel" => self.plan_urlchannel(current_state, desired_input).await,
            "customchannel" => self.plan_customchannel(current_state, desired_input).await,
            "adclient" => self.plan_adclient(current_state, desired_input).await,
            "report" => self.plan_report(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "adexchangeseller_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "saved" => self.create_saved(input).await,
            "preferreddeal" => self.create_preferreddeal(input).await,
            "urlchannel" => self.create_urlchannel(input).await,
            "customchannel" => self.create_customchannel(input).await,
            "adclient" => self.create_adclient(input).await,
            "report" => self.create_report(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "saved" => self.read_saved(id).await,
            "preferreddeal" => self.read_preferreddeal(id).await,
            "urlchannel" => self.read_urlchannel(id).await,
            "customchannel" => self.read_customchannel(id).await,
            "adclient" => self.read_adclient(id).await,
            "report" => self.read_report(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "saved" => self.update_saved(id, input).await,
            "preferreddeal" => self.update_preferreddeal(id, input).await,
            "urlchannel" => self.update_urlchannel(id, input).await,
            "customchannel" => self.update_customchannel(id, input).await,
            "adclient" => self.update_adclient(id, input).await,
            "report" => self.update_report(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "saved" => self.delete_saved(id).await,
            "preferreddeal" => self.delete_preferreddeal(id).await,
            "urlchannel" => self.delete_urlchannel(id).await,
            "customchannel" => self.delete_customchannel(id).await,
            "adclient" => self.delete_adclient(id).await,
            "report" => self.delete_report(id).await,
    ...
    async fn create_preferreddeal(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a preferreddeal resource
    async fn read_preferreddeal(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a preferreddeal resource
    async fn update_preferreddeal(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a preferreddeal resource
    async fn delete_preferreddeal(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
