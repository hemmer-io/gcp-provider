//! Areainsights_api service for Gcp provider
//!
//! This module handles all areainsights_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Areainsights_api service handler
...
impl<'a> Areainsights_apiService<'a> {
    ...
    /// Plan changes to a areainsight resource
    async fn plan_areainsight(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
