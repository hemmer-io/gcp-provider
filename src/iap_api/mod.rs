...
impl<'a> Iap_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "identity_aware_proxy_client" => {
                self.plan_identity_aware_proxy_client(current_state, desired_input).await
            }
            "brand" => {
                self.plan_brand(current_state, desired_input).await
            }
            "iap" => {
                self.plan_iap(current_state, desired_input).await
            }
            "dest_group" => {
                self.plan_dest_group(current_state, desired_input).await
            }
            "iap" => {
                self.plan_iap(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "identity_aware_proxy_client" => {
                self.create_identity_aware_proxy_client(input).await
            }
            "brand" => {
                self.create_brand(input).await
            }
            "iap" => {
                self.create_iap(input).await
            }
            "dest_group" => {
                self.create_dest_group(input).await
            }
            "iap" => {
                self.create_iap(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "identity_aware_proxy_client" => {
                self.read_identity_aware_proxy_client(id).await
            }
            "brand" => {
                self.read_brand(id).await
            }
            "iap" => {
                self.read_iap(id).await
            }
            "dest_group" => {
                self.read_dest_group(id).await
            }
            "iap" => {
                self.read_iap(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "iap" => {
                self.update_iap(id, input).await
            }
            "dest_group" => {
                self.update_dest_group(id, input).await
            }
            "iap" => {
                self.update_iap(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "identity_aware_proxy_client" => {
                self.delete_identity_aware_proxy_client(id).await
            }
            "brand" => {
                self.delete_brand(id).await
            }
            "iap" => {
                self.delete_iap(id).await
            }
            "dest_group" => {
                self.delete_dest_group(id).await
            }
            "iap" => {
                self.delete_iap(id).await
            }
    ...
    async fn read_identity_aware_proxy_client(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
