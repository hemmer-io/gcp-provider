...
impl<'a> Gmail_apiService<'a> {
    ...
    async fn create_forwarding_addresse(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_forwarding_addresse(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_forwarding_addresse(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
