...
impl<'a> Keypair<'a> {
    ...
    pub async fn create(&self, disable_time: Option<String>, enablement_state: Option<String>, pem: Option<String>, private_key_metadata: Option<Vec<String>>, subject_email_addresses: Option<Vec<String>>, key_pair_id: Option<String>, pkcs7: Option<String>, user_id: String) -> Result<String> {
