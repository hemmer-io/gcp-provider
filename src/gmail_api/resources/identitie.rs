...
impl<'a> Identitie<'a> {
    ...
    pub async fn create(&self, primary_key_pair_id: Option<String>, email_address: Option<String>, sign_and_encrypt_key_pairs: Option<String>, user_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, primary_key_pair_id: Option<String>, email_address: Option<String>, sign_and_encrypt_key_pairs: Option<String>) -> Result<()> {
