//! Gamesmanagement_api service for Gcp provider
//!
//! This module handles all gamesmanagement_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Gamesmanagement_api service handler
