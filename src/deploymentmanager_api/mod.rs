...
impl<'a> Deploymentmanager_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "type_provider" => {
                self.plan_type_provider(current_state, desired_input).await
            }
            "operation" => {
                self.plan_operation(current_state, desired_input).await
            }
            "manifest" => {
                self.plan_manifest(current_state, desired_input).await
            }
            "resource" => {
            ...
            "composite_type" => {
                self.plan_composite_type(current_state, desired_input).await
            }
            "operation" => {
                self.plan_operation(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "type_provider" => {
                self.create_type_provider(input).await
            }
            "operation" => {
                self.create_operation(input).await
            }
            "manifest" => {
                self.create_manifest(input).await
            }
            "resource" => {
            ...
            "composite_type" => {
                self.create_composite_type(input).await
            }
            "operation" => {
                self.create_operation(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "type_provider" => {
                self.read_type_provider(id).await
            }
            "operation" => {
                self.read_operation(id).await
            }
            "manifest" => {
                self.read_manifest(id).await
            }
            "resource" => {
            ...
            "composite_type" => {
                self.read_composite_type(id).await
            }
            "operation" => {
                self.read_operation(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "type_provider" => {
                self.update_type_provider(id, input).await
            }
            "operation" => {
                self.update_operation(id, input).await
            }
            "manifest" => {
                self.update_manifest(id, input).await
            }
            "resource" => {
            ...
            "composite_type" => {
                self.update_composite_type(id, input).await
            }
            "operation" => {
                self.update_operation(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "type_provider" => {
                self.delete_type_provider(id).await
            }
            "operation" => {
            ...
            "composite_type" => {
                self.delete_composite_type(id).await
            }
            "operation" => {
                self.delete_operation(id).await
            }
    ...
    async fn create_composite_type(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_composite_type(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
