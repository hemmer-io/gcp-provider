...
impl<'a> Containeranalysis_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "occurrence" => {
                self.plan_occurrence(current_state, desired_input).await
            }
            "resource" => {
                self.plan_resource(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "occurrence" => {
                self.create_occurrence(input).await
            }
            "resource" => {
                self.create_resource(input).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "occurrence" => {
                self.update_occurrence(id, input).await
            }
            "resource" => {
                self.update_resource(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "occurrence" => {
                self.delete_occurrence(id).await
            }
            "resource" => {
                self.delete_resource(id).await
            }
