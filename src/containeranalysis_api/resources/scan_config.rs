...
impl<'a> Scan_config<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, enabled: Option<bool>, name: Option<String>, update_time: Option<String>, description: Option<String>, create_time: Option<String>) -> Result<()> {
