...
impl<'a> User_activity<'a> {
    ...
    pub async fn create(&self, date_range: Option<String>, activity_types: Option<Vec<String>>, page_size: Option<i64>, view_id: Option<String>, page_token: Option<String>, user: Option<String>) -> Result<String> {
