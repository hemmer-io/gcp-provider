...
impl<'a> Adexchangebuyer_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "pubprofile" => self.plan_pubprofile(current_state, desired_input).await,
            "budget" => self.plan_budget(current_state, desired_input).await,
            "marketplacedeal" => {
                self.plan_marketplacedeal(current_state, desired_input)
                    .await
            }
            "marketplacenote" => {
                self.plan_marketplacenote(current_state, desired_input)
                    .await
            }
            "pretargeting_config" => {
                self.plan_pretargeting_config(current_state, desired_input)
                    .await
            }
            "billing_info" => self.plan_billing_info(current_state, desired_input).await,
            "marketplaceprivateauction" => {
                self.plan_marketplaceprivateauction(current_state, desired_input)
                    .await
            }
            ...
            "performance_report" => {
                self.plan_performance_report(current_state, desired_input)
                    .await
            }
            "direct_deal" => self.plan_direct_deal(current_state, desired_input).await,
            "performance_report" => {
                self.plan_performance_report(current_state, desired_input)
                    .await
            }
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "adexchangebuyer_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "pubprofile" => self.create_pubprofile(input).await,
            "budget" => self.create_budget(input).await,
            "marketplacedeal" => self.create_marketplacedeal(input).await,
            "marketplacenote" => self.create_marketplacenote(input).await,
            "pretargeting_config" => self.create_pretargeting_config(input).await,
            "billing_info" => self.create_billing_info(input).await,
            "marketplaceprivateauction" => self.create_marketplaceprivateauction(input).await,
            "account" => self.create_account(input).await,
            "product" => self.create_product(input).await,
            "creative" => self.create_creative(input).await,
            "performance_report" => self.create_performance_report(input).await,
            "direct_deal" => self.create_direct_deal(input).await,
            "performance_report" => self.create_performance_report(input).await,
            "pretargeting_config" => self.create_pretargeting_config(input).await,
            "budget" => self.create_budget(input).await,
            "billing_info" => self.create_billing_info(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "pubprofile" => self.read_pubprofile(id).await,
            "budget" => self.read_budget(id).await,
            "marketplacedeal" => self.read_marketplacedeal(id).await,
            "marketplacenote" => self.read_marketplacenote(id).await,
            "pretargeting_config" => self.read_pretargeting_config(id).await,
            "billing_info" => self.read_billing_info(id).await,
            "marketplaceprivateauction" => self.read_marketplaceprivateauction(id).await,
            "account" => self.read_account(id).await,
            "product" => self.read_product(id).await,
            "creative" => self.read_creative(id).await,
            "performance_report" => self.read_performance_report(id).await,
            "direct_deal" => self.read_direct_deal(id).await,
            "performance_report" => self.read_performance_report(id).await,
            "pretargeting_config" => self.read_pretargeting_config(id).await,
            "budget" => self.read_budget(id).await,
            "billing_info" => self.read_billing_info(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "pubprofile" => self.update_pubprofile(id, input).await,
            "budget" => self.update_budget(id, input).await,
            "marketplacedeal" => self.update_marketplacedeal(id, input).await,
            "marketplacenote" => self.update_marketplacenote(id, input).await,
            "pretargeting_config" => self.update_pretargeting_config(id, input).await,
            "billing_info" => self.update_billing_info(id, input).await,
            "marketplaceprivateauction" => self.update_marketplaceprivateauction(id, input).await,
            ...
            "performance_report" => self.update_performance_report(id, input).await,
            "direct_deal" => self.update_direct_deal(id, input).await,
            "performance_report" => self.update_performance_report(id, input).await,
            "pretargeting_config" => self.update_pretargeting_config(id, input).await,
            "budget" => self.update_budget(id, input).await,
            "billing_info" => self.update_billing_info(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "pubprofile" => self.delete_pubprofile(id).await,
            "budget" => self.delete_budget(id).await,
            "marketplacedeal" => self.delete_marketplacedeal(id).await,
            "marketplacenote" => self.delete_marketplacenote(id).await,
            "pretargeting_config" => self.delete_pretargeting_config(id).await,
            "billing_info" => self.delete_billing_info(id).await,
            "marketplaceprivateauction" => self.delete_marketplaceprivateauction(id).await,
            "account" => self.delete_account(id).await,
            "product" => self.delete_product(id).await,
            "creative" => self.delete_creative(id).await,
            "performance_report" => self.delete_performance_report(id).await,
            "direct_deal" => self.delete_direct_deal(id).await,
            "performance_report" => self.delete_performance_report(id).await,
            "pretargeting_config" => self.delete_pretargeting_config(id).await,
            "budget" => self.delete_budget(id).await,
            "billing_info" => self.delete_billing_info(id).await,
    ...
    async fn create_pubprofile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a pubprofile resource
    async fn read_pubprofile(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a pubprofile resource
    async fn update_pubprofile(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a pubprofile resource
    async fn delete_pubprofile(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_marketplacedeal(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a marketplacedeal resource
    async fn read_marketplacedeal(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_marketplacedeal(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_marketplacenote(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a marketplacenote resource
    async fn read_marketplacenote(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_marketplacenote(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_pretargeting_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a pretargeting_config resource
    async fn read_pretargeting_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_pretargeting_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_billing_info(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a billing_info resource
    async fn read_billing_info(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a billing_info resource
    async fn update_billing_info(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a billing_info resource
    async fn delete_billing_info(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_marketplaceprivateauction(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_marketplaceprivateauction(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_performance_report(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a performance_report resource
    async fn read_performance_report(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_performance_report(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_direct_deal(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a direct_deal resource
    async fn read_direct_deal(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a direct_deal resource
    async fn update_direct_deal(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a direct_deal resource
    async fn delete_direct_deal(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
