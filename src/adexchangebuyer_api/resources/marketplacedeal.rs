...
impl<'a> Marketplacedeal<'a> {
    ...
    pub async fn create(&self, update_action: Option<String>, proposal_revision_number: Option<String>, deals: Option<Vec<String>>, proposal_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, update_action: Option<String>, proposal_revision_number: Option<String>, deals: Option<Vec<String>>) -> Result<()> {
