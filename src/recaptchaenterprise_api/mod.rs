...
impl<'a> Recaptchaenterprise_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "relatedaccountgroup" => {
                self.plan_relatedaccountgroup(current_state, desired_input)
                    .await
            }
            "firewallpolicie" => {
                self.plan_firewallpolicie(current_state, desired_input)
                    .await
            }
            "relatedaccountgroupmembership" => {
                self.plan_relatedaccountgroupmembership(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "recaptchaenterprise_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "relatedaccountgroup" => self.create_relatedaccountgroup(input).await,
            "firewallpolicie" => self.create_firewallpolicie(input).await,
            "relatedaccountgroupmembership" => {
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "relatedaccountgroup" => self.read_relatedaccountgroup(id).await,
            "firewallpolicie" => self.read_firewallpolicie(id).await,
            "relatedaccountgroupmembership" => self.read_relatedaccountgroupmembership(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "recaptchaenterprise_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "relatedaccountgroup" => self.update_relatedaccountgroup(id, input).await,
            "firewallpolicie" => self.update_firewallpolicie(id, input).await,
            "relatedaccountgroupmembership" => {
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "relatedaccountgroup" => self.delete_relatedaccountgroup(id).await,
            "firewallpolicie" => self.delete_firewallpolicie(id).await,
            "relatedaccountgroupmembership" => self.delete_relatedaccountgroupmembership(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "recaptchaenterprise_api", resource_name
            ))),
    ...
    async fn create_relatedaccountgroup(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a relatedaccountgroup resource
    async fn read_relatedaccountgroup(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_relatedaccountgroup(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_firewallpolicie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a firewallpolicie resource
    async fn read_firewallpolicie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_firewallpolicie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_relatedaccountgroupmembership(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_relatedaccountgroupmembership(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
