...
impl<'a> Attribute<'a> {
    ...
    pub async fn create(&self, cardinality: Option<i64>, description: Option<String>, display_name: Option<String>, mandatory: Option<bool>, name: Option<String>, scope: Option<String>, data_type: Option<String>, definition_type: Option<String>, allowed_values: Option<Vec<String>>, create_time: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, cardinality: Option<i64>, description: Option<String>, display_name: Option<String>, mandatory: Option<bool>, name: Option<String>, scope: Option<String>, data_type: Option<String>, definition_type: Option<String>, allowed_values: Option<Vec<String>>, create_time: Option<String>, update_time: Option<String>) -> Result<()> {
