...
impl<'a> Curation<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, plugin_instance_actions: Option<Vec<String>>, create_time: Option<String>, last_execution_error_code: Option<String>, last_execution_state: Option<String>, name: Option<String>, description: Option<String>, last_execution_error_message: Option<String>, update_time: Option<String>, endpoint: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, display_name: Option<String>, plugin_instance_actions: Option<Vec<String>>, create_time: Option<String>, last_execution_error_code: Option<String>, last_execution_state: Option<String>, name: Option<String>, description: Option<String>, last_execution_error_message: Option<String>, update_time: Option<String>, endpoint: Option<String>) -> Result<()> {
