...
impl<'a> Spec<'a> {
    ...
    pub async fn create(&self, contents: Option<String>, attributes: Option<HashMap<String, String>>, details: Option<String>, parsing_mode: Option<String>, name: Option<String>, create_time: Option<String>, lint_response: Option<String>, source_metadata: Option<Vec<String>>, spec_type: Option<String>, display_name: Option<String>, source_uri: Option<String>, documentation: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
