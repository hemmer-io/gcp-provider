...
impl<'a> Apihub_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "host_project_registration" => {
                self.plan_host_project_registration(current_state, desired_input)
                    .await
            }
            "plugin" => self.plan_plugin(current_state, desired_input).await,
            "api_hub_instance" => {
                self.plan_api_hub_instance(current_state, desired_input)
                    .await
            }
            "curation" => self.plan_curation(current_state, desired_input).await,
            "discovered_api_operation" => {
                self.plan_discovered_api_operation(current_state, desired_input)
                    .await
            }
            "style_guide" => self.plan_style_guide(current_state, desired_input).await,
            "discovered_api_observation" => {
                self.plan_discovered_api_observation(current_state, desired_input)
                    .await
            }
            "dependencie" => self.plan_dependencie(current_state, desired_input).await,
            "instance" => self.plan_instance(current_state, desired_input).await,
            "external_api" => self.plan_external_api(current_state, desired_input).await,
            ...
            "runtime_project_attachment" => {
                self.plan_runtime_project_attachment(current_state, desired_input)
                    .await
            }
            ...
            "spec" => self.plan_spec(current_state, desired_input).await,
            "definition" => self.plan_definition(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apihub_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "host_project_registration" => self.create_host_project_registration(input).await,
            "plugin" => self.create_plugin(input).await,
            "api_hub_instance" => self.create_api_hub_instance(input).await,
            "curation" => self.create_curation(input).await,
            "discovered_api_operation" => self.create_discovered_api_operation(input).await,
            "style_guide" => self.create_style_guide(input).await,
            "discovered_api_observation" => self.create_discovered_api_observation(input).await,
            "dependencie" => self.create_dependencie(input).await,
            "instance" => self.create_instance(input).await,
            "external_api" => self.create_external_api(input).await,
            ...
            "runtime_project_attachment" => self.create_runtime_project_attachment(input).await,
            "location" => self.create_location(input).await,
            "operation" => self.create_operation(input).await,
            "spec" => self.create_spec(input).await,
            "definition" => self.create_definition(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apihub_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "host_project_registration" => self.read_host_project_registration(id).await,
            "plugin" => self.read_plugin(id).await,
            "api_hub_instance" => self.read_api_hub_instance(id).await,
            "curation" => self.read_curation(id).await,
            "discovered_api_operation" => self.read_discovered_api_operation(id).await,
            "style_guide" => self.read_style_guide(id).await,
            "discovered_api_observation" => self.read_discovered_api_observation(id).await,
            "dependencie" => self.read_dependencie(id).await,
            "instance" => self.read_instance(id).await,
            "external_api" => self.read_external_api(id).await,
            ...
            "runtime_project_attachment" => self.read_runtime_project_attachment(id).await,
            "location" => self.read_location(id).await,
            "operation" => self.read_operation(id).await,
            "spec" => self.read_spec(id).await,
            "definition" => self.read_definition(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apihub_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "host_project_registration" => self.update_host_project_registration(id, input).await,
            "plugin" => self.update_plugin(id, input).await,
            "api_hub_instance" => self.update_api_hub_instance(id, input).await,
            "curation" => self.update_curation(id, input).await,
            "discovered_api_operation" => self.update_discovered_api_operation(id, input).await,
            "style_guide" => self.update_style_guide(id, input).await,
            "discovered_api_observation" => self.update_discovered_api_observation(id, input).await,
            "dependencie" => self.update_dependencie(id, input).await,
            "instance" => self.update_instance(id, input).await,
            "external_api" => self.update_external_api(id, input).await,
            ...
            "runtime_project_attachment" => self.update_runtime_project_attachment(id, input).await,
            "location" => self.update_location(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "spec" => self.update_spec(id, input).await,
            "definition" => self.update_definition(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apihub_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "host_project_registration" => self.delete_host_project_registration(id).await,
            "plugin" => self.delete_plugin(id).await,
            "api_hub_instance" => self.delete_api_hub_instance(id).await,
            "curation" => self.delete_curation(id).await,
            "discovered_api_operation" => self.delete_discovered_api_operation(id).await,
            "style_guide" => self.delete_style_guide(id).await,
            "discovered_api_observation" => self.delete_discovered_api_observation(id).await,
            "dependencie" => self.delete_dependencie(id).await,
            "instance" => self.delete_instance(id).await,
            "external_api" => self.delete_external_api(id).await,
            ...
            "runtime_project_attachment" => self.delete_runtime_project_attachment(id).await,
            "location" => self.delete_location(id).await,
            "operation" => self.delete_operation(id).await,
            "spec" => self.delete_spec(id).await,
            "definition" => self.delete_definition(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apihub_api", resource_name
            ))),
    ...
    async fn read_host_project_registration(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_host_project_registration(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_plugin(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a plugin resource
    async fn read_plugin(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a plugin resource
    async fn update_plugin(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn create_api_hub_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a api_hub_instance resource
    async fn read_api_hub_instance(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_api_hub_instance(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_curation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a curation resource
    async fn read_curation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a curation resource
    async fn update_curation(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a curation resource
    async fn delete_curation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_discovered_api_operation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_discovered_api_operation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_style_guide(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a style_guide resource
    async fn read_style_guide(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a style_guide resource
    async fn update_style_guide(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a style_guide resource
    async fn delete_style_guide(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_discovered_api_observation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_discovered_api_observation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_dependencie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a dependencie resource
    async fn read_dependencie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a dependencie resource
    async fn update_dependencie(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a dependencie resource
    async fn delete_dependencie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_external_api(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a external_api resource
    async fn read_external_api(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a external_api resource
    async fn update_external_api(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a external_api resource
    async fn delete_external_api(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_runtime_project_attachment(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_runtime_project_attachment(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_spec(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a spec resource
    async fn read_spec(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a spec resource
    async fn update_spec(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn create_definition(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a definition resource
    async fn read_definition(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a definition resource
    async fn update_definition(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
