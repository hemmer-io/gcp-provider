...
impl<'a> Netapp_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "kms_config" => self.plan_kms_config(current_state, desired_input).await,
            "active_directorie" => {
                self.plan_active_directorie(current_state, desired_input)
                    .await
            }
            "storage_pool" => self.plan_storage_pool(current_state, desired_input).await,
            "backup_policie" => self.plan_backup_policie(current_state, desired_input).await,
            ...
            "quota_rule" => self.plan_quota_rule(current_state, desired_input).await,
            ...
            "replication" => self.plan_replication(current_state, desired_input).await,
            "operation" => self.plan_operation(current_state, desired_input).await,
            "kms_config" => self.plan_kms_config(current_state, desired_input).await,
            "location" => self.plan_location(current_state, desired_input).await,
            "snapshot" => self.plan_snapshot(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "kms_config" => self.create_kms_config(input).await,
            "active_directorie" => self.create_active_directorie(input).await,
            "storage_pool" => self.create_storage_pool(input).await,
            "backup_policie" => self.create_backup_policie(input).await,
            ...
            "quota_rule" => self.create_quota_rule(input).await,
            "operation" => self.create_operation(input).await,
            "snapshot" => self.create_snapshot(input).await,
            "replication" => self.create_replication(input).await,
            "operation" => self.create_operation(input).await,
            "kms_config" => self.create_kms_config(input).await,
            "location" => self.create_location(input).await,
            "snapshot" => self.create_snapshot(input).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "kms_config" => self.update_kms_config(id, input).await,
            "active_directorie" => self.update_active_directorie(id, input).await,
            "storage_pool" => self.update_storage_pool(id, input).await,
            "backup_policie" => self.update_backup_policie(id, input).await,
            ...
            "quota_rule" => self.update_quota_rule(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "snapshot" => self.update_snapshot(id, input).await,
            "replication" => self.update_replication(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "kms_config" => self.update_kms_config(id, input).await,
            "location" => self.update_location(id, input).await,
            "snapshot" => self.update_snapshot(id, input).await,
    ...
    async fn create_kms_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a kms_config resource
    async fn read_kms_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a kms_config resource
    async fn update_kms_config(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a kms_config resource
    async fn delete_kms_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_active_directorie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a active_directorie resource
    async fn read_active_directorie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_active_directorie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_backup_policie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a backup_policie resource
    async fn read_backup_policie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_backup_policie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_quota_rule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a quota_rule resource
    async fn read_quota_rule(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a quota_rule resource
    async fn update_quota_rule(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a quota_rule resource
    async fn delete_quota_rule(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_replication(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a replication resource
    async fn read_replication(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a replication resource
    async fn update_replication(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a replication resource
    async fn delete_replication(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
