...
impl<'a> Instance<'a> {
    ...
    pub async fn create(&self, name: Option<String>, create_time: Option<String>, kms_key: Option<String>, labels: Option<HashMap<String, String>>, state_note: Option<String>, state: Option<String>, workforce_identity_federation_config: Option<String>, host_config: Option<String>, update_time: Option<String>, private_config: Option<String>, parent: String) -> Result<String> {
