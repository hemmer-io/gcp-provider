...
impl<'a> Issue_comment<'a> {
    ...
    pub async fn create(&self, update_time: Option<String>, name: Option<String>, body: Option<String>, create_time: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, update_time: Option<String>, name: Option<String>, body: Option<String>, create_time: Option<String>) -> Result<()> {
