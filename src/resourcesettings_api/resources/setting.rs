...
impl<'a> Setting<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, local_value: Option<String>, etag: Option<String>, effective_value: Option<String>, name: Option<String>, metadata: Option<String>) -> Result<()> {
