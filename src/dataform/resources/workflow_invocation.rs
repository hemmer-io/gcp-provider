...
impl<'a> Workflow_invocation<'a> {
    ...
    pub async fn create(&self, state: Option<String>, resolved_compilation_result: Option<String>, data_encryption_state: Option<String>, invocation_timing: Option<String>, internal_metadata: Option<String>, compilation_result: Option<String>, invocation_config: Option<String>, name: Option<String>, workflow_config: Option<String>, parent: String) -> Result<String> {
