//! Adexperiencereport_api service for Gcp provider
//!
//! This module handles all adexperiencereport_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Adexperiencereport_api service handler
pub struct Adexperiencereport_apiService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> Adexperiencereport_apiService<'a> {
