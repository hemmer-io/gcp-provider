...
impl<'a> Ad_unit<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, ad_types: Option<Vec<String>>, reward_settings: Option<String>, ad_format: Option<String>, ad_unit_id: Option<String>, app_id: Option<String>, name: Option<String>, parent: String) -> Result<String> {
