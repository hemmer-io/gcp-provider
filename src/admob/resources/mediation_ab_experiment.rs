...
impl<'a> Mediation_ab_experiment<'a> {
    ...
    pub async fn create(&self, mediation_group_id: Option<String>, state: Option<String>, display_name: Option<String>, start_time: Option<String>, treatment_traffic_percentage: Option<String>, control_mediation_lines: Option<Vec<String>>, variant_leader: Option<String>, experiment_id: Option<String>, treatment_mediation_lines: Option<Vec<String>>, end_time: Option<String>, name: Option<String>, parent: String) -> Result<String> {
