...
impl<'a> Ad_unit_mapping<'a> {
    ...
    pub async fn create(&self, name: Option<String>, state: Option<String>, ad_unit_configurations: Option<HashMap<String, String>>, display_name: Option<String>, adapter_id: Option<String>, parent: String) -> Result<String> {
