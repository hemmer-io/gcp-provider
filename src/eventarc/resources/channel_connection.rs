...
impl<'a> Channel_connection<'a> {
    ...
    pub async fn create(&self, activation_token: Option<String>, uid: Option<String>, create_time: Option<String>, channel: Option<String>, name: Option<String>, update_time: Option<String>, labels: Option<HashMap<String, String>>, parent: String) -> Result<String> {
