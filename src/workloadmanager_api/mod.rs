...
impl<'a> Workloadmanager_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "discoveredprofile" => {
                self.plan_discoveredprofile(current_state, desired_input)
                    .await
            }
            ...
            "scanned_resource" => {
                self.plan_scanned_resource(current_state, desired_input)
                    .await
            }
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "workloadmanager_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "discoveredprofile" => self.create_discoveredprofile(input).await,
            ...
            "scanned_resource" => self.create_scanned_resource(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "discoveredprofile" => self.read_discoveredprofile(id).await,
            "rule" => self.read_rule(id).await,
            "evaluation" => self.read_evaluation(id).await,
            "operation" => self.read_operation(id).await,
            "scanned_resource" => self.read_scanned_resource(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "discoveredprofile" => self.update_discoveredprofile(id, input).await,
            ...
            "scanned_resource" => self.update_scanned_resource(id, input).await,
    ...
    async fn create_discoveredprofile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a discoveredprofile resource
    async fn read_discoveredprofile(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_discoveredprofile(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_scanned_resource(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a scanned_resource resource
    async fn read_scanned_resource(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_scanned_resource(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
