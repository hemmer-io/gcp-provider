...
impl<'a> Service_project_attachment<'a> {
    ...
    pub async fn create(&self, state: Option<String>, name: Option<String>, service_project: Option<String>, create_time: Option<String>, uid: Option<String>, parent: String) -> Result<String> {
