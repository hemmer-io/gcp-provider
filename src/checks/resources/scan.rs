...
impl<'a> Scan<'a> {
    ...
    pub async fn create(&self, cli_analysis: Option<String>, scm_metadata: Option<String>, local_scan_path: Option<String>, cli_version: Option<String>, parent: String) -> Result<String> {
