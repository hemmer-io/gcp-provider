...
impl<'a> App<'a> {
    ...
    pub async fn create(&self, dispatch_rules: Option<Vec<String>>, ssl_policy: Option<String>, default_cookie_expiration: Option<String>, default_bucket: Option<String>, location_id: Option<String>, generated_customer_metadata: Option<HashMap<String, String>>, service_account: Option<String>, name: Option<String>, serving_status: Option<String>, id: Option<String>, default_hostname: Option<String>, code_bucket: Option<String>, gcr_domain: Option<String>, auth_domain: Option<String>, feature_settings: Option<String>, iap: Option<String>, database_type: Option<String>) -> Result<String> {
