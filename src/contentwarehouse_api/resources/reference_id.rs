...
impl<'a> Reference_id<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, update_options: Option<String>, request_metadata: Option<String>, cloud_ai_document_option: Option<String>, document: Option<String>) -> Result<()> {
