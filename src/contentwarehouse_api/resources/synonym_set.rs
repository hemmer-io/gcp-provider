...
impl<'a> Synonym_set<'a> {
    ...
    pub async fn create(&self, synonyms: Option<Vec<String>>, context: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, synonyms: Option<Vec<String>>, context: Option<String>, name: Option<String>) -> Result<()> {
