...
impl<'a> Synonym_set<'a> {
    ...
    pub async fn create(&self, name: Option<String>, synonyms: Option<Vec<String>>, context: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, synonyms: Option<Vec<String>>, context: Option<String>) -> Result<()> {
