...
impl<'a> Contentwarehouse_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "document_link" => self.plan_document_link(current_state, desired_input).await,
            ...
            "document_schema" => {
                self.plan_document_schema(current_state, desired_input)
                    .await
            }
            "rule_set" => self.plan_rule_set(current_state, desired_input).await,
            "synonym_set" => self.plan_synonym_set(current_state, desired_input).await,
            "project" => self.plan_project(current_state, desired_input).await,
            "reference_id" => self.plan_reference_id(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "contentwarehouse_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "document_link" => self.create_document_link(input).await,
            "operation" => self.create_operation(input).await,
            "location" => self.create_location(input).await,
            "document_schema" => self.create_document_schema(input).await,
            "rule_set" => self.create_rule_set(input).await,
            "synonym_set" => self.create_synonym_set(input).await,
            "project" => self.create_project(input).await,
            "reference_id" => self.create_reference_id(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "contentwarehouse_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "document_link" => self.read_document_link(id).await,
            "operation" => self.read_operation(id).await,
            "location" => self.read_location(id).await,
            "document_schema" => self.read_document_schema(id).await,
            "rule_set" => self.read_rule_set(id).await,
            "synonym_set" => self.read_synonym_set(id).await,
            "project" => self.read_project(id).await,
            "reference_id" => self.read_reference_id(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "contentwarehouse_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "document_link" => self.update_document_link(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "location" => self.update_location(id, input).await,
            "document_schema" => self.update_document_schema(id, input).await,
            "rule_set" => self.update_rule_set(id, input).await,
            "synonym_set" => self.update_synonym_set(id, input).await,
            "project" => self.update_project(id, input).await,
            "reference_id" => self.update_reference_id(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "contentwarehouse_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "document_link" => self.delete_document_link(id).await,
            "operation" => self.delete_operation(id).await,
            "location" => self.delete_location(id).await,
            "document_schema" => self.delete_document_schema(id).await,
            "rule_set" => self.delete_rule_set(id).await,
            "synonym_set" => self.delete_synonym_set(id).await,
            "project" => self.delete_project(id).await,
            "reference_id" => self.delete_reference_id(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "contentwarehouse_api", resource_name
            ))),
    ...
    async fn create_document_link(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a document_link resource
    async fn read_document_link(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a document_link resource
    async fn update_document_link(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a document_link resource
    async fn delete_document_link(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_document_schema(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a document_schema resource
    async fn read_document_schema(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_document_schema(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_rule_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a rule_set resource
    async fn read_rule_set(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a rule_set resource
    async fn update_rule_set(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a rule_set resource
    async fn delete_rule_set(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_synonym_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a synonym_set resource
    async fn read_synonym_set(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a synonym_set resource
    async fn update_synonym_set(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a synonym_set resource
    async fn delete_synonym_set(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_reference_id(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a reference_id resource
    async fn read_reference_id(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a reference_id resource
    async fn update_reference_id(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a reference_id resource
    async fn delete_reference_id(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
