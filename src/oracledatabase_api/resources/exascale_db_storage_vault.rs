...
impl<'a> Exascale_db_storage_vault<'a> {
    ...
    pub async fn create(&self, gcp_oracle_zone: Option<String>, name: Option<String>, properties: Option<String>, create_time: Option<String>, labels: Option<HashMap<String, String>>, display_name: Option<String>, entitlement_id: Option<String>, parent: String) -> Result<String> {
