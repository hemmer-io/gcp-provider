...
impl<'a> Cloud_exadata_infrastructure<'a> {
    ...
    pub async fn create(&self, entitlement_id: Option<String>, display_name: Option<String>, gcp_oracle_zone: Option<String>, name: Option<String>, labels: Option<HashMap<String, String>>, create_time: Option<String>, properties: Option<String>, parent: String) -> Result<String> {
