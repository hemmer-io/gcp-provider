...
impl<'a> Cloud_exadata_infrastructure<'a> {
    ...
    pub async fn create(&self, labels: Option<HashMap<String, String>>, display_name: Option<String>, entitlement_id: Option<String>, name: Option<String>, create_time: Option<String>, gcp_oracle_zone: Option<String>, properties: Option<String>, parent: String) -> Result<String> {
