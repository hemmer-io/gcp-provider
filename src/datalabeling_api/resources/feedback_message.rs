...
impl<'a> Feedback_message<'a> {
    ...
    pub async fn create(&self, operator_feedback_metadata: Option<String>, image: Option<String>, create_time: Option<String>, body: Option<String>, requester_feedback_metadata: Option<String>, name: Option<String>, parent: String) -> Result<String> {
