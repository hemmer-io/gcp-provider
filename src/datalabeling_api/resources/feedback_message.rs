...
impl<'a> Feedback_message<'a> {
    ...
    pub async fn create(&self, image: Option<String>, operator_feedback_metadata: Option<String>, requester_feedback_metadata: Option<String>, body: Option<String>, create_time: Option<String>, name: Option<String>, parent: String) -> Result<String> {
