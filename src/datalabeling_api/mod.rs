...
impl<'a> Datalabeling_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "feedback_thread" => {
                self.plan_feedback_thread(current_state, desired_input).await
            }
            "video" => {
                self.plan_video(current_state, desired_input).await
            }
            "annotated_dataset" => {
                self.plan_annotated_dataset(current_state, desired_input).await
            }
            "text" => {
            ...
            "example_comparison" => {
                self.plan_example_comparison(current_state, desired_input).await
            }
            "annotation_spec_set" => {
                self.plan_annotation_spec_set(current_state, desired_input).await
            }
            "instruction" => {
                self.plan_instruction(current_state, desired_input).await
            }
            "dataset" => {
            ...
            "feedback_message" => {
                self.plan_feedback_message(current_state, desired_input).await
            }
            "operation" => {
                self.plan_operation(current_state, desired_input).await
            }
            "evaluation_job" => {
                self.plan_evaluation_job(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "feedback_thread" => {
                self.create_feedback_thread(input).await
            }
            "video" => {
                self.create_video(input).await
            }
            "annotated_dataset" => {
                self.create_annotated_dataset(input).await
            }
            "text" => {
            ...
            "example_comparison" => {
                self.create_example_comparison(input).await
            }
            "annotation_spec_set" => {
                self.create_annotation_spec_set(input).await
            }
            "instruction" => {
                self.create_instruction(input).await
            }
            "dataset" => {
            ...
            "feedback_message" => {
                self.create_feedback_message(input).await
            }
            "operation" => {
                self.create_operation(input).await
            }
            "evaluation_job" => {
                self.create_evaluation_job(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "datalabeling_api",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "feedback_thread" => {
                self.read_feedback_thread(id).await
            }
            "video" => {
                self.read_video(id).await
            }
            "annotated_dataset" => {
                self.read_annotated_dataset(id).await
            }
            "text" => {
            ...
            "example_comparison" => {
                self.read_example_comparison(id).await
            }
            "annotation_spec_set" => {
                self.read_annotation_spec_set(id).await
            }
            "instruction" => {
                self.read_instruction(id).await
            }
            "dataset" => {
            ...
            "feedback_message" => {
                self.read_feedback_message(id).await
            }
            "operation" => {
                self.read_operation(id).await
            }
            "evaluation_job" => {
                self.read_evaluation_job(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "datalabeling_api",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "feedback_thread" => {
                self.update_feedback_thread(id, input).await
            }
            "video" => {
                self.update_video(id, input).await
            }
            "annotated_dataset" => {
                self.update_annotated_dataset(id, input).await
            }
            "text" => {
            ...
            "example_comparison" => {
                self.update_example_comparison(id, input).await
            }
            "annotation_spec_set" => {
                self.update_annotation_spec_set(id, input).await
            }
            "instruction" => {
                self.update_instruction(id, input).await
            }
            "dataset" => {
            ...
            "feedback_message" => {
                self.update_feedback_message(id, input).await
            }
            "operation" => {
                self.update_operation(id, input).await
            }
            "evaluation_job" => {
                self.update_evaluation_job(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "datalabeling_api",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "feedback_thread" => {
                self.delete_feedback_thread(id).await
            }
            "video" => {
                self.delete_video(id).await
            }
            "annotated_dataset" => {
                self.delete_annotated_dataset(id).await
            }
            "text" => {
            ...
            "example_comparison" => {
                self.delete_example_comparison(id).await
            }
            "annotation_spec_set" => {
                self.delete_annotation_spec_set(id).await
            }
            "instruction" => {
            ...
            "feedback_message" => {
                self.delete_feedback_message(id).await
            }
            "operation" => {
                self.delete_operation(id).await
            }
            "evaluation_job" => {
                self.delete_evaluation_job(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "datalabeling_api",
    ...
    async fn delete_feedback_thread(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_annotated_dataset(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_annotated_dataset(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_example_comparison(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_example_comparison(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_example_comparison(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_annotation_spec_set(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_feedback_message(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_feedback_message(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_feedback_message(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
