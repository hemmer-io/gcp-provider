...
impl<'a> Alloydb_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "supported_database_flag" => {
                self.plan_supported_database_flag(current_state, desired_input).await
            }
            "location" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "supported_database_flag" => {
                self.create_supported_database_flag(input).await
            }
            "location" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "supported_database_flag" => {
                self.read_supported_database_flag(id).await
            }
            "location" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "supported_database_flag" => {
                self.update_supported_database_flag(id, input).await
            }
            "location" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "supported_database_flag" => {
                self.delete_supported_database_flag(id).await
            }
            "location" => {
    ...
    async fn create_supported_database_flag(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_supported_database_flag(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_supported_database_flag(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
