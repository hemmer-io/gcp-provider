...
impl<'a> Domainsrdap_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "ip" => self.plan_ip(current_state, desired_input).await,
            "domain" => self.plan_domain(current_state, desired_input).await,
            "nameserver" => self.plan_nameserver(current_state, desired_input).await,
            "entity" => self.plan_entity(current_state, desired_input).await,
            "autnum" => self.plan_autnum(current_state, desired_input).await,
            "domainsrdap" => self.plan_domainsrdap(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "domainsrdap_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "ip" => self.create_ip(input).await,
            "domain" => self.create_domain(input).await,
            "nameserver" => self.create_nameserver(input).await,
            "entity" => self.create_entity(input).await,
            "autnum" => self.create_autnum(input).await,
            "domainsrdap" => self.create_domainsrdap(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "domainsrdap_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "ip" => self.read_ip(id).await,
            "domain" => self.read_domain(id).await,
            "nameserver" => self.read_nameserver(id).await,
            "entity" => self.read_entity(id).await,
            "autnum" => self.read_autnum(id).await,
            "domainsrdap" => self.read_domainsrdap(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "domainsrdap_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "ip" => self.update_ip(id, input).await,
            "domain" => self.update_domain(id, input).await,
            "nameserver" => self.update_nameserver(id, input).await,
            "entity" => self.update_entity(id, input).await,
            "autnum" => self.update_autnum(id, input).await,
            "domainsrdap" => self.update_domainsrdap(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "domainsrdap_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "ip" => self.delete_ip(id).await,
            "domain" => self.delete_domain(id).await,
            "nameserver" => self.delete_nameserver(id).await,
            "entity" => self.delete_entity(id).await,
            "autnum" => self.delete_autnum(id).await,
            "domainsrdap" => self.delete_domainsrdap(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "domainsrdap_api", resource_name
            ))),
    ...
    async fn create_ip(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a ip resource
    async fn read_ip(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a ip resource
    async fn update_ip(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a ip resource
    async fn delete_ip(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_nameserver(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a nameserver resource
    async fn read_nameserver(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a nameserver resource
    async fn update_nameserver(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a nameserver resource
    async fn delete_nameserver(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_autnum(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a autnum resource
    async fn read_autnum(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a autnum resource
    async fn update_autnum(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a autnum resource
    async fn delete_autnum(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_domainsrdap(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a domainsrdap resource
    async fn read_domainsrdap(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a domainsrdap resource
    async fn update_domainsrdap(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a domainsrdap resource
    async fn delete_domainsrdap(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
