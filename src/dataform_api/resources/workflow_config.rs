...
impl<'a> Workflow_config<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, update_time: Option<String>, disabled: Option<bool>, name: Option<String>, release_config: Option<String>, recent_scheduled_execution_records: Option<Vec<String>>, time_zone: Option<String>, cron_schedule: Option<String>, invocation_config: Option<String>, internal_metadata: Option<String>, parent: String) -> Result<String> {
