...
impl<'a> Transfer<'a> {
    ...
    pub async fn create(&self, application_data_transfers: Option<Vec<String>>, kind: Option<String>, new_owner_user_id: Option<String>, id: Option<String>, etag: Option<String>, overall_transfer_status_code: Option<String>, old_owner_user_id: Option<String>, request_time: Option<String>) -> Result<String> {
