...
impl<'a> Domain_aliase<'a> {
    ...
    pub async fn create(&self, creation_time: Option<String>, verified: Option<bool>, kind: Option<String>, etag: Option<String>, parent_domain_name: Option<String>, domain_alias_name: Option<String>, customer: String) -> Result<String> {
