...
impl<'a> Local_inventorie<'a> {
    ...
    pub async fn create(&self, account: Option<String>, local_inventory_attributes: Option<String>, store_code: Option<String>, name: Option<String>, parent: String) -> Result<String> {
