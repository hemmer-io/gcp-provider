...
impl<'a> Product_input<'a> {
    ...
    pub async fn create(&self, name: Option<String>, channel: Option<String>, product: Option<String>, content_language: Option<String>, version_number: Option<String>, attributes: Option<String>, feed_label: Option<String>, offer_id: Option<String>, custom_attributes: Option<Vec<String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, channel: Option<String>, product: Option<String>, content_language: Option<String>, version_number: Option<String>, attributes: Option<String>, feed_label: Option<String>, offer_id: Option<String>, custom_attributes: Option<Vec<String>>) -> Result<()> {
