...
impl<'a> Notificationsubscription<'a> {
    ...
    pub async fn create(&self, all_managed_accounts: Option<bool>, call_back_uri: Option<String>, name: Option<String>, registered_event: Option<String>, target_account: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, all_managed_accounts: Option<bool>, call_back_uri: Option<String>, name: Option<String>, registered_event: Option<String>, target_account: Option<String>) -> Result<()> {
