...
impl<'a> Merchant_review<'a> {
    ...
    pub async fn create(&self, custom_attributes: Option<Vec<String>>, data_source: Option<String>, merchant_review_attributes: Option<String>, merchant_review_id: Option<String>, name: Option<String>, merchant_review_status: Option<String>, parent: String) -> Result<String> {
