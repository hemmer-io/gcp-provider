...
impl<'a> Product_review<'a> {
    ...
    pub async fn create(&self, name: Option<String>, custom_attributes: Option<Vec<String>>, data_source: Option<String>, product_review_attributes: Option<String>, product_review_id: Option<String>, product_review_status: Option<String>, parent: String) -> Result<String> {
