//! Assuredworkloads Service
//!
//! Auto-generated service module for assuredworkloads

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for assuredworkloads
pub struct AssuredworkloadsService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> AssuredworkloadsService<'a> {
