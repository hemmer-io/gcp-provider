//! Blogger_3 service for Gcp provider
//!
//! This module handles all blogger_3 resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Blogger_3 service handler
pub struct Blogger_3Service<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> Blogger_3Service<'a> {
    ...
    async fn create_post_user_info(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
