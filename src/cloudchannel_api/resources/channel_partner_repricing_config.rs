...
impl<'a> Channel_partner_repricing_config<'a> {
    ...
    pub async fn create(&self, update_time: Option<String>, name: Option<String>, repricing_config: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, update_time: Option<String>, name: Option<String>, repricing_config: Option<String>) -> Result<()> {
