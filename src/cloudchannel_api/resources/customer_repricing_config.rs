...
impl<'a> Customer_repricing_config<'a> {
    ...
    pub async fn create(&self, name: Option<String>, update_time: Option<String>, repricing_config: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, update_time: Option<String>, repricing_config: Option<String>) -> Result<()> {
