...
impl<'a> Customer_repricing_config<'a> {
    ...
    pub async fn create(&self, repricing_config: Option<String>, update_time: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, repricing_config: Option<String>, update_time: Option<String>, name: Option<String>) -> Result<()> {
