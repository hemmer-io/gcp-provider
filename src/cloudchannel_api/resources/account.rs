...
impl<'a> Account<'a> {
    ...
    pub async fn create(&self, billing_account: Option<String>, language_code: Option<String>, cloud_identity_id: Option<String>, page_token: Option<String>, customer_name: Option<String>, sku: Option<String>, page_size: Option<i64>, parent: String) -> Result<String> {
