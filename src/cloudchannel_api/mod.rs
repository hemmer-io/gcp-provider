...
impl<'a> Cloudchannel_apiService<'a> {
    ...
    async fn read_channel_partner_repricing_config(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
