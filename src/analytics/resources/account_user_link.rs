...
impl<'a> Account_user_link<'a> {
    ...
    pub async fn create(&self, self_link: Option<String>, user_ref: Option<String>, entity: Option<String>, kind: Option<String>, id: Option<String>, permissions: Option<String>, account_id: String) -> Result<String> {
