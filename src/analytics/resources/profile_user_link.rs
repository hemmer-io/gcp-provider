...
impl<'a> Profile_user_link<'a> {
    ...
    pub async fn create(&self, self_link: Option<String>, user_ref: Option<String>, entity: Option<String>, kind: Option<String>, id: Option<String>, permissions: Option<String>, profile_id: String, web_property_id: String, account_id: String) -> Result<String> {
