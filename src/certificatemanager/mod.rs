...
//!
//! Auto-generated service module for certificatemanager

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for certificatemanager
pub struct CertificatemanagerService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> CertificatemanagerService<'a> {
