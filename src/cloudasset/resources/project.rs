...
impl<'a> Project<'a> {
    ...
    pub async fn create(&self, content_type: Option<String>, asset_types: Option<Vec<String>>, read_time: Option<String>, output_config: Option<String>, parent: String) -> Result<String> {
