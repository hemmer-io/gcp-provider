...
impl<'a> Idea_activitie<'a> {
    ...
    pub async fn create(&self, uri: Option<String>, name: Option<String>, type: Option<String>, topics: Option<Vec<String>>, ideas: Option<Vec<String>>, parent: String) -> Result<String> {
