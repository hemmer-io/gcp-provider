...
impl<'a> Cluster<'a> {
    ...
    pub async fn create(&self, parent: Option<String>, zone: Option<String>, project_id: Option<String>, cluster: Option<String>, project_id: String, zone: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, parent: Option<String>, zone: Option<String>, project_id: Option<String>, cluster: Option<String>) -> Result<()> {
