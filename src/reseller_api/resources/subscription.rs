...
impl<'a> Subscription<'a> {
    ...
    pub async fn create(&self, deal_code: Option<String>, customer_domain: Option<String>, trial_settings: Option<String>, plan: Option<String>, subscription_id: Option<String>, resource_ui_url: Option<String>, suspension_reasons: Option<Vec<String>>, customer_id: Option<String>, transfer_info: Option<String>, kind: Option<String>, creation_time: Option<String>, sku_id: Option<String>, purchase_order_id: Option<String>, renewal_settings: Option<String>, seats: Option<String>, sku_name: Option<String>, status: Option<String>, billing_method: Option<String>, customer_id: String) -> Result<String> {
