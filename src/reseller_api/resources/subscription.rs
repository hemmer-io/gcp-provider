...
impl<'a> Subscription<'a> {
    ...
    pub async fn create(&self, subscription_id: Option<String>, deal_code: Option<String>, trial_settings: Option<String>, sku_id: Option<String>, suspension_reasons: Option<Vec<String>>, customer_id: Option<String>, purchase_order_id: Option<String>, billing_method: Option<String>, status: Option<String>, seats: Option<String>, creation_time: Option<String>, kind: Option<String>, plan: Option<String>, transfer_info: Option<String>, renewal_settings: Option<String>, sku_name: Option<String>, customer_domain: Option<String>, resource_ui_url: Option<String>, customer_id: String) -> Result<String> {
