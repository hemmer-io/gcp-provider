...
impl<'a> Customer<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, primary_admin: Option<String>, customer_type: Option<String>, customer_domain_verified: Option<bool>, phone_number: Option<String>, resource_ui_url: Option<String>, customer_id: Option<String>, alternate_email: Option<String>, postal_address: Option<String>, customer_domain: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, kind: Option<String>, primary_admin: Option<String>, customer_type: Option<String>, customer_domain_verified: Option<bool>, phone_number: Option<String>, resource_ui_url: Option<String>, customer_id: Option<String>, alternate_email: Option<String>, postal_address: Option<String>, customer_domain: Option<String>) -> Result<()> {
