...
impl<'a> Customer<'a> {
    ...
    pub async fn create(&self, customer_domain: Option<String>, customer_id: Option<String>, customer_type: Option<String>, kind: Option<String>, primary_admin: Option<String>, phone_number: Option<String>, alternate_email: Option<String>, customer_domain_verified: Option<bool>, postal_address: Option<String>, resource_ui_url: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, customer_domain: Option<String>, customer_id: Option<String>, customer_type: Option<String>, kind: Option<String>, primary_admin: Option<String>, phone_number: Option<String>, alternate_email: Option<String>, customer_domain_verified: Option<bool>, postal_address: Option<String>, resource_ui_url: Option<String>) -> Result<()> {
