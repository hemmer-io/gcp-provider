...
impl<'a> Folder<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, service_enablement_state: Option<String>, service_account: Option<String>, update_time: Option<String>, modules: Option<HashMap<String, String>>, name: Option<String>) -> Result<()> {
