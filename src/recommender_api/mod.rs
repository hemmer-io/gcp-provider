...
impl<'a> Recommender_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "insight_type" => self.plan_insight_type(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "insight_type" => self.create_insight_type(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "insight_type" => self.read_insight_type(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "insight_type" => self.update_insight_type(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "insight_type" => self.delete_insight_type(id).await,
    ...
    async fn create_insight_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a insight_type resource
    async fn read_insight_type(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a insight_type resource
    async fn update_insight_type(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a insight_type resource
    async fn delete_insight_type(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
