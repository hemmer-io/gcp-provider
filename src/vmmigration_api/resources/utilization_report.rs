...
impl<'a> Utilization_report<'a> {
    ...
    pub async fn create(&self, state_time: Option<String>, name: Option<String>, frame_end_time: Option<String>, create_time: Option<String>, error: Option<String>, display_name: Option<String>, time_frame: Option<String>, vm_count: Option<i64>, vms: Option<Vec<String>>, vms_count: Option<i64>, state: Option<String>, parent: String) -> Result<String> {
