...
impl<'a> Vmmigration_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "image_import" => {
                self.plan_image_import(current_state, desired_input).await
            }
            "target_project" => {
                self.plan_target_project(current_state, desired_input).await
            }
            "group" => {
            ...
            "image_import_job" => {
                self.plan_image_import_job(current_state, desired_input).await
            }
            "source" => {
                self.plan_source(current_state, desired_input).await
            }
            "datacenter_connector" => {
                self.plan_datacenter_connector(current_state, desired_input).await
            }
            "utilization_report" => {
                self.plan_utilization_report(current_state, desired_input).await
            }
            "migrating_vm" => {
                self.plan_migrating_vm(current_state, desired_input).await
            }
            "disk_migration_job" => {
                self.plan_disk_migration_job(current_state, desired_input).await
            }
            "replication_cycle" => {
                self.plan_replication_cycle(current_state, desired_input).await
            }
            "clone_job" => {
                self.plan_clone_job(current_state, desired_input).await
            }
            "cutover_job" => {
                self.plan_cutover_job(current_state, desired_input).await
            }
            "datacenter_connector" => {
                self.plan_datacenter_connector(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "image_import" => {
                self.create_image_import(input).await
            }
            "target_project" => {
                self.create_target_project(input).await
            }
            "group" => {
            ...
            "image_import_job" => {
                self.create_image_import_job(input).await
            }
            "source" => {
                self.create_source(input).await
            }
            "datacenter_connector" => {
                self.create_datacenter_connector(input).await
            }
            "utilization_report" => {
                self.create_utilization_report(input).await
            }
            "migrating_vm" => {
                self.create_migrating_vm(input).await
            }
            "disk_migration_job" => {
                self.create_disk_migration_job(input).await
            }
            "replication_cycle" => {
                self.create_replication_cycle(input).await
            }
            "clone_job" => {
                self.create_clone_job(input).await
            }
            "cutover_job" => {
                self.create_cutover_job(input).await
            }
            "datacenter_connector" => {
                self.create_datacenter_connector(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "image_import" => {
                self.read_image_import(id).await
            }
            "target_project" => {
                self.read_target_project(id).await
            }
            "group" => {
            ...
            "image_import_job" => {
                self.read_image_import_job(id).await
            }
            "source" => {
                self.read_source(id).await
            }
            "datacenter_connector" => {
                self.read_datacenter_connector(id).await
            }
            "utilization_report" => {
                self.read_utilization_report(id).await
            }
            "migrating_vm" => {
                self.read_migrating_vm(id).await
            }
            "disk_migration_job" => {
                self.read_disk_migration_job(id).await
            }
            "replication_cycle" => {
                self.read_replication_cycle(id).await
            }
            "clone_job" => {
                self.read_clone_job(id).await
            }
            "cutover_job" => {
                self.read_cutover_job(id).await
            }
            "datacenter_connector" => {
                self.read_datacenter_connector(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "image_import" => {
                self.update_image_import(id, input).await
            }
            "target_project" => {
                self.update_target_project(id, input).await
            }
            "group" => {
            ...
            "image_import_job" => {
                self.update_image_import_job(id, input).await
            }
            "source" => {
                self.update_source(id, input).await
            }
            "datacenter_connector" => {
                self.update_datacenter_connector(id, input).await
            }
            "utilization_report" => {
                self.update_utilization_report(id, input).await
            }
            "migrating_vm" => {
                self.update_migrating_vm(id, input).await
            }
            "disk_migration_job" => {
                self.update_disk_migration_job(id, input).await
            }
            "replication_cycle" => {
                self.update_replication_cycle(id, input).await
            }
            "clone_job" => {
                self.update_clone_job(id, input).await
            }
            "cutover_job" => {
                self.update_cutover_job(id, input).await
            }
            "datacenter_connector" => {
                self.update_datacenter_connector(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "image_import" => {
                self.delete_image_import(id).await
            }
            "target_project" => {
                self.delete_target_project(id).await
            }
            "group" => {
            ...
            "image_import_job" => {
                self.delete_image_import_job(id).await
            }
            "source" => {
                self.delete_source(id).await
            }
            "datacenter_connector" => {
                self.delete_datacenter_connector(id).await
            }
            "utilization_report" => {
                self.delete_utilization_report(id).await
            }
            "migrating_vm" => {
                self.delete_migrating_vm(id).await
            }
            "disk_migration_job" => {
                self.delete_disk_migration_job(id).await
            }
            "replication_cycle" => {
                self.delete_replication_cycle(id).await
            }
            "clone_job" => {
                self.delete_clone_job(id).await
            }
            "cutover_job" => {
                self.delete_cutover_job(id).await
            }
            "datacenter_connector" => {
                self.delete_datacenter_connector(id).await
            }
    ...
    async fn create_image_import_job(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_image_import_job(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_image_import_job(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_datacenter_connector(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_utilization_report(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_disk_migration_job(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_replication_cycle(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_replication_cycle(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_replication_cycle(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
