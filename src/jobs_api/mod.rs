...
impl<'a> Jobs_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "client_event" => {
                self.plan_client_event(current_state, desired_input).await
            }
            "companie" => {
                self.plan_companie(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "client_event" => {
                self.create_client_event(input).await
            }
            "companie" => {
                self.create_companie(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "client_event" => {
                self.read_client_event(id).await
            }
            "companie" => {
                self.read_companie(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "client_event" => {
                self.update_client_event(id, input).await
            }
            "companie" => {
                self.update_companie(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "client_event" => {
                self.delete_client_event(id).await
            }
            "companie" => {
                self.delete_companie(id).await
            }
