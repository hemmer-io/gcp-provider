...
impl<'a> Youtubeanalytics_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "group_item" => {
                self.plan_group_item(current_state, desired_input).await
            }
            "group" => {
                self.plan_group(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "group_item" => {
                self.create_group_item(input).await
            }
            "group" => {
                self.create_group(input).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "group_item" => {
                self.update_group_item(id, input).await
            }
            "group" => {
                self.update_group(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "group_item" => {
                self.delete_group_item(id).await
            }
            "group" => {
                self.delete_group(id).await
            }
