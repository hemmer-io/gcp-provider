...
impl<'a> Managedconfigurationsforuser<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, kind: Option<String>, product_id: Option<String>, managed_property: Option<Vec<String>>, configuration_variables: Option<String>) -> Result<()> {
