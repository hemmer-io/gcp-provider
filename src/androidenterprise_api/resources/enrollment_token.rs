...
impl<'a> Enrollment_token<'a> {
    ...
    pub async fn create(&self, duration: Option<String>, google_authentication_options: Option<String>, enrollment_token_type: Option<String>, token: Option<String>, enterprise_id: String) -> Result<String> {
