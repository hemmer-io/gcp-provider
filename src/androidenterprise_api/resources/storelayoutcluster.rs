...
impl<'a> Storelayoutcluster<'a> {
    ...
    pub async fn create(&self, order_in_page: Option<String>, product_id: Option<Vec<String>>, id: Option<String>, name: Option<Vec<String>>, page_id: String, enterprise_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, order_in_page: Option<String>, product_id: Option<Vec<String>>, id: Option<String>, name: Option<Vec<String>>) -> Result<()> {
