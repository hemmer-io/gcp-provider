...
impl<'a> Storelayoutpage<'a> {
    ...
    pub async fn create(&self, name: Option<Vec<String>>, id: Option<String>, link: Option<Vec<String>>, enterprise_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<Vec<String>>, id: Option<String>, link: Option<Vec<String>>) -> Result<()> {
