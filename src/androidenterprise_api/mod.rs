...
impl<'a> Androidenterprise_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "serviceaccountkey" => {
                self.plan_serviceaccountkey(current_state, desired_input).await
            }
            "managedconfigurationssetting" => {
                self.plan_managedconfigurationssetting(current_state, desired_input).await
            }
            "permission" => {
                self.plan_permission(current_state, desired_input).await
            }
            "storelayoutpage" => {
                self.plan_storelayoutpage(current_state, desired_input).await
            }
            "webapp" => {
                self.plan_webapp(current_state, desired_input).await
            }
            "storelayoutcluster" => {
                self.plan_storelayoutcluster(current_state, desired_input).await
            }
            "managedconfigurationsforuser" => {
                self.plan_managedconfigurationsforuser(current_state, desired_input).await
            }
            "enrollment_token" => {
                self.plan_enrollment_token(current_state, desired_input).await
            }
            "managedconfigurationsfordevice" => {
                self.plan_managedconfigurationsfordevice(current_state, desired_input).await
            }
            "install" => {
                self.plan_install(current_state, desired_input).await
            }
            "enterprise" => {
            ...
            "grouplicenseuser" => {
                self.plan_grouplicenseuser(current_state, desired_input).await
            }
            "grouplicense" => {
                self.plan_grouplicense(current_state, desired_input).await
            }
            "device" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "serviceaccountkey" => {
                self.create_serviceaccountkey(input).await
            }
            "managedconfigurationssetting" => {
                self.create_managedconfigurationssetting(input).await
            }
            "permission" => {
                self.create_permission(input).await
            }
            "storelayoutpage" => {
                self.create_storelayoutpage(input).await
            }
            "webapp" => {
                self.create_webapp(input).await
            }
            "storelayoutcluster" => {
                self.create_storelayoutcluster(input).await
            }
            "managedconfigurationsforuser" => {
                self.create_managedconfigurationsforuser(input).await
            }
            "enrollment_token" => {
            ...
            "install" => {
                self.create_install(input).await
            }
            "enterprise" => {
            ...
            "grouplicenseuser" => {
                self.create_grouplicenseuser(input).await
            }
            "grouplicense" => {
                self.create_grouplicense(input).await
            }
            "device" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "serviceaccountkey" => {
                self.read_serviceaccountkey(id).await
            }
            "managedconfigurationssetting" => {
                self.read_managedconfigurationssetting(id).await
            }
            "permission" => {
                self.read_permission(id).await
            }
            "storelayoutpage" => {
                self.read_storelayoutpage(id).await
            }
            "webapp" => {
                self.read_webapp(id).await
            }
            "storelayoutcluster" => {
                self.read_storelayoutcluster(id).await
            }
            "managedconfigurationsforuser" => {
                self.read_managedconfigurationsforuser(id).await
            }
            "enrollment_token" => {
                self.read_enrollment_token(id).await
            }
            "managedconfigurationsfordevice" => {
                self.read_managedconfigurationsfordevice(id).await
            }
            "install" => {
                self.read_install(id).await
            }
            "enterprise" => {
            ...
            "grouplicenseuser" => {
                self.read_grouplicenseuser(id).await
            }
            "grouplicense" => {
                self.read_grouplicense(id).await
            }
            "device" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "serviceaccountkey" => {
                self.update_serviceaccountkey(id, input).await
            }
            "managedconfigurationssetting" => {
            ...
            "storelayoutpage" => {
                self.update_storelayoutpage(id, input).await
            }
            "webapp" => {
                self.update_webapp(id, input).await
            }
            "storelayoutcluster" => {
                self.update_storelayoutcluster(id, input).await
            }
            "managedconfigurationsforuser" => {
            ...
            "install" => {
                self.update_install(id, input).await
            }
            "enterprise" => {
            ...
            "grouplicenseuser" => {
                self.update_grouplicenseuser(id, input).await
            }
            "grouplicense" => {
                self.update_grouplicense(id, input).await
            }
            "device" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "serviceaccountkey" => {
                self.delete_serviceaccountkey(id).await
            }
            "managedconfigurationssetting" => {
                self.delete_managedconfigurationssetting(id).await
            }
            "permission" => {
                self.delete_permission(id).await
            }
            "storelayoutpage" => {
                self.delete_storelayoutpage(id).await
            }
            "webapp" => {
                self.delete_webapp(id).await
            }
            "storelayoutcluster" => {
                self.delete_storelayoutcluster(id).await
            }
            "managedconfigurationsforuser" => {
                self.delete_managedconfigurationsforuser(id).await
            }
            "enrollment_token" => {
            ...
            "grouplicenseuser" => {
                self.delete_grouplicenseuser(id).await
            }
            "grouplicense" => {
                self.delete_grouplicense(id).await
            }
            "device" => {
    ...
    async fn create_serviceaccountkey(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn read_serviceaccountkey(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_serviceaccountkey(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_managedconfigurationssetting(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_managedconfigurationssetting(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_storelayoutpage(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_storelayoutpage(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_storelayoutcluster(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_storelayoutcluster(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_storelayoutcluster(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_managedconfigurationsforuser(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_managedconfigurationsforuser(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_managedconfigurationsfordevice(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_managedconfigurationsfordevice(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_grouplicenseuser(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_grouplicenseuser(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_grouplicenseuser(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
