...
impl<'a> Servicenetworking_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "dns_record_set" => self.plan_dns_record_set(current_state, desired_input).await,
            "peered_dns_domain" => {
                self.plan_peered_dns_domain(current_state, desired_input)
                    .await
            }
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "servicenetworking_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "dns_record_set" => self.create_dns_record_set(input).await,
            "peered_dns_domain" => self.create_peered_dns_domain(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "dns_record_set" => self.read_dns_record_set(id).await,
            "peered_dns_domain" => self.read_peered_dns_domain(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "dns_record_set" => self.update_dns_record_set(id, input).await,
            "peered_dns_domain" => self.update_peered_dns_domain(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "dns_record_set" => self.delete_dns_record_set(id).await,
            "peered_dns_domain" => self.delete_peered_dns_domain(id).await,
    ...
    async fn create_dns_record_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a dns_record_set resource
    async fn read_dns_record_set(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_dns_record_set(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_peered_dns_domain(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a peered_dns_domain resource
    async fn read_peered_dns_domain(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_peered_dns_domain(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
