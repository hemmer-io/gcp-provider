...
impl<'a> Service<'a> {
    ...
    pub async fn create(&self, network: Option<String>, ip_prefix_length: Option<i64>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, network: Option<String>, ip_prefix_length: Option<i64>) -> Result<()> {
