...
impl<'a> Connection<'a> {
    ...
    pub async fn create(&self, reserved_peering_ranges: Option<Vec<String>>, network: Option<String>, peering: Option<String>, service: Option<String>, parent: String) -> Result<String> {
