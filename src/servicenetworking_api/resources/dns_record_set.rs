...
impl<'a> Dns_record_set<'a> {
    ...
    pub async fn create(&self, consumer_network: Option<String>, dns_record_set: Option<String>, zone: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, consumer_network: Option<String>, dns_record_set: Option<String>, zone: Option<String>) -> Result<()> {
