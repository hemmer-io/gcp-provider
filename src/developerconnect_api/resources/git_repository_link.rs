...
impl<'a> Git_repository_link<'a> {
    ...
    pub async fn create(&self, uid: Option<String>, clone_uri: Option<String>, git_proxy_uri: Option<String>, annotations: Option<HashMap<String, String>>, name: Option<String>, reconciling: Option<bool>, labels: Option<HashMap<String, String>>, delete_time: Option<String>, etag: Option<String>, create_time: Option<String>, webhook_id: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
