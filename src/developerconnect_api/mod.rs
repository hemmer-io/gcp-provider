...
impl<'a> Developerconnect_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "git_repository_link" => {
                self.plan_git_repository_link(current_state, desired_input)
                    .await
            }
            "location" => self.plan_location(current_state, desired_input).await,
            "insights_config" => {
                self.plan_insights_config(current_state, desired_input)
                    .await
            }
            "account_connector" => {
                self.plan_account_connector(current_state, desired_input)
                    .await
            }
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "developerconnect_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "git_repository_link" => self.create_git_repository_link(input).await,
            "location" => self.create_location(input).await,
            "insights_config" => self.create_insights_config(input).await,
            "account_connector" => self.create_account_connector(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "git_repository_link" => self.read_git_repository_link(id).await,
            "location" => self.read_location(id).await,
            "insights_config" => self.read_insights_config(id).await,
            "account_connector" => self.read_account_connector(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "git_repository_link" => self.update_git_repository_link(id, input).await,
            "location" => self.update_location(id, input).await,
            "insights_config" => self.update_insights_config(id, input).await,
            "account_connector" => self.update_account_connector(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "git_repository_link" => self.delete_git_repository_link(id).await,
            "location" => self.delete_location(id).await,
            "insights_config" => self.delete_insights_config(id).await,
            "account_connector" => self.delete_account_connector(id).await,
    ...
    async fn create_git_repository_link(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a git_repository_link resource
    async fn read_git_repository_link(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_git_repository_link(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_insights_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a insights_config resource
    async fn read_insights_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_insights_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_account_connector(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a account_connector resource
    async fn read_account_connector(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_account_connector(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
