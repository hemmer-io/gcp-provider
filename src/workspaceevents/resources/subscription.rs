...
impl<'a> Subscription<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, event_types: Option<Vec<String>>, payload_options: Option<String>, authority: Option<String>, etag: Option<String>, expire_time: Option<String>, name: Option<String>, suspension_reason: Option<String>, target_resource: Option<String>, reconciling: Option<bool>, ttl: Option<String>, uid: Option<String>, state: Option<String>, notification_endpoint: Option<String>, update_time: Option<String>) -> Result<String> {
