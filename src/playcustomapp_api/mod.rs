...
impl<'a> Playcustomapp_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "custom_app" => {
                self.plan_custom_app(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "custom_app" => {
                self.create_custom_app(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "playcustomapp_api",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "custom_app" => {
                self.update_custom_app(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "playcustomapp_api",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "custom_app" => {
                self.delete_custom_app(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "playcustomapp_api",
