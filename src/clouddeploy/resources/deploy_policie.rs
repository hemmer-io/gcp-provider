...
impl<'a> Deploy_policie<'a> {
    ...
    pub async fn create(&self, labels: Option<HashMap<String, String>>, annotations: Option<HashMap<String, String>>, create_time: Option<String>, suspended: Option<bool>, description: Option<String>, rules: Option<Vec<String>>, etag: Option<String>, name: Option<String>, selectors: Option<Vec<String>>, update_time: Option<String>, uid: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, labels: Option<HashMap<String, String>>, annotations: Option<HashMap<String, String>>, create_time: Option<String>, suspended: Option<bool>, description: Option<String>, rules: Option<Vec<String>>, etag: Option<String>, name: Option<String>, selectors: Option<Vec<String>>, update_time: Option<String>, uid: Option<String>) -> Result<()> {
