...
impl<'a> Composer_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "user_workloads_secret" => {
                self.plan_user_workloads_secret(current_state, desired_input)
                    .await
            }
            ...
            "user_workloads_config_map" => {
                self.plan_user_workloads_config_map(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "user_workloads_secret" => self.create_user_workloads_secret(input).await,
            ...
            "user_workloads_config_map" => self.create_user_workloads_config_map(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "user_workloads_secret" => self.read_user_workloads_secret(id).await,
            "workload" => self.read_workload(id).await,
            "operation" => self.read_operation(id).await,
            "environment" => self.read_environment(id).await,
            "user_workloads_config_map" => self.read_user_workloads_config_map(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "user_workloads_secret" => self.update_user_workloads_secret(id, input).await,
            ...
            "user_workloads_config_map" => self.update_user_workloads_config_map(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "user_workloads_secret" => self.delete_user_workloads_secret(id).await,
            ...
            "user_workloads_config_map" => self.delete_user_workloads_config_map(id).await,
    ...
    async fn create_user_workloads_secret(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a user_workloads_secret resource
    async fn read_user_workloads_secret(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_user_workloads_secret(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_user_workloads_config_map(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_user_workloads_config_map(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
