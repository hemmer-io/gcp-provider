...
impl<'a> Target_ssl_proxie<'a> {
    ...
    pub async fn create(&self, self_link: Option<String>, proxy_header: Option<String>, ssl_certificates: Option<Vec<String>>, certificate_map: Option<String>, service: Option<String>, ssl_policy: Option<String>, name: Option<String>, description: Option<String>, creation_timestamp: Option<String>, kind: Option<String>, id: Option<String>, project: String) -> Result<String> {
