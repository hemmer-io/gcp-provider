...
impl<'a> Backend_bucket<'a> {
    ...
    pub async fn create(&self, cdn_policy: Option<String>, region: Option<String>, custom_response_headers: Option<Vec<String>>, enable_cdn: Option<bool>, load_balancing_scheme: Option<String>, self_link: Option<String>, creation_timestamp: Option<String>, edge_security_policy: Option<String>, kind: Option<String>, compression_mode: Option<String>, id: Option<String>, name: Option<String>, params: Option<String>, bucket_name: Option<String>, used_by: Option<Vec<String>>, description: Option<String>, project: String) -> Result<String> {
