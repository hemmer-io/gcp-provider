...
impl<'a> Region_notification_endpoint<'a> {
    ...
    pub async fn create(&self, grpc_settings: Option<String>, self_link: Option<String>, region: Option<String>, name: Option<String>, creation_timestamp: Option<String>, description: Option<String>, kind: Option<String>, id: Option<String>, region: String, project: String) -> Result<String> {
