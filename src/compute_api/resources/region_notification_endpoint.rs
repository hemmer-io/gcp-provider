...
impl<'a> Region_notification_endpoint<'a> {
    ...
    pub async fn create(&self, grpc_settings: Option<String>, id: Option<String>, self_link: Option<String>, creation_timestamp: Option<String>, description: Option<String>, region: Option<String>, kind: Option<String>, name: Option<String>, project: String, region: String) -> Result<String> {
