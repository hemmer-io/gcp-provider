...
impl<'a> Snapshot_group<'a> {
    ...
    pub async fn create(&self, source_info: Option<String>, kind: Option<String>, name: Option<String>, status: Option<String>, creation_timestamp: Option<String>, self_link: Option<String>, self_link_with_id: Option<String>, description: Option<String>, source_instant_snapshot_group: Option<String>, id: Option<String>, source_instant_snapshot_group_info: Option<String>, project: String) -> Result<String> {
