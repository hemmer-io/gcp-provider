...
impl<'a> Region_health_check_service<'a> {
    ...
    pub async fn create(&self, notification_endpoints: Option<Vec<String>>, region: Option<String>, self_link: Option<String>, id: Option<String>, health_status_aggregation_strategy: Option<String>, health_checks: Option<Vec<String>>, kind: Option<String>, name: Option<String>, description: Option<String>, fingerprint: Option<String>, creation_timestamp: Option<String>, network_endpoint_groups: Option<Vec<String>>, health_status_aggregation_policy: Option<String>, project: String, region: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, notification_endpoints: Option<Vec<String>>, region: Option<String>, self_link: Option<String>, id: Option<String>, health_status_aggregation_strategy: Option<String>, health_checks: Option<Vec<String>>, kind: Option<String>, name: Option<String>, description: Option<String>, fingerprint: Option<String>, creation_timestamp: Option<String>, network_endpoint_groups: Option<Vec<String>>, health_status_aggregation_policy: Option<String>) -> Result<()> {
