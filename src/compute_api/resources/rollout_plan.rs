...
impl<'a> Rollout_plan<'a> {
    ...
    pub async fn create(&self, self_link_with_id: Option<String>, creation_timestamp: Option<String>, id: Option<String>, waves: Option<Vec<String>>, name: Option<String>, location_scope: Option<String>, kind: Option<String>, self_link: Option<String>, description: Option<String>, project: String) -> Result<String> {
