...
impl<'a> Cross_site_network<'a> {
    ...
    pub async fn create(&self, name: Option<String>, creation_timestamp: Option<String>, self_link: Option<String>, kind: Option<String>, description: Option<String>, id: Option<String>, project: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, creation_timestamp: Option<String>, self_link: Option<String>, kind: Option<String>, description: Option<String>, id: Option<String>) -> Result<()> {
