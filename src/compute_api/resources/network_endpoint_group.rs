...
impl<'a> Network_endpoint_group<'a> {
    ...
    pub async fn create(&self, self_link: Option<String>, serverless_deployment: Option<String>, default_port: Option<i64>, cloud_function: Option<String>, annotations: Option<HashMap<String, String>>, load_balancer: Option<String>, cloud_run: Option<String>, region: Option<String>, name: Option<String>, psc_target_service: Option<String>, description: Option<String>, id: Option<String>, size: Option<i64>, app_engine: Option<String>, kind: Option<String>, network: Option<String>, subnetwork: Option<String>, network_endpoint_type: Option<String>, creation_timestamp: Option<String>, psc_data: Option<String>, zone: Option<String>, project: String, zone: String) -> Result<String> {
