...
impl<'a> External_vpn_gateway<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, labels: Option<HashMap<String, String>>, description: Option<String>, interfaces: Option<Vec<String>>, creation_timestamp: Option<String>, label_fingerprint: Option<String>, name: Option<String>, id: Option<String>, redundancy_type: Option<String>, self_link: Option<String>, project: String) -> Result<String> {
