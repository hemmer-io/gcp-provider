...
impl<'a> Region_health_source<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, region: Option<String>, self_link: Option<String>, self_link_with_id: Option<String>, id: Option<String>, source_type: Option<String>, creation_timestamp: Option<String>, health_aggregation_policy: Option<String>, description: Option<String>, sources: Option<Vec<String>>, fingerprint: Option<String>, name: Option<String>, region: String, project: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, kind: Option<String>, region: Option<String>, self_link: Option<String>, self_link_with_id: Option<String>, id: Option<String>, source_type: Option<String>, creation_timestamp: Option<String>, health_aggregation_policy: Option<String>, description: Option<String>, sources: Option<Vec<String>>, fingerprint: Option<String>, name: Option<String>) -> Result<()> {
