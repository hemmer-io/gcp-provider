...
impl<'a> Instance_group_manager_resize_request<'a> {
    ...
    pub async fn create(&self, instances: Option<Vec<String>>, self_link_with_id: Option<String>, requested_run_duration: Option<String>, id: Option<String>, kind: Option<String>, resize_by: Option<i64>, self_link: Option<String>, count: Option<i64>, status: Option<String>, zone: Option<String>, region: Option<String>, creation_timestamp: Option<String>, name: Option<String>, state: Option<String>, description: Option<String>, instance_group_manager: String, project: String, zone: String) -> Result<String> {
