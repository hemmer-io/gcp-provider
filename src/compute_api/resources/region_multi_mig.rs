...
impl<'a> Region_multi_mig<'a> {
    ...
    pub async fn create(&self, id: Option<String>, kind: Option<String>, name: Option<String>, description: Option<String>, self_link: Option<String>, region: Option<String>, status: Option<String>, creation_timestamp: Option<String>, resource_policies: Option<String>, project: String, region: String) -> Result<String> {
