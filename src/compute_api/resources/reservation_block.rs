...
impl<'a> Reservation_block<'a> {
    ...
    pub async fn create(&self, policy: Option<String>, etag: Option<String>, bindings: Option<Vec<String>>, resource: String, zone: String, parent_resource: String, project: String) -> Result<String> {
