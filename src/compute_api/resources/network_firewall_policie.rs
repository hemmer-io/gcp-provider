...
impl<'a> Network_firewall_policie<'a> {
    ...
    pub async fn create(&self, short_name: Option<String>, packet_mirroring_rules: Option<Vec<String>>, fingerprint: Option<String>, policy_type: Option<String>, name: Option<String>, rule_tuple_count: Option<i64>, id: Option<String>, region: Option<String>, associations: Option<Vec<String>>, rules: Option<Vec<String>>, creation_timestamp: Option<String>, self_link_with_id: Option<String>, parent: Option<String>, display_name: Option<String>, self_link: Option<String>, kind: Option<String>, description: Option<String>, policy_source: Option<String>, project: String) -> Result<String> {
