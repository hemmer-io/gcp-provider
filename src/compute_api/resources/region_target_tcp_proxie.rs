...
impl<'a> Region_target_tcp_proxie<'a> {
    ...
    pub async fn create(&self, name: Option<String>, creation_timestamp: Option<String>, id: Option<String>, self_link: Option<String>, region: Option<String>, description: Option<String>, kind: Option<String>, proxy_header: Option<String>, proxy_bind: Option<bool>, service: Option<String>, project: String, region: String) -> Result<String> {
