...
impl<'a> Region_target_tcp_proxie<'a> {
    ...
    pub async fn create(&self, service: Option<String>, kind: Option<String>, self_link: Option<String>, proxy_header: Option<String>, name: Option<String>, id: Option<String>, creation_timestamp: Option<String>, proxy_bind: Option<bool>, region: Option<String>, description: Option<String>, project: String, region: String) -> Result<String> {
