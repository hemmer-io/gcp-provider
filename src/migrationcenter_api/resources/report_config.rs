...
impl<'a> Report_config<'a> {
    ...
    pub async fn create(&self, description: Option<String>, group_preferenceset_assignments: Option<Vec<String>>, update_time: Option<String>, display_name: Option<String>, create_time: Option<String>, name: Option<String>, parent: String) -> Result<String> {
