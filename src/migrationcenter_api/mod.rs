...
impl<'a> Migrationcenter_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "preference_set" => self.plan_preference_set(current_state, desired_input).await,
            "source" => self.plan_source(current_state, desired_input).await,
            "import_data_file" => {
                self.plan_import_data_file(current_state, desired_input)
                    .await
            }
            "group" => self.plan_group(current_state, desired_input).await,
            "relation" => self.plan_relation(current_state, desired_input).await,
            ...
            "discovery_client" => {
                self.plan_discovery_client(current_state, desired_input)
                    .await
            }
            "error_frame" => self.plan_error_frame(current_state, desired_input).await,
            "report_config" => self.plan_report_config(current_state, desired_input).await,
            "report" => self.plan_report(current_state, desired_input).await,
            "assets_export_job" => {
                self.plan_assets_export_job(current_state, desired_input)
                    .await
            }
            "import_job" => self.plan_import_job(current_state, desired_input).await,
            "asset" => self.plan_asset(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "migrationcenter_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "preference_set" => self.create_preference_set(input).await,
            "source" => self.create_source(input).await,
            "import_data_file" => self.create_import_data_file(input).await,
            "group" => self.create_group(input).await,
            "relation" => self.create_relation(input).await,
            "location" => self.create_location(input).await,
            "operation" => self.create_operation(input).await,
            "asset" => self.create_asset(input).await,
            "discovery_client" => self.create_discovery_client(input).await,
            "error_frame" => self.create_error_frame(input).await,
            "report_config" => self.create_report_config(input).await,
            "report" => self.create_report(input).await,
            "assets_export_job" => self.create_assets_export_job(input).await,
            "import_job" => self.create_import_job(input).await,
            "asset" => self.create_asset(input).await,
            "import_data_file" => self.create_import_data_file(input).await,
            "group" => self.create_group(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "preference_set" => self.read_preference_set(id).await,
            "source" => self.read_source(id).await,
            "import_data_file" => self.read_import_data_file(id).await,
            "group" => self.read_group(id).await,
            "relation" => self.read_relation(id).await,
            "location" => self.read_location(id).await,
            "operation" => self.read_operation(id).await,
            "asset" => self.read_asset(id).await,
            "discovery_client" => self.read_discovery_client(id).await,
            "error_frame" => self.read_error_frame(id).await,
            "report_config" => self.read_report_config(id).await,
            "report" => self.read_report(id).await,
            "assets_export_job" => self.read_assets_export_job(id).await,
            "import_job" => self.read_import_job(id).await,
            "asset" => self.read_asset(id).await,
            "import_data_file" => self.read_import_data_file(id).await,
            "group" => self.read_group(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "preference_set" => self.update_preference_set(id, input).await,
            "source" => self.update_source(id, input).await,
            "import_data_file" => self.update_import_data_file(id, input).await,
            "group" => self.update_group(id, input).await,
            "relation" => self.update_relation(id, input).await,
            ...
            "discovery_client" => self.update_discovery_client(id, input).await,
            "error_frame" => self.update_error_frame(id, input).await,
            "report_config" => self.update_report_config(id, input).await,
            "report" => self.update_report(id, input).await,
            "assets_export_job" => self.update_assets_export_job(id, input).await,
            "import_job" => self.update_import_job(id, input).await,
            "asset" => self.update_asset(id, input).await,
            "import_data_file" => self.update_import_data_file(id, input).await,
            "group" => self.update_group(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "preference_set" => self.delete_preference_set(id).await,
            "source" => self.delete_source(id).await,
            "import_data_file" => self.delete_import_data_file(id).await,
            "group" => self.delete_group(id).await,
            "relation" => self.delete_relation(id).await,
            "location" => self.delete_location(id).await,
            "operation" => self.delete_operation(id).await,
            "asset" => self.delete_asset(id).await,
            "discovery_client" => self.delete_discovery_client(id).await,
            "error_frame" => self.delete_error_frame(id).await,
            "report_config" => self.delete_report_config(id).await,
            "report" => self.delete_report(id).await,
            "assets_export_job" => self.delete_assets_export_job(id).await,
            "import_job" => self.delete_import_job(id).await,
            "asset" => self.delete_asset(id).await,
            "import_data_file" => self.delete_import_data_file(id).await,
            "group" => self.delete_group(id).await,
    ...
    async fn create_preference_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a preference_set resource
    async fn read_preference_set(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_preference_set(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_import_data_file(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a import_data_file resource
    async fn read_import_data_file(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_import_data_file(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_relation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a relation resource
    async fn read_relation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a relation resource
    async fn update_relation(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn create_discovery_client(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a discovery_client resource
    async fn read_discovery_client(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_discovery_client(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_error_frame(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a error_frame resource
    async fn read_error_frame(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a error_frame resource
    async fn update_error_frame(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a error_frame resource
    async fn delete_error_frame(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_report_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a report_config resource
    async fn read_report_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a report_config resource
    async fn update_report_config(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a report_config resource
    async fn delete_report_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_assets_export_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a assets_export_job resource
    async fn read_assets_export_job(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_assets_export_job(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
