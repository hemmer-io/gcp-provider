...
impl<'a> Apigee_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "reference" => {
                self.plan_reference(current_state, desired_input).await
            }
            "security_incident" => {
                self.plan_security_incident(current_state, desired_input).await
            }
            "data" => {
                self.plan_data(current_state, desired_input).await
            }
            "security_monitoring_condition" => {
                self.plan_security_monitoring_condition(current_state, desired_input).await
            }
            "apidoc" => {
                self.plan_apidoc(current_state, desired_input).await
            }
            "datastore" => {
            ...
            "resourcefile" => {
                self.plan_resourcefile(current_state, desired_input).await
            }
            "stat" => {
                self.plan_stat(current_state, desired_input).await
            }
            "security_report" => {
                self.plan_security_report(current_state, desired_input).await
            }
            "developer" => {
                self.plan_developer(current_state, desired_input).await
            }
            "subscription" => {
                self.plan_subscription(current_state, desired_input).await
            }
            "security_assessment_result" => {
                self.plan_security_assessment_result(current_state, desired_input).await
            }
            "targetserver" => {
                self.plan_targetserver(current_state, desired_input).await
            }
            "optimized_host_stat" => {
                self.plan_optimized_host_stat(current_state, desired_input).await
            }
            "querie" => {
                self.plan_querie(current_state, desired_input).await
            }
            "security_stat" => {
                self.plan_security_stat(current_state, desired_input).await
            }
            "optimized_stat" => {
                self.plan_optimized_stat(current_state, desired_input).await
            }
            "envgroup" => {
                self.plan_envgroup(current_state, desired_input).await
            }
            "entrie" => {
                self.plan_entrie(current_state, desired_input).await
            }
            "archive_deployment" => {
                self.plan_archive_deployment(current_state, desired_input).await
            }
            "apicategorie" => {
                self.plan_apicategorie(current_state, desired_input).await
            }
            "host_querie" => {
                self.plan_host_querie(current_state, desired_input).await
            }
            "nat_addresse" => {
                self.plan_nat_addresse(current_state, desired_input).await
            }
            "attribute" => {
                self.plan_attribute(current_state, desired_input).await
            }
            "security_action" => {
                self.plan_security_action(current_state, desired_input).await
            }
            "debugsession" => {
                self.plan_debugsession(current_state, desired_input).await
            }
            "app" => {
            ...
            "keyvaluemap" => {
                self.plan_keyvaluemap(current_state, desired_input).await
            }
            "project" => {
            ...
            "security_feedback" => {
                self.plan_security_feedback(current_state, desired_input).await
            }
            "appgroup" => {
                self.plan_appgroup(current_state, desired_input).await
            }
            "addons_config" => {
                self.plan_addons_config(current_state, desired_input).await
            }
            "rateplan" => {
                self.plan_rateplan(current_state, desired_input).await
            }
            "sharedflow" => {
                self.plan_sharedflow(current_state, desired_input).await
            }
            "organization" => {
            ...
            "apiproduct" => {
                self.plan_apiproduct(current_state, desired_input).await
            }
            "create" => {
                self.plan_create(current_state, desired_input).await
            }
            "key" => {
            ...
            "datacollector" => {
                self.plan_datacollector(current_state, desired_input).await
            }
            "endpoint_attachment" => {
                self.plan_endpoint_attachment(current_state, desired_input).await
            }
            "keystore" => {
                self.plan_keystore(current_state, desired_input).await
            }
            "flowhook" => {
                self.plan_flowhook(current_state, desired_input).await
            }
            "cache" => {
                self.plan_cache(current_state, desired_input).await
            }
            "host_security_report" => {
                self.plan_host_security_report(current_state, desired_input).await
            }
            "operation" => {
            ...
            "balance" => {
                self.plan_balance(current_state, desired_input).await
            }
            "canaryevaluation" => {
                self.plan_canaryevaluation(current_state, desired_input).await
            }
            "dns_zone" => {
                self.plan_dns_zone(current_state, desired_input).await
            }
            "override_" => {
                self.plan_override_(current_state, desired_input).await
            }
            "aliase" => {
                self.plan_aliase(current_state, desired_input).await
            }
            "security_profile" => {
            ...
            "host_stat" => {
                self.plan_host_stat(current_state, desired_input).await
            }
            "security_profiles_v2" => {
                self.plan_security_profiles_v2(current_state, desired_input).await
            }
            "report" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "reference" => {
                self.create_reference(input).await
            }
            "security_incident" => {
                self.create_security_incident(input).await
            }
            "data" => {
            ...
            "apidoc" => {
                self.create_apidoc(input).await
            }
            "datastore" => {
            ...
            "resourcefile" => {
                self.create_resourcefile(input).await
            }
            "stat" => {
                self.create_stat(input).await
            }
            "security_report" => {
                self.create_security_report(input).await
            }
            "developer" => {
                self.create_developer(input).await
            }
            "subscription" => {
                self.create_subscription(input).await
            }
            "security_assessment_result" => {
                self.create_security_assessment_result(input).await
            }
            "targetserver" => {
                self.create_targetserver(input).await
            }
            "optimized_host_stat" => {
                self.create_optimized_host_stat(input).await
            }
            "querie" => {
                self.create_querie(input).await
            }
            "security_stat" => {
                self.create_security_stat(input).await
            }
            "optimized_stat" => {
                self.create_optimized_stat(input).await
            }
            "envgroup" => {
                self.create_envgroup(input).await
            }
            "entrie" => {
                self.create_entrie(input).await
            }
            "archive_deployment" => {
                self.create_archive_deployment(input).await
            }
            "apicategorie" => {
                self.create_apicategorie(input).await
            }
            "host_querie" => {
                self.create_host_querie(input).await
            }
            "nat_addresse" => {
                self.create_nat_addresse(input).await
            }
            "attribute" => {
                self.create_attribute(input).await
            }
            "security_action" => {
                self.create_security_action(input).await
            }
            "debugsession" => {
                self.create_debugsession(input).await
            }
            "app" => {
            ...
            "keyvaluemap" => {
                self.create_keyvaluemap(input).await
            }
            "project" => {
            ...
            "security_feedback" => {
                self.create_security_feedback(input).await
            }
            "appgroup" => {
                self.create_appgroup(input).await
            }
            "addons_config" => {
                self.create_addons_config(input).await
            }
            "rateplan" => {
                self.create_rateplan(input).await
            }
            "sharedflow" => {
                self.create_sharedflow(input).await
            }
            "organization" => {
            ...
            "apiproduct" => {
                self.create_apiproduct(input).await
            }
            "create" => {
                self.create_create(input).await
            }
            "key" => {
            ...
            "datacollector" => {
                self.create_datacollector(input).await
            }
            "endpoint_attachment" => {
                self.create_endpoint_attachment(input).await
            }
            "keystore" => {
                self.create_keystore(input).await
            }
            "flowhook" => {
                self.create_flowhook(input).await
            }
            "cache" => {
                self.create_cache(input).await
            }
            "host_security_report" => {
                self.create_host_security_report(input).await
            }
            "operation" => {
            ...
            "balance" => {
                self.create_balance(input).await
            }
            "canaryevaluation" => {
                self.create_canaryevaluation(input).await
            }
            "dns_zone" => {
                self.create_dns_zone(input).await
            }
            "override_" => {
                self.create_override_(input).await
            }
            "aliase" => {
                self.create_aliase(input).await
            }
            "security_profile" => {
            ...
            "host_stat" => {
                self.create_host_stat(input).await
            }
            "security_profiles_v2" => {
                self.create_security_profiles_v2(input).await
            }
            "report" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "reference" => {
                self.read_reference(id).await
            }
            "security_incident" => {
                self.read_security_incident(id).await
            }
            "data" => {
                self.read_data(id).await
            }
            "security_monitoring_condition" => {
                self.read_security_monitoring_condition(id).await
            }
            "apidoc" => {
                self.read_apidoc(id).await
            }
            "datastore" => {
            ...
            "resourcefile" => {
                self.read_resourcefile(id).await
            }
            "stat" => {
                self.read_stat(id).await
            }
            "security_report" => {
                self.read_security_report(id).await
            }
            "developer" => {
                self.read_developer(id).await
            }
            "subscription" => {
                self.read_subscription(id).await
            }
            "security_assessment_result" => {
                self.read_security_assessment_result(id).await
            }
            "targetserver" => {
                self.read_targetserver(id).await
            }
            "optimized_host_stat" => {
                self.read_optimized_host_stat(id).await
            }
            "querie" => {
                self.read_querie(id).await
            }
            "security_stat" => {
                self.read_security_stat(id).await
            }
            "optimized_stat" => {
                self.read_optimized_stat(id).await
            }
            "envgroup" => {
                self.read_envgroup(id).await
            }
            "entrie" => {
                self.read_entrie(id).await
            }
            "archive_deployment" => {
                self.read_archive_deployment(id).await
            }
            "apicategorie" => {
                self.read_apicategorie(id).await
            }
            "host_querie" => {
                self.read_host_querie(id).await
            }
            "nat_addresse" => {
                self.read_nat_addresse(id).await
            }
            "attribute" => {
                self.read_attribute(id).await
            }
            "security_action" => {
                self.read_security_action(id).await
            }
            "debugsession" => {
                self.read_debugsession(id).await
            }
            "app" => {
            ...
            "keyvaluemap" => {
                self.read_keyvaluemap(id).await
            }
            "project" => {
            ...
            "security_feedback" => {
                self.read_security_feedback(id).await
            }
            "appgroup" => {
                self.read_appgroup(id).await
            }
            "addons_config" => {
                self.read_addons_config(id).await
            }
            "rateplan" => {
                self.read_rateplan(id).await
            }
            "sharedflow" => {
                self.read_sharedflow(id).await
            }
            "organization" => {
            ...
            "apiproduct" => {
                self.read_apiproduct(id).await
            }
            "create" => {
                self.read_create(id).await
            }
            "key" => {
            ...
            "datacollector" => {
                self.read_datacollector(id).await
            }
            "endpoint_attachment" => {
                self.read_endpoint_attachment(id).await
            }
            "keystore" => {
                self.read_keystore(id).await
            }
            "flowhook" => {
                self.read_flowhook(id).await
            }
            "cache" => {
                self.read_cache(id).await
            }
            "host_security_report" => {
                self.read_host_security_report(id).await
            }
            "operation" => {
            ...
            "canaryevaluation" => {
                self.read_canaryevaluation(id).await
            }
            "dns_zone" => {
                self.read_dns_zone(id).await
            }
            "override_" => {
                self.read_override_(id).await
            }
            "aliase" => {
                self.read_aliase(id).await
            }
            "security_profile" => {
            ...
            "host_stat" => {
                self.read_host_stat(id).await
            }
            "security_profiles_v2" => {
                self.read_security_profiles_v2(id).await
            }
            "report" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "reference" => {
                self.update_reference(id, input).await
            }
            "security_incident" => {
                self.update_security_incident(id, input).await
            }
            "data" => {
            ...
            "apidoc" => {
                self.update_apidoc(id, input).await
            }
            "datastore" => {
            ...
            "resourcefile" => {
                self.update_resourcefile(id, input).await
            }
            "stat" => {
                self.update_stat(id, input).await
            }
            "security_report" => {
                self.update_security_report(id, input).await
            }
            "developer" => {
                self.update_developer(id, input).await
            }
            "subscription" => {
                self.update_subscription(id, input).await
            }
            "security_assessment_result" => {
                self.update_security_assessment_result(id, input).await
            }
            "targetserver" => {
                self.update_targetserver(id, input).await
            }
            "optimized_host_stat" => {
                self.update_optimized_host_stat(id, input).await
            }
            "querie" => {
                self.update_querie(id, input).await
            }
            "security_stat" => {
                self.update_security_stat(id, input).await
            }
            "optimized_stat" => {
                self.update_optimized_stat(id, input).await
            }
            "envgroup" => {
                self.update_envgroup(id, input).await
            }
            "entrie" => {
                self.update_entrie(id, input).await
            }
            "archive_deployment" => {
                self.update_archive_deployment(id, input).await
            }
            "apicategorie" => {
                self.update_apicategorie(id, input).await
            }
            "host_querie" => {
                self.update_host_querie(id, input).await
            }
            "nat_addresse" => {
                self.update_nat_addresse(id, input).await
            }
            "attribute" => {
                self.update_attribute(id, input).await
            }
            "security_action" => {
                self.update_security_action(id, input).await
            }
            "debugsession" => {
                self.update_debugsession(id, input).await
            }
            "app" => {
            ...
            "keyvaluemap" => {
                self.update_keyvaluemap(id, input).await
            }
            "project" => {
            ...
            "security_feedback" => {
                self.update_security_feedback(id, input).await
            }
            "appgroup" => {
                self.update_appgroup(id, input).await
            }
            "addons_config" => {
                self.update_addons_config(id, input).await
            }
            "rateplan" => {
                self.update_rateplan(id, input).await
            }
            "sharedflow" => {
                self.update_sharedflow(id, input).await
            }
            "organization" => {
            ...
            "apiproduct" => {
                self.update_apiproduct(id, input).await
            }
            "create" => {
                self.update_create(id, input).await
            }
            "key" => {
            ...
            "datacollector" => {
                self.update_datacollector(id, input).await
            }
            "endpoint_attachment" => {
                self.update_endpoint_attachment(id, input).await
            }
            "keystore" => {
                self.update_keystore(id, input).await
            }
            "flowhook" => {
                self.update_flowhook(id, input).await
            }
            "cache" => {
                self.update_cache(id, input).await
            }
            "host_security_report" => {
                self.update_host_security_report(id, input).await
            }
            "operation" => {
            ...
            "balance" => {
                self.update_balance(id, input).await
            }
            "canaryevaluation" => {
                self.update_canaryevaluation(id, input).await
            }
            "dns_zone" => {
                self.update_dns_zone(id, input).await
            }
            "override_" => {
                self.update_override_(id, input).await
            }
            "aliase" => {
                self.update_aliase(id, input).await
            }
            "security_profile" => {
            ...
            "host_stat" => {
                self.update_host_stat(id, input).await
            }
            "security_profiles_v2" => {
                self.update_security_profiles_v2(id, input).await
            }
            "report" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "reference" => {
                self.delete_reference(id).await
            }
            "security_incident" => {
                self.delete_security_incident(id).await
            }
            "data" => {
                self.delete_data(id).await
            }
            "security_monitoring_condition" => {
                self.delete_security_monitoring_condition(id).await
            }
            "apidoc" => {
                self.delete_apidoc(id).await
            }
            "datastore" => {
            ...
            "resourcefile" => {
                self.delete_resourcefile(id).await
            }
            "stat" => {
                self.delete_stat(id).await
            }
            "security_report" => {
                self.delete_security_report(id).await
            }
            "developer" => {
                self.delete_developer(id).await
            }
            "subscription" => {
                self.delete_subscription(id).await
            }
            "security_assessment_result" => {
                self.delete_security_assessment_result(id).await
            }
            "targetserver" => {
                self.delete_targetserver(id).await
            }
            "optimized_host_stat" => {
                self.delete_optimized_host_stat(id).await
            }
            "querie" => {
                self.delete_querie(id).await
            }
            "security_stat" => {
                self.delete_security_stat(id).await
            }
            "optimized_stat" => {
                self.delete_optimized_stat(id).await
            }
            "envgroup" => {
                self.delete_envgroup(id).await
            }
            "entrie" => {
                self.delete_entrie(id).await
            }
            "archive_deployment" => {
                self.delete_archive_deployment(id).await
            }
            "apicategorie" => {
                self.delete_apicategorie(id).await
            }
            "host_querie" => {
                self.delete_host_querie(id).await
            }
            "nat_addresse" => {
                self.delete_nat_addresse(id).await
            }
            "attribute" => {
                self.delete_attribute(id).await
            }
            "security_action" => {
                self.delete_security_action(id).await
            }
            "debugsession" => {
                self.delete_debugsession(id).await
            }
            "app" => {
            ...
            "keyvaluemap" => {
                self.delete_keyvaluemap(id).await
            }
            "project" => {
            ...
            "security_feedback" => {
                self.delete_security_feedback(id).await
            }
            "appgroup" => {
                self.delete_appgroup(id).await
            }
            "addons_config" => {
                self.delete_addons_config(id).await
            }
            "rateplan" => {
                self.delete_rateplan(id).await
            }
            "sharedflow" => {
                self.delete_sharedflow(id).await
            }
            "organization" => {
            ...
            "apiproduct" => {
                self.delete_apiproduct(id).await
            }
            "create" => {
                self.delete_create(id).await
            }
            "key" => {
            ...
            "datacollector" => {
                self.delete_datacollector(id).await
            }
            "endpoint_attachment" => {
                self.delete_endpoint_attachment(id).await
            }
            "keystore" => {
                self.delete_keystore(id).await
            }
            "flowhook" => {
                self.delete_flowhook(id).await
            }
            "cache" => {
                self.delete_cache(id).await
            }
            "host_security_report" => {
                self.delete_host_security_report(id).await
            }
            "operation" => {
            ...
            "balance" => {
                self.delete_balance(id).await
            }
            "canaryevaluation" => {
                self.delete_canaryevaluation(id).await
            }
            "dns_zone" => {
                self.delete_dns_zone(id).await
            }
            "override_" => {
                self.delete_override_(id).await
            }
            "aliase" => {
                self.delete_aliase(id).await
            }
            "security_profile" => {
            ...
            "host_stat" => {
                self.delete_host_stat(id).await
            }
            "security_profiles_v2" => {
                self.delete_security_profiles_v2(id).await
            }
            "report" => {
    ...
    async fn create_security_incident(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_security_incident(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_security_incident(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_security_monitoring_condition(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_security_monitoring_condition(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_security_report(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_security_assessment_result(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_security_assessment_result(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_optimized_host_stat(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_optimized_host_stat(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_optimized_host_stat(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_optimized_stat(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_optimized_stat(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_archive_deployment(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_archive_deployment(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_archive_deployment(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_security_action(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_security_action(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_security_feedback(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_security_feedback(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_security_feedback(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_host_security_report(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_host_security_report(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_host_security_report(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_canaryevaluation(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_canaryevaluation(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_canaryevaluation(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_security_profiles_v2(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_security_profiles_v2(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_security_profiles_v2(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
