...
impl<'a> Security_assessment_result<'a> {
    ...
    pub async fn create(&self, profile: Option<String>, include: Option<String>, page_size: Option<i64>, scope: Option<String>, page_token: Option<String>, include_all_resources: Option<String>, name: String) -> Result<String> {
