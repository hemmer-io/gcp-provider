...
impl<'a> Endpoint_attachment<'a> {
    ...
    pub async fn create(&self, service_attachment: Option<String>, state: Option<String>, host: Option<String>, connection_state: Option<String>, location: Option<String>, name: Option<String>, parent: String) -> Result<String> {
