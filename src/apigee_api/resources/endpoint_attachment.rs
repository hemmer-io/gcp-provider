...
impl<'a> Endpoint_attachment<'a> {
    ...
    pub async fn create(&self, host: Option<String>, name: Option<String>, state: Option<String>, connection_state: Option<String>, location: Option<String>, service_attachment: Option<String>, parent: String) -> Result<String> {
