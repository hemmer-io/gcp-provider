...
impl<'a> Admin_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "privilege" => {
                self.plan_privilege(current_state, desired_input).await
            }
            "schema" => {
            ...
            "role_assignment" => {
                self.plan_role_assignment(current_state, desired_input).await
            }
            "aliase" => {
            ...
            "mobiledevice" => {
                self.plan_mobiledevice(current_state, desired_input).await
            }
            "photo" => {
            ...
            "building" => {
                self.plan_building(current_state, desired_input).await
            }
            "chromeosdevice" => {
                self.plan_chromeosdevice(current_state, desired_input).await
            }
            "asp" => {
                self.plan_asp(current_state, desired_input).await
            }
            "domain_aliase" => {
                self.plan_domain_aliase(current_state, desired_input).await
            }
            "feature" => {
                self.plan_feature(current_state, desired_input).await
            }
            "print_server" => {
                self.plan_print_server(current_state, desired_input).await
            }
            "command" => {
            ...
            "two_step_verification" => {
                self.plan_two_step_verification(current_state, desired_input).await
            }
            "verification_code" => {
                self.plan_verification_code(current_state, desired_input).await
            }
            "customer" => {
                self.plan_customer(current_state, desired_input).await
            }
            "printer" => {
                self.plan_printer(current_state, desired_input).await
            }
            "user" => {
            ...
            "chromeo" => {
                self.plan_chromeo(current_state, desired_input).await
            }
            "application" => {
                self.plan_application(current_state, desired_input).await
            }
            "transfer" => {
                self.plan_transfer(current_state, desired_input).await
            }
            "activitie" => {
                self.plan_activitie(current_state, desired_input).await
            }
            "user_usage_report" => {
                self.plan_user_usage_report(current_state, desired_input).await
            }
            "entity_usage_report" => {
                self.plan_entity_usage_report(current_state, desired_input).await
            }
            "channel" => {
                self.plan_channel(current_state, desired_input).await
            }
            "customer_usage_report" => {
                self.plan_customer_usage_report(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "privilege" => {
                self.create_privilege(input).await
            }
            "schema" => {
            ...
            "role_assignment" => {
                self.create_role_assignment(input).await
            }
            "aliase" => {
            ...
            "mobiledevice" => {
                self.create_mobiledevice(input).await
            }
            "photo" => {
            ...
            "building" => {
                self.create_building(input).await
            }
            "chromeosdevice" => {
                self.create_chromeosdevice(input).await
            }
            "asp" => {
                self.create_asp(input).await
            }
            "domain_aliase" => {
                self.create_domain_aliase(input).await
            }
            "feature" => {
                self.create_feature(input).await
            }
            "print_server" => {
                self.create_print_server(input).await
            }
            "command" => {
            ...
            "two_step_verification" => {
                self.create_two_step_verification(input).await
            }
            "verification_code" => {
                self.create_verification_code(input).await
            }
            "customer" => {
                self.create_customer(input).await
            }
            "printer" => {
                self.create_printer(input).await
            }
            "user" => {
            ...
            "chromeo" => {
                self.create_chromeo(input).await
            }
            "application" => {
            ...
            "user_usage_report" => {
                self.create_user_usage_report(input).await
            }
            "entity_usage_report" => {
                self.create_entity_usage_report(input).await
            }
            "channel" => {
                self.create_channel(input).await
            }
            "customer_usage_report" => {
                self.create_customer_usage_report(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "admin_api",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "role_assignment" => {
                self.read_role_assignment(id).await
            }
            "aliase" => {
            ...
            "mobiledevice" => {
                self.read_mobiledevice(id).await
            }
            "photo" => {
            ...
            "building" => {
                self.read_building(id).await
            }
            "chromeosdevice" => {
                self.read_chromeosdevice(id).await
            }
            "asp" => {
                self.read_asp(id).await
            }
            "domain_aliase" => {
                self.read_domain_aliase(id).await
            }
            "feature" => {
                self.read_feature(id).await
            }
            "print_server" => {
                self.read_print_server(id).await
            }
            "command" => {
            ...
            "two_step_verification" => {
                self.read_two_step_verification(id).await
            }
            "verification_code" => {
                self.read_verification_code(id).await
            }
            "customer" => {
                self.read_customer(id).await
            }
            "printer" => {
                self.read_printer(id).await
            }
            "user" => {
            ...
            "chromeo" => {
                self.read_chromeo(id).await
            }
            "application" => {
                self.read_application(id).await
            }
            "transfer" => {
                self.read_transfer(id).await
            }
            "activitie" => {
                self.read_activitie(id).await
            }
            "user_usage_report" => {
                self.read_user_usage_report(id).await
            }
            "entity_usage_report" => {
                self.read_entity_usage_report(id).await
            }
            "channel" => {
                self.read_channel(id).await
            }
            "customer_usage_report" => {
                self.read_customer_usage_report(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "admin_api",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "privilege" => {
                self.update_privilege(id, input).await
            }
            "schema" => {
            ...
            "role_assignment" => {
                self.update_role_assignment(id, input).await
            }
            "aliase" => {
            ...
            "mobiledevice" => {
                self.update_mobiledevice(id, input).await
            }
            "photo" => {
            ...
            "building" => {
                self.update_building(id, input).await
            }
            "chromeosdevice" => {
                self.update_chromeosdevice(id, input).await
            }
            "asp" => {
                self.update_asp(id, input).await
            }
            "domain_aliase" => {
                self.update_domain_aliase(id, input).await
            }
            "feature" => {
                self.update_feature(id, input).await
            }
            "print_server" => {
                self.update_print_server(id, input).await
            }
            "command" => {
            ...
            "two_step_verification" => {
                self.update_two_step_verification(id, input).await
            }
            "verification_code" => {
                self.update_verification_code(id, input).await
            }
            "customer" => {
                self.update_customer(id, input).await
            }
            "printer" => {
                self.update_printer(id, input).await
            }
            "user" => {
            ...
            "chromeo" => {
                self.update_chromeo(id, input).await
            }
            "application" => {
            ...
            "user_usage_report" => {
                self.update_user_usage_report(id, input).await
            }
            "entity_usage_report" => {
                self.update_entity_usage_report(id, input).await
            }
            "channel" => {
                self.update_channel(id, input).await
            }
            "customer_usage_report" => {
                self.update_customer_usage_report(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "admin_api",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "privilege" => {
                self.delete_privilege(id).await
            }
            "schema" => {
            ...
            "role_assignment" => {
                self.delete_role_assignment(id).await
            }
            "aliase" => {
            ...
            "mobiledevice" => {
                self.delete_mobiledevice(id).await
            }
            "photo" => {
            ...
            "building" => {
                self.delete_building(id).await
            }
            "chromeosdevice" => {
                self.delete_chromeosdevice(id).await
            }
            "asp" => {
                self.delete_asp(id).await
            }
            "domain_aliase" => {
                self.delete_domain_aliase(id).await
            }
            "feature" => {
                self.delete_feature(id).await
            }
            "print_server" => {
                self.delete_print_server(id).await
            }
            "command" => {
            ...
            "two_step_verification" => {
                self.delete_two_step_verification(id).await
            }
            "verification_code" => {
                self.delete_verification_code(id).await
            }
            "customer" => {
                self.delete_customer(id).await
            }
            "printer" => {
                self.delete_printer(id).await
            }
            "user" => {
            ...
            "user_usage_report" => {
                self.delete_user_usage_report(id).await
            }
            "entity_usage_report" => {
                self.delete_entity_usage_report(id).await
            }
            "channel" => {
                self.delete_channel(id).await
            }
            "customer_usage_report" => {
                self.delete_customer_usage_report(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "admin_api",
    ...
    async fn create_chromeosdevice(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_chromeosdevice(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_two_step_verification(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_two_step_verification(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_two_step_verification(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_verification_code(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_user_usage_report(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_user_usage_report(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_user_usage_report(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_entity_usage_report(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_entity_usage_report(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_entity_usage_report(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_customer_usage_report(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_customer_usage_report(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_customer_usage_report(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
