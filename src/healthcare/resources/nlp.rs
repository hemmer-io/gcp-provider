...
impl<'a> Nlp<'a> {
    ...
    pub async fn create(&self, document_content: Option<String>, alternative_output_format: Option<String>, licensed_vocabularies: Option<Vec<String>>, nlp_service: String) -> Result<String> {
