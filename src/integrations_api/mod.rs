...
impl<'a> Integrations_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "callback" => self.plan_callback(current_state, desired_input).await,
            "project" => self.plan_project(current_state, desired_input).await,
            "location" => self.plan_location(current_state, desired_input).await,
            "executionsnapshot" => {
                self.plan_executionsnapshot(current_state, desired_input)
                    .await
            }
            "apps_script_project" => {
                self.plan_apps_script_project(current_state, desired_input)
                    .await
            }
            ...
            "suspension" => self.plan_suspension(current_state, desired_input).await,
            "product" => self.plan_product(current_state, desired_input).await,
            "sfdc_instance" => self.plan_sfdc_instance(current_state, desired_input).await,
            "cloud_function" => self.plan_cloud_function(current_state, desired_input).await,
            "auth_config" => self.plan_auth_config(current_state, desired_input).await,
            "connection" => self.plan_connection(current_state, desired_input).await,
            "runtime_action_schema" => {
                self.plan_runtime_action_schema(current_state, desired_input)
                    .await
            }
            ...
            "connector_platform_region" => {
                self.plan_connector_platform_region(current_state, desired_input)
                    .await
            }
            "runtime_entity_schema" => {
                self.plan_runtime_entity_schema(current_state, desired_input)
                    .await
            }
            "sfdc_channel" => self.plan_sfdc_channel(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "integrations_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "callback" => self.create_callback(input).await,
            "project" => self.create_project(input).await,
            "location" => self.create_location(input).await,
            "executionsnapshot" => self.create_executionsnapshot(input).await,
            "apps_script_project" => self.create_apps_script_project(input).await,
            "version" => self.create_version(input).await,
            "execution" => self.create_execution(input).await,
            "suspension" => self.create_suspension(input).await,
            "product" => self.create_product(input).await,
            "sfdc_instance" => self.create_sfdc_instance(input).await,
            "cloud_function" => self.create_cloud_function(input).await,
            "auth_config" => self.create_auth_config(input).await,
            "connection" => self.create_connection(input).await,
            "runtime_action_schema" => self.create_runtime_action_schema(input).await,
            "client" => self.create_client(input).await,
            "certificate" => self.create_certificate(input).await,
            "connector_platform_region" => self.create_connector_platform_region(input).await,
            "runtime_entity_schema" => self.create_runtime_entity_schema(input).await,
            "sfdc_channel" => self.create_sfdc_channel(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "callback" => self.read_callback(id).await,
            "project" => self.read_project(id).await,
            "location" => self.read_location(id).await,
            "executionsnapshot" => self.read_executionsnapshot(id).await,
            "apps_script_project" => self.read_apps_script_project(id).await,
            "version" => self.read_version(id).await,
            "execution" => self.read_execution(id).await,
            "suspension" => self.read_suspension(id).await,
            "product" => self.read_product(id).await,
            "sfdc_instance" => self.read_sfdc_instance(id).await,
            "cloud_function" => self.read_cloud_function(id).await,
            "auth_config" => self.read_auth_config(id).await,
            "connection" => self.read_connection(id).await,
            "runtime_action_schema" => self.read_runtime_action_schema(id).await,
            "client" => self.read_client(id).await,
            "certificate" => self.read_certificate(id).await,
            "connector_platform_region" => self.read_connector_platform_region(id).await,
            "runtime_entity_schema" => self.read_runtime_entity_schema(id).await,
            "sfdc_channel" => self.read_sfdc_channel(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "callback" => self.update_callback(id, input).await,
            "project" => self.update_project(id, input).await,
            "location" => self.update_location(id, input).await,
            "executionsnapshot" => self.update_executionsnapshot(id, input).await,
            "apps_script_project" => self.update_apps_script_project(id, input).await,
            "version" => self.update_version(id, input).await,
            "execution" => self.update_execution(id, input).await,
            "suspension" => self.update_suspension(id, input).await,
            "product" => self.update_product(id, input).await,
            "sfdc_instance" => self.update_sfdc_instance(id, input).await,
            "cloud_function" => self.update_cloud_function(id, input).await,
            "auth_config" => self.update_auth_config(id, input).await,
            "connection" => self.update_connection(id, input).await,
            "runtime_action_schema" => self.update_runtime_action_schema(id, input).await,
            "client" => self.update_client(id, input).await,
            "certificate" => self.update_certificate(id, input).await,
            "connector_platform_region" => self.update_connector_platform_region(id, input).await,
            "runtime_entity_schema" => self.update_runtime_entity_schema(id, input).await,
            "sfdc_channel" => self.update_sfdc_channel(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "callback" => self.delete_callback(id).await,
            "project" => self.delete_project(id).await,
            "location" => self.delete_location(id).await,
            "executionsnapshot" => self.delete_executionsnapshot(id).await,
            "apps_script_project" => self.delete_apps_script_project(id).await,
            "version" => self.delete_version(id).await,
            "execution" => self.delete_execution(id).await,
            "suspension" => self.delete_suspension(id).await,
            "product" => self.delete_product(id).await,
            "sfdc_instance" => self.delete_sfdc_instance(id).await,
            "cloud_function" => self.delete_cloud_function(id).await,
            "auth_config" => self.delete_auth_config(id).await,
            "connection" => self.delete_connection(id).await,
            "runtime_action_schema" => self.delete_runtime_action_schema(id).await,
            "client" => self.delete_client(id).await,
            "certificate" => self.delete_certificate(id).await,
            "connector_platform_region" => self.delete_connector_platform_region(id).await,
            "runtime_entity_schema" => self.delete_runtime_entity_schema(id).await,
            "sfdc_channel" => self.delete_sfdc_channel(id).await,
    ...
    async fn create_callback(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a callback resource
    async fn read_callback(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a callback resource
    async fn update_callback(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a callback resource
    async fn delete_callback(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_executionsnapshot(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a executionsnapshot resource
    async fn read_executionsnapshot(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_executionsnapshot(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_apps_script_project(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a apps_script_project resource
    async fn read_apps_script_project(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_apps_script_project(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_suspension(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a suspension resource
    async fn read_suspension(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a suspension resource
    async fn update_suspension(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a suspension resource
    async fn delete_suspension(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_sfdc_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a sfdc_instance resource
    async fn read_sfdc_instance(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a sfdc_instance resource
    async fn update_sfdc_instance(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a sfdc_instance resource
    async fn delete_sfdc_instance(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_cloud_function(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a cloud_function resource
    async fn read_cloud_function(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_cloud_function(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_auth_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a auth_config resource
    async fn read_auth_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a auth_config resource
    async fn update_auth_config(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a auth_config resource
    async fn delete_auth_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_runtime_action_schema(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a runtime_action_schema resource
    async fn read_runtime_action_schema(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_runtime_action_schema(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_connector_platform_region(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_connector_platform_region(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_runtime_entity_schema(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a runtime_entity_schema resource
    async fn read_runtime_entity_schema(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_runtime_entity_schema(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_sfdc_channel(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a sfdc_channel resource
    async fn read_sfdc_channel(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a sfdc_channel resource
    async fn update_sfdc_channel(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a sfdc_channel resource
    async fn delete_sfdc_channel(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
