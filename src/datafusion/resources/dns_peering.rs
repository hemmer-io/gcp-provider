...
impl<'a> Dns_peering<'a> {
    ...
    pub async fn create(&self, domain: Option<String>, description: Option<String>, target_network: Option<String>, name: Option<String>, target_project: Option<String>, parent: String) -> Result<String> {
