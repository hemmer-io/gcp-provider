...
impl<'a> Policysimulator_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "org_policy_violations_preview" => {
                self.plan_org_policy_violations_preview(current_state, desired_input)
                    .await
            }
            "replay" => self.plan_replay(current_state, desired_input).await,
            "org_policy_violation" => {
                self.plan_org_policy_violation(current_state, desired_input)
                    .await
            }
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "policysimulator_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "org_policy_violation" => self.create_org_policy_violation(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "org_policy_violations_preview" => self.read_org_policy_violations_preview(id).await,
            "replay" => self.read_replay(id).await,
            "org_policy_violation" => self.read_org_policy_violation(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "org_policy_violation" => self.update_org_policy_violation(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "org_policy_violations_preview" => self.delete_org_policy_violations_preview(id).await,
            "replay" => self.delete_replay(id).await,
            "org_policy_violation" => self.delete_org_policy_violation(id).await,
    ...
    async fn read_org_policy_violations_preview(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_org_policy_violations_preview(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_org_policy_violation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a org_policy_violation resource
    async fn read_org_policy_violation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_org_policy_violation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
