...
impl<'a> Keypair<'a> {
    ...
    pub async fn create(&self, pkcs7: Option<String>, subject_email_addresses: Option<Vec<String>>, disable_time: Option<String>, pem: Option<String>, enablement_state: Option<String>, private_key_metadata: Option<Vec<String>>, key_pair_id: Option<String>, user_id: String) -> Result<String> {
