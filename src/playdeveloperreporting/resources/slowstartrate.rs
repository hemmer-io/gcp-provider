...
impl<'a> Slowstartrate<'a> {
    ...
    pub async fn create(&self, user_cohort: Option<String>, page_size: Option<i64>, dimensions: Option<Vec<String>>, page_token: Option<String>, filter: Option<String>, timeline_spec: Option<String>, metrics: Option<Vec<String>>, name: String) -> Result<String> {
