//! Playdeveloperreporting Service
//!
//! Auto-generated service module for playdeveloperreporting

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for playdeveloperreporting
pub struct PlaydeveloperreportingService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> PlaydeveloperreportingService<'a> {
