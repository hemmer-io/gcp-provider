//! Redis_api service for Gcp provider
//!
//! This module handles all redis_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Redis_api service handler
pub struct Redis_apiService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> Redis_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "backup_collection" => {
                self.plan_backup_collection(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "backup_collection" => self.create_backup_collection(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "backup_collection" => self.read_backup_collection(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "backup_collection" => self.update_backup_collection(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "backup_collection" => self.delete_backup_collection(id).await,
    ...
    // ------------------------------------------------------------------------
    // Backup_collection resource operations
    // ------------------------------------------------------------------------

    /// Plan changes to a backup_collection resource
    async fn plan_backup_collection(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Create a new backup_collection resource
    async fn create_backup_collection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a backup_collection resource
    async fn read_backup_collection(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a backup_collection resource
    async fn update_backup_collection(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    /// Delete a backup_collection resource
    async fn delete_backup_collection(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
