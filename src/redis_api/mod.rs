...
impl<'a> Redis_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "backup_collection" => {
                self.plan_backup_collection(current_state, desired_input).await
            }
            "backup" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "backup_collection" => {
                self.create_backup_collection(input).await
            }
            "backup" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "backup_collection" => {
                self.read_backup_collection(id).await
            }
            "backup" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "backup_collection" => {
                self.update_backup_collection(id, input).await
            }
            "backup" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "backup_collection" => {
                self.delete_backup_collection(id).await
            }
            "backup" => {
    ...
    async fn create_backup_collection(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_backup_collection(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_backup_collection(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
