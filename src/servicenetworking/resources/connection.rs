...
impl<'a> Connection<'a> {
    ...
    pub async fn create(&self, network: Option<String>, peering: Option<String>, reserved_peering_ranges: Option<Vec<String>>, service: Option<String>, parent: String) -> Result<String> {
