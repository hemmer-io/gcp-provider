...
impl<'a> Readerrevenuesubscriptionlinking_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "reader" => {
                self.plan_reader(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "reader" => {
                self.create_reader(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "readerrevenuesubscriptionlinking_api",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "reader" => {
                self.update_reader(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "readerrevenuesubscriptionlinking_api",
