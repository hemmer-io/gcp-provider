...
impl<'a> Metadata_job<'a> {
    ...
    pub async fn create(&self, import_result: Option<String>, export_result: Option<String>, name: Option<String>, update_time: Option<String>, status: Option<String>, uid: Option<String>, labels: Option<HashMap<String, String>>, export_spec: Option<String>, import_spec: Option<String>, type: Option<String>, create_time: Option<String>, parent: String) -> Result<String> {
