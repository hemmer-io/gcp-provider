...
impl<'a> Aspect_type<'a> {
    ...
    pub async fn create(&self, name: Option<String>, update_time: Option<String>, metadata_template: Option<String>, data_classification: Option<String>, labels: Option<HashMap<String, String>>, authorization: Option<String>, description: Option<String>, etag: Option<String>, uid: Option<String>, transfer_status: Option<String>, display_name: Option<String>, create_time: Option<String>, parent: String) -> Result<String> {
