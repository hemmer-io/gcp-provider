...
impl<'a> Vault_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "matter" => self.plan_matter(current_state, desired_input).await,
            "hold" => self.plan_hold(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "matter" => self.create_matter(input).await,
            "hold" => self.create_hold(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "matter" => self.read_matter(id).await,
            "hold" => self.read_hold(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "matter" => self.update_matter(id, input).await,
            "hold" => self.update_hold(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "matter" => self.delete_matter(id).await,
            "hold" => self.delete_hold(id).await,
    ...
    async fn create_matter(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a matter resource
    async fn read_matter(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a matter resource
    async fn update_matter(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn create_hold(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a hold resource
    async fn read_hold(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a hold resource
    async fn update_hold(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a hold resource
    async fn delete_hold(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
