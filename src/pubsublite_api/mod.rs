...
impl<'a> Pubsublite_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "cursor" => {
                self.plan_cursor(current_state, desired_input).await
            }
            "operation" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "cursor" => {
                self.create_cursor(input).await
            }
            "operation" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "cursor" => {
                self.update_cursor(id, input).await
            }
            "operation" => {
