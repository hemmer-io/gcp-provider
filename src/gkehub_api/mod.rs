...
impl<'a> Gkehub_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "rbacrolebinding" => {
                self.plan_rbacrolebinding(current_state, desired_input).await
            }
            "scope" => {
                self.plan_scope(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "rbacrolebinding" => {
                self.create_rbacrolebinding(input).await
            }
            "scope" => {
                self.create_scope(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "rbacrolebinding" => {
                self.read_rbacrolebinding(id).await
            }
            "scope" => {
                self.read_scope(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "rbacrolebinding" => {
                self.update_rbacrolebinding(id, input).await
            }
            "scope" => {
                self.update_scope(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "rbacrolebinding" => {
                self.delete_rbacrolebinding(id).await
            }
            "scope" => {
                self.delete_scope(id).await
            }
    ...
    async fn create_rbacrolebinding(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_rbacrolebinding(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
