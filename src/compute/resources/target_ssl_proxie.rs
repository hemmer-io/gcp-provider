...
impl<'a> Target_ssl_proxie<'a> {
    ...
    pub async fn create(&self, proxy_header: Option<String>, id: Option<String>, self_link: Option<String>, ssl_certificates: Option<Vec<String>>, ssl_policy: Option<String>, certificate_map: Option<String>, kind: Option<String>, service: Option<String>, description: Option<String>, creation_timestamp: Option<String>, name: Option<String>, project: String) -> Result<String> {
