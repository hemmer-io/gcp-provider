...
impl<'a> Instant_snapshot_group<'a> {
    ...
    pub async fn create(&self, status: Option<String>, description: Option<String>, region: Option<String>, self_link: Option<String>, kind: Option<String>, id: Option<String>, creation_timestamp: Option<String>, name: Option<String>, zone: Option<String>, resource_status: Option<String>, self_link_with_id: Option<String>, source_consistency_group: Option<String>, project: String, zone: String) -> Result<String> {
