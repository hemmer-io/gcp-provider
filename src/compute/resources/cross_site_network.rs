...
impl<'a> Cross_site_network<'a> {
    ...
    pub async fn create(&self, creation_timestamp: Option<String>, self_link: Option<String>, name: Option<String>, kind: Option<String>, id: Option<String>, description: Option<String>, project: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, creation_timestamp: Option<String>, self_link: Option<String>, name: Option<String>, kind: Option<String>, id: Option<String>, description: Option<String>) -> Result<()> {
