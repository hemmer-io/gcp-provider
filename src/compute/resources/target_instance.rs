...
impl<'a> Target_instance<'a> {
    ...
    pub async fn create(&self, description: Option<String>, network: Option<String>, creation_timestamp: Option<String>, zone: Option<String>, security_policy: Option<String>, instance: Option<String>, self_link: Option<String>, name: Option<String>, kind: Option<String>, nat_policy: Option<String>, id: Option<String>, zone: String, project: String) -> Result<String> {
