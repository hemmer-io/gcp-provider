...
impl<'a> Region_notification_endpoint<'a> {
    ...
    pub async fn create(&self, description: Option<String>, region: Option<String>, creation_timestamp: Option<String>, self_link: Option<String>, id: Option<String>, kind: Option<String>, name: Option<String>, grpc_settings: Option<String>, project: String, region: String) -> Result<String> {
