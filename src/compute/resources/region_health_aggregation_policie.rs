...
impl<'a> Region_health_aggregation_policie<'a> {
    ...
    pub async fn create(&self, healthy_percent_threshold: Option<i64>, description: Option<String>, id: Option<String>, min_healthy_threshold: Option<i64>, policy_type: Option<String>, region: Option<String>, self_link_with_id: Option<String>, name: Option<String>, fingerprint: Option<String>, creation_timestamp: Option<String>, kind: Option<String>, self_link: Option<String>, project: String, region: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, healthy_percent_threshold: Option<i64>, description: Option<String>, id: Option<String>, min_healthy_threshold: Option<i64>, policy_type: Option<String>, region: Option<String>, self_link_with_id: Option<String>, name: Option<String>, fingerprint: Option<String>, creation_timestamp: Option<String>, kind: Option<String>, self_link: Option<String>) -> Result<()> {
