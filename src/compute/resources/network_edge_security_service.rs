...
impl<'a> Network_edge_security_service<'a> {
    ...
    pub async fn create(&self, id: Option<String>, security_policy: Option<String>, self_link: Option<String>, name: Option<String>, self_link_with_id: Option<String>, kind: Option<String>, fingerprint: Option<String>, creation_timestamp: Option<String>, description: Option<String>, region: Option<String>, project: String, region: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, id: Option<String>, security_policy: Option<String>, self_link: Option<String>, name: Option<String>, self_link_with_id: Option<String>, kind: Option<String>, fingerprint: Option<String>, creation_timestamp: Option<String>, description: Option<String>, region: Option<String>) -> Result<()> {
