...
impl<'a> Region_target_tcp_proxie<'a> {
    ...
    pub async fn create(&self, self_link: Option<String>, name: Option<String>, id: Option<String>, proxy_bind: Option<bool>, proxy_header: Option<String>, description: Option<String>, region: Option<String>, kind: Option<String>, service: Option<String>, creation_timestamp: Option<String>, project: String, region: String) -> Result<String> {
