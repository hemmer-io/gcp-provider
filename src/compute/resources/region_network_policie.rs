...
impl<'a> Region_network_policie<'a> {
    ...
    pub async fn create(&self, name: Option<String>, region: Option<String>, associations: Option<Vec<String>>, creation_timestamp: Option<String>, description: Option<String>, rule_tuple_count: Option<i64>, self_link: Option<String>, id: Option<String>, traffic_classification_rules: Option<Vec<String>>, kind: Option<String>, self_link_with_id: Option<String>, region: String, project: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, region: Option<String>, associations: Option<Vec<String>>, creation_timestamp: Option<String>, description: Option<String>, rule_tuple_count: Option<i64>, self_link: Option<String>, id: Option<String>, traffic_classification_rules: Option<Vec<String>>, kind: Option<String>, self_link_with_id: Option<String>) -> Result<()> {
