...
impl<'a> Region_target_http_proxie<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, http_filters: Option<Vec<String>>, http_keep_alive_timeout_sec: Option<i64>, name: Option<String>, region: Option<String>, self_link: Option<String>, url_map: Option<String>, creation_timestamp: Option<String>, proxy_bind: Option<bool>, fingerprint: Option<String>, id: Option<String>, description: Option<String>, region: String, project: String) -> Result<String> {
