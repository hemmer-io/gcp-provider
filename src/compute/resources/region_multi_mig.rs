...
impl<'a> Region_multi_mig<'a> {
    ...
    pub async fn create(&self, self_link: Option<String>, resource_policies: Option<String>, description: Option<String>, status: Option<String>, id: Option<String>, creation_timestamp: Option<String>, kind: Option<String>, name: Option<String>, region: Option<String>, project: String, region: String) -> Result<String> {
