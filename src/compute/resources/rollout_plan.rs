...
impl<'a> Rollout_plan<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, self_link: Option<String>, id: Option<String>, description: Option<String>, name: Option<String>, creation_timestamp: Option<String>, self_link_with_id: Option<String>, waves: Option<Vec<String>>, location_scope: Option<String>, project: String) -> Result<String> {
