...
impl<'a> Region_instance_group_manager_resize_request<'a> {
    ...
    pub async fn create(&self, count: Option<i64>, state: Option<String>, zone: Option<String>, kind: Option<String>, id: Option<String>, self_link_with_id: Option<String>, self_link: Option<String>, requested_run_duration: Option<String>, creation_timestamp: Option<String>, name: Option<String>, status: Option<String>, resize_by: Option<i64>, region: Option<String>, instances: Option<Vec<String>>, description: Option<String>, region: String, instance_group_manager: String, project: String) -> Result<String> {
