...
impl<'a> External_vpn_gateway<'a> {
    ...
    pub async fn create(&self, id: Option<String>, description: Option<String>, creation_timestamp: Option<String>, label_fingerprint: Option<String>, redundancy_type: Option<String>, self_link: Option<String>, labels: Option<HashMap<String, String>>, interfaces: Option<Vec<String>>, name: Option<String>, kind: Option<String>, project: String) -> Result<String> {
