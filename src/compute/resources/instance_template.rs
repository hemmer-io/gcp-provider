...
impl<'a> Instance_template<'a> {
    ...
    pub async fn create(&self, source_instance: Option<String>, description: Option<String>, id: Option<String>, self_link: Option<String>, kind: Option<String>, region: Option<String>, creation_timestamp: Option<String>, source_instance_params: Option<String>, properties: Option<String>, name: Option<String>, project: String) -> Result<String> {
