...
impl<'a> Texttospeech_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "voice" => self.plan_voice(current_state, desired_input).await,
            "text" => self.plan_text(current_state, desired_input).await,
            "voice" => self.plan_voice(current_state, desired_input).await,
            "location" => self.plan_location(current_state, desired_input).await,
            "operation" => self.plan_operation(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "texttospeech_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "voice" => self.create_voice(input).await,
            "text" => self.create_text(input).await,
            "voice" => self.create_voice(input).await,
            "location" => self.create_location(input).await,
            "operation" => self.create_operation(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "voice" => self.read_voice(id).await,
            "text" => self.read_text(id).await,
            "voice" => self.read_voice(id).await,
            "location" => self.read_location(id).await,
            "operation" => self.read_operation(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "voice" => self.update_voice(id, input).await,
            "text" => self.update_text(id, input).await,
            "voice" => self.update_voice(id, input).await,
            "location" => self.update_location(id, input).await,
            "operation" => self.update_operation(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "voice" => self.delete_voice(id).await,
            "text" => self.delete_text(id).await,
            "voice" => self.delete_voice(id).await,
            "location" => self.delete_location(id).await,
            "operation" => self.delete_operation(id).await,
    ...
    async fn create_voice(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a voice resource
    async fn read_voice(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a voice resource
    async fn update_voice(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a voice resource
    async fn delete_voice(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
