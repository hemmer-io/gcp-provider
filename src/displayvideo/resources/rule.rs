...
impl<'a> Rule<'a> {
    ...
    pub async fn create(&self, active: Option<bool>, error: Option<String>, state: Option<String>, name: Option<String>, custom_bidding_algorithm_id: Option<String>, custom_bidding_algorithm_rules_id: Option<String>, rules: Option<String>, create_time: Option<String>, custom_bidding_algorithm_id: String) -> Result<String> {
