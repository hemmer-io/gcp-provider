...
impl<'a> Targeting_option<'a> {
    ...
    pub async fn create(&self, advertiser_id: Option<String>, page_token: Option<String>, business_chain_search_terms: Option<String>, page_size: Option<i64>, poi_search_terms: Option<String>, geo_region_search_terms: Option<String>, targeting_type: String) -> Result<String> {
