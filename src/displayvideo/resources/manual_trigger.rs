...
impl<'a> Manual_trigger<'a> {
    ...
    pub async fn create(&self, latest_activation_time: Option<String>, activation_duration_minutes: Option<String>, advertiser_id: Option<String>, state: Option<String>, trigger_id: Option<String>, display_name: Option<String>, name: Option<String>, advertiser_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, latest_activation_time: Option<String>, activation_duration_minutes: Option<String>, advertiser_id: Option<String>, state: Option<String>, trigger_id: Option<String>, display_name: Option<String>, name: Option<String>) -> Result<()> {
