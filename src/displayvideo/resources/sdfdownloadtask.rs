...
impl<'a> Sdfdownloadtask<'a> {
    ...
    pub async fn create(&self, partner_id: Option<String>, id_filter: Option<String>, inventory_source_filter: Option<String>, version: Option<String>, parent_entity_filter: Option<String>, advertiser_id: Option<String>) -> Result<String> {
