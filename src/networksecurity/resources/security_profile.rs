...
impl<'a> Security_profile<'a> {
    ...
    pub async fn create(&self, description: Option<String>, create_time: Option<String>, custom_intercept_profile: Option<String>, name: Option<String>, threat_prevention_profile: Option<String>, update_time: Option<String>, labels: Option<HashMap<String, String>>, custom_mirroring_profile: Option<String>, etag: Option<String>, type: Option<String>, url_filtering_profile: Option<String>, parent: String) -> Result<String> {
