...
impl<'a> Sac_attachment<'a> {
    ...
    pub async fn create(&self, country: Option<String>, name: Option<String>, time_zone: Option<String>, create_time: Option<String>, state: Option<String>, labels: Option<HashMap<String, String>>, sac_realm: Option<String>, update_time: Option<String>, symantec_options: Option<String>, ncc_gateway: Option<String>, parent: String) -> Result<String> {
