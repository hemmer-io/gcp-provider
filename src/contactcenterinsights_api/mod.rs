...
impl<'a> Contactcenterinsights_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "assessment_rule" => {
                self.plan_assessment_rule(current_state, desired_input)
                    .await
            }
            "qa_question_tag" => {
                self.plan_qa_question_tag(current_state, desired_input)
                    .await
            }
            "feedback_label" => self.plan_feedback_label(current_state, desired_input).await,
            "location" => self.plan_location(current_state, desired_input).await,
            "analysis_rule" => self.plan_analysis_rule(current_state, desired_input).await,
            "conversation" => self.plan_conversation(current_state, desired_input).await,
            "authorized_view" => {
                self.plan_authorized_view(current_state, desired_input)
                    .await
            }
            "issue_model" => self.plan_issue_model(current_state, desired_input).await,
            "qa_question" => self.plan_qa_question(current_state, desired_input).await,
            "qa_scorecard" => self.plan_qa_scorecard(current_state, desired_input).await,
            "phrase_matcher" => self.plan_phrase_matcher(current_state, desired_input).await,
            "assessment" => self.plan_assessment(current_state, desired_input).await,
            "encryption_spec" => {
                self.plan_encryption_spec(current_state, desired_input)
                    .await
            }
            "insightsdata" => self.plan_insightsdata(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "assessment_rule" => self.create_assessment_rule(input).await,
            "qa_question_tag" => self.create_qa_question_tag(input).await,
            "feedback_label" => self.create_feedback_label(input).await,
            "location" => self.create_location(input).await,
            "analysis_rule" => self.create_analysis_rule(input).await,
            "conversation" => self.create_conversation(input).await,
            "authorized_view" => self.create_authorized_view(input).await,
            "issue_model" => self.create_issue_model(input).await,
            "qa_question" => self.create_qa_question(input).await,
            "qa_scorecard" => self.create_qa_scorecard(input).await,
            "phrase_matcher" => self.create_phrase_matcher(input).await,
            "assessment" => self.create_assessment(input).await,
            "encryption_spec" => self.create_encryption_spec(input).await,
            "insightsdata" => self.create_insightsdata(input).await,
            "view" => self.create_view(input).await,
            "dataset" => self.create_dataset(input).await,
            "operation" => self.create_operation(input).await,
            "analyse" => self.create_analyse(input).await,
            "segment" => self.create_segment(input).await,
            "note" => self.create_note(input).await,
            "authorized_view_set" => self.create_authorized_view_set(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "assessment_rule" => self.read_assessment_rule(id).await,
            "qa_question_tag" => self.read_qa_question_tag(id).await,
            "feedback_label" => self.read_feedback_label(id).await,
            "location" => self.read_location(id).await,
            "analysis_rule" => self.read_analysis_rule(id).await,
            "conversation" => self.read_conversation(id).await,
            "authorized_view" => self.read_authorized_view(id).await,
            "issue_model" => self.read_issue_model(id).await,
            "qa_question" => self.read_qa_question(id).await,
            "qa_scorecard" => self.read_qa_scorecard(id).await,
            "phrase_matcher" => self.read_phrase_matcher(id).await,
            "assessment" => self.read_assessment(id).await,
            "encryption_spec" => self.read_encryption_spec(id).await,
            "insightsdata" => self.read_insightsdata(id).await,
            "view" => self.read_view(id).await,
            "dataset" => self.read_dataset(id).await,
            "operation" => self.read_operation(id).await,
            "analyse" => self.read_analyse(id).await,
            "segment" => self.read_segment(id).await,
            "note" => self.read_note(id).await,
            "authorized_view_set" => self.read_authorized_view_set(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "assessment_rule" => self.update_assessment_rule(id, input).await,
            "qa_question_tag" => self.update_qa_question_tag(id, input).await,
            "feedback_label" => self.update_feedback_label(id, input).await,
            "location" => self.update_location(id, input).await,
            "analysis_rule" => self.update_analysis_rule(id, input).await,
            "conversation" => self.update_conversation(id, input).await,
            "authorized_view" => self.update_authorized_view(id, input).await,
            "issue_model" => self.update_issue_model(id, input).await,
            "qa_question" => self.update_qa_question(id, input).await,
            "qa_scorecard" => self.update_qa_scorecard(id, input).await,
            "phrase_matcher" => self.update_phrase_matcher(id, input).await,
            "assessment" => self.update_assessment(id, input).await,
            "encryption_spec" => self.update_encryption_spec(id, input).await,
            "insightsdata" => self.update_insightsdata(id, input).await,
            ...
            "analyse" => self.update_analyse(id, input).await,
            "segment" => self.update_segment(id, input).await,
            "note" => self.update_note(id, input).await,
            "authorized_view_set" => self.update_authorized_view_set(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "assessment_rule" => self.delete_assessment_rule(id).await,
            "qa_question_tag" => self.delete_qa_question_tag(id).await,
            "feedback_label" => self.delete_feedback_label(id).await,
            "location" => self.delete_location(id).await,
            "analysis_rule" => self.delete_analysis_rule(id).await,
            "conversation" => self.delete_conversation(id).await,
            "authorized_view" => self.delete_authorized_view(id).await,
            "issue_model" => self.delete_issue_model(id).await,
            "qa_question" => self.delete_qa_question(id).await,
            "qa_scorecard" => self.delete_qa_scorecard(id).await,
            "phrase_matcher" => self.delete_phrase_matcher(id).await,
            "assessment" => self.delete_assessment(id).await,
            "encryption_spec" => self.delete_encryption_spec(id).await,
            "insightsdata" => self.delete_insightsdata(id).await,
            "view" => self.delete_view(id).await,
            "dataset" => self.delete_dataset(id).await,
            "operation" => self.delete_operation(id).await,
            "analyse" => self.delete_analyse(id).await,
            "segment" => self.delete_segment(id).await,
            "note" => self.delete_note(id).await,
            "authorized_view_set" => self.delete_authorized_view_set(id).await,
    ...
    async fn create_assessment_rule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a assessment_rule resource
    async fn read_assessment_rule(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_assessment_rule(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_qa_question_tag(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a qa_question_tag resource
    async fn read_qa_question_tag(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_qa_question_tag(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_feedback_label(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a feedback_label resource
    async fn read_feedback_label(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_feedback_label(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_analysis_rule(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a analysis_rule resource
    async fn read_analysis_rule(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a analysis_rule resource
    async fn update_analysis_rule(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a analysis_rule resource
    async fn delete_analysis_rule(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_authorized_view(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a authorized_view resource
    async fn read_authorized_view(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_authorized_view(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_issue_model(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a issue_model resource
    async fn read_issue_model(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a issue_model resource
    async fn update_issue_model(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a issue_model resource
    async fn delete_issue_model(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_qa_question(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a qa_question resource
    async fn read_qa_question(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a qa_question resource
    async fn update_qa_question(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a qa_question resource
    async fn delete_qa_question(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_qa_scorecard(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a qa_scorecard resource
    async fn read_qa_scorecard(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a qa_scorecard resource
    async fn update_qa_scorecard(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a qa_scorecard resource
    async fn delete_qa_scorecard(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_phrase_matcher(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a phrase_matcher resource
    async fn read_phrase_matcher(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_phrase_matcher(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_insightsdata(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a insightsdata resource
    async fn read_insightsdata(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a insightsdata resource
    async fn update_insightsdata(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a insightsdata resource
    async fn delete_insightsdata(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_analyse(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a analyse resource
    async fn read_analyse(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a analyse resource
    async fn update_analyse(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a analyse resource
    async fn delete_analyse(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_authorized_view_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a authorized_view_set resource
    async fn read_authorized_view_set(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_authorized_view_set(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
