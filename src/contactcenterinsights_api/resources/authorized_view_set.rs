...
impl<'a> Authorized_view_set<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, create_time: Option<String>, update_time: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, display_name: Option<String>, create_time: Option<String>, update_time: Option<String>, name: Option<String>) -> Result<()> {
