...
impl<'a> Consumer_quota_metric<'a> {
    ...
    pub async fn create(&self, force: Option<bool>, force_justification: Option<String>, inline_source: Option<String>, force_only: Option<Vec<String>>, parent: String) -> Result<String> {
