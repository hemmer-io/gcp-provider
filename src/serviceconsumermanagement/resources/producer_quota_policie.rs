...
impl<'a> Producer_quota_policie<'a> {
    ...
    pub async fn create(&self, container: Option<String>, dimensions: Option<HashMap<String, String>>, name: Option<String>, policy_value: Option<String>, unit: Option<String>, metric: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, container: Option<String>, dimensions: Option<HashMap<String, String>>, name: Option<String>, policy_value: Option<String>, unit: Option<String>, metric: Option<String>) -> Result<()> {
