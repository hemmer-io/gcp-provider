//! Websecurityscanner Service
//!
//! Auto-generated service module for websecurityscanner

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for websecurityscanner
pub struct WebsecurityscannerService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> WebsecurityscannerService<'a> {
