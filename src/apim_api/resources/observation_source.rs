...
impl<'a> Observation_source<'a> {
    ...
    pub async fn create(&self, gclb_observation_source: Option<String>, name: Option<String>, create_time: Option<String>, state: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
