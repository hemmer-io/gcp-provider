...
impl<'a> Observation_job<'a> {
    ...
    pub async fn create(&self, sources: Option<Vec<String>>, create_time: Option<String>, state: Option<String>, update_time: Option<String>, name: Option<String>, parent: String) -> Result<String> {
