...
impl<'a> Observation_job<'a> {
    ...
    pub async fn create(&self, state: Option<String>, update_time: Option<String>, create_time: Option<String>, name: Option<String>, sources: Option<Vec<String>>, parent: String) -> Result<String> {
