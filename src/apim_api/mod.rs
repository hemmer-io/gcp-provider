...
impl<'a> Apim_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "observation_job" => {
                self.plan_observation_job(current_state, desired_input)
                    .await
            }
            ...
            "api_observation" => {
                self.plan_api_observation(current_state, desired_input)
                    .await
            }
            "api_operation" => self.plan_api_operation(current_state, desired_input).await,
            "observation_source" => {
                self.plan_observation_source(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apim_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "observation_job" => self.create_observation_job(input).await,
            "operation" => self.create_operation(input).await,
            "location" => self.create_location(input).await,
            "api_observation" => self.create_api_observation(input).await,
            "api_operation" => self.create_api_operation(input).await,
            "observation_source" => self.create_observation_source(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apim_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "observation_job" => self.read_observation_job(id).await,
            "operation" => self.read_operation(id).await,
            "location" => self.read_location(id).await,
            "api_observation" => self.read_api_observation(id).await,
            "api_operation" => self.read_api_operation(id).await,
            "observation_source" => self.read_observation_source(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apim_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "observation_job" => self.update_observation_job(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "location" => self.update_location(id, input).await,
            "api_observation" => self.update_api_observation(id, input).await,
            "api_operation" => self.update_api_operation(id, input).await,
            "observation_source" => self.update_observation_source(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apim_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "observation_job" => self.delete_observation_job(id).await,
            "operation" => self.delete_operation(id).await,
            "location" => self.delete_location(id).await,
            "api_observation" => self.delete_api_observation(id).await,
            "api_operation" => self.delete_api_operation(id).await,
            "observation_source" => self.delete_observation_source(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "apim_api", resource_name
            ))),
    ...
    async fn create_observation_job(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a observation_job resource
    async fn read_observation_job(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_observation_job(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_api_observation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a api_observation resource
    async fn read_api_observation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_api_observation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_api_operation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a api_operation resource
    async fn read_api_operation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a api_operation resource
    async fn update_api_operation(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a api_operation resource
    async fn delete_api_operation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_observation_source(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a observation_source resource
    async fn read_observation_source(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_observation_source(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
