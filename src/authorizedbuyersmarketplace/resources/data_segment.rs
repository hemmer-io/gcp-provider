...
impl<'a> Data_segment<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, update_time: Option<String>, name: Option<String>, cpm_fee: Option<String>, state: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, create_time: Option<String>, update_time: Option<String>, name: Option<String>, cpm_fee: Option<String>, state: Option<String>) -> Result<()> {
