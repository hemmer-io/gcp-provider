...
impl<'a> Service_project_attachment<'a> {
    ...
    pub async fn create(&self, uid: Option<String>, create_time: Option<String>, service_project: Option<String>, state: Option<String>, name: Option<String>, parent: String) -> Result<String> {
