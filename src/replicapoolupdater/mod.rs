...
//!
//! Auto-generated service module for replicapoolupdater

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for replicapoolupdater
pub struct ReplicapoolupdaterService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> ReplicapoolupdaterService<'a> {
