...
impl<'a> Vision_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "product_set" => self.plan_product_set(current_state, desired_input).await,
            ...
            "reference_image" => {
                self.plan_reference_image(current_state, desired_input)
                    .await
            }
            "file" => self.plan_file(current_state, desired_input).await,
            "image" => self.plan_image(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "product_set" => self.create_product_set(input).await,
            ...
            "reference_image" => self.create_reference_image(input).await,
            "file" => self.create_file(input).await,
            "image" => self.create_image(input).await,
            "file" => self.create_file(input).await,
            "image" => self.create_image(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "product_set" => self.read_product_set(id).await,
            ...
            "reference_image" => self.read_reference_image(id).await,
            "file" => self.read_file(id).await,
            "image" => self.read_image(id).await,
            "file" => self.read_file(id).await,
            "image" => self.read_image(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "product_set" => self.update_product_set(id, input).await,
            ...
            "reference_image" => self.update_reference_image(id, input).await,
            "file" => self.update_file(id, input).await,
            "image" => self.update_image(id, input).await,
            "file" => self.update_file(id, input).await,
            "image" => self.update_image(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "product_set" => self.delete_product_set(id).await,
            ...
            "reference_image" => self.delete_reference_image(id).await,
            "file" => self.delete_file(id).await,
            "image" => self.delete_image(id).await,
            "file" => self.delete_file(id).await,
            "image" => self.delete_image(id).await,
    ...
    async fn create_product_set(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a product_set resource
    async fn read_product_set(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a product_set resource
    async fn update_product_set(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a product_set resource
    async fn delete_product_set(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_reference_image(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a reference_image resource
    async fn read_reference_image(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_reference_image(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
