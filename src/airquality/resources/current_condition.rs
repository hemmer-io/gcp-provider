...
impl<'a> Current_condition<'a> {
    ...
    pub async fn create(&self, custom_local_aqis: Option<Vec<String>>, location: Option<String>, uaqi_color_palette: Option<String>, universal_aqi: Option<bool>, language_code: Option<String>, extra_computations: Option<Vec<String>>) -> Result<String> {
