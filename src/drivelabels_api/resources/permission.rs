...
impl<'a> Permission<'a> {
    ...
    pub async fn create(&self, group: Option<String>, role: Option<String>, audience: Option<String>, name: Option<String>, email: Option<String>, person: Option<String>, parent: String) -> Result<String> {
