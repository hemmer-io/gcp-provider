...
impl<'a> Permission<'a> {
    ...
    pub async fn create(&self, email: Option<String>, name: Option<String>, role: Option<String>, audience: Option<String>, group: Option<String>, person: Option<String>, parent: String) -> Result<String> {
