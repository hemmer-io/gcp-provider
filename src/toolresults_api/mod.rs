...
impl<'a> Toolresults_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "historie" => self.plan_historie(current_state, desired_input).await,
            "sample" => self.plan_sample(current_state, desired_input).await,
            ...
            "perf_metrics_summary" => {
                self.plan_perf_metrics_summary(current_state, desired_input)
                    .await
            }
            ...
            "perf_sample_serie" => {
                self.plan_perf_sample_serie(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "historie" => self.create_historie(input).await,
            "sample" => self.create_sample(input).await,
            "cluster" => self.create_cluster(input).await,
            "execution" => self.create_execution(input).await,
            "perf_metrics_summary" => self.create_perf_metrics_summary(input).await,
            "project" => self.create_project(input).await,
            "test_case" => self.create_test_case(input).await,
            "perf_sample_serie" => self.create_perf_sample_serie(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "historie" => self.read_historie(id).await,
            "sample" => self.read_sample(id).await,
            "cluster" => self.read_cluster(id).await,
            "execution" => self.read_execution(id).await,
            "perf_metrics_summary" => self.read_perf_metrics_summary(id).await,
            "project" => self.read_project(id).await,
            "test_case" => self.read_test_case(id).await,
            "perf_sample_serie" => self.read_perf_sample_serie(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "historie" => self.update_historie(id, input).await,
            "sample" => self.update_sample(id, input).await,
            "cluster" => self.update_cluster(id, input).await,
            "execution" => self.update_execution(id, input).await,
            "perf_metrics_summary" => self.update_perf_metrics_summary(id, input).await,
            "project" => self.update_project(id, input).await,
            "test_case" => self.update_test_case(id, input).await,
            "perf_sample_serie" => self.update_perf_sample_serie(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "historie" => self.delete_historie(id).await,
            "sample" => self.delete_sample(id).await,
            "cluster" => self.delete_cluster(id).await,
            "execution" => self.delete_execution(id).await,
            "perf_metrics_summary" => self.delete_perf_metrics_summary(id).await,
            "project" => self.delete_project(id).await,
            "test_case" => self.delete_test_case(id).await,
            "perf_sample_serie" => self.delete_perf_sample_serie(id).await,
    ...
    async fn create_historie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a historie resource
    async fn read_historie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a historie resource
    async fn update_historie(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a historie resource
    async fn delete_historie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_sample(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a sample resource
    async fn read_sample(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a sample resource
    async fn update_sample(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a sample resource
    async fn delete_sample(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_perf_metrics_summary(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a perf_metrics_summary resource
    async fn read_perf_metrics_summary(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_perf_metrics_summary(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_perf_sample_serie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a perf_sample_serie resource
    async fn read_perf_sample_serie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_perf_sample_serie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
