...
impl<'a> Css_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "css_product" => {
                self.plan_css_product(current_state, desired_input).await
            }
            "css_product_input" => {
                self.plan_css_product_input(current_state, desired_input).await
            }
            "label" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "css_product" => {
                self.create_css_product(input).await
            }
            "css_product_input" => {
                self.create_css_product_input(input).await
            }
            "label" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "css_product" => {
                self.read_css_product(id).await
            }
            "css_product_input" => {
                self.read_css_product_input(id).await
            }
            "label" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "css_product" => {
                self.update_css_product(id, input).await
            }
            "css_product_input" => {
                self.update_css_product_input(id, input).await
            }
            "label" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "css_product" => {
                self.delete_css_product(id).await
            }
            "css_product_input" => {
                self.delete_css_product_input(id).await
            }
            "label" => {
    ...
    async fn create_css_product_input(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_css_product_input(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
