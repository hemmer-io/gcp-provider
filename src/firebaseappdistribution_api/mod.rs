...
impl<'a> Firebaseappdistribution_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "feedback_report" => {
                self.plan_feedback_report(current_state, desired_input)
                    .await
            }
            ...
            "release_by_hash" => {
                self.plan_release_by_hash(current_state, desired_input)
                    .await
            }
            "upload_statu" => self.plan_upload_statu(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "firebaseappdistribution_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "feedback_report" => self.create_feedback_report(input).await,
            ...
            "release_by_hash" => self.create_release_by_hash(input).await,
            "upload_statu" => self.create_upload_statu(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "firebaseappdistribution_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "feedback_report" => self.read_feedback_report(id).await,
            ...
            "release_by_hash" => self.read_release_by_hash(id).await,
            "upload_statu" => self.read_upload_statu(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "firebaseappdistribution_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "feedback_report" => self.update_feedback_report(id, input).await,
            ...
            "release_by_hash" => self.update_release_by_hash(id, input).await,
            "upload_statu" => self.update_upload_statu(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "firebaseappdistribution_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "feedback_report" => self.delete_feedback_report(id).await,
            ...
            "release_by_hash" => self.delete_release_by_hash(id).await,
            "upload_statu" => self.delete_upload_statu(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "firebaseappdistribution_api", resource_name
            ))),
    ...
    async fn create_feedback_report(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a feedback_report resource
    async fn read_feedback_report(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_feedback_report(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_release_by_hash(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a release_by_hash resource
    async fn read_release_by_hash(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_release_by_hash(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_upload_statu(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a upload_statu resource
    async fn read_upload_statu(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a upload_statu resource
    async fn update_upload_statu(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a upload_statu resource
    async fn delete_upload_statu(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
