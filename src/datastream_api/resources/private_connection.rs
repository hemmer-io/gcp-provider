...
impl<'a> Private_connection<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, state: Option<String>, name: Option<String>, labels: Option<HashMap<String, String>>, error: Option<String>, vpc_peering_config: Option<String>, display_name: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
