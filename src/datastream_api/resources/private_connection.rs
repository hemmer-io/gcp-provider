...
impl<'a> Private_connection<'a> {
    ...
    pub async fn create(&self, update_time: Option<String>, error: Option<String>, display_name: Option<String>, name: Option<String>, create_time: Option<String>, labels: Option<HashMap<String, String>>, state: Option<String>, vpc_peering_config: Option<String>, parent: String) -> Result<String> {
