...
impl<'a> Private_connection<'a> {
    ...
    pub async fn create(&self, state: Option<String>, labels: Option<HashMap<String, String>>, error: Option<String>, display_name: Option<String>, create_time: Option<String>, update_time: Option<String>, name: Option<String>, vpc_peering_config: Option<String>, parent: String) -> Result<String> {
