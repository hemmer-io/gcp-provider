...
impl<'a> Domainmapping<'a> {
    ...
    pub async fn create(&self, api_version: Option<String>, status: Option<String>, metadata: Option<String>, spec: Option<String>, kind: Option<String>, parent: String) -> Result<String> {
