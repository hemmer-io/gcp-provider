...
impl<'a> Domainmapping<'a> {
    ...
    pub async fn create(&self, metadata: Option<String>, spec: Option<String>, api_version: Option<String>, kind: Option<String>, status: Option<String>, parent: String) -> Result<String> {
