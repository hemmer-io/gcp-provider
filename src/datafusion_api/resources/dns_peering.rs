...
impl<'a> Dns_peering<'a> {
    ...
    pub async fn create(&self, target_project: Option<String>, domain: Option<String>, description: Option<String>, target_network: Option<String>, name: Option<String>, parent: String) -> Result<String> {
