//! Binaryauthorization Service
//!
//! Auto-generated service module for binaryauthorization

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for binaryauthorization
pub struct BinaryauthorizationService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> BinaryauthorizationService<'a> {
