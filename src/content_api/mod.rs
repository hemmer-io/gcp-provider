...
impl<'a> Content_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "shoppingadsprogram" => {
                self.plan_shoppingadsprogram(current_state, desired_input).await
            }
            "collectionstatuse" => {
                self.plan_collectionstatuse(current_state, desired_input).await
            }
            "recommendation" => {
                self.plan_recommendation(current_state, desired_input).await
            }
            "pubsubnotificationsetting" => {
                self.plan_pubsubnotificationsetting(current_state, desired_input).await
            }
            "po" => {
                self.plan_po(current_state, desired_input).await
            }
            "collection" => {
                self.plan_collection(current_state, desired_input).await
            }
            "ordertrackingsignal" => {
                self.plan_ordertrackingsignal(current_state, desired_input).await
            }
            "regionalinventory" => {
                self.plan_regionalinventory(current_state, desired_input).await
            }
            "returnaddres" => {
                self.plan_returnaddres(current_state, desired_input).await
            }
            "product" => {
                self.plan_product(current_state, desired_input).await
            }
            "datafeed" => {
                self.plan_datafeed(current_state, desired_input).await
            }
            "conversionsource" => {
                self.plan_conversionsource(current_state, desired_input).await
            }
            "returncarrier" => {
                self.plan_returncarrier(current_state, desired_input).await
            }
            "accountstatuse" => {
                self.plan_accountstatuse(current_state, desired_input).await
            }
            "csse" => {
                self.plan_csse(current_state, desired_input).await
            }
            "region" => {
                self.plan_region(current_state, desired_input).await
            }
            "productstatuse" => {
                self.plan_productstatuse(current_state, desired_input).await
            }
            "label" => {
                self.plan_label(current_state, desired_input).await
            }
            "returnpolicy" => {
                self.plan_returnpolicy(current_state, desired_input).await
            }
            "datafeedstatuse" => {
                self.plan_datafeedstatuse(current_state, desired_input).await
            }
            "report" => {
            ...
            "liasetting" => {
                self.plan_liasetting(current_state, desired_input).await
            }
            "shippingsetting" => {
                self.plan_shippingsetting(current_state, desired_input).await
            }
            "productdeliverytime" => {
                self.plan_productdeliverytime(current_state, desired_input).await
            }
            "merchantsupport" => {
                self.plan_merchantsupport(current_state, desired_input).await
            }
            "credential" => {
                self.plan_credential(current_state, desired_input).await
            }
            "returnpolicyonline" => {
                self.plan_returnpolicyonline(current_state, desired_input).await
            }
            "localinventory" => {
                self.plan_localinventory(current_state, desired_input).await
            }
            "freelistingsprogram" => {
                self.plan_freelistingsprogram(current_state, desired_input).await
            }
            "checkoutsetting" => {
                self.plan_checkoutsetting(current_state, desired_input).await
            }
            "accounttax" => {
                self.plan_accounttax(current_state, desired_input).await
            }
            "orderpayment" => {
                self.plan_orderpayment(current_state, desired_input).await
            }
            "order" => {
                self.plan_order(current_state, desired_input).await
            }
            "orderreturn" => {
                self.plan_orderreturn(current_state, desired_input).await
            }
            "orderinvoice" => {
                self.plan_orderinvoice(current_state, desired_input).await
            }
            "shippingsetting" => {
                self.plan_shippingsetting(current_state, desired_input).await
            }
            "orderreport" => {
                self.plan_orderreport(current_state, desired_input).await
            }
            "liasetting" => {
                self.plan_liasetting(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "shoppingadsprogram" => {
                self.create_shoppingadsprogram(input).await
            }
            "collectionstatuse" => {
                self.create_collectionstatuse(input).await
            }
            "recommendation" => {
                self.create_recommendation(input).await
            }
            "pubsubnotificationsetting" => {
                self.create_pubsubnotificationsetting(input).await
            }
            "po" => {
                self.create_po(input).await
            }
            "collection" => {
                self.create_collection(input).await
            }
            "ordertrackingsignal" => {
                self.create_ordertrackingsignal(input).await
            }
            "regionalinventory" => {
                self.create_regionalinventory(input).await
            }
            "returnaddres" => {
                self.create_returnaddres(input).await
            }
            "product" => {
                self.create_product(input).await
            }
            "datafeed" => {
                self.create_datafeed(input).await
            }
            "conversionsource" => {
                self.create_conversionsource(input).await
            }
            "returncarrier" => {
                self.create_returncarrier(input).await
            }
            "accountstatuse" => {
                self.create_accountstatuse(input).await
            }
            "csse" => {
                self.create_csse(input).await
            }
            "region" => {
                self.create_region(input).await
            }
            "productstatuse" => {
                self.create_productstatuse(input).await
            }
            "label" => {
                self.create_label(input).await
            }
            "returnpolicy" => {
                self.create_returnpolicy(input).await
            }
            "datafeedstatuse" => {
                self.create_datafeedstatuse(input).await
            }
            "report" => {
            ...
            "liasetting" => {
                self.create_liasetting(input).await
            }
            "shippingsetting" => {
                self.create_shippingsetting(input).await
            }
            "productdeliverytime" => {
                self.create_productdeliverytime(input).await
            }
            "merchantsupport" => {
                self.create_merchantsupport(input).await
            }
            "credential" => {
                self.create_credential(input).await
            }
            "returnpolicyonline" => {
                self.create_returnpolicyonline(input).await
            }
            "localinventory" => {
                self.create_localinventory(input).await
            }
            "freelistingsprogram" => {
                self.create_freelistingsprogram(input).await
            }
            "checkoutsetting" => {
                self.create_checkoutsetting(input).await
            }
            "accounttax" => {
                self.create_accounttax(input).await
            }
            "orderpayment" => {
                self.create_orderpayment(input).await
            }
            "order" => {
                self.create_order(input).await
            }
            "orderreturn" => {
                self.create_orderreturn(input).await
            }
            "orderinvoice" => {
                self.create_orderinvoice(input).await
            }
            "shippingsetting" => {
                self.create_shippingsetting(input).await
            }
            "orderreport" => {
                self.create_orderreport(input).await
            }
            "liasetting" => {
                self.create_liasetting(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "shoppingadsprogram" => {
                self.read_shoppingadsprogram(id).await
            }
            "collectionstatuse" => {
                self.read_collectionstatuse(id).await
            }
            "recommendation" => {
                self.read_recommendation(id).await
            }
            "pubsubnotificationsetting" => {
                self.read_pubsubnotificationsetting(id).await
            }
            "po" => {
                self.read_po(id).await
            }
            "collection" => {
                self.read_collection(id).await
            }
            "ordertrackingsignal" => {
                self.read_ordertrackingsignal(id).await
            }
            "regionalinventory" => {
                self.read_regionalinventory(id).await
            }
            "returnaddres" => {
                self.read_returnaddres(id).await
            }
            "product" => {
                self.read_product(id).await
            }
            "datafeed" => {
                self.read_datafeed(id).await
            }
            "conversionsource" => {
                self.read_conversionsource(id).await
            }
            "returncarrier" => {
                self.read_returncarrier(id).await
            }
            "accountstatuse" => {
                self.read_accountstatuse(id).await
            }
            "csse" => {
                self.read_csse(id).await
            }
            "region" => {
                self.read_region(id).await
            }
            "productstatuse" => {
                self.read_productstatuse(id).await
            }
            "label" => {
                self.read_label(id).await
            }
            "returnpolicy" => {
                self.read_returnpolicy(id).await
            }
            "datafeedstatuse" => {
                self.read_datafeedstatuse(id).await
            }
            "report" => {
            ...
            "liasetting" => {
                self.read_liasetting(id).await
            }
            "shippingsetting" => {
                self.read_shippingsetting(id).await
            }
            "productdeliverytime" => {
                self.read_productdeliverytime(id).await
            }
            "merchantsupport" => {
                self.read_merchantsupport(id).await
            }
            "credential" => {
                self.read_credential(id).await
            }
            "returnpolicyonline" => {
                self.read_returnpolicyonline(id).await
            }
            "localinventory" => {
                self.read_localinventory(id).await
            }
            "freelistingsprogram" => {
                self.read_freelistingsprogram(id).await
            }
            "checkoutsetting" => {
                self.read_checkoutsetting(id).await
            }
            "accounttax" => {
                self.read_accounttax(id).await
            }
            "orderpayment" => {
                self.read_orderpayment(id).await
            }
            "order" => {
                self.read_order(id).await
            }
            "orderreturn" => {
                self.read_orderreturn(id).await
            }
            "orderinvoice" => {
                self.read_orderinvoice(id).await
            }
            "shippingsetting" => {
                self.read_shippingsetting(id).await
            }
            "orderreport" => {
                self.read_orderreport(id).await
            }
            "liasetting" => {
                self.read_liasetting(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "shoppingadsprogram" => {
                self.update_shoppingadsprogram(id, input).await
            }
            "collectionstatuse" => {
                self.update_collectionstatuse(id, input).await
            }
            "recommendation" => {
                self.update_recommendation(id, input).await
            }
            "pubsubnotificationsetting" => {
                self.update_pubsubnotificationsetting(id, input).await
            }
            "po" => {
                self.update_po(id, input).await
            }
            "collection" => {
                self.update_collection(id, input).await
            }
            "ordertrackingsignal" => {
                self.update_ordertrackingsignal(id, input).await
            }
            "regionalinventory" => {
                self.update_regionalinventory(id, input).await
            }
            "returnaddres" => {
                self.update_returnaddres(id, input).await
            }
            "product" => {
                self.update_product(id, input).await
            }
            "datafeed" => {
                self.update_datafeed(id, input).await
            }
            "conversionsource" => {
                self.update_conversionsource(id, input).await
            }
            "returncarrier" => {
                self.update_returncarrier(id, input).await
            }
            "accountstatuse" => {
                self.update_accountstatuse(id, input).await
            }
            "csse" => {
                self.update_csse(id, input).await
            }
            "region" => {
                self.update_region(id, input).await
            }
            "productstatuse" => {
                self.update_productstatuse(id, input).await
            }
            "label" => {
                self.update_label(id, input).await
            }
            "returnpolicy" => {
                self.update_returnpolicy(id, input).await
            }
            "datafeedstatuse" => {
                self.update_datafeedstatuse(id, input).await
            }
            "report" => {
            ...
            "liasetting" => {
                self.update_liasetting(id, input).await
            }
            "shippingsetting" => {
                self.update_shippingsetting(id, input).await
            }
            "productdeliverytime" => {
                self.update_productdeliverytime(id, input).await
            }
            "merchantsupport" => {
                self.update_merchantsupport(id, input).await
            }
            "credential" => {
                self.update_credential(id, input).await
            }
            "returnpolicyonline" => {
                self.update_returnpolicyonline(id, input).await
            }
            "localinventory" => {
                self.update_localinventory(id, input).await
            }
            "freelistingsprogram" => {
                self.update_freelistingsprogram(id, input).await
            }
            "checkoutsetting" => {
                self.update_checkoutsetting(id, input).await
            }
            "accounttax" => {
                self.update_accounttax(id, input).await
            }
            "orderpayment" => {
                self.update_orderpayment(id, input).await
            }
            "order" => {
                self.update_order(id, input).await
            }
            "orderreturn" => {
                self.update_orderreturn(id, input).await
            }
            "orderinvoice" => {
                self.update_orderinvoice(id, input).await
            }
            "shippingsetting" => {
                self.update_shippingsetting(id, input).await
            }
            "orderreport" => {
                self.update_orderreport(id, input).await
            }
            "liasetting" => {
                self.update_liasetting(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "shoppingadsprogram" => {
                self.delete_shoppingadsprogram(id).await
            }
            "collectionstatuse" => {
                self.delete_collectionstatuse(id).await
            }
            "recommendation" => {
                self.delete_recommendation(id).await
            }
            "pubsubnotificationsetting" => {
                self.delete_pubsubnotificationsetting(id).await
            }
            "po" => {
                self.delete_po(id).await
            }
            "collection" => {
                self.delete_collection(id).await
            }
            "ordertrackingsignal" => {
                self.delete_ordertrackingsignal(id).await
            }
            "regionalinventory" => {
                self.delete_regionalinventory(id).await
            }
            "returnaddres" => {
                self.delete_returnaddres(id).await
            }
            "product" => {
                self.delete_product(id).await
            }
            "datafeed" => {
                self.delete_datafeed(id).await
            }
            "conversionsource" => {
                self.delete_conversionsource(id).await
            }
            "returncarrier" => {
                self.delete_returncarrier(id).await
            }
            "accountstatuse" => {
                self.delete_accountstatuse(id).await
            }
            "csse" => {
                self.delete_csse(id).await
            }
            "region" => {
                self.delete_region(id).await
            }
            "productstatuse" => {
                self.delete_productstatuse(id).await
            }
            "label" => {
                self.delete_label(id).await
            }
            "returnpolicy" => {
                self.delete_returnpolicy(id).await
            }
            "datafeedstatuse" => {
                self.delete_datafeedstatuse(id).await
            }
            "report" => {
            ...
            "liasetting" => {
                self.delete_liasetting(id).await
            }
            "shippingsetting" => {
                self.delete_shippingsetting(id).await
            }
            "productdeliverytime" => {
                self.delete_productdeliverytime(id).await
            }
            "merchantsupport" => {
                self.delete_merchantsupport(id).await
            }
            "credential" => {
                self.delete_credential(id).await
            }
            "returnpolicyonline" => {
                self.delete_returnpolicyonline(id).await
            }
            "localinventory" => {
                self.delete_localinventory(id).await
            }
            "freelistingsprogram" => {
                self.delete_freelistingsprogram(id).await
            }
            "checkoutsetting" => {
                self.delete_checkoutsetting(id).await
            }
            "accounttax" => {
                self.delete_accounttax(id).await
            }
            "orderpayment" => {
                self.delete_orderpayment(id).await
            }
            "order" => {
                self.delete_order(id).await
            }
            "orderreturn" => {
                self.delete_orderreturn(id).await
            }
            "orderinvoice" => {
                self.delete_orderinvoice(id).await
            }
            "shippingsetting" => {
                self.delete_shippingsetting(id).await
            }
            "orderreport" => {
                self.delete_orderreport(id).await
            }
            "liasetting" => {
                self.delete_liasetting(id).await
            }
    ...
    async fn create_shoppingadsprogram(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_shoppingadsprogram(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_shoppingadsprogram(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_collectionstatuse(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_collectionstatuse(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_collectionstatuse(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_pubsubnotificationsetting(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_pubsubnotificationsetting(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_ordertrackingsignal(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_ordertrackingsignal(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_ordertrackingsignal(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_regionalinventory(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_regionalinventory(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_regionalinventory(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_conversionsource(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_conversionsource(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_conversionsource(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_accountstatuse(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_accountstatuse(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_productstatuse(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_productstatuse(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_datafeedstatuse(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_datafeedstatuse(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_shippingsetting(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_shippingsetting(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_productdeliverytime(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_productdeliverytime(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_productdeliverytime(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_merchantsupport(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_merchantsupport(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_returnpolicyonline(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_returnpolicyonline(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_returnpolicyonline(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_localinventory(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_localinventory(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_freelistingsprogram(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_freelistingsprogram(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_freelistingsprogram(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_checkoutsetting(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_checkoutsetting(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
