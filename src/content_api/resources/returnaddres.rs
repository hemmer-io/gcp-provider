...
impl<'a> Returnaddres<'a> {
    ...
    pub async fn create(&self, address: Option<String>, return_address_id: Option<String>, kind: Option<String>, label: Option<String>, phone_number: Option<String>, country: Option<String>, merchant_id: String) -> Result<String> {
