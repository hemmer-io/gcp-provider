...
impl<'a> Returnaddres<'a> {
    ...
    pub async fn create(&self, address: Option<String>, kind: Option<String>, country: Option<String>, phone_number: Option<String>, return_address_id: Option<String>, label: Option<String>, merchant_id: String) -> Result<String> {
