...
impl<'a> Returnaddres<'a> {
    ...
    pub async fn create(&self, phone_number: Option<String>, kind: Option<String>, return_address_id: Option<String>, address: Option<String>, country: Option<String>, label: Option<String>, merchant_id: String) -> Result<String> {
