...
impl<'a> Recommendation<'a> {
    ...
    pub async fn create(&self, interaction_type: Option<String>, response_token: Option<String>, subtype: Option<String>, type: Option<String>, merchant_id: String) -> Result<String> {
