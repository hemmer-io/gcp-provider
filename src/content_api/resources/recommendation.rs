...
impl<'a> Recommendation<'a> {
    ...
    pub async fn create(&self, subtype: Option<String>, type: Option<String>, interaction_type: Option<String>, response_token: Option<String>, merchant_id: String) -> Result<String> {
