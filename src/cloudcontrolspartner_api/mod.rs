...
impl<'a> Cloudcontrolspartner_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "access_approval_request" => {
                self.plan_access_approval_request(current_state, desired_input)
                    .await
            }
            "violation" => self.plan_violation(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "cloudcontrolspartner_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "access_approval_request" => self.create_access_approval_request(input).await,
            "violation" => self.create_violation(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "access_approval_request" => self.read_access_approval_request(id).await,
            "violation" => self.read_violation(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "access_approval_request" => self.update_access_approval_request(id, input).await,
            "violation" => self.update_violation(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "access_approval_request" => self.delete_access_approval_request(id).await,
            "violation" => self.delete_violation(id).await,
    ...
    async fn create_access_approval_request(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a access_approval_request resource
    async fn read_access_approval_request(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_access_approval_request(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_violation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a violation resource
    async fn read_violation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a violation resource
    async fn update_violation(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a violation resource
    async fn delete_violation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
