...
impl<'a> Merchant_center_account_link<'a> {
    ...
    pub async fn create(&self, feed_filters: Option<Vec<String>>, name: Option<String>, branch_id: Option<String>, language_code: Option<String>, project_id: Option<String>, source: Option<String>, state: Option<String>, feed_label: Option<String>, merchant_center_account_id: Option<String>, id: Option<String>, parent: String) -> Result<String> {
