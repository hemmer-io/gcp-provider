...
impl<'a> Classroom_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "add_on_attachment" => {
                self.plan_add_on_attachment(current_state, desired_input).await
            }
            "guardian" => {
                self.plan_guardian(current_state, desired_input).await
            }
            "announcement" => {
                self.plan_announcement(current_state, desired_input).await
            }
            "course" => {
                self.plan_course(current_state, desired_input).await
            }
            "guardian_invitation" => {
                self.plan_guardian_invitation(current_state, desired_input).await
            }
            "user_profile" => {
            ...
            "student_submission" => {
                self.plan_student_submission(current_state, desired_input).await
            }
            "teacher" => {
                self.plan_teacher(current_state, desired_input).await
            }
            "course_work_material" => {
                self.plan_course_work_material(current_state, desired_input).await
            }
            "student" => {
                self.plan_student(current_state, desired_input).await
            }
            "aliase" => {
            ...
            "rubric" => {
                self.plan_rubric(current_state, desired_input).await
            }
            "course_work" => {
                self.plan_course_work(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "add_on_attachment" => {
                self.create_add_on_attachment(input).await
            }
            "guardian" => {
                self.create_guardian(input).await
            }
            "announcement" => {
                self.create_announcement(input).await
            }
            "course" => {
                self.create_course(input).await
            }
            "guardian_invitation" => {
                self.create_guardian_invitation(input).await
            }
            "user_profile" => {
            ...
            "student_submission" => {
                self.create_student_submission(input).await
            }
            "teacher" => {
                self.create_teacher(input).await
            }
            "course_work_material" => {
                self.create_course_work_material(input).await
            }
            "student" => {
                self.create_student(input).await
            }
            "aliase" => {
            ...
            "rubric" => {
                self.create_rubric(input).await
            }
            "course_work" => {
                self.create_course_work(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "classroom_api",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "add_on_attachment" => {
                self.read_add_on_attachment(id).await
            }
            "guardian" => {
                self.read_guardian(id).await
            }
            "announcement" => {
                self.read_announcement(id).await
            }
            "course" => {
                self.read_course(id).await
            }
            "guardian_invitation" => {
                self.read_guardian_invitation(id).await
            }
            "user_profile" => {
            ...
            "student_submission" => {
                self.read_student_submission(id).await
            }
            "teacher" => {
                self.read_teacher(id).await
            }
            "course_work_material" => {
                self.read_course_work_material(id).await
            }
            "student" => {
                self.read_student(id).await
            }
            "aliase" => {
            ...
            "rubric" => {
                self.read_rubric(id).await
            }
            "course_work" => {
                self.read_course_work(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "classroom_api",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "add_on_attachment" => {
                self.update_add_on_attachment(id, input).await
            }
            "guardian" => {
                self.update_guardian(id, input).await
            }
            "announcement" => {
                self.update_announcement(id, input).await
            }
            "course" => {
                self.update_course(id, input).await
            }
            "guardian_invitation" => {
                self.update_guardian_invitation(id, input).await
            }
            "user_profile" => {
            ...
            "student_submission" => {
                self.update_student_submission(id, input).await
            }
            "teacher" => {
                self.update_teacher(id, input).await
            }
            "course_work_material" => {
                self.update_course_work_material(id, input).await
            }
            "student" => {
                self.update_student(id, input).await
            }
            "aliase" => {
            ...
            "rubric" => {
                self.update_rubric(id, input).await
            }
            "course_work" => {
                self.update_course_work(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "classroom_api",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "add_on_attachment" => {
                self.delete_add_on_attachment(id).await
            }
            "guardian" => {
                self.delete_guardian(id).await
            }
            "announcement" => {
                self.delete_announcement(id).await
            }
            "course" => {
                self.delete_course(id).await
            }
            "guardian_invitation" => {
                self.delete_guardian_invitation(id).await
            }
            "user_profile" => {
            ...
            "student_submission" => {
                self.delete_student_submission(id).await
            }
            "teacher" => {
                self.delete_teacher(id).await
            }
            "course_work_material" => {
                self.delete_course_work_material(id).await
            }
            "student" => {
            ...
            "rubric" => {
                self.delete_rubric(id).await
            }
            "course_work" => {
                self.delete_course_work(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "classroom_api",
    ...
    async fn create_add_on_attachment(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn read_add_on_attachment(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_add_on_attachment(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_guardian_invitation(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_guardian_invitation(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_student_submission(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_student_submission(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_student_submission(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_course_work_material(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_course_work_material(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_course_work_material(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
