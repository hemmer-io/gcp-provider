...
impl<'a> Student<'a> {
    ...
    pub async fn create(&self, course_id: Option<String>, user_id: Option<String>, student_work_folder: Option<String>, profile: Option<String>, course_id: String) -> Result<String> {
