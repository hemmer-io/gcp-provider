...
impl<'a> Servicebroker_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "servicebroker" => self.plan_servicebroker(current_state, desired_input).await,
            ...
            "service_instance" => {
                self.plan_service_instance(current_state, desired_input)
                    .await
            }
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "servicebroker_api", resource_name
            ))),
        }
    }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "servicebroker" => self.update_servicebroker(id, input).await,
            ...
            "service_instance" => self.update_service_instance(id, input).await,
    ...
    async fn create_servicebroker(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a servicebroker resource
    async fn read_servicebroker(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a servicebroker resource
    async fn update_servicebroker(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a servicebroker resource
    async fn delete_servicebroker(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_service_instance(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a service_instance resource
    async fn read_service_instance(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_service_instance(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
