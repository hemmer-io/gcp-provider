...
impl<'a> Service_binding<'a> {
    ...
    pub async fn create(&self, bind_resource: Option<HashMap<String, String>>, binding_id: Option<String>, service_id: Option<String>, create_time: Option<String>, parameters: Option<HashMap<String, String>>, plan_id: Option<String>, instance_id: String, binding_id: String, parent: String) -> Result<String> {
