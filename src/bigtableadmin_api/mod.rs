...
impl<'a> Bigtableadmin_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "materialized_view" => {
                self.plan_materialized_view(current_state, desired_input)
                    .await
            }
            "app_profile" => self.plan_app_profile(current_state, desired_input).await,
            "instance" => self.plan_instance(current_state, desired_input).await,
            "cluster" => self.plan_cluster(current_state, desired_input).await,
            "schema_bundle" => self.plan_schema_bundle(current_state, desired_input).await,
            "operation" => self.plan_operation(current_state, desired_input).await,
            "logical_view" => self.plan_logical_view(current_state, desired_input).await,
            "backup" => self.plan_backup(current_state, desired_input).await,
            "hot_tablet" => self.plan_hot_tablet(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "bigtableadmin_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "materialized_view" => self.create_materialized_view(input).await,
            "app_profile" => self.create_app_profile(input).await,
            "instance" => self.create_instance(input).await,
            "cluster" => self.create_cluster(input).await,
            "schema_bundle" => self.create_schema_bundle(input).await,
            "operation" => self.create_operation(input).await,
            "logical_view" => self.create_logical_view(input).await,
            "backup" => self.create_backup(input).await,
            "hot_tablet" => self.create_hot_tablet(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "materialized_view" => self.read_materialized_view(id).await,
            "app_profile" => self.read_app_profile(id).await,
            "instance" => self.read_instance(id).await,
            "cluster" => self.read_cluster(id).await,
            "schema_bundle" => self.read_schema_bundle(id).await,
            "operation" => self.read_operation(id).await,
            "logical_view" => self.read_logical_view(id).await,
            "backup" => self.read_backup(id).await,
            "hot_tablet" => self.read_hot_tablet(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "materialized_view" => self.update_materialized_view(id, input).await,
            "app_profile" => self.update_app_profile(id, input).await,
            "instance" => self.update_instance(id, input).await,
            "cluster" => self.update_cluster(id, input).await,
            "schema_bundle" => self.update_schema_bundle(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "logical_view" => self.update_logical_view(id, input).await,
            "backup" => self.update_backup(id, input).await,
            "hot_tablet" => self.update_hot_tablet(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "materialized_view" => self.delete_materialized_view(id).await,
            "app_profile" => self.delete_app_profile(id).await,
            "instance" => self.delete_instance(id).await,
            "cluster" => self.delete_cluster(id).await,
            "schema_bundle" => self.delete_schema_bundle(id).await,
            "operation" => self.delete_operation(id).await,
            "logical_view" => self.delete_logical_view(id).await,
            "backup" => self.delete_backup(id).await,
            "hot_tablet" => self.delete_hot_tablet(id).await,
    ...
    async fn create_materialized_view(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a materialized_view resource
    async fn read_materialized_view(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_materialized_view(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_app_profile(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a app_profile resource
    async fn read_app_profile(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a app_profile resource
    async fn update_app_profile(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a app_profile resource
    async fn delete_app_profile(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_schema_bundle(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a schema_bundle resource
    async fn read_schema_bundle(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a schema_bundle resource
    async fn update_schema_bundle(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a schema_bundle resource
    async fn delete_schema_bundle(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_logical_view(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a logical_view resource
    async fn read_logical_view(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a logical_view resource
    async fn update_logical_view(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a logical_view resource
    async fn delete_logical_view(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_hot_tablet(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a hot_tablet resource
    async fn read_hot_tablet(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a hot_tablet resource
    async fn update_hot_tablet(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a hot_tablet resource
    async fn delete_hot_tablet(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
