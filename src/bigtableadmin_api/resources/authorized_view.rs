...
impl<'a> Authorized_view<'a> {
    ...
    pub async fn create(&self, subset_view: Option<String>, deletion_protection: Option<bool>, name: Option<String>, etag: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, subset_view: Option<String>, deletion_protection: Option<bool>, name: Option<String>, etag: Option<String>) -> Result<()> {
