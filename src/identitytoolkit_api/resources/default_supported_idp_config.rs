...
impl<'a> Default_supported_idp_config<'a> {
    ...
    pub async fn create(&self, client_id: Option<String>, name: Option<String>, client_secret: Option<String>, enabled: Option<bool>, apple_sign_in_config: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, client_id: Option<String>, name: Option<String>, client_secret: Option<String>, enabled: Option<bool>, apple_sign_in_config: Option<String>) -> Result<()> {
