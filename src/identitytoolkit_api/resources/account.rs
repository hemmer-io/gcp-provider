...
impl<'a> Account<'a> {
    ...
    pub async fn create(&self, token_type: Option<String>, token: Option<String>, redirect_uri: Option<String>, provider_id: Option<String>, id_token: Option<String>, tenant_id: Option<String>) -> Result<String> {
