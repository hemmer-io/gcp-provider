...
impl<'a> Securityposture_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "posture_deployment" => {
                self.plan_posture_deployment(current_state, desired_input)
                    .await
            }
            "posture_template" => {
                self.plan_posture_template(current_state, desired_input)
                    .await
            }
            "posture" => self.plan_posture(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "securityposture_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "posture_deployment" => self.create_posture_deployment(input).await,
            "posture_template" => self.create_posture_template(input).await,
            "posture" => self.create_posture(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "posture_deployment" => self.read_posture_deployment(id).await,
            "posture_template" => self.read_posture_template(id).await,
            "posture" => self.read_posture(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "posture_deployment" => self.update_posture_deployment(id, input).await,
            "posture_template" => self.update_posture_template(id, input).await,
            "posture" => self.update_posture(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "posture_deployment" => self.delete_posture_deployment(id).await,
            "posture_template" => self.delete_posture_template(id).await,
            "posture" => self.delete_posture(id).await,
    ...
    async fn create_posture_deployment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a posture_deployment resource
    async fn read_posture_deployment(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_posture_deployment(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_posture_template(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a posture_template resource
    async fn read_posture_template(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_posture_template(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_posture(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a posture resource
    async fn read_posture(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a posture resource
    async fn update_posture(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a posture resource
    async fn delete_posture(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
