...
impl<'a> Glossary_entrie<'a> {
    ...
    pub async fn create(&self, name: Option<String>, terms_pair: Option<String>, terms_set: Option<String>, description: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, terms_pair: Option<String>, terms_set: Option<String>, description: Option<String>) -> Result<()> {
