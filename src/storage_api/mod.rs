...
impl<'a> Storage_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "anywhere_cache" => self.plan_anywhere_cache(current_state, desired_input).await,
            "folder" => self.plan_folder(current_state, desired_input).await,
            "managed_folder" => self.plan_managed_folder(current_state, desired_input).await,
            "hmac_key" => self.plan_hmac_key(current_state, desired_input).await,
            "service_account" => {
            ...
            "default_object_access_control" => {
                self.plan_default_object_access_control(current_state, desired_input)
                    .await
            }
            "bucket" => self.plan_bucket(current_state, desired_input).await,
            "bucket_access_control" => {
                self.plan_bucket_access_control(current_state, desired_input)
                    .await
            }
            "object" => self.plan_object(current_state, desired_input).await,
            "object_access_control" => {
                self.plan_object_access_control(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "anywhere_cache" => self.create_anywhere_cache(input).await,
            "folder" => self.create_folder(input).await,
            "managed_folder" => self.create_managed_folder(input).await,
            "hmac_key" => self.create_hmac_key(input).await,
            ...
            "bucket_access_control" => self.create_bucket_access_control(input).await,
            "object" => self.create_object(input).await,
            "object_access_control" => self.create_object_access_control(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "anywhere_cache" => self.read_anywhere_cache(id).await,
            "folder" => self.read_folder(id).await,
            "managed_folder" => self.read_managed_folder(id).await,
            "hmac_key" => self.read_hmac_key(id).await,
            "service_account" => self.read_service_account(id).await,
            "channel" => self.read_channel(id).await,
            "default_object_access_control" => self.read_default_object_access_control(id).await,
            "bucket" => self.read_bucket(id).await,
            "bucket_access_control" => self.read_bucket_access_control(id).await,
            "object" => self.read_object(id).await,
            "object_access_control" => self.read_object_access_control(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "anywhere_cache" => self.update_anywhere_cache(id, input).await,
            "folder" => self.update_folder(id, input).await,
            "managed_folder" => self.update_managed_folder(id, input).await,
            "hmac_key" => self.update_hmac_key(id, input).await,
            ...
            "bucket_access_control" => self.update_bucket_access_control(id, input).await,
            "object" => self.update_object(id, input).await,
            "object_access_control" => self.update_object_access_control(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "anywhere_cache" => self.delete_anywhere_cache(id).await,
            "folder" => self.delete_folder(id).await,
            "managed_folder" => self.delete_managed_folder(id).await,
            "hmac_key" => self.delete_hmac_key(id).await,
            "service_account" => self.delete_service_account(id).await,
            "channel" => self.delete_channel(id).await,
            "default_object_access_control" => self.delete_default_object_access_control(id).await,
            "bucket" => self.delete_bucket(id).await,
            "bucket_access_control" => self.delete_bucket_access_control(id).await,
            "object" => self.delete_object(id).await,
            "object_access_control" => self.delete_object_access_control(id).await,
    ...
    async fn create_anywhere_cache(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a anywhere_cache resource
    async fn read_anywhere_cache(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_anywhere_cache(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_managed_folder(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a managed_folder resource
    async fn read_managed_folder(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_managed_folder(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_hmac_key(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a hmac_key resource
    async fn read_hmac_key(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a hmac_key resource
    async fn update_hmac_key(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a hmac_key resource
    async fn delete_hmac_key(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_default_object_access_control(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_default_object_access_control(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_bucket_access_control(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a bucket_access_control resource
    async fn read_bucket_access_control(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_bucket_access_control(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_object_access_control(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a object_access_control resource
    async fn read_object_access_control(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_object_access_control(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
