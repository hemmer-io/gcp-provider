...
impl<'a> Androidpublisher_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "inapppurchase" => {
                self.plan_inapppurchase(current_state, desired_input).await
            }
            "product" => {
                self.plan_product(current_state, desired_input).await
            }
            "voidedpurchase" => {
                self.plan_voidedpurchase(current_state, desired_input).await
            }
            "grant" => {
            ...
            "variant" => {
                self.plan_variant(current_state, desired_input).await
            }
            "internalappsharingartifact" => {
                self.plan_internalappsharingartifact(current_state, desired_input).await
            }
            "product" => {
                self.plan_product(current_state, desired_input).await
            }
            "bundle" => {
                self.plan_bundle(current_state, desired_input).await
            }
            "expansionfile" => {
                self.plan_expansionfile(current_state, desired_input).await
            }
            "subscriptionsv2" => {
                self.plan_subscriptionsv2(current_state, desired_input).await
            }
            "inappproduct" => {
                self.plan_inappproduct(current_state, desired_input).await
            }
            "detail" => {
            ...
            "listing" => {
                self.plan_listing(current_state, desired_input).await
            }
            "externaltransaction" => {
                self.plan_externaltransaction(current_state, desired_input).await
            }
            "monetization" => {
                self.plan_monetization(current_state, desired_input).await
            }
            "base_plan" => {
                self.plan_base_plan(current_state, desired_input).await
            }
            "voidedpurchase" => {
                self.plan_voidedpurchase(current_state, desired_input).await
            }
            "device_tier_config" => {
                self.plan_device_tier_config(current_state, desired_input).await
            }
            "productsv2" => {
                self.plan_productsv2(current_state, desired_input).await
            }
            "countryavailability" => {
                self.plan_countryavailability(current_state, desired_input).await
            }
            "subscription" => {
            ...
            "review" => {
                self.plan_review(current_state, desired_input).await
            }
            "tester" => {
            ...
            "generatedapk" => {
                self.plan_generatedapk(current_state, desired_input).await
            }
            "apprecovery" => {
                self.plan_apprecovery(current_state, desired_input).await
            }
            "purchase_option" => {
                self.plan_purchase_option(current_state, desired_input).await
            }
            "deobfuscationfile" => {
                self.plan_deobfuscationfile(current_state, desired_input).await
            }
            "onetimeproduct" => {
                self.plan_onetimeproduct(current_state, desired_input).await
            }
            "apk" => {
                self.plan_apk(current_state, desired_input).await
            }
            "edit" => {
                self.plan_edit(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "inapppurchase" => {
                self.create_inapppurchase(input).await
            }
            "product" => {
                self.create_product(input).await
            }
            "voidedpurchase" => {
                self.create_voidedpurchase(input).await
            }
            "grant" => {
            ...
            "variant" => {
                self.create_variant(input).await
            }
            "internalappsharingartifact" => {
                self.create_internalappsharingartifact(input).await
            }
            "product" => {
                self.create_product(input).await
            }
            "bundle" => {
                self.create_bundle(input).await
            }
            "expansionfile" => {
                self.create_expansionfile(input).await
            }
            "subscriptionsv2" => {
                self.create_subscriptionsv2(input).await
            }
            "inappproduct" => {
                self.create_inappproduct(input).await
            }
            "detail" => {
            ...
            "listing" => {
                self.create_listing(input).await
            }
            "externaltransaction" => {
                self.create_externaltransaction(input).await
            }
            "monetization" => {
                self.create_monetization(input).await
            }
            "base_plan" => {
                self.create_base_plan(input).await
            }
            "voidedpurchase" => {
                self.create_voidedpurchase(input).await
            }
            "device_tier_config" => {
                self.create_device_tier_config(input).await
            }
            "productsv2" => {
                self.create_productsv2(input).await
            }
            "countryavailability" => {
                self.create_countryavailability(input).await
            }
            "subscription" => {
            ...
            "generatedapk" => {
                self.create_generatedapk(input).await
            }
            "apprecovery" => {
                self.create_apprecovery(input).await
            }
            "purchase_option" => {
                self.create_purchase_option(input).await
            }
            "deobfuscationfile" => {
                self.create_deobfuscationfile(input).await
            }
            "onetimeproduct" => {
                self.create_onetimeproduct(input).await
            }
            "apk" => {
                self.create_apk(input).await
            }
            "edit" => {
                self.create_edit(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "androidpublisher_api",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "inapppurchase" => {
                self.read_inapppurchase(id).await
            }
            "product" => {
                self.read_product(id).await
            }
            "voidedpurchase" => {
                self.read_voidedpurchase(id).await
            }
            "grant" => {
            ...
            "variant" => {
                self.read_variant(id).await
            }
            "internalappsharingartifact" => {
                self.read_internalappsharingartifact(id).await
            }
            "product" => {
                self.read_product(id).await
            }
            "bundle" => {
                self.read_bundle(id).await
            }
            "expansionfile" => {
                self.read_expansionfile(id).await
            }
            "subscriptionsv2" => {
                self.read_subscriptionsv2(id).await
            }
            "inappproduct" => {
                self.read_inappproduct(id).await
            }
            "detail" => {
            ...
            "listing" => {
                self.read_listing(id).await
            }
            "externaltransaction" => {
                self.read_externaltransaction(id).await
            }
            "monetization" => {
                self.read_monetization(id).await
            }
            "base_plan" => {
                self.read_base_plan(id).await
            }
            "voidedpurchase" => {
                self.read_voidedpurchase(id).await
            }
            "device_tier_config" => {
                self.read_device_tier_config(id).await
            }
            "productsv2" => {
                self.read_productsv2(id).await
            }
            "countryavailability" => {
                self.read_countryavailability(id).await
            }
            "subscription" => {
            ...
            "generatedapk" => {
                self.read_generatedapk(id).await
            }
            "apprecovery" => {
                self.read_apprecovery(id).await
            }
            "purchase_option" => {
                self.read_purchase_option(id).await
            }
            "deobfuscationfile" => {
                self.read_deobfuscationfile(id).await
            }
            "onetimeproduct" => {
                self.read_onetimeproduct(id).await
            }
            "apk" => {
                self.read_apk(id).await
            }
            "edit" => {
                self.read_edit(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "androidpublisher_api",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "inapppurchase" => {
                self.update_inapppurchase(id, input).await
            }
            "product" => {
                self.update_product(id, input).await
            }
            "voidedpurchase" => {
                self.update_voidedpurchase(id, input).await
            }
            "grant" => {
            ...
            "variant" => {
                self.update_variant(id, input).await
            }
            "internalappsharingartifact" => {
                self.update_internalappsharingartifact(id, input).await
            }
            "product" => {
                self.update_product(id, input).await
            }
            "bundle" => {
                self.update_bundle(id, input).await
            }
            "expansionfile" => {
                self.update_expansionfile(id, input).await
            }
            "subscriptionsv2" => {
                self.update_subscriptionsv2(id, input).await
            }
            "inappproduct" => {
                self.update_inappproduct(id, input).await
            }
            "detail" => {
            ...
            "listing" => {
                self.update_listing(id, input).await
            }
            "externaltransaction" => {
                self.update_externaltransaction(id, input).await
            }
            "monetization" => {
                self.update_monetization(id, input).await
            }
            "base_plan" => {
                self.update_base_plan(id, input).await
            }
            "voidedpurchase" => {
                self.update_voidedpurchase(id, input).await
            }
            "device_tier_config" => {
                self.update_device_tier_config(id, input).await
            }
            "productsv2" => {
                self.update_productsv2(id, input).await
            }
            "countryavailability" => {
                self.update_countryavailability(id, input).await
            }
            "subscription" => {
            ...
            "review" => {
                self.update_review(id, input).await
            }
            "tester" => {
            ...
            "generatedapk" => {
                self.update_generatedapk(id, input).await
            }
            "apprecovery" => {
                self.update_apprecovery(id, input).await
            }
            "purchase_option" => {
                self.update_purchase_option(id, input).await
            }
            "deobfuscationfile" => {
                self.update_deobfuscationfile(id, input).await
            }
            "onetimeproduct" => {
                self.update_onetimeproduct(id, input).await
            }
            "apk" => {
                self.update_apk(id, input).await
            }
            "edit" => {
                self.update_edit(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "androidpublisher_api",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "inapppurchase" => {
                self.delete_inapppurchase(id).await
            }
            "product" => {
                self.delete_product(id).await
            }
            "voidedpurchase" => {
                self.delete_voidedpurchase(id).await
            }
            "grant" => {
            ...
            "internalappsharingartifact" => {
                self.delete_internalappsharingartifact(id).await
            }
            "product" => {
                self.delete_product(id).await
            }
            "bundle" => {
                self.delete_bundle(id).await
            }
            "expansionfile" => {
                self.delete_expansionfile(id).await
            }
            "subscriptionsv2" => {
                self.delete_subscriptionsv2(id).await
            }
            "inappproduct" => {
                self.delete_inappproduct(id).await
            }
            "detail" => {
            ...
            "listing" => {
                self.delete_listing(id).await
            }
            "externaltransaction" => {
                self.delete_externaltransaction(id).await
            }
            "monetization" => {
                self.delete_monetization(id).await
            }
            "base_plan" => {
                self.delete_base_plan(id).await
            }
            "voidedpurchase" => {
                self.delete_voidedpurchase(id).await
            }
            "device_tier_config" => {
                self.delete_device_tier_config(id).await
            }
            "productsv2" => {
                self.delete_productsv2(id).await
            }
            "countryavailability" => {
                self.delete_countryavailability(id).await
            }
            "subscription" => {
            ...
            "generatedapk" => {
                self.delete_generatedapk(id).await
            }
            "apprecovery" => {
                self.delete_apprecovery(id).await
            }
            "purchase_option" => {
                self.delete_purchase_option(id).await
            }
            "deobfuscationfile" => {
                self.delete_deobfuscationfile(id).await
            }
            "onetimeproduct" => {
                self.delete_onetimeproduct(id).await
            }
            "apk" => {
                self.delete_apk(id).await
            }
            "edit" => {
                self.delete_edit(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "androidpublisher_api",
    ...
    async fn create_voidedpurchase(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_voidedpurchase(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_internalappsharingartifact(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_internalappsharingartifact(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_subscriptionsv2(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_subscriptionsv2(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_externaltransaction(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_externaltransaction(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_externaltransaction(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_device_tier_config(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_device_tier_config(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_device_tier_config(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_countryavailability(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_countryavailability(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_countryavailability(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_purchase_option(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_purchase_option(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_deobfuscationfile(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_deobfuscationfile(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_deobfuscationfile(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_onetimeproduct(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_onetimeproduct(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
