...
impl<'a> Device_tier_config<'a> {
    ...
    pub async fn create(&self, user_country_sets: Option<Vec<String>>, device_tier_set: Option<String>, device_tier_config_id: Option<String>, device_groups: Option<Vec<String>>, package_name: String) -> Result<String> {
