...
impl<'a> Connectors_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "eventtype" => self.plan_eventtype(current_state, desired_input).await,
            "connection_schema_metadata" => {
                self.plan_connection_schema_metadata(current_state, desired_input)
                    .await
            }
            ...
            "end_user_authentication" => {
                self.plan_end_user_authentication(current_state, desired_input)
                    .await
            }
            ...
            "custom_connector_version" => {
                self.plan_custom_connector_version(current_state, desired_input)
                    .await
            }
            ...
            "custom_connector" => {
                self.plan_custom_connector(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "eventtype" => self.create_eventtype(input).await,
            "connection_schema_metadata" => self.create_connection_schema_metadata(input).await,
            "provider" => self.create_provider(input).await,
            "connector" => self.create_connector(input).await,
            "end_user_authentication" => self.create_end_user_authentication(input).await,
            ...
            "custom_connector_version" => self.create_custom_connector_version(input).await,
            "operation" => self.create_operation(input).await,
            "managed_zone" => self.create_managed_zone(input).await,
            "custom_connector" => self.create_custom_connector(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "eventtype" => self.read_eventtype(id).await,
            "connection_schema_metadata" => self.read_connection_schema_metadata(id).await,
            "provider" => self.read_provider(id).await,
            "connector" => self.read_connector(id).await,
            "end_user_authentication" => self.read_end_user_authentication(id).await,
            ...
            "custom_connector_version" => self.read_custom_connector_version(id).await,
            "operation" => self.read_operation(id).await,
            "managed_zone" => self.read_managed_zone(id).await,
            "custom_connector" => self.read_custom_connector(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "eventtype" => self.update_eventtype(id, input).await,
            "connection_schema_metadata" => self.update_connection_schema_metadata(id, input).await,
            "provider" => self.update_provider(id, input).await,
            "connector" => self.update_connector(id, input).await,
            "end_user_authentication" => self.update_end_user_authentication(id, input).await,
            ...
            "custom_connector_version" => self.update_custom_connector_version(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "managed_zone" => self.update_managed_zone(id, input).await,
            "custom_connector" => self.update_custom_connector(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "eventtype" => self.delete_eventtype(id).await,
            "connection_schema_metadata" => self.delete_connection_schema_metadata(id).await,
            "provider" => self.delete_provider(id).await,
            "connector" => self.delete_connector(id).await,
            "end_user_authentication" => self.delete_end_user_authentication(id).await,
            ...
            "custom_connector_version" => self.delete_custom_connector_version(id).await,
            "operation" => self.delete_operation(id).await,
            "managed_zone" => self.delete_managed_zone(id).await,
            "custom_connector" => self.delete_custom_connector(id).await,
    ...
    async fn create_eventtype(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a eventtype resource
    async fn read_eventtype(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a eventtype resource
    async fn update_eventtype(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a eventtype resource
    async fn delete_eventtype(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_connection_schema_metadata(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_connection_schema_metadata(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_end_user_authentication(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a end_user_authentication resource
    async fn read_end_user_authentication(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_end_user_authentication(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_custom_connector_version(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_custom_connector_version(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_custom_connector(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a custom_connector resource
    async fn read_custom_connector(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_custom_connector(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
