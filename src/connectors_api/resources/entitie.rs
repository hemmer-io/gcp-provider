...
impl<'a> Entitie<'a> {
    ...
    pub async fn create(&self, name: Option<String>, metadata: Option<HashMap<String, HashMap<String, String>>>, fields: Option<HashMap<String, String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, metadata: Option<HashMap<String, HashMap<String, String>>>, fields: Option<HashMap<String, String>>) -> Result<()> {
