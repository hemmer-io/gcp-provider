...
impl<'a> End_user_authentication<'a> {
    ...
    pub async fn create(&self, status: Option<String>, roles: Option<Vec<String>>, notify_endpoint_destination: Option<String>, create_time: Option<String>, user_id: Option<String>, end_user_authentication_config: Option<String>, update_time: Option<String>, labels: Option<Vec<String>>, destination_configs: Option<Vec<String>>, name: Option<String>, config_variables: Option<Vec<String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, status: Option<String>, roles: Option<Vec<String>>, notify_endpoint_destination: Option<String>, create_time: Option<String>, user_id: Option<String>, end_user_authentication_config: Option<String>, update_time: Option<String>, labels: Option<Vec<String>>, destination_configs: Option<Vec<String>>, name: Option<String>, config_variables: Option<Vec<String>>) -> Result<()> {
