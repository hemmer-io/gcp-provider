...
impl<'a> Searchads360_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "search_ads360_field" => {
                self.plan_search_ads360_field(current_state, desired_input)
                    .await
            }
            "customer" => self.plan_customer(current_state, desired_input).await,
            "search_ads360" => self.plan_search_ads360(current_state, desired_input).await,
            "custom_column" => self.plan_custom_column(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "searchads360_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "search_ads360_field" => self.create_search_ads360_field(input).await,
            "customer" => self.create_customer(input).await,
            "search_ads360" => self.create_search_ads360(input).await,
            "custom_column" => self.create_custom_column(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "searchads360_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "search_ads360_field" => self.read_search_ads360_field(id).await,
            "customer" => self.read_customer(id).await,
            "search_ads360" => self.read_search_ads360(id).await,
            "custom_column" => self.read_custom_column(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "searchads360_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "search_ads360_field" => self.update_search_ads360_field(id, input).await,
            "customer" => self.update_customer(id, input).await,
            "search_ads360" => self.update_search_ads360(id, input).await,
            "custom_column" => self.update_custom_column(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "searchads360_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "search_ads360_field" => self.delete_search_ads360_field(id).await,
            "customer" => self.delete_customer(id).await,
            "search_ads360" => self.delete_search_ads360(id).await,
            "custom_column" => self.delete_custom_column(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "searchads360_api", resource_name
            ))),
    ...
    async fn create_search_ads360_field(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a search_ads360_field resource
    async fn read_search_ads360_field(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_search_ads360_field(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_search_ads360(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a search_ads360 resource
    async fn read_search_ads360(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a search_ads360 resource
    async fn update_search_ads360(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a search_ads360 resource
    async fn delete_search_ads360(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_custom_column(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a custom_column resource
    async fn read_custom_column(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a custom_column resource
    async fn update_custom_column(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
