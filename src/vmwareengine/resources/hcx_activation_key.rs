...
impl<'a> Hcx_activation_key<'a> {
    ...
    pub async fn create(&self, uid: Option<String>, create_time: Option<String>, activation_key: Option<String>, state: Option<String>, name: Option<String>, parent: String) -> Result<String> {
