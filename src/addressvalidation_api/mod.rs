//! Addressvalidation_api service for Gcp provider
//!
//! This module handles all addressvalidation_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Addressvalidation_api service handler
...
impl<'a> Addressvalidation_apiService<'a> {
    ...
    /// Plan changes to a addressvalidation resource
    async fn plan_addressvalidation(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    async fn update_addressvalidation(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
