...
impl<'a> Logging<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, kms_key_version_name: Option<String>, name: Option<String>, service_account_id: Option<String>, kms_key_name: Option<String>) -> Result<()> {
