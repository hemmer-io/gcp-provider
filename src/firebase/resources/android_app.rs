...
impl<'a> Android_app<'a> {
    ...
    pub async fn create(&self, sha1_hashes: Option<Vec<String>>, app_id: Option<String>, expire_time: Option<String>, name: Option<String>, api_key_id: Option<String>, display_name: Option<String>, etag: Option<String>, project_id: Option<String>, state: Option<String>, package_name: Option<String>, sha256_hashes: Option<Vec<String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, sha1_hashes: Option<Vec<String>>, app_id: Option<String>, expire_time: Option<String>, name: Option<String>, api_key_id: Option<String>, display_name: Option<String>, etag: Option<String>, project_id: Option<String>, state: Option<String>, package_name: Option<String>, sha256_hashes: Option<Vec<String>>) -> Result<()> {
