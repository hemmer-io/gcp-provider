...
impl<'a> Networkconnectivity_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "multicloud_data_transfer_supported_service" => {
                self.plan_multicloud_data_transfer_supported_service(current_state, desired_input).await
            }
            "service_connection_token" => {
                self.plan_service_connection_token(current_state, desired_input).await
            }
            "operation" => {
                self.plan_operation(current_state, desired_input).await
            }
            "spoke" => {
                self.plan_spoke(current_state, desired_input).await
            }
            "group" => {
            ...
            "service_classe" => {
                self.plan_service_classe(current_state, desired_input).await
            }
            "route" => {
            ...
            "internal_range" => {
                self.plan_internal_range(current_state, desired_input).await
            }
            "service_connection_map" => {
                self.plan_service_connection_map(current_state, desired_input).await
            }
            "regional_endpoint" => {
                self.plan_regional_endpoint(current_state, desired_input).await
            }
            "destination" => {
                self.plan_destination(current_state, desired_input).await
            }
            "service_connection_policie" => {
                self.plan_service_connection_policie(current_state, desired_input).await
            }
            "policy_based_route" => {
                self.plan_policy_based_route(current_state, desired_input).await
            }
            "multicloud_data_transfer_config" => {
                self.plan_multicloud_data_transfer_config(current_state, desired_input).await
            }
            "route_table" => {
                self.plan_route_table(current_state, desired_input).await
            }
            "operation" => {
                self.plan_operation(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "multicloud_data_transfer_supported_service" => {
                self.create_multicloud_data_transfer_supported_service(input).await
            }
            "service_connection_token" => {
                self.create_service_connection_token(input).await
            }
            "operation" => {
                self.create_operation(input).await
            }
            "spoke" => {
                self.create_spoke(input).await
            }
            "group" => {
            ...
            "service_classe" => {
                self.create_service_classe(input).await
            }
            "route" => {
            ...
            "internal_range" => {
                self.create_internal_range(input).await
            }
            "service_connection_map" => {
                self.create_service_connection_map(input).await
            }
            "regional_endpoint" => {
                self.create_regional_endpoint(input).await
            }
            "destination" => {
                self.create_destination(input).await
            }
            "service_connection_policie" => {
                self.create_service_connection_policie(input).await
            }
            "policy_based_route" => {
                self.create_policy_based_route(input).await
            }
            "multicloud_data_transfer_config" => {
                self.create_multicloud_data_transfer_config(input).await
            }
            "route_table" => {
                self.create_route_table(input).await
            }
            "operation" => {
                self.create_operation(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "multicloud_data_transfer_supported_service" => {
                self.read_multicloud_data_transfer_supported_service(id).await
            }
            "service_connection_token" => {
                self.read_service_connection_token(id).await
            }
            "operation" => {
                self.read_operation(id).await
            }
            "spoke" => {
                self.read_spoke(id).await
            }
            "group" => {
            ...
            "service_classe" => {
                self.read_service_classe(id).await
            }
            "route" => {
            ...
            "internal_range" => {
                self.read_internal_range(id).await
            }
            "service_connection_map" => {
                self.read_service_connection_map(id).await
            }
            "regional_endpoint" => {
                self.read_regional_endpoint(id).await
            }
            "destination" => {
                self.read_destination(id).await
            }
            "service_connection_policie" => {
                self.read_service_connection_policie(id).await
            }
            "policy_based_route" => {
                self.read_policy_based_route(id).await
            }
            "multicloud_data_transfer_config" => {
                self.read_multicloud_data_transfer_config(id).await
            }
            "route_table" => {
                self.read_route_table(id).await
            }
            "operation" => {
                self.read_operation(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "multicloud_data_transfer_supported_service" => {
                self.update_multicloud_data_transfer_supported_service(id, input).await
            }
            "service_connection_token" => {
                self.update_service_connection_token(id, input).await
            }
            "operation" => {
                self.update_operation(id, input).await
            }
            "spoke" => {
                self.update_spoke(id, input).await
            }
            "group" => {
            ...
            "service_classe" => {
                self.update_service_classe(id, input).await
            }
            "route" => {
            ...
            "internal_range" => {
                self.update_internal_range(id, input).await
            }
            "service_connection_map" => {
                self.update_service_connection_map(id, input).await
            }
            "regional_endpoint" => {
                self.update_regional_endpoint(id, input).await
            }
            "destination" => {
                self.update_destination(id, input).await
            }
            "service_connection_policie" => {
                self.update_service_connection_policie(id, input).await
            }
            "policy_based_route" => {
                self.update_policy_based_route(id, input).await
            }
            "multicloud_data_transfer_config" => {
                self.update_multicloud_data_transfer_config(id, input).await
            }
            "route_table" => {
                self.update_route_table(id, input).await
            }
            "operation" => {
                self.update_operation(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "multicloud_data_transfer_supported_service" => {
                self.delete_multicloud_data_transfer_supported_service(id).await
            }
            "service_connection_token" => {
                self.delete_service_connection_token(id).await
            }
            "operation" => {
                self.delete_operation(id).await
            }
            "spoke" => {
                self.delete_spoke(id).await
            }
            "group" => {
            ...
            "service_classe" => {
                self.delete_service_classe(id).await
            }
            "route" => {
            ...
            "internal_range" => {
                self.delete_internal_range(id).await
            }
            "service_connection_map" => {
                self.delete_service_connection_map(id).await
            }
            "regional_endpoint" => {
                self.delete_regional_endpoint(id).await
            }
            "destination" => {
                self.delete_destination(id).await
            }
            "service_connection_policie" => {
                self.delete_service_connection_policie(id).await
            }
            "policy_based_route" => {
                self.delete_policy_based_route(id).await
            }
            "multicloud_data_transfer_config" => {
                self.delete_multicloud_data_transfer_config(id).await
            }
            "route_table" => {
                self.delete_route_table(id).await
            }
            "operation" => {
                self.delete_operation(id).await
            }
    ...
    async fn delete_multicloud_data_transfer_supported_service(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_service_connection_token(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_service_classe(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_service_classe(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_service_connection_map(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_regional_endpoint(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_regional_endpoint(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_regional_endpoint(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_service_connection_policie(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_service_connection_policie(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_policy_based_route(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_multicloud_data_transfer_config(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
