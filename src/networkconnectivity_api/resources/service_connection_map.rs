...
impl<'a> Service_connection_map<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, service_class_uri: Option<String>, infrastructure: Option<String>, producer_psc_configs: Option<Vec<String>>, service_class: Option<String>, token: Option<String>, etag: Option<String>, description: Option<String>, name: Option<String>, consumer_psc_configs: Option<Vec<String>>, labels: Option<HashMap<String, String>>, consumer_psc_connections: Option<Vec<String>>, update_time: Option<String>, parent: String) -> Result<String> {
