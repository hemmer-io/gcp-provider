...
impl<'a> Regional_endpoint<'a> {
    ...
    pub async fn create(&self, subnetwork: Option<String>, address: Option<String>, description: Option<String>, target_google_api: Option<String>, psc_forwarding_rule: Option<String>, update_time: Option<String>, ip_address: Option<String>, network: Option<String>, create_time: Option<String>, name: Option<String>, labels: Option<HashMap<String, String>>, access_type: Option<String>, parent: String) -> Result<String> {
