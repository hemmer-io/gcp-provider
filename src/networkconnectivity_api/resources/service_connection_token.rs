...
impl<'a> Service_connection_token<'a> {
    ...
    pub async fn create(&self, etag: Option<String>, token: Option<String>, labels: Option<HashMap<String, String>>, network: Option<String>, name: Option<String>, create_time: Option<String>, expire_time: Option<String>, update_time: Option<String>, description: Option<String>, parent: String) -> Result<String> {
