...
impl<'a> Multicloud_data_transfer_config<'a> {
    ...
    pub async fn create(&self, description: Option<String>, destinations_active_count: Option<i64>, services: Option<HashMap<String, String>>, uid: Option<String>, destinations_count: Option<i64>, name: Option<String>, update_time: Option<String>, labels: Option<HashMap<String, String>>, etag: Option<String>, create_time: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, destinations_active_count: Option<i64>, services: Option<HashMap<String, String>>, uid: Option<String>, destinations_count: Option<i64>, name: Option<String>, update_time: Option<String>, labels: Option<HashMap<String, String>>, etag: Option<String>, create_time: Option<String>) -> Result<()> {
