...
impl<'a> Multicloud_data_transfer_config<'a> {
    ...
    pub async fn create(&self, name: Option<String>, description: Option<String>, destinations_count: Option<i64>, create_time: Option<String>, labels: Option<HashMap<String, String>>, uid: Option<String>, destinations_active_count: Option<i64>, update_time: Option<String>, services: Option<HashMap<String, String>>, etag: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, description: Option<String>, destinations_count: Option<i64>, create_time: Option<String>, labels: Option<HashMap<String, String>>, uid: Option<String>, destinations_active_count: Option<i64>, update_time: Option<String>, services: Option<HashMap<String, String>>, etag: Option<String>) -> Result<()> {
