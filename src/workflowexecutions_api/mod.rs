...
impl<'a> Workflowexecutions_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "step_entrie" => self.plan_step_entrie(current_state, desired_input).await,
            "execution" => self.plan_execution(current_state, desired_input).await,
            "execution" => self.plan_execution(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "workflowexecutions_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "step_entrie" => self.create_step_entrie(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "step_entrie" => self.read_step_entrie(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "step_entrie" => self.update_step_entrie(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "step_entrie" => self.delete_step_entrie(id).await,
    ...
    async fn create_step_entrie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a step_entrie resource
    async fn read_step_entrie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a step_entrie resource
    async fn update_step_entrie(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a step_entrie resource
    async fn delete_step_entrie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
