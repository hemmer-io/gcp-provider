...
impl<'a> Node_group<'a> {
    ...
    pub async fn create(&self, labels: Option<HashMap<String, String>>, roles: Option<Vec<String>>, name: Option<String>, node_group_config: Option<String>, parent: String) -> Result<String> {
