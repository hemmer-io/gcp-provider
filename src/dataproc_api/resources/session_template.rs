...
impl<'a> Session_template<'a> {
    ...
    pub async fn create(&self, name: Option<String>, create_time: Option<String>, runtime_config: Option<String>, labels: Option<HashMap<String, String>>, uuid: Option<String>, description: Option<String>, creator: Option<String>, environment_config: Option<String>, jupyter_session: Option<String>, spark_connect_session: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
