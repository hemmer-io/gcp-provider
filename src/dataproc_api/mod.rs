...
impl<'a> Dataproc_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "workflow_template" => {
                self.plan_workflow_template(current_state, desired_input)
                    .await
            }
            "node_group" => self.plan_node_group(current_state, desired_input).await,
            "job" => self.plan_job(current_state, desired_input).await,
            "autoscaling_policie" => {
                self.plan_autoscaling_policie(current_state, desired_input)
                    .await
            }
            "batche" => self.plan_batche(current_state, desired_input).await,
            "session_template" => {
                self.plan_session_template(current_state, desired_input)
                    .await
            }
            "session" => self.plan_session(current_state, desired_input).await,
            "spark_application" => {
                self.plan_spark_application(current_state, desired_input)
                    .await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "workflow_template" => self.create_workflow_template(input).await,
            "node_group" => self.create_node_group(input).await,
            "job" => self.create_job(input).await,
            "autoscaling_policie" => self.create_autoscaling_policie(input).await,
            "batche" => self.create_batche(input).await,
            "session_template" => self.create_session_template(input).await,
            "session" => self.create_session(input).await,
            "spark_application" => self.create_spark_application(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "workflow_template" => self.read_workflow_template(id).await,
            "node_group" => self.read_node_group(id).await,
            "job" => self.read_job(id).await,
            "autoscaling_policie" => self.read_autoscaling_policie(id).await,
            "batche" => self.read_batche(id).await,
            "session_template" => self.read_session_template(id).await,
            "session" => self.read_session(id).await,
            "spark_application" => self.read_spark_application(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "workflow_template" => self.update_workflow_template(id, input).await,
            "node_group" => self.update_node_group(id, input).await,
            "job" => self.update_job(id, input).await,
            "autoscaling_policie" => self.update_autoscaling_policie(id, input).await,
            "batche" => self.update_batche(id, input).await,
            "session_template" => self.update_session_template(id, input).await,
            "session" => self.update_session(id, input).await,
            "spark_application" => self.update_spark_application(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "workflow_template" => self.delete_workflow_template(id).await,
            "node_group" => self.delete_node_group(id).await,
            "job" => self.delete_job(id).await,
            "autoscaling_policie" => self.delete_autoscaling_policie(id).await,
            "batche" => self.delete_batche(id).await,
            "session_template" => self.delete_session_template(id).await,
            "session" => self.delete_session(id).await,
            "spark_application" => self.delete_spark_application(id).await,
    ...
    async fn create_workflow_template(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a workflow_template resource
    async fn read_workflow_template(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_workflow_template(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_autoscaling_policie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a autoscaling_policie resource
    async fn read_autoscaling_policie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_autoscaling_policie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_batche(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a batche resource
    async fn read_batche(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a batche resource
    async fn update_batche(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a batche resource
    async fn delete_batche(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_session_template(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a session_template resource
    async fn read_session_template(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_session_template(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_spark_application(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a spark_application resource
    async fn read_spark_application(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_spark_application(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
