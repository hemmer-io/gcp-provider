...
impl<'a> Binaryauthorization_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "systempolicy" => self.plan_systempolicy(current_state, desired_input).await,
            "project" => self.plan_project(current_state, desired_input).await,
            "policy" => self.plan_policy(current_state, desired_input).await,
            "attestor" => self.plan_attestor(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "binaryauthorization_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "systempolicy" => self.create_systempolicy(input).await,
            "project" => self.create_project(input).await,
            "policy" => self.create_policy(input).await,
            "attestor" => self.create_attestor(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "systempolicy" => self.read_systempolicy(id).await,
            "project" => self.read_project(id).await,
            "policy" => self.read_policy(id).await,
            "attestor" => self.read_attestor(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "systempolicy" => self.update_systempolicy(id, input).await,
            "project" => self.update_project(id, input).await,
            "policy" => self.update_policy(id, input).await,
            "attestor" => self.update_attestor(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "systempolicy" => self.delete_systempolicy(id).await,
            "project" => self.delete_project(id).await,
            "policy" => self.delete_policy(id).await,
            "attestor" => self.delete_attestor(id).await,
    ...
    async fn create_systempolicy(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a systempolicy resource
    async fn read_systempolicy(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a systempolicy resource
    async fn update_systempolicy(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a systempolicy resource
    async fn delete_systempolicy(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_attestor(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a attestor resource
    async fn read_attestor(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a attestor resource
    async fn update_attestor(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a attestor resource
    async fn delete_attestor(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
