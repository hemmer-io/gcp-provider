...
impl<'a> Photo_sequence<'a> {
    ...
    pub async fn create(&self, distance_meters: Option<f64>, imu: Option<String>, failure_details: Option<String>, id: Option<String>, failure_reason: Option<String>, filename: Option<String>, photos: Option<Vec<String>>, raw_gps_timeline: Option<Vec<String>>, processing_state: Option<String>, capture_time_override: Option<String>, upload_reference: Option<String>, view_count: Option<String>, sequence_bounds: Option<String>, upload_time: Option<String>, gps_source: Option<String>) -> Result<String> {
