...
impl<'a> Entitlement<'a> {
    ...
    pub async fn create(&self, entitlement_migrated: Option<String>, properties: Option<HashMap<String, String>>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, entitlement_migrated: Option<String>, properties: Option<HashMap<String, String>>) -> Result<()> {
