//! Acmedns_api service for Gcp provider
//!
//! This module handles all acmedns_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Acmedns_api service handler
...
impl<'a> Acmedns_apiService<'a> {
    ...
    /// Plan changes to a acme_challenge_set resource
    async fn plan_acme_challenge_set(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    async fn update_acme_challenge_set(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
