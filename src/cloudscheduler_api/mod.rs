//! Cloudscheduler_api service for Gcp provider
//!
//! This module handles all cloudscheduler_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Cloudscheduler_api service handler
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "cloudscheduler_api", resource_name
            ))),
        }
    }
