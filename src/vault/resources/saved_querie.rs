...
impl<'a> Saved_querie<'a> {
    ...
    pub async fn create(&self, matter_id: Option<String>, query: Option<String>, saved_query_id: Option<String>, create_time: Option<String>, display_name: Option<String>, matter_id: String) -> Result<String> {
