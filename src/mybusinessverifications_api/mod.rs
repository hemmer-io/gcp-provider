...
impl<'a> Mybusinessverifications_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "verification" => self.plan_verification(current_state, desired_input).await,
            "location" => self.plan_location(current_state, desired_input).await,
            "verification_token" => {
                self.plan_verification_token(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "mybusinessverifications_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "verification" => self.create_verification(input).await,
            "location" => self.create_location(input).await,
            "verification_token" => self.create_verification_token(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "mybusinessverifications_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "verification" => self.read_verification(id).await,
            "location" => self.read_location(id).await,
            "verification_token" => self.read_verification_token(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "mybusinessverifications_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "verification" => self.update_verification(id, input).await,
            "location" => self.update_location(id, input).await,
            "verification_token" => self.update_verification_token(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "mybusinessverifications_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "verification" => self.delete_verification(id).await,
            "location" => self.delete_location(id).await,
            "verification_token" => self.delete_verification_token(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "mybusinessverifications_api", resource_name
            ))),
    ...
    async fn create_verification(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a verification resource
    async fn read_verification(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a verification resource
    async fn update_verification(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn create_verification_token(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a verification_token resource
    async fn read_verification_token(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_verification_token(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
