//! Notebooks_api service for Gcp provider
//!
//! This module handles all notebooks_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Notebooks_api service handler
pub struct Notebooks_apiService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> Notebooks_apiService<'a> {
