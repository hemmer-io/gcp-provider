...
impl<'a> Debugsession<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, count: Option<i64>, filter: Option<String>, name: Option<String>, timeout: Option<String>, tracesize: Option<i64>, validity: Option<i64>, parent: String) -> Result<String> {
