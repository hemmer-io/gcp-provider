...
impl<'a> Security_assessment_result<'a> {
    ...
    pub async fn create(&self, include: Option<String>, page_token: Option<String>, profile: Option<String>, scope: Option<String>, page_size: Option<i64>, include_all_resources: Option<String>, name: String) -> Result<String> {
