...
impl<'a> Endpoint_attachment<'a> {
    ...
    pub async fn create(&self, service_attachment: Option<String>, location: Option<String>, host: Option<String>, name: Option<String>, state: Option<String>, connection_state: Option<String>, parent: String) -> Result<String> {
