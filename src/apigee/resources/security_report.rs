...
impl<'a> Security_report<'a> {
    ...
    pub async fn create(&self, group_by_time_unit: Option<String>, csv_delimiter: Option<String>, limit: Option<i64>, time_range: Option<String>, report_definition_id: Option<String>, dimensions: Option<Vec<String>>, filter: Option<String>, mime_type: Option<String>, metrics: Option<Vec<String>>, envgroup_hostname: Option<String>, display_name: Option<String>, parent: String) -> Result<String> {
