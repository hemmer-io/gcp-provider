...
impl<'a> Flowhook<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, flow_hook_point: Option<String>, continue_on_error: Option<bool>, description: Option<String>, shared_flow: Option<String>) -> Result<()> {
