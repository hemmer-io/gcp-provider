...
impl<'a> Verifiedaccess_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "challenge" => {
                self.plan_challenge(current_state, desired_input).await
            }
            "challenge" => {
                self.plan_challenge(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "challenge" => {
                self.create_challenge(input).await
            }
            "challenge" => {
                self.create_challenge(input).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "challenge" => {
                self.update_challenge(id, input).await
            }
            "challenge" => {
                self.update_challenge(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "challenge" => {
                self.delete_challenge(id).await
            }
            "challenge" => {
                self.delete_challenge(id).await
            }
