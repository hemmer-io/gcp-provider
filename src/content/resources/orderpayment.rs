...
impl<'a> Orderpayment<'a> {
    ...
    pub async fn create(&self, charge_state: Option<String>, invoice_id: Option<String>, invoice_ids: Option<Vec<String>>, order_id: String, merchant_id: String) -> Result<String> {
