...
impl<'a> Returnaddres<'a> {
    ...
    pub async fn create(&self, label: Option<String>, address: Option<String>, return_address_id: Option<String>, kind: Option<String>, phone_number: Option<String>, country: Option<String>, merchant_id: String) -> Result<String> {
