...
impl<'a> Audience_export<'a> {
    ...
    pub async fn create(&self, begin_creating_time: Option<String>, audience_display_name: Option<String>, audience: Option<String>, creation_quota_tokens_charged: Option<i64>, dimensions: Option<Vec<String>>, row_count: Option<i64>, name: Option<String>, error_message: Option<String>, percentage_completed: Option<f64>, state: Option<String>, parent: String) -> Result<String> {
