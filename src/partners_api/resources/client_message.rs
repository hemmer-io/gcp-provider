...
impl<'a> Client_message<'a> {
    ...
    pub async fn create(&self, details: Option<String>, request_metadata: Option<String>, client_info: Option<HashMap<String, String>>, level: Option<String>) -> Result<String> {
