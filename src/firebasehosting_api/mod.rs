//! Firebasehosting_api service for Gcp provider
//!
//! This module handles all firebasehosting_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Firebasehosting_api service handler
pub struct Firebasehosting_apiService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> Firebasehosting_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "operation" => self.plan_operation(current_state, desired_input).await,
            "custom_domain" => self.plan_custom_domain(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "firebasehosting_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "operation" => self.create_operation(input).await,
            "custom_domain" => self.create_custom_domain(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "operation" => self.read_operation(id).await,
            "custom_domain" => self.read_custom_domain(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "operation" => self.update_operation(id, input).await,
            "custom_domain" => self.update_custom_domain(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "operation" => self.delete_operation(id).await,
            "custom_domain" => self.delete_custom_domain(id).await,
    ...
    async fn create_custom_domain(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a custom_domain resource
    async fn read_custom_domain(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a custom_domain resource
    async fn update_custom_domain(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a custom_domain resource
    async fn delete_custom_domain(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
