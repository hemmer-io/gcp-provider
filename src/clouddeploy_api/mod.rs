...
impl<'a> Clouddeploy_apiService<'a> {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "deploy_policie" => self.create_deploy_policie(input).await,
            "location" => self.create_location(input).await,
            "release" => self.create_release(input).await,
            "automation_run" => self.create_automation_run(input).await,
            "automation" => self.create_automation(input).await,
            "operation" => self.create_operation(input).await,
            "target" => self.create_target(input).await,
            "delivery_pipeline" => self.create_delivery_pipeline(input).await,
            "rollout" => self.create_rollout(input).await,
            "custom_target_type" => self.create_custom_target_type(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "deploy_policie" => self.read_deploy_policie(id).await,
            "location" => self.read_location(id).await,
            "release" => self.read_release(id).await,
            "automation_run" => self.read_automation_run(id).await,
            "automation" => self.read_automation(id).await,
            "operation" => self.read_operation(id).await,
            "target" => self.read_target(id).await,
            "delivery_pipeline" => self.read_delivery_pipeline(id).await,
            "rollout" => self.read_rollout(id).await,
            "custom_target_type" => self.read_custom_target_type(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "deploy_policie" => self.update_deploy_policie(id, input).await,
            "location" => self.update_location(id, input).await,
            "release" => self.update_release(id, input).await,
            "automation_run" => self.update_automation_run(id, input).await,
            "automation" => self.update_automation(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "target" => self.update_target(id, input).await,
            "delivery_pipeline" => self.update_delivery_pipeline(id, input).await,
            "rollout" => self.update_rollout(id, input).await,
            "custom_target_type" => self.update_custom_target_type(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "deploy_policie" => self.delete_deploy_policie(id).await,
            "location" => self.delete_location(id).await,
            "release" => self.delete_release(id).await,
            "automation_run" => self.delete_automation_run(id).await,
            "automation" => self.delete_automation(id).await,
            "operation" => self.delete_operation(id).await,
            "target" => self.delete_target(id).await,
            "delivery_pipeline" => self.delete_delivery_pipeline(id).await,
            "rollout" => self.delete_rollout(id).await,
            "custom_target_type" => self.delete_custom_target_type(id).await,
    ...
    async fn create_deploy_policie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a deploy_policie resource
    async fn read_deploy_policie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_deploy_policie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_automation_run(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a automation_run resource
    async fn read_automation_run(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_automation_run(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_automation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a automation resource
    async fn read_automation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a automation resource
    async fn update_automation(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a automation resource
    async fn delete_automation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_delivery_pipeline(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a delivery_pipeline resource
    async fn read_delivery_pipeline(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_delivery_pipeline(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_custom_target_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a custom_target_type resource
    async fn read_custom_target_type(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_custom_target_type(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
