...
impl<'a> Automation<'a> {
    ...
    pub async fn create(&self, description: Option<String>, update_time: Option<String>, service_account: Option<String>, suspended: Option<bool>, annotations: Option<HashMap<String, String>>, rules: Option<Vec<String>>, etag: Option<String>, selector: Option<String>, labels: Option<HashMap<String, String>>, uid: Option<String>, create_time: Option<String>, name: Option<String>, parent: String) -> Result<String> {
