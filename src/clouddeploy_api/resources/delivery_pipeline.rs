...
impl<'a> Delivery_pipeline<'a> {
    ...
    pub async fn create(&self, serial_pipeline: Option<String>, description: Option<String>, update_time: Option<String>, etag: Option<String>, annotations: Option<HashMap<String, String>>, name: Option<String>, suspended: Option<bool>, condition: Option<String>, uid: Option<String>, create_time: Option<String>, labels: Option<HashMap<String, String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, serial_pipeline: Option<String>, description: Option<String>, update_time: Option<String>, etag: Option<String>, annotations: Option<HashMap<String, String>>, name: Option<String>, suspended: Option<bool>, condition: Option<String>, uid: Option<String>, create_time: Option<String>, labels: Option<HashMap<String, String>>) -> Result<()> {
