...
impl<'a> Delivery_pipeline<'a> {
    ...
    pub async fn create(&self, condition: Option<String>, labels: Option<HashMap<String, String>>, update_time: Option<String>, name: Option<String>, annotations: Option<HashMap<String, String>>, create_time: Option<String>, description: Option<String>, serial_pipeline: Option<String>, etag: Option<String>, suspended: Option<bool>, uid: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, condition: Option<String>, labels: Option<HashMap<String, String>>, update_time: Option<String>, name: Option<String>, annotations: Option<HashMap<String, String>>, create_time: Option<String>, description: Option<String>, serial_pipeline: Option<String>, etag: Option<String>, suspended: Option<bool>, uid: Option<String>) -> Result<()> {
