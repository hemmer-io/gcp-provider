...
impl<'a> Firebase_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "default_location" => {
                self.plan_default_location(current_state, desired_input).await
            }
            "project" => {
                self.plan_project(current_state, desired_input).await
            }
            "android_app" => {
                self.plan_android_app(current_state, desired_input).await
            }
            "operation" => {
                self.plan_operation(current_state, desired_input).await
            }
            "sha" => {
                self.plan_sha(current_state, desired_input).await
            }
            "available_location" => {
                self.plan_available_location(current_state, desired_input).await
            }
            "available_project" => {
                self.plan_available_project(current_state, desired_input).await
            }
            "web_app" => {
                self.plan_web_app(current_state, desired_input).await
            }
            "ios_app" => {
                self.plan_ios_app(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "default_location" => {
                self.create_default_location(input).await
            }
            "project" => {
                self.create_project(input).await
            }
            "android_app" => {
                self.create_android_app(input).await
            }
            "operation" => {
                self.create_operation(input).await
            }
            "sha" => {
                self.create_sha(input).await
            }
            "available_location" => {
                self.create_available_location(input).await
            }
            "available_project" => {
                self.create_available_project(input).await
            }
            "web_app" => {
                self.create_web_app(input).await
            }
            "ios_app" => {
                self.create_ios_app(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "firebase_api",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "default_location" => {
                self.read_default_location(id).await
            }
            "project" => {
                self.read_project(id).await
            }
            "android_app" => {
                self.read_android_app(id).await
            }
            "operation" => {
                self.read_operation(id).await
            }
            "sha" => {
                self.read_sha(id).await
            }
            "available_location" => {
                self.read_available_location(id).await
            }
            "available_project" => {
                self.read_available_project(id).await
            }
            "web_app" => {
                self.read_web_app(id).await
            }
            "ios_app" => {
                self.read_ios_app(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "firebase_api",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "default_location" => {
                self.update_default_location(id, input).await
            }
            "project" => {
                self.update_project(id, input).await
            }
            "android_app" => {
                self.update_android_app(id, input).await
            }
            "operation" => {
                self.update_operation(id, input).await
            }
            "sha" => {
                self.update_sha(id, input).await
            }
            "available_location" => {
                self.update_available_location(id, input).await
            }
            "available_project" => {
                self.update_available_project(id, input).await
            }
            "web_app" => {
                self.update_web_app(id, input).await
            }
            "ios_app" => {
                self.update_ios_app(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "firebase_api",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "default_location" => {
                self.delete_default_location(id).await
            }
            "project" => {
                self.delete_project(id).await
            }
            "android_app" => {
                self.delete_android_app(id).await
            }
            "operation" => {
                self.delete_operation(id).await
            }
            "sha" => {
                self.delete_sha(id).await
            }
            "available_location" => {
                self.delete_available_location(id).await
            }
            "available_project" => {
                self.delete_available_project(id).await
            }
            "web_app" => {
                self.delete_web_app(id).await
            }
            "ios_app" => {
                self.delete_ios_app(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "firebase_api",
    ...
    async fn read_default_location(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_default_location(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_available_location(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_available_location(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_available_location(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_available_project(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_available_project(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_available_project(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
