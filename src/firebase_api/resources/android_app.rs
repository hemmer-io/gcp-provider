...
impl<'a> Android_app<'a> {
    ...
    pub async fn create(&self, expire_time: Option<String>, etag: Option<String>, package_name: Option<String>, sha256_hashes: Option<Vec<String>>, display_name: Option<String>, sha1_hashes: Option<Vec<String>>, api_key_id: Option<String>, app_id: Option<String>, project_id: Option<String>, state: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, expire_time: Option<String>, etag: Option<String>, package_name: Option<String>, sha256_hashes: Option<Vec<String>>, display_name: Option<String>, sha1_hashes: Option<Vec<String>>, api_key_id: Option<String>, app_id: Option<String>, project_id: Option<String>, state: Option<String>, name: Option<String>) -> Result<()> {
