...
impl<'a> Android_app<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, package_name: Option<String>, project_id: Option<String>, sha1_hashes: Option<Vec<String>>, expire_time: Option<String>, state: Option<String>, api_key_id: Option<String>, name: Option<String>, etag: Option<String>, sha256_hashes: Option<Vec<String>>, app_id: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, display_name: Option<String>, package_name: Option<String>, project_id: Option<String>, sha1_hashes: Option<Vec<String>>, expire_time: Option<String>, state: Option<String>, api_key_id: Option<String>, name: Option<String>, etag: Option<String>, sha256_hashes: Option<Vec<String>>, app_id: Option<String>) -> Result<()> {
