...
impl<'a> Idea_activitie<'a> {
    ...
    pub async fn create(&self, topics: Option<Vec<String>>, type: Option<String>, name: Option<String>, ideas: Option<Vec<String>>, uri: Option<String>, parent: String) -> Result<String> {
