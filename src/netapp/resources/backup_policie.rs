...
impl<'a> Backup_policie<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, assigned_volume_count: Option<i64>, state: Option<String>, weekly_backup_limit: Option<i64>, daily_backup_limit: Option<i64>, labels: Option<HashMap<String, String>>, name: Option<String>, enabled: Option<bool>, monthly_backup_limit: Option<i64>, description: Option<String>, parent: String) -> Result<String> {
