...
impl<'a> Baremetalsolution_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "provisioning_config" => {
                self.plan_provisioning_config(current_state, desired_input)
                    .await
            }
            "snapshot" => self.plan_snapshot(current_state, desired_input).await,
            "lun" => self.plan_lun(current_state, desired_input).await,
            "os_image" => self.plan_os_image(current_state, desired_input).await,
            "instance" => self.plan_instance(current_state, desired_input).await,
            "ssh_key" => self.plan_ssh_key(current_state, desired_input).await,
            "provisioning_quota" => {
                self.plan_provisioning_quota(current_state, desired_input)
                    .await
            }
            "operation" => self.plan_operation(current_state, desired_input).await,
            "nfs_share" => self.plan_nfs_share(current_state, desired_input).await,
            "location" => self.plan_location(current_state, desired_input).await,
            "provisioning_quota" => {
                self.plan_provisioning_quota(current_state, desired_input)
                    .await
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "baremetalsolution_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "provisioning_config" => self.create_provisioning_config(input).await,
            "snapshot" => self.create_snapshot(input).await,
            "lun" => self.create_lun(input).await,
            "os_image" => self.create_os_image(input).await,
            "instance" => self.create_instance(input).await,
            "ssh_key" => self.create_ssh_key(input).await,
            "provisioning_quota" => self.create_provisioning_quota(input).await,
            "operation" => self.create_operation(input).await,
            "nfs_share" => self.create_nfs_share(input).await,
            "location" => self.create_location(input).await,
            "provisioning_quota" => self.create_provisioning_quota(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "provisioning_config" => self.read_provisioning_config(id).await,
            "snapshot" => self.read_snapshot(id).await,
            "lun" => self.read_lun(id).await,
            "os_image" => self.read_os_image(id).await,
            "instance" => self.read_instance(id).await,
            "ssh_key" => self.read_ssh_key(id).await,
            "provisioning_quota" => self.read_provisioning_quota(id).await,
            "operation" => self.read_operation(id).await,
            "nfs_share" => self.read_nfs_share(id).await,
            "location" => self.read_location(id).await,
            "provisioning_quota" => self.read_provisioning_quota(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "provisioning_config" => self.update_provisioning_config(id, input).await,
            "snapshot" => self.update_snapshot(id, input).await,
            "lun" => self.update_lun(id, input).await,
            "os_image" => self.update_os_image(id, input).await,
            "instance" => self.update_instance(id, input).await,
            "ssh_key" => self.update_ssh_key(id, input).await,
            "provisioning_quota" => self.update_provisioning_quota(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "nfs_share" => self.update_nfs_share(id, input).await,
            "location" => self.update_location(id, input).await,
            "provisioning_quota" => self.update_provisioning_quota(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "provisioning_config" => self.delete_provisioning_config(id).await,
            "snapshot" => self.delete_snapshot(id).await,
            "lun" => self.delete_lun(id).await,
            "os_image" => self.delete_os_image(id).await,
            "instance" => self.delete_instance(id).await,
            "ssh_key" => self.delete_ssh_key(id).await,
            "provisioning_quota" => self.delete_provisioning_quota(id).await,
            "operation" => self.delete_operation(id).await,
            "nfs_share" => self.delete_nfs_share(id).await,
            "location" => self.delete_location(id).await,
            "provisioning_quota" => self.delete_provisioning_quota(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
    ...
    async fn create_provisioning_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a provisioning_config resource
    async fn read_provisioning_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_provisioning_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_lun(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a lun resource
    async fn read_lun(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a lun resource
    async fn update_lun(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a lun resource
    async fn delete_lun(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_os_image(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a os_image resource
    async fn read_os_image(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a os_image resource
    async fn update_os_image(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a os_image resource
    async fn delete_os_image(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_ssh_key(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a ssh_key resource
    async fn read_ssh_key(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a ssh_key resource
    async fn update_ssh_key(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn create_provisioning_quota(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a provisioning_quota resource
    async fn read_provisioning_quota(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_provisioning_quota(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_nfs_share(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a nfs_share resource
    async fn read_nfs_share(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a nfs_share resource
    async fn update_nfs_share(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a nfs_share resource
    async fn delete_nfs_share(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
