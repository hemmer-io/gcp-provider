...
impl<'a> Human_review_config<'a> {
    ...
    pub async fn create(&self, priority: Option<String>, inline_document: Option<String>, enable_schema_validation: Option<bool>, document_schema: Option<String>, human_review_config: String) -> Result<String> {
