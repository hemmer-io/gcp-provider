...
impl<'a> Documentai_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "processor" => self.plan_processor(current_state, desired_input).await,
            "processor_type" => self.plan_processor_type(current_state, desired_input).await,
            "processor" => self.plan_processor(current_state, desired_input).await,
            "schema_version" => self.plan_schema_version(current_state, desired_input).await,
            "operation" => self.plan_operation(current_state, desired_input).await,
            "processor_type" => self.plan_processor_type(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "processor_version" => self.create_processor_version(input).await,
            "dataset" => self.create_dataset(input).await,
            "schema" => self.create_schema(input).await,
            "human_review_config" => self.create_human_review_config(input).await,
            "location" => self.create_location(input).await,
            "schema_version" => self.create_schema_version(input).await,
            "processor" => self.create_processor(input).await,
            "processor_type" => self.create_processor_type(input).await,
            "processor" => self.create_processor(input).await,
            "schema_version" => self.create_schema_version(input).await,
            "operation" => self.create_operation(input).await,
            "processor_type" => self.create_processor_type(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "processor_version" => self.read_processor_version(id).await,
            "dataset" => self.read_dataset(id).await,
            "schema" => self.read_schema(id).await,
            "human_review_config" => self.read_human_review_config(id).await,
            "location" => self.read_location(id).await,
            "schema_version" => self.read_schema_version(id).await,
            "processor" => self.read_processor(id).await,
            "processor_type" => self.read_processor_type(id).await,
            "processor" => self.read_processor(id).await,
            "schema_version" => self.read_schema_version(id).await,
            "operation" => self.read_operation(id).await,
            "processor_type" => self.read_processor_type(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "processor_version" => self.update_processor_version(id, input).await,
            "dataset" => self.update_dataset(id, input).await,
            "schema" => self.update_schema(id, input).await,
            "human_review_config" => self.update_human_review_config(id, input).await,
            "location" => self.update_location(id, input).await,
            "schema_version" => self.update_schema_version(id, input).await,
            "processor" => self.update_processor(id, input).await,
            "processor_type" => self.update_processor_type(id, input).await,
            "processor" => self.update_processor(id, input).await,
            "schema_version" => self.update_schema_version(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "processor_type" => self.update_processor_type(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "processor_version" => self.delete_processor_version(id).await,
            "dataset" => self.delete_dataset(id).await,
            "schema" => self.delete_schema(id).await,
            "human_review_config" => self.delete_human_review_config(id).await,
            "location" => self.delete_location(id).await,
            "schema_version" => self.delete_schema_version(id).await,
            "processor" => self.delete_processor(id).await,
            "processor_type" => self.delete_processor_type(id).await,
            "processor" => self.delete_processor(id).await,
            "schema_version" => self.delete_schema_version(id).await,
            "operation" => self.delete_operation(id).await,
            "processor_type" => self.delete_processor_type(id).await,
    ...
    async fn create_processor_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a processor_version resource
    async fn read_processor_version(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_processor_version(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_human_review_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a human_review_config resource
    async fn read_human_review_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_human_review_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_processor(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a processor resource
    async fn read_processor(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a processor resource
    async fn update_processor(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a processor resource
    async fn delete_processor(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_processor_type(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a processor_type resource
    async fn read_processor_type(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_processor_type(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
