...
impl<'a> Analytics_account_link<'a> {
    ...
    pub async fn create(&self, link_verification_state: Option<String>, name: Option<String>, display_name: Option<String>, analytics_account: Option<String>, parent: String) -> Result<String> {
