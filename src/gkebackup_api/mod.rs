...
impl<'a> Gkebackup_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "backup_channel" => {
                self.plan_backup_channel(current_state, desired_input).await
            }
            "volume_restore" => {
                self.plan_volume_restore(current_state, desired_input).await
            }
            "restore_plan_binding" => {
                self.plan_restore_plan_binding(current_state, desired_input).await
            }
            "operation" => {
                self.plan_operation(current_state, desired_input).await
            }
            "restore" => {
                self.plan_restore(current_state, desired_input).await
            }
            "backup" => {
                self.plan_backup(current_state, desired_input).await
            }
            "restore_channel" => {
                self.plan_restore_channel(current_state, desired_input).await
            }
            "location" => {
                self.plan_location(current_state, desired_input).await
            }
            "restore_plan" => {
                self.plan_restore_plan(current_state, desired_input).await
            }
            "backup_plan" => {
                self.plan_backup_plan(current_state, desired_input).await
            }
            "volume_backup" => {
                self.plan_volume_backup(current_state, desired_input).await
            }
            "backup_plan_binding" => {
                self.plan_backup_plan_binding(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "backup_channel" => {
                self.create_backup_channel(input).await
            }
            "volume_restore" => {
                self.create_volume_restore(input).await
            }
            "restore_plan_binding" => {
                self.create_restore_plan_binding(input).await
            }
            "operation" => {
                self.create_operation(input).await
            }
            "restore" => {
                self.create_restore(input).await
            }
            "backup" => {
                self.create_backup(input).await
            }
            "restore_channel" => {
                self.create_restore_channel(input).await
            }
            "location" => {
                self.create_location(input).await
            }
            "restore_plan" => {
                self.create_restore_plan(input).await
            }
            "backup_plan" => {
                self.create_backup_plan(input).await
            }
            "volume_backup" => {
                self.create_volume_backup(input).await
            }
            "backup_plan_binding" => {
                self.create_backup_plan_binding(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gkebackup_api",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "backup_channel" => {
                self.read_backup_channel(id).await
            }
            "volume_restore" => {
                self.read_volume_restore(id).await
            }
            "restore_plan_binding" => {
                self.read_restore_plan_binding(id).await
            }
            "operation" => {
                self.read_operation(id).await
            }
            "restore" => {
                self.read_restore(id).await
            }
            "backup" => {
                self.read_backup(id).await
            }
            "restore_channel" => {
                self.read_restore_channel(id).await
            }
            "location" => {
                self.read_location(id).await
            }
            "restore_plan" => {
                self.read_restore_plan(id).await
            }
            "backup_plan" => {
                self.read_backup_plan(id).await
            }
            "volume_backup" => {
                self.read_volume_backup(id).await
            }
            "backup_plan_binding" => {
                self.read_backup_plan_binding(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gkebackup_api",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "backup_channel" => {
                self.update_backup_channel(id, input).await
            }
            "volume_restore" => {
                self.update_volume_restore(id, input).await
            }
            "restore_plan_binding" => {
                self.update_restore_plan_binding(id, input).await
            }
            "operation" => {
                self.update_operation(id, input).await
            }
            "restore" => {
                self.update_restore(id, input).await
            }
            "backup" => {
                self.update_backup(id, input).await
            }
            "restore_channel" => {
                self.update_restore_channel(id, input).await
            }
            "location" => {
                self.update_location(id, input).await
            }
            "restore_plan" => {
                self.update_restore_plan(id, input).await
            }
            "backup_plan" => {
                self.update_backup_plan(id, input).await
            }
            "volume_backup" => {
                self.update_volume_backup(id, input).await
            }
            "backup_plan_binding" => {
                self.update_backup_plan_binding(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gkebackup_api",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "backup_channel" => {
                self.delete_backup_channel(id).await
            }
            "volume_restore" => {
                self.delete_volume_restore(id).await
            }
            "restore_plan_binding" => {
                self.delete_restore_plan_binding(id).await
            }
            "operation" => {
                self.delete_operation(id).await
            }
            "restore" => {
                self.delete_restore(id).await
            }
            "backup" => {
                self.delete_backup(id).await
            }
            "restore_channel" => {
                self.delete_restore_channel(id).await
            }
            "location" => {
                self.delete_location(id).await
            }
            "restore_plan" => {
                self.delete_restore_plan(id).await
            }
            "backup_plan" => {
                self.delete_backup_plan(id).await
            }
            "volume_backup" => {
                self.delete_volume_backup(id).await
            }
            "backup_plan_binding" => {
                self.delete_backup_plan_binding(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gkebackup_api",
    ...
    async fn create_volume_restore(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_volume_restore(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_restore_plan_binding(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_restore_plan_binding(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_restore_plan_binding(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_backup_plan_binding(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_backup_plan_binding(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_backup_plan_binding(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
