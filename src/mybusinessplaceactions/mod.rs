//! Mybusinessplaceactions Service
//!
//! Auto-generated service module for mybusinessplaceactions

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for mybusinessplaceactions
pub struct MybusinessplaceactionsService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> MybusinessplaceactionsService<'a> {
