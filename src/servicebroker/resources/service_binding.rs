...
impl<'a> Service_binding<'a> {
    ...
    pub async fn create(&self, plan_id: Option<String>, bind_resource: Option<HashMap<String, String>>, binding_id: Option<String>, create_time: Option<String>, service_id: Option<String>, parameters: Option<HashMap<String, String>>, instance_id: String, binding_id: String, parent: String) -> Result<String> {
