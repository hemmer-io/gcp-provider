...
impl<'a> Customchannel<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, id: Option<String>, code: Option<String>, name: Option<String>, ad_client_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, kind: Option<String>, id: Option<String>, code: Option<String>, name: Option<String>) -> Result<()> {
