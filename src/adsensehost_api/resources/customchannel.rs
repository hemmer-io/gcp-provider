...
impl<'a> Customchannel<'a> {
    ...
    pub async fn create(&self, id: Option<String>, name: Option<String>, code: Option<String>, kind: Option<String>, ad_client_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, id: Option<String>, name: Option<String>, code: Option<String>, kind: Option<String>) -> Result<()> {
