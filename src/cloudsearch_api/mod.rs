//! Cloudsearch_api service for Gcp provider
//!
//! This module handles all cloudsearch_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Cloudsearch_api service handler
pub struct Cloudsearch_apiService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> Cloudsearch_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "unmappedid" => self.plan_unmappedid(current_state, desired_input).await,
            ...
            "searchapplication" => {
                self.plan_searchapplication(current_state, desired_input)
                    .await
            }
            "operation" => self.plan_operation(current_state, desired_input).await,
            "stat" => self.plan_stat(current_state, desired_input).await,
            "cloudsearch" => self.plan_cloudsearch(current_state, desired_input).await,
            "datasource" => self.plan_datasource(current_state, desired_input).await,
            "lro" => self.plan_lro(current_state, desired_input).await,
            "query" => self.plan_query(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudsearch_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "unmappedid" => self.create_unmappedid(input).await,
            ...
            "searchapplication" => self.create_searchapplication(input).await,
            "operation" => self.create_operation(input).await,
            "stat" => self.create_stat(input).await,
            "cloudsearch" => self.create_cloudsearch(input).await,
            "datasource" => self.create_datasource(input).await,
            "lro" => self.create_lro(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "unmappedid" => self.read_unmappedid(id).await,
            ...
            "searchapplication" => self.read_searchapplication(id).await,
            "operation" => self.read_operation(id).await,
            "stat" => self.read_stat(id).await,
            "cloudsearch" => self.read_cloudsearch(id).await,
            "datasource" => self.read_datasource(id).await,
            "lro" => self.read_lro(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "unmappedid" => self.update_unmappedid(id, input).await,
            ...
            "searchapplication" => self.update_searchapplication(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "stat" => self.update_stat(id, input).await,
            "cloudsearch" => self.update_cloudsearch(id, input).await,
            "datasource" => self.update_datasource(id, input).await,
            "lro" => self.update_lro(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "unmappedid" => self.delete_unmappedid(id).await,
            ...
            "searchapplication" => self.delete_searchapplication(id).await,
            "operation" => self.delete_operation(id).await,
            "stat" => self.delete_stat(id).await,
            "cloudsearch" => self.delete_cloudsearch(id).await,
            "datasource" => self.delete_datasource(id).await,
            "lro" => self.delete_lro(id).await,
    ...
    // ------------------------------------------------------------------------
    // Unmappedid resource operations
    // ------------------------------------------------------------------------

    /// Plan changes to a unmappedid resource
    async fn plan_unmappedid(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Create a new unmappedid resource
    async fn create_unmappedid(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a unmappedid resource
    async fn read_unmappedid(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a unmappedid resource
    async fn update_unmappedid(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a unmappedid resource
    async fn delete_unmappedid(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    // ------------------------------------------------------------------------
    // Searchapplication resource operations
    // ------------------------------------------------------------------------

    /// Plan changes to a searchapplication resource
    async fn plan_searchapplication(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Create a new searchapplication resource
    async fn create_searchapplication(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a searchapplication resource
    async fn read_searchapplication(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a searchapplication resource
    async fn update_searchapplication(
        &self,
        id: &str,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    /// Delete a searchapplication resource
    async fn delete_searchapplication(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    // ------------------------------------------------------------------------
    // Cloudsearch resource operations
    // ------------------------------------------------------------------------

    /// Plan changes to a cloudsearch resource
    async fn plan_cloudsearch(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    /// Create a new cloudsearch resource
    async fn create_cloudsearch(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a cloudsearch resource
    async fn read_cloudsearch(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a cloudsearch resource
    async fn update_cloudsearch(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a cloudsearch resource
    async fn delete_cloudsearch(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }

    // ------------------------------------------------------------------------
    // Datasource resource operations
    // ------------------------------------------------------------------------

    /// Plan changes to a datasource resource
    async fn plan_datasource(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ) -> Result<ResourcePlan> {
    ...
    async fn create_datasource(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a datasource resource
    async fn read_datasource(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a datasource resource
    async fn update_datasource(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a datasource resource
    async fn delete_datasource(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }

    // ------------------------------------------------------------------------
    // Lro resource operations
    // ------------------------------------------------------------------------

    /// Plan changes to a lro resource
    async fn plan_lro(
        &self,
        current_state: Option<&ResourceOutput>,
        desired_input: &ResourceInput,
    ...
    /// Create a new lro resource
    async fn create_lro(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a lro resource
    async fn read_lro(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a lro resource
    async fn update_lro(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a lro resource
    async fn delete_lro(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
