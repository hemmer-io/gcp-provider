//! Firebaseremoteconfig_api service for Gcp provider
//!
//! This module handles all firebaseremoteconfig_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Firebaseremoteconfig_api service handler
