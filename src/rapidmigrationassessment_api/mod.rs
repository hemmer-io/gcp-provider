...
impl<'a> Rapidmigrationassessment_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "collector" => {
                self.plan_collector(current_state, desired_input).await
            }
            "location" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "collector" => {
                self.create_collector(input).await
            }
            "location" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "collector" => {
                self.update_collector(id, input).await
            }
            "location" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "collector" => {
                self.delete_collector(id).await
            }
            "location" => {
