...
impl<'a> Model_monitoring_job<'a> {
    ...
    pub async fn create(&self, job_execution_detail: Option<String>, schedule: Option<String>, model_monitoring_spec: Option<String>, update_time: Option<String>, name: Option<String>, display_name: Option<String>, create_time: Option<String>, schedule_time: Option<String>, state: Option<String>, parent: String) -> Result<String> {
