...
impl<'a> Authorized_view<'a> {
    ...
    pub async fn create(&self, deletion_protection: Option<bool>, subset_view: Option<String>, etag: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, deletion_protection: Option<bool>, subset_view: Option<String>, etag: Option<String>, name: Option<String>) -> Result<()> {
