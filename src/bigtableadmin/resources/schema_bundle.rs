...
impl<'a> Schema_bundle<'a> {
    ...
    pub async fn create(&self, etag: Option<String>, proto_schema: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, etag: Option<String>, proto_schema: Option<String>, name: Option<String>) -> Result<()> {
