...
impl<'a> Slowrenderingrate<'a> {
    ...
    pub async fn create(&self, page_size: Option<i64>, page_token: Option<String>, timeline_spec: Option<String>, user_cohort: Option<String>, dimensions: Option<Vec<String>>, filter: Option<String>, metrics: Option<Vec<String>>, name: String) -> Result<String> {
