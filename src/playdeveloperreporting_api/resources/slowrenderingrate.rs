...
impl<'a> Slowrenderingrate<'a> {
    ...
    pub async fn create(&self, page_token: Option<String>, metrics: Option<Vec<String>>, page_size: Option<i64>, timeline_spec: Option<String>, user_cohort: Option<String>, dimensions: Option<Vec<String>>, filter: Option<String>, name: String) -> Result<String> {
