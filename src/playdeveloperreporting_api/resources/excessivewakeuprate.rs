...
impl<'a> Excessivewakeuprate<'a> {
    ...
    pub async fn create(&self, filter: Option<String>, metrics: Option<Vec<String>>, timeline_spec: Option<String>, dimensions: Option<Vec<String>>, page_size: Option<i64>, page_token: Option<String>, user_cohort: Option<String>, name: String) -> Result<String> {
