...
impl<'a> Excessivewakeuprate<'a> {
    ...
    pub async fn create(&self, page_token: Option<String>, metrics: Option<Vec<String>>, dimensions: Option<Vec<String>>, filter: Option<String>, timeline_spec: Option<String>, user_cohort: Option<String>, page_size: Option<i64>, name: String) -> Result<String> {
