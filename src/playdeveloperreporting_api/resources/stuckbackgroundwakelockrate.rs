...
impl<'a> Stuckbackgroundwakelockrate<'a> {
    ...
    pub async fn create(&self, page_size: Option<i64>, filter: Option<String>, page_token: Option<String>, user_cohort: Option<String>, dimensions: Option<Vec<String>>, metrics: Option<Vec<String>>, timeline_spec: Option<String>, name: String) -> Result<String> {
