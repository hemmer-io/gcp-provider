...
impl<'a> Stuckbackgroundwakelockrate<'a> {
    ...
    pub async fn create(&self, filter: Option<String>, page_size: Option<i64>, page_token: Option<String>, timeline_spec: Option<String>, metrics: Option<Vec<String>>, dimensions: Option<Vec<String>>, user_cohort: Option<String>, name: String) -> Result<String> {
