...
impl<'a> Slowstartrate<'a> {
    ...
    pub async fn create(&self, metrics: Option<Vec<String>>, page_token: Option<String>, filter: Option<String>, dimensions: Option<Vec<String>>, page_size: Option<i64>, timeline_spec: Option<String>, user_cohort: Option<String>, name: String) -> Result<String> {
