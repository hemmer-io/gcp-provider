...
impl<'a> Slowstartrate<'a> {
    ...
    pub async fn create(&self, dimensions: Option<Vec<String>>, page_size: Option<i64>, filter: Option<String>, page_token: Option<String>, timeline_spec: Option<String>, metrics: Option<Vec<String>>, user_cohort: Option<String>, name: String) -> Result<String> {
