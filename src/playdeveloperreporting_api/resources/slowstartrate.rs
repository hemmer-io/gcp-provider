...
impl<'a> Slowstartrate<'a> {
    ...
    pub async fn create(&self, timeline_spec: Option<String>, filter: Option<String>, dimensions: Option<Vec<String>>, user_cohort: Option<String>, page_token: Option<String>, page_size: Option<i64>, metrics: Option<Vec<String>>, name: String) -> Result<String> {
