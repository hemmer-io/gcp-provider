...
impl<'a> Audience_export<'a> {
    ...
    pub async fn create(&self, audience_display_name: Option<String>, dimensions: Option<Vec<String>>, error_message: Option<String>, row_count: Option<i64>, percentage_completed: Option<f64>, audience: Option<String>, state: Option<String>, name: Option<String>, creation_quota_tokens_charged: Option<i64>, begin_creating_time: Option<String>, parent: String) -> Result<String> {
