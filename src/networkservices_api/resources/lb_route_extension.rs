...
impl<'a> Lb_route_extension<'a> {
    ...
    pub async fn create(&self, description: Option<String>, extension_chains: Option<Vec<String>>, forwarding_rules: Option<Vec<String>>, load_balancing_scheme: Option<String>, name: Option<String>, update_time: Option<String>, metadata: Option<HashMap<String, String>>, create_time: Option<String>, labels: Option<HashMap<String, String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, description: Option<String>, extension_chains: Option<Vec<String>>, forwarding_rules: Option<Vec<String>>, load_balancing_scheme: Option<String>, name: Option<String>, update_time: Option<String>, metadata: Option<HashMap<String, String>>, create_time: Option<String>, labels: Option<HashMap<String, String>>) -> Result<()> {
