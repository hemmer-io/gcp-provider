...
impl<'a> Acme_challenge_set<'a> {
    ...
    pub async fn create(&self, records_to_add: Option<Vec<String>>, access_token: Option<String>, records_to_remove: Option<Vec<String>>, keep_expired_records: Option<bool>, root_domain: String) -> Result<String> {
