//! Test_api service for Gcp provider
//!
//! This module handles all test_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Test_api service handler
pub struct Test_apiService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> Test_apiService<'a> {
