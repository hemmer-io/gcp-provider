...
impl<'a> Androiddeviceprovisioning_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "dpc" => {
                self.plan_dpc(current_state, desired_input).await
            }
            "customer" => {
            ...
            "vendor" => {
                self.plan_vendor(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "vendor" => {
                self.create_vendor(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "androiddeviceprovisioning_api",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "dpc" => {
                self.update_dpc(id, input).await
            }
            "customer" => {
            ...
            "vendor" => {
                self.update_vendor(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "androiddeviceprovisioning_api",
