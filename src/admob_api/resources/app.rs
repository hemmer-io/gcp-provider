...
impl<'a> App<'a> {
    ...
    pub async fn create(&self, app_approval_state: Option<String>, platform: Option<String>, app_id: Option<String>, linked_app_info: Option<String>, manual_app_info: Option<String>, name: Option<String>, parent: String) -> Result<String> {
