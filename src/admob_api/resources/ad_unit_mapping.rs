...
impl<'a> Ad_unit_mapping<'a> {
    ...
    pub async fn create(&self, state: Option<String>, adapter_id: Option<String>, ad_unit_configurations: Option<HashMap<String, String>>, name: Option<String>, display_name: Option<String>, parent: String) -> Result<String> {
