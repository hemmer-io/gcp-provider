...
impl<'a> Ad_unit_mapping<'a> {
    ...
    pub async fn create(&self, adapter_id: Option<String>, display_name: Option<String>, name: Option<String>, ad_unit_configurations: Option<HashMap<String, String>>, state: Option<String>, parent: String) -> Result<String> {
