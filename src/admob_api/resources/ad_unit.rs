...
impl<'a> Ad_unit<'a> {
    ...
    pub async fn create(&self, ad_format: Option<String>, name: Option<String>, app_id: Option<String>, ad_unit_id: Option<String>, ad_types: Option<Vec<String>>, display_name: Option<String>, reward_settings: Option<String>, parent: String) -> Result<String> {
