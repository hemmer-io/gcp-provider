...
impl<'a> Admob_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "network_report" => {
                self.plan_network_report(current_state, desired_input).await
            }
            "mediation_report" => {
                self.plan_mediation_report(current_state, desired_input).await
            }
            "ad_unit" => {
                self.plan_ad_unit(current_state, desired_input).await
            }
            "adapter" => {
            ...
            "ad_unit_mapping" => {
                self.plan_ad_unit_mapping(current_state, desired_input).await
            }
            "app" => {
                self.plan_app(current_state, desired_input).await
            }
            "ad_source" => {
                self.plan_ad_source(current_state, desired_input).await
            }
            "mediation_ab_experiment" => {
                self.plan_mediation_ab_experiment(current_state, desired_input).await
            }
            "campaign_report" => {
                self.plan_campaign_report(current_state, desired_input).await
            }
            "mediation_report" => {
                self.plan_mediation_report(current_state, desired_input).await
            }
            ...
            "mediation_group" => {
                self.plan_mediation_group(current_state, desired_input).await
            }
            "ad_unit" => {
                self.plan_ad_unit(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "network_report" => {
                self.create_network_report(input).await
            }
            "mediation_report" => {
                self.create_mediation_report(input).await
            }
            "ad_unit" => {
                self.create_ad_unit(input).await
            }
            "adapter" => {
            ...
            "ad_unit_mapping" => {
                self.create_ad_unit_mapping(input).await
            }
            "app" => {
                self.create_app(input).await
            }
            "ad_source" => {
                self.create_ad_source(input).await
            }
            "mediation_ab_experiment" => {
                self.create_mediation_ab_experiment(input).await
            }
            "campaign_report" => {
                self.create_campaign_report(input).await
            }
            "mediation_report" => {
                self.create_mediation_report(input).await
            }
            ...
            "mediation_group" => {
                self.create_mediation_group(input).await
            }
            "ad_unit" => {
                self.create_ad_unit(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "network_report" => {
                self.read_network_report(id).await
            }
            "mediation_report" => {
                self.read_mediation_report(id).await
            }
            "ad_unit" => {
                self.read_ad_unit(id).await
            }
            "adapter" => {
            ...
            "ad_unit_mapping" => {
                self.read_ad_unit_mapping(id).await
            }
            "app" => {
                self.read_app(id).await
            }
            "ad_source" => {
                self.read_ad_source(id).await
            }
            "mediation_ab_experiment" => {
                self.read_mediation_ab_experiment(id).await
            }
            "campaign_report" => {
                self.read_campaign_report(id).await
            }
            "mediation_report" => {
                self.read_mediation_report(id).await
            }
            ...
            "mediation_group" => {
                self.read_mediation_group(id).await
            }
            "ad_unit" => {
                self.read_ad_unit(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "network_report" => {
                self.update_network_report(id, input).await
            }
            "mediation_report" => {
                self.update_mediation_report(id, input).await
            }
            "ad_unit" => {
                self.update_ad_unit(id, input).await
            }
            "adapter" => {
            ...
            "ad_unit_mapping" => {
                self.update_ad_unit_mapping(id, input).await
            }
            "app" => {
                self.update_app(id, input).await
            }
            "ad_source" => {
                self.update_ad_source(id, input).await
            }
            "mediation_ab_experiment" => {
                self.update_mediation_ab_experiment(id, input).await
            }
            "campaign_report" => {
                self.update_campaign_report(id, input).await
            }
            "mediation_report" => {
                self.update_mediation_report(id, input).await
            }
            ...
            "mediation_group" => {
                self.update_mediation_group(id, input).await
            }
            "ad_unit" => {
                self.update_ad_unit(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "network_report" => {
                self.delete_network_report(id).await
            }
            "mediation_report" => {
                self.delete_mediation_report(id).await
            }
            "ad_unit" => {
                self.delete_ad_unit(id).await
            }
            "adapter" => {
            ...
            "ad_unit_mapping" => {
                self.delete_ad_unit_mapping(id).await
            }
            "app" => {
                self.delete_app(id).await
            }
            "ad_source" => {
                self.delete_ad_source(id).await
            }
            "mediation_ab_experiment" => {
                self.delete_mediation_ab_experiment(id).await
            }
            "campaign_report" => {
                self.delete_campaign_report(id).await
            }
            "mediation_report" => {
                self.delete_mediation_report(id).await
            }
            ...
            "mediation_group" => {
                self.delete_mediation_group(id).await
            }
            "ad_unit" => {
                self.delete_ad_unit(id).await
            }
    ...
    async fn create_network_report(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_network_report(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_mediation_report(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_mediation_report(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_mediation_report(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_ad_unit_mapping(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_ad_unit_mapping(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_mediation_ab_experiment(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_mediation_ab_experiment(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_mediation_ab_experiment(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_campaign_report(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_campaign_report(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_mediation_group(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_mediation_group(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
