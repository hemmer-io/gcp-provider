...
impl<'a> Adsense_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "payment" => self.plan_payment(current_state, desired_input).await,
            ...
            "saved" => self.plan_saved(current_state, desired_input).await,
            "site" => self.plan_site(current_state, desired_input).await,
            "alert" => self.plan_alert(current_state, desired_input).await,
            "policy_issue" => self.plan_policy_issue(current_state, desired_input).await,
            "adclient" => self.plan_adclient(current_state, desired_input).await,
            "customchannel" => self.plan_customchannel(current_state, desired_input).await,
            "payment" => self.plan_payment(current_state, desired_input).await,
            "urlchannel" => self.plan_urlchannel(current_state, desired_input).await,
            ...
            "alert" => self.plan_alert(current_state, desired_input).await,
            "saved" => self.plan_saved(current_state, desired_input).await,
            "savedadstyle" => self.plan_savedadstyle(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "alert" => self.create_alert(input).await,
            "saved" => self.create_saved(input).await,
            "savedadstyle" => self.create_savedadstyle(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "alert" => self.read_alert(id).await,
            "saved" => self.read_saved(id).await,
            "savedadstyle" => self.read_savedadstyle(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "alert" => self.update_alert(id, input).await,
            "saved" => self.update_saved(id, input).await,
            "savedadstyle" => self.update_savedadstyle(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "alert" => self.delete_alert(id).await,
            "saved" => self.delete_saved(id).await,
            "savedadstyle" => self.delete_savedadstyle(id).await,
    ...
    async fn create_payment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a payment resource
    async fn read_payment(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a payment resource
    async fn update_payment(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn create_saved(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a saved resource
    async fn read_saved(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a saved resource
    async fn update_saved(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a saved resource
    async fn delete_saved(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_policy_issue(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a policy_issue resource
    async fn read_policy_issue(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a policy_issue resource
    async fn update_policy_issue(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a policy_issue resource
    async fn delete_policy_issue(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_savedadstyle(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a savedadstyle resource
    async fn read_savedadstyle(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a savedadstyle resource
    async fn update_savedadstyle(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a savedadstyle resource
    async fn delete_savedadstyle(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
