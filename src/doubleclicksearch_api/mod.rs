...
impl<'a> Doubleclicksearch_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "saved_column" => self.plan_saved_column(current_state, desired_input).await,
            "report" => self.plan_report(current_state, desired_input).await,
            "conversion" => self.plan_conversion(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "doubleclicksearch_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "saved_column" => self.create_saved_column(input).await,
            "report" => self.create_report(input).await,
            "conversion" => self.create_conversion(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "doubleclicksearch_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "saved_column" => self.read_saved_column(id).await,
            "report" => self.read_report(id).await,
            "conversion" => self.read_conversion(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "doubleclicksearch_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "saved_column" => self.update_saved_column(id, input).await,
            "report" => self.update_report(id, input).await,
            "conversion" => self.update_conversion(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "doubleclicksearch_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "saved_column" => self.delete_saved_column(id).await,
            "report" => self.delete_report(id).await,
            "conversion" => self.delete_conversion(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "doubleclicksearch_api", resource_name
            ))),
    ...
    async fn create_saved_column(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a saved_column resource
    async fn read_saved_column(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a saved_column resource
    async fn update_saved_column(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a saved_column resource
    async fn delete_saved_column(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_conversion(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a conversion resource
    async fn read_conversion(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a conversion resource
    async fn update_conversion(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a conversion resource
    async fn delete_conversion(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
