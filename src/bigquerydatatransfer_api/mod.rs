...
impl<'a> Bigquerydatatransfer_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "transfer_config" => {
                self.plan_transfer_config(current_state, desired_input)
                    .await
            }
            "transfer_log" => self.plan_transfer_log(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "bigquerydatatransfer_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "transfer_config" => self.create_transfer_config(input).await,
            "transfer_log" => self.create_transfer_log(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "transfer_config" => self.read_transfer_config(id).await,
            "transfer_log" => self.read_transfer_log(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "transfer_config" => self.update_transfer_config(id, input).await,
            "transfer_log" => self.update_transfer_log(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "transfer_config" => self.delete_transfer_config(id).await,
            "transfer_log" => self.delete_transfer_log(id).await,
    ...
    async fn create_transfer_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a transfer_config resource
    async fn read_transfer_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_transfer_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_transfer_log(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a transfer_log resource
    async fn read_transfer_log(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a transfer_log resource
    async fn update_transfer_log(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a transfer_log resource
    async fn delete_transfer_log(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
