...
impl<'a> Dataset<'a> {
    ...
    pub async fn create(&self, end_time_millis: Option<String>, aggregate_by: Option<Vec<String>>, bucket_by_activity_segment: Option<String>, bucket_by_time: Option<String>, bucket_by_activity_type: Option<String>, start_time_millis: Option<String>, bucket_by_session: Option<String>, filtered_data_quality_standard: Option<Vec<String>>, user_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, end_time_millis: Option<String>, aggregate_by: Option<Vec<String>>, bucket_by_activity_segment: Option<String>, bucket_by_time: Option<String>, bucket_by_activity_type: Option<String>, start_time_millis: Option<String>, bucket_by_session: Option<String>, filtered_data_quality_standard: Option<Vec<String>>) -> Result<()> {
