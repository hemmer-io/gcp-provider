...
impl<'a> Mobileapppanel<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, is_public_panel: Option<bool>, language: Option<String>, mobile_app_panel_id: Option<String>, owners: Option<Vec<String>>, country: Option<String>) -> Result<()> {
