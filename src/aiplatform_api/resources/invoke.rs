...
impl<'a> Invoke<'a> {
    ...
    pub async fn create(&self, http_body: Option<String>, deployed_model_id: Option<String>, endpoint: String, deployed_model_id: String, invoke_id: String) -> Result<String> {
