...
impl<'a> Invoke<'a> {
    ...
    pub async fn create(&self, http_body: Option<String>, deployed_model_id: Option<String>, invoke_id: String, deployed_model_id: String, endpoint: String) -> Result<String> {
