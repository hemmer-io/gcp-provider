...
impl<'a> Entity_type<'a> {
    ...
    pub async fn create(&self, monitoring_config: Option<String>, create_time: Option<String>, name: Option<String>, etag: Option<String>, description: Option<String>, labels: Option<HashMap<String, String>>, offline_storage_ttl_days: Option<i64>, satisfies_pzi: Option<bool>, update_time: Option<String>, satisfies_pzs: Option<bool>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, monitoring_config: Option<String>, create_time: Option<String>, name: Option<String>, etag: Option<String>, description: Option<String>, labels: Option<HashMap<String, String>>, offline_storage_ttl_days: Option<i64>, satisfies_pzi: Option<bool>, update_time: Option<String>, satisfies_pzs: Option<bool>) -> Result<()> {
