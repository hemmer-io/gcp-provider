...
impl<'a> Model_monitoring_job<'a> {
    ...
    pub async fn create(&self, schedule: Option<String>, state: Option<String>, model_monitoring_spec: Option<String>, display_name: Option<String>, job_execution_detail: Option<String>, schedule_time: Option<String>, create_time: Option<String>, name: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
