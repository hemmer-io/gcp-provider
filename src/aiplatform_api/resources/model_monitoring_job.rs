...
impl<'a> Model_monitoring_job<'a> {
    ...
    pub async fn create(&self, name: Option<String>, job_execution_detail: Option<String>, schedule: Option<String>, schedule_time: Option<String>, display_name: Option<String>, update_time: Option<String>, create_time: Option<String>, state: Option<String>, model_monitoring_spec: Option<String>, parent: String) -> Result<String> {
