...
impl<'a> Metadata_schema<'a> {
    ...
    pub async fn create(&self, schema_version: Option<String>, schema_type: Option<String>, schema: Option<String>, create_time: Option<String>, name: Option<String>, description: Option<String>, parent: String) -> Result<String> {
