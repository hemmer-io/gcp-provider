...
impl<'a> Metadata_store<'a> {
    ...
    pub async fn create(&self, name: Option<String>, update_time: Option<String>, description: Option<String>, encryption_spec: Option<String>, state: Option<String>, create_time: Option<String>, dataplex_config: Option<String>, parent: String) -> Result<String> {
