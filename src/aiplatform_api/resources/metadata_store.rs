...
impl<'a> Metadata_store<'a> {
    ...
    pub async fn create(&self, dataplex_config: Option<String>, name: Option<String>, encryption_spec: Option<String>, update_time: Option<String>, create_time: Option<String>, state: Option<String>, description: Option<String>, parent: String) -> Result<String> {
