...
impl<'a> Metadata_store<'a> {
    ...
    pub async fn create(&self, encryption_spec: Option<String>, state: Option<String>, update_time: Option<String>, name: Option<String>, create_time: Option<String>, dataplex_config: Option<String>, description: Option<String>, parent: String) -> Result<String> {
