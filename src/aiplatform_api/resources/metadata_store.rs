...
impl<'a> Metadata_store<'a> {
    ...
    pub async fn create(&self, update_time: Option<String>, encryption_spec: Option<String>, create_time: Option<String>, name: Option<String>, state: Option<String>, description: Option<String>, dataplex_config: Option<String>, parent: String) -> Result<String> {
