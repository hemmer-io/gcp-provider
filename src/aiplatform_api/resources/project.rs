...
impl<'a> Project<'a> {
    ...
    pub async fn create(&self, publisher_model_config: Option<String>, name: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, publisher_model_config: Option<String>) -> Result<()> {
