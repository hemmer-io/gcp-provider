...
impl<'a> Evaluation_item<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, evaluation_response: Option<String>, evaluation_request: Option<String>, labels: Option<HashMap<String, String>>, name: Option<String>, error: Option<String>, evaluation_item_type: Option<String>, gcs_uri: Option<String>, metadata: Option<String>, create_time: Option<String>, parent: String) -> Result<String> {
