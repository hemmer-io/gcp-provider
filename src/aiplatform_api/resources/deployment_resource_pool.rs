...
impl<'a> Deployment_resource_pool<'a> {
    ...
    pub async fn create(&self, deployment_resource_pool_id: Option<String>, deployment_resource_pool: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, deployment_resource_pool_id: Option<String>, deployment_resource_pool: Option<String>) -> Result<()> {
