...
impl<'a> Record<'a> {
    ...
    pub async fn create(&self, origin: Option<String>, url: Option<String>, metrics: Option<Vec<String>>, form_factor: Option<String>, collection_period_count: Option<i64>) -> Result<String> {
