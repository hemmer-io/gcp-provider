//! Remotebuildexecution Service
//!
//! Auto-generated service module for remotebuildexecution

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for remotebuildexecution
pub struct RemotebuildexecutionService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> RemotebuildexecutionService<'a> {
