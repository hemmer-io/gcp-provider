...
impl<'a> Instance<'a> {
    ...
    pub async fn create(&self, instance: Option<String>, parent: Option<String>, instance_id: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, instance: Option<String>, parent: Option<String>, instance_id: Option<String>) -> Result<()> {
