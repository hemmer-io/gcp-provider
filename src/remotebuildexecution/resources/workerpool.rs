...
impl<'a> Workerpool<'a> {
    ...
    pub async fn create(&self, parent: Option<String>, pool_id: Option<String>, worker_pool: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, parent: Option<String>, pool_id: Option<String>, worker_pool: Option<String>) -> Result<()> {
