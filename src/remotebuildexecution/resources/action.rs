...
impl<'a> Action<'a> {
    ...
    pub async fn create(&self, action_digest: Option<String>, results_cache_policy: Option<String>, execution_policy: Option<String>, skip_cache_lookup: Option<bool>, instance_name: String) -> Result<String> {
