...
impl<'a> Action_result<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, output_directories: Option<Vec<String>>, exit_code: Option<i64>, stdout_raw: Option<String>, execution_metadata: Option<String>, stderr_raw: Option<String>, stderr_digest: Option<String>, output_directory_symlinks: Option<Vec<String>>, stdout_digest: Option<String>, output_file_symlinks: Option<Vec<String>>, output_files: Option<Vec<String>>, output_symlinks: Option<Vec<String>>) -> Result<()> {
