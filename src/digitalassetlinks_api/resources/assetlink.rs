...
impl<'a> Assetlink<'a> {
    ...
    pub async fn create(&self, statements: Option<Vec<String>>, default_relation: Option<String>, default_target: Option<String>, return_relation_extensions: Option<bool>, default_source: Option<String>) -> Result<String> {
