...
impl<'a> Digitalassetlinks_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "assetlink" => self.plan_assetlink(current_state, desired_input).await,
            "statement" => self.plan_statement(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "digitalassetlinks_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "assetlink" => self.create_assetlink(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "assetlink" => self.read_assetlink(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "assetlink" => self.update_assetlink(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "assetlink" => self.delete_assetlink(id).await,
    ...
    async fn create_assetlink(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a assetlink resource
    async fn read_assetlink(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a assetlink resource
    async fn update_assetlink(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a assetlink resource
    async fn delete_assetlink(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
