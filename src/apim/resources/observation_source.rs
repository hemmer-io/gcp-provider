...
impl<'a> Observation_source<'a> {
    ...
    pub async fn create(&self, update_time: Option<String>, name: Option<String>, create_time: Option<String>, gclb_observation_source: Option<String>, state: Option<String>, parent: String) -> Result<String> {
