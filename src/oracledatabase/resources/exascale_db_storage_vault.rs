...
impl<'a> Exascale_db_storage_vault<'a> {
    ...
    pub async fn create(&self, properties: Option<String>, gcp_oracle_zone: Option<String>, display_name: Option<String>, labels: Option<HashMap<String, String>>, entitlement_id: Option<String>, create_time: Option<String>, name: Option<String>, parent: String) -> Result<String> {
