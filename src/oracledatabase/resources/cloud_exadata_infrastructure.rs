...
impl<'a> Cloud_exadata_infrastructure<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, entitlement_id: Option<String>, labels: Option<HashMap<String, String>>, gcp_oracle_zone: Option<String>, name: Option<String>, properties: Option<String>, create_time: Option<String>, parent: String) -> Result<String> {
