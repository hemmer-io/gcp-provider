...
impl<'a> Access_binding<'a> {
    ...
    pub async fn create(&self, user: Option<String>, name: Option<String>, roles: Option<Vec<String>>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, user: Option<String>, name: Option<String>, roles: Option<Vec<String>>) -> Result<()> {
