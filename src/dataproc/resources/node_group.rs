...
impl<'a> Node_group<'a> {
    ...
    pub async fn create(&self, roles: Option<Vec<String>>, labels: Option<HashMap<String, String>>, name: Option<String>, node_group_config: Option<String>, parent: String) -> Result<String> {
