...
impl<'a> Realtimebidding_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "publisher_connection" => {
                self.plan_publisher_connection(current_state, desired_input)
                    .await
            }
            "buyer" => self.plan_buyer(current_state, desired_input).await,
            "endpoint" => self.plan_endpoint(current_state, desired_input).await,
            "user_list" => self.plan_user_list(current_state, desired_input).await,
            "bidder" => self.plan_bidder(current_state, desired_input).await,
            "bidding_function" => {
                self.plan_bidding_function(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "realtimebidding_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "publisher_connection" => self.create_publisher_connection(input).await,
            "buyer" => self.create_buyer(input).await,
            "endpoint" => self.create_endpoint(input).await,
            "user_list" => self.create_user_list(input).await,
            "bidder" => self.create_bidder(input).await,
            "bidding_function" => self.create_bidding_function(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "realtimebidding_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "publisher_connection" => self.read_publisher_connection(id).await,
            "buyer" => self.read_buyer(id).await,
            "endpoint" => self.read_endpoint(id).await,
            "user_list" => self.read_user_list(id).await,
            "bidder" => self.read_bidder(id).await,
            "bidding_function" => self.read_bidding_function(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "realtimebidding_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "publisher_connection" => self.update_publisher_connection(id, input).await,
            "buyer" => self.update_buyer(id, input).await,
            "endpoint" => self.update_endpoint(id, input).await,
            "user_list" => self.update_user_list(id, input).await,
            "bidder" => self.update_bidder(id, input).await,
            "bidding_function" => self.update_bidding_function(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "realtimebidding_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "publisher_connection" => self.delete_publisher_connection(id).await,
            "buyer" => self.delete_buyer(id).await,
            "endpoint" => self.delete_endpoint(id).await,
            "user_list" => self.delete_user_list(id).await,
            "bidder" => self.delete_bidder(id).await,
            "bidding_function" => self.delete_bidding_function(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "realtimebidding_api", resource_name
            ))),
    ...
    async fn create_publisher_connection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a publisher_connection resource
    async fn read_publisher_connection(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_publisher_connection(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_buyer(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a buyer resource
    async fn read_buyer(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a buyer resource
    async fn update_buyer(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a buyer resource
    async fn delete_buyer(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_user_list(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a user_list resource
    async fn read_user_list(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a user_list resource
    async fn update_user_list(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a user_list resource
    async fn delete_user_list(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_bidder(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a bidder resource
    async fn read_bidder(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a bidder resource
    async fn update_bidder(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a bidder resource
    async fn delete_bidder(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_bidding_function(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a bidding_function resource
    async fn read_bidding_function(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_bidding_function(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
