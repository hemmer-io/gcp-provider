...
impl<'a> Recaptcha_config<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, min_valid_score: Option<f64>, name: Option<String>, site_secret_set: Option<bool>, token_ttl: Option<String>, site_secret: Option<String>) -> Result<()> {
