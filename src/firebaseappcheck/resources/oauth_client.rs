...
impl<'a> Oauth_client<'a> {
    ...
    pub async fn create(&self, attestation_statement: Option<String>, key_id: Option<String>, challenge: Option<String>, limited_use: Option<bool>, app: String) -> Result<String> {
