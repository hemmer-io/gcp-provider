...
impl<'a> Play_integrity_config<'a> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, account_details: Option<String>, app_integrity: Option<String>, name: Option<String>, device_integrity: Option<String>, token_ttl: Option<String>) -> Result<()> {
