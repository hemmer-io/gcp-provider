//! Firebaseappcheck Service
//!
//! Auto-generated service module for firebaseappcheck

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for firebaseappcheck
pub struct FirebaseappcheckService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> FirebaseappcheckService<'a> {
