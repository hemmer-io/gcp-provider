...
//!
//! Auto-generated service module for contactcenterinsights

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for contactcenterinsights
pub struct ContactcenterinsightsService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> ContactcenterinsightsService<'a> {
