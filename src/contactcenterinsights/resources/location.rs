...
impl<'a> Location<'a> {
    ...
    pub async fn create(&self, filter: Option<String>, comparison_query_interval: Option<String>, query_interval: Option<String>, agent_performance_source: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, filter: Option<String>, comparison_query_interval: Option<String>, query_interval: Option<String>, agent_performance_source: Option<String>) -> Result<()> {
