...
impl<'a> Subscription<'a> {
    ...
    pub async fn create(&self, creation_time: Option<String>, customer_domain: Option<String>, sku_name: Option<String>, deal_code: Option<String>, renewal_settings: Option<String>, seats: Option<String>, plan: Option<String>, purchase_order_id: Option<String>, customer_id: Option<String>, kind: Option<String>, resource_ui_url: Option<String>, sku_id: Option<String>, suspension_reasons: Option<Vec<String>>, transfer_info: Option<String>, billing_method: Option<String>, subscription_id: Option<String>, trial_settings: Option<String>, status: Option<String>, customer_id: String) -> Result<String> {
