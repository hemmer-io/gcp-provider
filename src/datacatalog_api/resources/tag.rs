...
impl<'a> Tag<'a> {
    ...
    pub async fn create(&self, name: Option<String>, template: Option<String>, column: Option<String>, fields: Option<HashMap<String, String>>, template_display_name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, template: Option<String>, column: Option<String>, fields: Option<HashMap<String, String>>, template_display_name: Option<String>) -> Result<()> {
