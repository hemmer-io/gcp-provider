...
impl<'a> Cloudiot_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "registrie" => self.plan_registrie(current_state, desired_input).await,
            "state" => self.plan_state(current_state, desired_input).await,
            "config_version" => self.plan_config_version(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "registrie" => self.create_registrie(input).await,
            "state" => self.create_state(input).await,
            "config_version" => self.create_config_version(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "registrie" => self.read_registrie(id).await,
            "state" => self.read_state(id).await,
            "config_version" => self.read_config_version(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "registrie" => self.update_registrie(id, input).await,
            "state" => self.update_state(id, input).await,
            "config_version" => self.update_config_version(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "registrie" => self.delete_registrie(id).await,
            "state" => self.delete_state(id).await,
            "config_version" => self.delete_config_version(id).await,
    ...
    async fn create_registrie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a registrie resource
    async fn read_registrie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a registrie resource
    async fn update_registrie(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a registrie resource
    async fn delete_registrie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_state(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a state resource
    async fn read_state(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a state resource
    async fn update_state(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn create_config_version(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a config_version resource
    async fn read_config_version(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_config_version(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
