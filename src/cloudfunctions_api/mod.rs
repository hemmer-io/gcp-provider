//! Cloudfunctions_api service for Gcp provider
//!
//! This module handles all cloudfunctions_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Cloudfunctions_api service handler
