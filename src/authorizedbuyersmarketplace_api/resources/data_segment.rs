...
impl<'a> Data_segment<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, state: Option<String>, cpm_fee: Option<String>, name: Option<String>, update_time: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, create_time: Option<String>, state: Option<String>, cpm_fee: Option<String>, name: Option<String>, update_time: Option<String>) -> Result<()> {
