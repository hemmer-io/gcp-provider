...
impl<'a> Data_segment<'a> {
    ...
    pub async fn create(&self, name: Option<String>, cpm_fee: Option<String>, update_time: Option<String>, state: Option<String>, create_time: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, cpm_fee: Option<String>, update_time: Option<String>, state: Option<String>, create_time: Option<String>) -> Result<()> {
