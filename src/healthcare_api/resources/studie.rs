...
impl<'a> Studie<'a> {
    ...
    pub async fn create(&self, content_type: Option<String>, extensions: Option<Vec<HashMap<String, String>>>, data: Option<String>, parent: String, dicom_web_path: String) -> Result<String> {
