...
impl<'a> Consent_artifact<'a> {
    ...
    pub async fn create(&self, user_signature: Option<String>, consent_content_version: Option<String>, metadata: Option<HashMap<String, String>>, consent_content_screenshots: Option<Vec<String>>, user_id: Option<String>, witness_signature: Option<String>, guardian_signature: Option<String>, name: Option<String>, parent: String) -> Result<String> {
