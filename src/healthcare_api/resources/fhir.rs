...
impl<'a> Fhir<'a> {
    ...
    pub async fn create(&self, data: Option<String>, extensions: Option<Vec<HashMap<String, String>>>, content_type: Option<String>, type: String, parent: String) -> Result<String> {
