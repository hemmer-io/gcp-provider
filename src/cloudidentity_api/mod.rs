...
impl<'a> Cloudidentity_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "userinvitation" => {
                self.plan_userinvitation(current_state, desired_input).await
            }
            "device_user" => {
                self.plan_device_user(current_state, desired_input).await
            }
            "idp_credential" => {
                self.plan_idp_credential(current_state, desired_input).await
            }
            "policie" => {
                self.plan_policie(current_state, desired_input).await
            }
            "inbound_saml_sso_profile" => {
                self.plan_inbound_saml_sso_profile(current_state, desired_input).await
            }
            "client_state" => {
                self.plan_client_state(current_state, desired_input).await
            }
            "group" => {
            ...
            "inbound_oidc_sso_profile" => {
                self.plan_inbound_oidc_sso_profile(current_state, desired_input).await
            }
            "inbound_sso_assignment" => {
                self.plan_inbound_sso_assignment(current_state, desired_input).await
            }
            "membership" => {
                self.plan_membership(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "userinvitation" => {
                self.create_userinvitation(input).await
            }
            "device_user" => {
                self.create_device_user(input).await
            }
            "idp_credential" => {
                self.create_idp_credential(input).await
            }
            "policie" => {
                self.create_policie(input).await
            }
            "inbound_saml_sso_profile" => {
                self.create_inbound_saml_sso_profile(input).await
            }
            "client_state" => {
                self.create_client_state(input).await
            }
            "group" => {
            ...
            "inbound_oidc_sso_profile" => {
                self.create_inbound_oidc_sso_profile(input).await
            }
            "inbound_sso_assignment" => {
                self.create_inbound_sso_assignment(input).await
            }
            "membership" => {
                self.create_membership(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "userinvitation" => {
                self.read_userinvitation(id).await
            }
            "device_user" => {
                self.read_device_user(id).await
            }
            "idp_credential" => {
                self.read_idp_credential(id).await
            }
            "policie" => {
                self.read_policie(id).await
            }
            "inbound_saml_sso_profile" => {
                self.read_inbound_saml_sso_profile(id).await
            }
            "client_state" => {
                self.read_client_state(id).await
            }
            "group" => {
            ...
            "inbound_oidc_sso_profile" => {
                self.read_inbound_oidc_sso_profile(id).await
            }
            "inbound_sso_assignment" => {
                self.read_inbound_sso_assignment(id).await
            }
            "membership" => {
                self.read_membership(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "userinvitation" => {
                self.update_userinvitation(id, input).await
            }
            "device_user" => {
                self.update_device_user(id, input).await
            }
            "idp_credential" => {
                self.update_idp_credential(id, input).await
            }
            "policie" => {
                self.update_policie(id, input).await
            }
            "inbound_saml_sso_profile" => {
                self.update_inbound_saml_sso_profile(id, input).await
            }
            "client_state" => {
                self.update_client_state(id, input).await
            }
            "group" => {
            ...
            "inbound_oidc_sso_profile" => {
                self.update_inbound_oidc_sso_profile(id, input).await
            }
            "inbound_sso_assignment" => {
                self.update_inbound_sso_assignment(id, input).await
            }
            "membership" => {
                self.update_membership(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "userinvitation" => {
                self.delete_userinvitation(id).await
            }
            "device_user" => {
                self.delete_device_user(id).await
            }
            "idp_credential" => {
                self.delete_idp_credential(id).await
            }
            "policie" => {
                self.delete_policie(id).await
            }
            "inbound_saml_sso_profile" => {
                self.delete_inbound_saml_sso_profile(id).await
            }
            "client_state" => {
                self.delete_client_state(id).await
            }
            "group" => {
            ...
            "inbound_oidc_sso_profile" => {
                self.delete_inbound_oidc_sso_profile(id).await
            }
            "inbound_sso_assignment" => {
                self.delete_inbound_sso_assignment(id).await
            }
            "membership" => {
                self.delete_membership(id).await
            }
    ...
    async fn create_userinvitation(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
    ...
    async fn delete_userinvitation(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_idp_credential(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_idp_credential(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_inbound_saml_sso_profile(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_inbound_saml_sso_profile(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_inbound_oidc_sso_profile(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_inbound_oidc_sso_profile(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_inbound_sso_assignment(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_inbound_sso_assignment(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_inbound_sso_assignment(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
