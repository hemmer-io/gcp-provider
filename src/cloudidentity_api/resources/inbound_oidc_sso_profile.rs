...
impl<'a> Inbound_oidc_sso_profile<'a> {
    ...
    pub async fn create(&self, customer: Option<String>, display_name: Option<String>, name: Option<String>, rp_config: Option<String>, idp_config: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, customer: Option<String>, display_name: Option<String>, name: Option<String>, rp_config: Option<String>, idp_config: Option<String>) -> Result<()> {
