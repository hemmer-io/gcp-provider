...
impl<'a> Inbound_oidc_sso_profile<'a> {
    ...
    pub async fn create(&self, rp_config: Option<String>, customer: Option<String>, name: Option<String>, idp_config: Option<String>, display_name: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, rp_config: Option<String>, customer: Option<String>, name: Option<String>, idp_config: Option<String>, display_name: Option<String>) -> Result<()> {
