...
impl<'a> Inbound_oidc_sso_profile<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, idp_config: Option<String>, name: Option<String>, customer: Option<String>, rp_config: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, display_name: Option<String>, idp_config: Option<String>, name: Option<String>, customer: Option<String>, rp_config: Option<String>) -> Result<()> {
