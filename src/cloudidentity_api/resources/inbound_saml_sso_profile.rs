...
impl<'a> Inbound_saml_sso_profile<'a> {
    ...
    pub async fn create(&self, customer: Option<String>, sp_config: Option<String>, name: Option<String>, display_name: Option<String>, idp_config: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, customer: Option<String>, sp_config: Option<String>, name: Option<String>, display_name: Option<String>, idp_config: Option<String>) -> Result<()> {
