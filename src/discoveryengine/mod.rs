...
//!
//! Auto-generated service module for discoveryengine

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for discoveryengine
pub struct DiscoveryengineService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> DiscoveryengineService<'a> {
