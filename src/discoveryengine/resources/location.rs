...
impl<'a> Location<'a> {
    ...
    pub async fn create(&self, crawl_type: Option<String>, crawl_rate: Option<i64>, crawl_rate_scope: Option<String>, mode: Option<String>, location: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, crawl_type: Option<String>, crawl_rate: Option<i64>, crawl_rate_scope: Option<String>, mode: Option<String>) -> Result<()> {
