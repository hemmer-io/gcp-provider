...
impl<'a> Sample_query_set<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, display_name: Option<String>, description: Option<String>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, create_time: Option<String>, display_name: Option<String>, description: Option<String>, name: Option<String>) -> Result<()> {
