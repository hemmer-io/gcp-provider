...
impl<'a> Inspect_template<'a> {
    ...
    pub async fn create(&self, template_id: Option<String>, location_id: Option<String>, inspect_template: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, template_id: Option<String>, location_id: Option<String>, inspect_template: Option<String>) -> Result<()> {
