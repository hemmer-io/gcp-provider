...
impl<'a> Inspect_template<'a> {
    ...
    pub async fn create(&self, location_id: Option<String>, template_id: Option<String>, inspect_template: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, location_id: Option<String>, template_id: Option<String>, inspect_template: Option<String>) -> Result<()> {
