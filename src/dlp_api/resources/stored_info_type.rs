...
impl<'a> Stored_info_type<'a> {
    ...
    pub async fn create(&self, location_id: Option<String>, stored_info_type_id: Option<String>, config: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, location_id: Option<String>, stored_info_type_id: Option<String>, config: Option<String>) -> Result<()> {
