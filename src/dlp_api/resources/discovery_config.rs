...
impl<'a> Discovery_config<'a> {
    ...
    pub async fn create(&self, discovery_config: Option<String>, config_id: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, discovery_config: Option<String>, config_id: Option<String>) -> Result<()> {
