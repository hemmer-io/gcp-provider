...
impl<'a> Creative_field_value<'a> {
    ...
    pub async fn create(&self, id: Option<String>, kind: Option<String>, value: Option<String>, creative_field_id: String, profile_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, id: Option<String>, kind: Option<String>, value: Option<String>) -> Result<()> {
