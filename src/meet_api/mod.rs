...
impl<'a> Meet_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "participant_session" => {
                self.plan_participant_session(current_state, desired_input)
                    .await
            }
            "recording" => self.plan_recording(current_state, desired_input).await,
            ...
            "conference_record" => {
                self.plan_conference_record(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "meet_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "participant_session" => self.create_participant_session(input).await,
            "recording" => self.create_recording(input).await,
            ...
            "conference_record" => self.create_conference_record(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "meet_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "participant_session" => self.read_participant_session(id).await,
            "recording" => self.read_recording(id).await,
            ...
            "conference_record" => self.read_conference_record(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "meet_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "participant_session" => self.update_participant_session(id, input).await,
            "recording" => self.update_recording(id, input).await,
            ...
            "conference_record" => self.update_conference_record(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "meet_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "participant_session" => self.delete_participant_session(id).await,
            "recording" => self.delete_recording(id).await,
            ...
            "conference_record" => self.delete_conference_record(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "meet_api", resource_name
            ))),
    ...
    async fn create_participant_session(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a participant_session resource
    async fn read_participant_session(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_participant_session(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_recording(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a recording resource
    async fn read_recording(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a recording resource
    async fn update_recording(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn create_conference_record(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a conference_record resource
    async fn read_conference_record(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_conference_record(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
