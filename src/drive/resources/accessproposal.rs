...
impl<'a> Accessproposal<'a> {
    ...
    pub async fn create(&self, role: Option<Vec<String>>, send_notification: Option<bool>, action: Option<String>, view: Option<String>, file_id: String, proposal_id: String) -> Result<String> {
