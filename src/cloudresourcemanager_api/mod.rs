...
impl<'a> Cloudresourcemanager_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "lien" => self.plan_lien(current_state, desired_input).await,
            ...
            "operation" => self.plan_operation(current_state, desired_input).await,
            "lien" => self.plan_lien(current_state, desired_input).await,
            "tag_key" => self.plan_tag_key(current_state, desired_input).await,
            "organization" => self.plan_organization(current_state, desired_input).await,
            "tag_binding_collection" => {
                self.plan_tag_binding_collection(current_state, desired_input)
                    .await
            }
            "effective_tag" => self.plan_effective_tag(current_state, desired_input).await,
            "folder" => self.plan_folder(current_state, desired_input).await,
            "tag_value" => self.plan_tag_value(current_state, desired_input).await,
            "tag_binding" => self.plan_tag_binding(current_state, desired_input).await,
            "capabilitie" => self.plan_capabilitie(current_state, desired_input).await,
            "effective_tag_binding_collection" => {
                self.plan_effective_tag_binding_collection(current_state, desired_input)
                    .await
            }
            "tag_hold" => self.plan_tag_hold(current_state, desired_input).await,
            "project" => self.plan_project(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudresourcemanager_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "lien" => self.create_lien(input).await,
            ...
            "operation" => self.create_operation(input).await,
            "lien" => self.create_lien(input).await,
            "tag_key" => self.create_tag_key(input).await,
            "organization" => self.create_organization(input).await,
            "tag_binding_collection" => self.create_tag_binding_collection(input).await,
            "effective_tag" => self.create_effective_tag(input).await,
            "folder" => self.create_folder(input).await,
            "tag_value" => self.create_tag_value(input).await,
            "tag_binding" => self.create_tag_binding(input).await,
            "capabilitie" => self.create_capabilitie(input).await,
            "effective_tag_binding_collection" => {
                self.create_effective_tag_binding_collection(input).await
            }
            "tag_hold" => self.create_tag_hold(input).await,
            "project" => self.create_project(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudresourcemanager_api", resource_name
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "operation" => self.read_operation(id).await,
            "lien" => self.read_lien(id).await,
            "tag_key" => self.read_tag_key(id).await,
            "organization" => self.read_organization(id).await,
            "tag_binding_collection" => self.read_tag_binding_collection(id).await,
            "effective_tag" => self.read_effective_tag(id).await,
            "folder" => self.read_folder(id).await,
            "tag_value" => self.read_tag_value(id).await,
            "tag_binding" => self.read_tag_binding(id).await,
            "capabilitie" => self.read_capabilitie(id).await,
            "effective_tag_binding_collection" => {
                self.read_effective_tag_binding_collection(id).await
            }
            "tag_hold" => self.read_tag_hold(id).await,
            "project" => self.read_project(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudresourcemanager_api", resource_name
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "lien" => self.update_lien(id, input).await,
            ...
            "operation" => self.update_operation(id, input).await,
            "lien" => self.update_lien(id, input).await,
            "tag_key" => self.update_tag_key(id, input).await,
            "organization" => self.update_organization(id, input).await,
            "tag_binding_collection" => self.update_tag_binding_collection(id, input).await,
            "effective_tag" => self.update_effective_tag(id, input).await,
            "folder" => self.update_folder(id, input).await,
            "tag_value" => self.update_tag_value(id, input).await,
            "tag_binding" => self.update_tag_binding(id, input).await,
            "capabilitie" => self.update_capabilitie(id, input).await,
            "effective_tag_binding_collection" => {
                self.update_effective_tag_binding_collection(id, input)
                    .await
            }
            "tag_hold" => self.update_tag_hold(id, input).await,
            "project" => self.update_project(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudresourcemanager_api", resource_name
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "lien" => self.delete_lien(id).await,
            ...
            "operation" => self.delete_operation(id).await,
            "lien" => self.delete_lien(id).await,
            "tag_key" => self.delete_tag_key(id).await,
            "organization" => self.delete_organization(id).await,
            "tag_binding_collection" => self.delete_tag_binding_collection(id).await,
            "effective_tag" => self.delete_effective_tag(id).await,
            "folder" => self.delete_folder(id).await,
            "tag_value" => self.delete_tag_value(id).await,
            "tag_binding" => self.delete_tag_binding(id).await,
            "capabilitie" => self.delete_capabilitie(id).await,
            "effective_tag_binding_collection" => {
                self.delete_effective_tag_binding_collection(id).await
            }
            "tag_hold" => self.delete_tag_hold(id).await,
            "project" => self.delete_project(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudresourcemanager_api", resource_name
    ...
    async fn create_lien(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a lien resource
    async fn read_lien(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a lien resource
    async fn update_lien(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a lien resource
    async fn delete_lien(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_tag_key(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a tag_key resource
    async fn read_tag_key(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a tag_key resource
    async fn update_tag_key(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a tag_key resource
    async fn delete_tag_key(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_tag_binding_collection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a tag_binding_collection resource
    async fn read_tag_binding_collection(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_tag_binding_collection(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_effective_tag(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a effective_tag resource
    async fn read_effective_tag(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a effective_tag resource
    async fn update_effective_tag(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a effective_tag resource
    async fn delete_effective_tag(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_tag_value(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a tag_value resource
    async fn read_tag_value(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a tag_value resource
    async fn update_tag_value(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a tag_value resource
    async fn delete_tag_value(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_tag_binding(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a tag_binding resource
    async fn read_tag_binding(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a tag_binding resource
    async fn update_tag_binding(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a tag_binding resource
    async fn delete_tag_binding(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_capabilitie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a capabilitie resource
    async fn read_capabilitie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a capabilitie resource
    async fn update_capabilitie(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a capabilitie resource
    async fn delete_capabilitie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_effective_tag_binding_collection(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_effective_tag_binding_collection(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_tag_hold(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a tag_hold resource
    async fn read_tag_hold(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a tag_hold resource
    async fn update_tag_hold(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a tag_hold resource
    async fn delete_tag_hold(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
