...
impl<'a> Securitycenter_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "resource_value_config" => {
                self.plan_resource_value_config(current_state, desired_input)
                    .await
            }
            "effective_custom_module" => {
                self.plan_effective_custom_module(current_state, desired_input)
                    .await
            }
            "finding" => self.plan_finding(current_state, desired_input).await,
            "external_system" => {
                self.plan_external_system(current_state, desired_input)
                    .await
            }
            "operation" => self.plan_operation(current_state, desired_input).await,
            "attack_path" => self.plan_attack_path(current_state, desired_input).await,
            ...
            "simulation" => self.plan_simulation(current_state, desired_input).await,
            "valued_resource" => {
                self.plan_valued_resource(current_state, desired_input)
                    .await
            }
            "custom_module" => self.plan_custom_module(current_state, desired_input).await,
            "big_query_export" => {
                self.plan_big_query_export(current_state, desired_input)
                    .await
            }
            "event_threat_detection_setting" => {
                self.plan_event_threat_detection_setting(current_state, desired_input)
                    .await
            }
            "asset" => self.plan_asset(current_state, desired_input).await,
            "mute_config" => self.plan_mute_config(current_state, desired_input).await,
            "operation" => self.plan_operation(current_state, desired_input).await,
            "folder" => self.plan_folder(current_state, desired_input).await,
            "rapid_vulnerability_detection_setting" => {
                self.plan_rapid_vulnerability_detection_setting(current_state, desired_input)
                    .await
            }
            "virtual_machine_threat_detection_setting" => {
                self.plan_virtual_machine_threat_detection_setting(current_state, desired_input)
                    .await
            }
            "web_security_scanner_setting" => {
                self.plan_web_security_scanner_setting(current_state, desired_input)
                    .await
            }
            "organization" => self.plan_organization(current_state, desired_input).await,
            ...
            "security_health_analytics_setting" => {
                self.plan_security_health_analytics_setting(current_state, desired_input)
                    .await
            }
            "container_threat_detection_setting" => {
                self.plan_container_threat_detection_setting(current_state, desired_input)
                    .await
            }
            "organization" => self.plan_organization(current_state, desired_input).await,
            "asset" => self.plan_asset(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "securitycenter_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "resource_value_config" => self.create_resource_value_config(input).await,
            "effective_custom_module" => self.create_effective_custom_module(input).await,
            "finding" => self.create_finding(input).await,
            "external_system" => self.create_external_system(input).await,
            "operation" => self.create_operation(input).await,
            "attack_path" => self.create_attack_path(input).await,
            "organization" => self.create_organization(input).await,
            "source" => self.create_source(input).await,
            "simulation" => self.create_simulation(input).await,
            "valued_resource" => self.create_valued_resource(input).await,
            "custom_module" => self.create_custom_module(input).await,
            "big_query_export" => self.create_big_query_export(input).await,
            "event_threat_detection_setting" => {
                self.create_event_threat_detection_setting(input).await
            }
            "asset" => self.create_asset(input).await,
            "mute_config" => self.create_mute_config(input).await,
            "operation" => self.create_operation(input).await,
            "folder" => self.create_folder(input).await,
            "rapid_vulnerability_detection_setting" => {
                self.create_rapid_vulnerability_detection_setting(input)
                    .await
            }
            "virtual_machine_threat_detection_setting" => {
                self.create_virtual_machine_threat_detection_setting(input)
                    .await
            }
            "web_security_scanner_setting" => self.create_web_security_scanner_setting(input).await,
            "organization" => self.create_organization(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "resource_value_config" => self.read_resource_value_config(id).await,
            "effective_custom_module" => self.read_effective_custom_module(id).await,
            "finding" => self.read_finding(id).await,
            "external_system" => self.read_external_system(id).await,
            "operation" => self.read_operation(id).await,
            "attack_path" => self.read_attack_path(id).await,
            "organization" => self.read_organization(id).await,
            "source" => self.read_source(id).await,
            "simulation" => self.read_simulation(id).await,
            "valued_resource" => self.read_valued_resource(id).await,
            "custom_module" => self.read_custom_module(id).await,
            "big_query_export" => self.read_big_query_export(id).await,
            "event_threat_detection_setting" => self.read_event_threat_detection_setting(id).await,
            "asset" => self.read_asset(id).await,
            "mute_config" => self.read_mute_config(id).await,
            "operation" => self.read_operation(id).await,
            ...
            "web_security_scanner_setting" => self.read_web_security_scanner_setting(id).await,
            "organization" => self.read_organization(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "resource_value_config" => self.update_resource_value_config(id, input).await,
            "effective_custom_module" => self.update_effective_custom_module(id, input).await,
            "finding" => self.update_finding(id, input).await,
            "external_system" => self.update_external_system(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "attack_path" => self.update_attack_path(id, input).await,
            "organization" => self.update_organization(id, input).await,
            "source" => self.update_source(id, input).await,
            "simulation" => self.update_simulation(id, input).await,
            "valued_resource" => self.update_valued_resource(id, input).await,
            "custom_module" => self.update_custom_module(id, input).await,
            "big_query_export" => self.update_big_query_export(id, input).await,
            "event_threat_detection_setting" => {
                self.update_event_threat_detection_setting(id, input).await
            }
            "asset" => self.update_asset(id, input).await,
            "mute_config" => self.update_mute_config(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "folder" => self.update_folder(id, input).await,
            "rapid_vulnerability_detection_setting" => {
                self.update_rapid_vulnerability_detection_setting(id, input)
                    .await
            }
            "virtual_machine_threat_detection_setting" => {
                self.update_virtual_machine_threat_detection_setting(id, input)
                    .await
            }
            "web_security_scanner_setting" => {
            ...
            "security_health_analytics_setting" => {
                self.update_security_health_analytics_setting(id, input)
                    .await
            }
            "container_threat_detection_setting" => {
                self.update_container_threat_detection_setting(id, input)
                    .await
            }
            "organization" => self.update_organization(id, input).await,
            "asset" => self.update_asset(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "resource_value_config" => self.delete_resource_value_config(id).await,
            "effective_custom_module" => self.delete_effective_custom_module(id).await,
            "finding" => self.delete_finding(id).await,
            "external_system" => self.delete_external_system(id).await,
            "operation" => self.delete_operation(id).await,
            "attack_path" => self.delete_attack_path(id).await,
            "organization" => self.delete_organization(id).await,
            "source" => self.delete_source(id).await,
            "simulation" => self.delete_simulation(id).await,
            "valued_resource" => self.delete_valued_resource(id).await,
            "custom_module" => self.delete_custom_module(id).await,
            "big_query_export" => self.delete_big_query_export(id).await,
            "event_threat_detection_setting" => {
                self.delete_event_threat_detection_setting(id).await
            }
            "asset" => self.delete_asset(id).await,
            "mute_config" => self.delete_mute_config(id).await,
            "operation" => self.delete_operation(id).await,
            ...
            "virtual_machine_threat_detection_setting" => {
                self.delete_virtual_machine_threat_detection_setting(id)
                    .await
            }
            "web_security_scanner_setting" => self.delete_web_security_scanner_setting(id).await,
            "organization" => self.delete_organization(id).await,
    ...
    async fn create_resource_value_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a resource_value_config resource
    async fn read_resource_value_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_resource_value_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_effective_custom_module(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a effective_custom_module resource
    async fn read_effective_custom_module(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_effective_custom_module(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_external_system(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a external_system resource
    async fn read_external_system(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_external_system(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_attack_path(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a attack_path resource
    async fn read_attack_path(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a attack_path resource
    async fn update_attack_path(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a attack_path resource
    async fn delete_attack_path(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_simulation(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a simulation resource
    async fn read_simulation(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a simulation resource
    async fn update_simulation(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a simulation resource
    async fn delete_simulation(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_valued_resource(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a valued_resource resource
    async fn read_valued_resource(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_valued_resource(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_custom_module(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a custom_module resource
    async fn read_custom_module(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a custom_module resource
    async fn update_custom_module(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a custom_module resource
    async fn delete_custom_module(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_big_query_export(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a big_query_export resource
    async fn read_big_query_export(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_big_query_export(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_event_threat_detection_setting(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_event_threat_detection_setting(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_mute_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a mute_config resource
    async fn read_mute_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a mute_config resource
    async fn update_mute_config(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a mute_config resource
    async fn delete_mute_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_rapid_vulnerability_detection_setting(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_rapid_vulnerability_detection_setting(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn delete_virtual_machine_threat_detection_setting(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_web_security_scanner_setting(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_web_security_scanner_setting(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_security_health_analytics_setting(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_security_health_analytics_setting(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_container_threat_detection_setting(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_container_threat_detection_setting(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
