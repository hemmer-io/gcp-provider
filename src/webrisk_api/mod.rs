...
impl<'a> Webrisk_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "uri" => {
                self.plan_uri(current_state, desired_input).await
            }
            "submission" => {
                self.plan_submission(current_state, desired_input).await
            }
            "hashe" => {
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "uri" => {
                self.create_uri(input).await
            }
            "submission" => {
                self.create_submission(input).await
            }
            "hashe" => {
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "uri" => {
                self.read_uri(id).await
            }
            "submission" => {
                self.read_submission(id).await
            }
            "hashe" => {
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "uri" => {
                self.update_uri(id, input).await
            }
            "submission" => {
                self.update_submission(id, input).await
            }
            "hashe" => {
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "uri" => {
                self.delete_uri(id).await
            }
            "submission" => {
                self.delete_submission(id).await
            }
            "hashe" => {
