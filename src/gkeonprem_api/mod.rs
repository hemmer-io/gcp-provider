...
impl<'a> Gkeonprem_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "vmware_cluster" => self.plan_vmware_cluster(current_state, desired_input).await,
            "vmware_admin_cluster" => {
                self.plan_vmware_admin_cluster(current_state, desired_input)
                    .await
            }
            "bare_metal_admin_cluster" => {
                self.plan_bare_metal_admin_cluster(current_state, desired_input)
                    .await
            }
            "bare_metal_node_pool" => {
                self.plan_bare_metal_node_pool(current_state, desired_input)
                    .await
            }
            "vmware_node_pool" => {
                self.plan_vmware_node_pool(current_state, desired_input)
                    .await
            }
            ...
            "bare_metal_cluster" => {
                self.plan_bare_metal_cluster(current_state, desired_input)
                    .await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gkeonprem_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "vmware_cluster" => self.create_vmware_cluster(input).await,
            "vmware_admin_cluster" => self.create_vmware_admin_cluster(input).await,
            "bare_metal_admin_cluster" => self.create_bare_metal_admin_cluster(input).await,
            "bare_metal_node_pool" => self.create_bare_metal_node_pool(input).await,
            "vmware_node_pool" => self.create_vmware_node_pool(input).await,
            "location" => self.create_location(input).await,
            "operation" => self.create_operation(input).await,
            "bare_metal_cluster" => self.create_bare_metal_cluster(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gkeonprem_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "vmware_cluster" => self.read_vmware_cluster(id).await,
            "vmware_admin_cluster" => self.read_vmware_admin_cluster(id).await,
            "bare_metal_admin_cluster" => self.read_bare_metal_admin_cluster(id).await,
            "bare_metal_node_pool" => self.read_bare_metal_node_pool(id).await,
            "vmware_node_pool" => self.read_vmware_node_pool(id).await,
            "location" => self.read_location(id).await,
            "operation" => self.read_operation(id).await,
            "bare_metal_cluster" => self.read_bare_metal_cluster(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gkeonprem_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "vmware_cluster" => self.update_vmware_cluster(id, input).await,
            "vmware_admin_cluster" => self.update_vmware_admin_cluster(id, input).await,
            "bare_metal_admin_cluster" => self.update_bare_metal_admin_cluster(id, input).await,
            "bare_metal_node_pool" => self.update_bare_metal_node_pool(id, input).await,
            "vmware_node_pool" => self.update_vmware_node_pool(id, input).await,
            "location" => self.update_location(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "bare_metal_cluster" => self.update_bare_metal_cluster(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gkeonprem_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "vmware_cluster" => self.delete_vmware_cluster(id).await,
            "vmware_admin_cluster" => self.delete_vmware_admin_cluster(id).await,
            "bare_metal_admin_cluster" => self.delete_bare_metal_admin_cluster(id).await,
            "bare_metal_node_pool" => self.delete_bare_metal_node_pool(id).await,
            "vmware_node_pool" => self.delete_vmware_node_pool(id).await,
            "location" => self.delete_location(id).await,
            "operation" => self.delete_operation(id).await,
            "bare_metal_cluster" => self.delete_bare_metal_cluster(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "gkeonprem_api", resource_name
            ))),
    ...
    async fn create_vmware_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a vmware_cluster resource
    async fn read_vmware_cluster(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_vmware_cluster(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_vmware_admin_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a vmware_admin_cluster resource
    async fn read_vmware_admin_cluster(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_vmware_admin_cluster(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_bare_metal_admin_cluster(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_bare_metal_admin_cluster(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_bare_metal_node_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a bare_metal_node_pool resource
    async fn read_bare_metal_node_pool(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_bare_metal_node_pool(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_vmware_node_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a vmware_node_pool resource
    async fn read_vmware_node_pool(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_vmware_node_pool(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_bare_metal_cluster(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a bare_metal_cluster resource
    async fn read_bare_metal_cluster(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_bare_metal_cluster(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
