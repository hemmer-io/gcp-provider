...
impl<'a> Accesscontextmanager_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "service_perimeter" => {
                self.plan_service_perimeter(current_state, desired_input).await
            }
            "gcp_user_access_binding" => {
                self.plan_gcp_user_access_binding(current_state, desired_input).await
            }
            "service" => {
            ...
            "access_policie" => {
                self.plan_access_policie(current_state, desired_input).await
            }
            "access_level" => {
                self.plan_access_level(current_state, desired_input).await
            }
            "authorized_orgs_desc" => {
                self.plan_authorized_orgs_desc(current_state, desired_input).await
            }
            "access_policie" => {
                self.plan_access_policie(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "service_perimeter" => {
                self.create_service_perimeter(input).await
            }
            "gcp_user_access_binding" => {
                self.create_gcp_user_access_binding(input).await
            }
            "service" => {
            ...
            "access_policie" => {
                self.create_access_policie(input).await
            }
            "access_level" => {
                self.create_access_level(input).await
            }
            "authorized_orgs_desc" => {
                self.create_authorized_orgs_desc(input).await
            }
            "access_policie" => {
                self.create_access_policie(input).await
            }
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            "service_perimeter" => {
                self.read_service_perimeter(id).await
            }
            "gcp_user_access_binding" => {
                self.read_gcp_user_access_binding(id).await
            }
            "service" => {
            ...
            "access_policie" => {
                self.read_access_policie(id).await
            }
            "access_level" => {
                self.read_access_level(id).await
            }
            "authorized_orgs_desc" => {
                self.read_authorized_orgs_desc(id).await
            }
            "access_policie" => {
                self.read_access_policie(id).await
            }
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "service_perimeter" => {
                self.update_service_perimeter(id, input).await
            }
            "gcp_user_access_binding" => {
                self.update_gcp_user_access_binding(id, input).await
            }
            "service" => {
            ...
            "access_policie" => {
                self.update_access_policie(id, input).await
            }
            "access_level" => {
                self.update_access_level(id, input).await
            }
            "authorized_orgs_desc" => {
                self.update_authorized_orgs_desc(id, input).await
            }
            "access_policie" => {
                self.update_access_policie(id, input).await
            }
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            "service_perimeter" => {
                self.delete_service_perimeter(id).await
            }
            "gcp_user_access_binding" => {
                self.delete_gcp_user_access_binding(id).await
            }
            "service" => {
            ...
            "access_policie" => {
                self.delete_access_policie(id).await
            }
            "access_level" => {
                self.delete_access_level(id).await
            }
            "authorized_orgs_desc" => {
                self.delete_authorized_orgs_desc(id).await
            }
            "access_policie" => {
                self.delete_access_policie(id).await
            }
    ...
    async fn read_service_perimeter(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_gcp_user_access_binding(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_access_policie(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_access_policie(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_authorized_orgs_desc(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_authorized_orgs_desc(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_authorized_orgs_desc(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
