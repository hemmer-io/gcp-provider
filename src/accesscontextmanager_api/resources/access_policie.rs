...
impl<'a> Access_policie<'a> {
    ...
    pub async fn create(&self, parent: Option<String>, name: Option<String>, title: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, parent: Option<String>, name: Option<String>, title: Option<String>) -> Result<()> {
