...
impl<'a> Access_policie<'a> {
    ...
    pub async fn create(&self, name: Option<String>, title: Option<String>, parent: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, title: Option<String>, parent: Option<String>) -> Result<()> {
