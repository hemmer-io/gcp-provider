...
impl<'a> Container_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "node_pool" => self.plan_node_pool(current_state, desired_input).await,
            "operation" => self.plan_operation(current_state, desired_input).await,
            "usable_subnetwork" => {
                self.plan_usable_subnetwork(current_state, desired_input)
                    .await
            }
            "zone" => self.plan_zone(current_state, desired_input).await,
            "location" => self.plan_location(current_state, desired_input).await,
            "well_known" => self.plan_well_known(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "node_pool" => self.create_node_pool(input).await,
            "operation" => self.create_operation(input).await,
            "usable_subnetwork" => self.create_usable_subnetwork(input).await,
            "zone" => self.create_zone(input).await,
            "location" => self.create_location(input).await,
            "well_known" => self.create_well_known(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "node_pool" => self.read_node_pool(id).await,
            "operation" => self.read_operation(id).await,
            "usable_subnetwork" => self.read_usable_subnetwork(id).await,
            "zone" => self.read_zone(id).await,
            "location" => self.read_location(id).await,
            "well_known" => self.read_well_known(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "node_pool" => self.update_node_pool(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "usable_subnetwork" => self.update_usable_subnetwork(id, input).await,
            "zone" => self.update_zone(id, input).await,
            "location" => self.update_location(id, input).await,
            "well_known" => self.update_well_known(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "node_pool" => self.delete_node_pool(id).await,
            "operation" => self.delete_operation(id).await,
            "usable_subnetwork" => self.delete_usable_subnetwork(id).await,
            "zone" => self.delete_zone(id).await,
            "location" => self.delete_location(id).await,
            "well_known" => self.delete_well_known(id).await,
    ...
    async fn create_node_pool(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a node_pool resource
    async fn read_node_pool(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a node_pool resource
    async fn update_node_pool(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a node_pool resource
    async fn delete_node_pool(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_usable_subnetwork(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a usable_subnetwork resource
    async fn read_usable_subnetwork(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_usable_subnetwork(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_well_known(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a well_known resource
    async fn read_well_known(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a well_known resource
    async fn update_well_known(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a well_known resource
    async fn delete_well_known(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
