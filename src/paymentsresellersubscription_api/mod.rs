...
impl<'a> Paymentsresellersubscription_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "user_session" => self.plan_user_session(current_state, desired_input).await,
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "paymentsresellersubscription_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "user_session" => self.create_user_session(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "user_session" => self.read_user_session(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "user_session" => self.update_user_session(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "user_session" => self.delete_user_session(id).await,
    ...
    async fn create_user_session(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a user_session resource
    async fn read_user_session(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a user_session resource
    async fn update_user_session(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a user_session resource
    async fn delete_user_session(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
