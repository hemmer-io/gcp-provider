//! Securityposture Service
//!
//! Auto-generated service module for securityposture

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for securityposture
pub struct SecuritypostureService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> SecuritypostureService<'a> {
