...
impl<'a> Subscription<'a> {
    ...
    pub async fn create(&self, name: Option<String>, state: Option<String>, target_resource: Option<String>, uid: Option<String>, reconciling: Option<bool>, update_time: Option<String>, payload_options: Option<String>, etag: Option<String>, notification_endpoint: Option<String>, event_types: Option<Vec<String>>, expire_time: Option<String>, suspension_reason: Option<String>, ttl: Option<String>, authority: Option<String>, create_time: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, state: Option<String>, target_resource: Option<String>, uid: Option<String>, reconciling: Option<bool>, update_time: Option<String>, payload_options: Option<String>, etag: Option<String>, notification_endpoint: Option<String>, event_types: Option<Vec<String>>, expire_time: Option<String>, suspension_reason: Option<String>, ttl: Option<String>, authority: Option<String>, create_time: Option<String>) -> Result<()> {
