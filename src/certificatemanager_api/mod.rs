...
impl<'a> Certificatemanager_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "dns_authorization" => {
                self.plan_dns_authorization(current_state, desired_input)
                    .await
            }
            "trust_config" => self.plan_trust_config(current_state, desired_input).await,
            "certificate_map" => {
                self.plan_certificate_map(current_state, desired_input)
                    .await
            }
            "certificate_issuance_config" => {
                self.plan_certificate_issuance_config(current_state, desired_input)
                    .await
            }
            "location" => self.plan_location(current_state, desired_input).await,
            "certificate_map_entrie" => {
                self.plan_certificate_map_entrie(current_state, desired_input)
                    .await
            }
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "certificatemanager_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "dns_authorization" => self.create_dns_authorization(input).await,
            "trust_config" => self.create_trust_config(input).await,
            "certificate_map" => self.create_certificate_map(input).await,
            "certificate_issuance_config" => self.create_certificate_issuance_config(input).await,
            "location" => self.create_location(input).await,
            "certificate_map_entrie" => self.create_certificate_map_entrie(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "dns_authorization" => self.read_dns_authorization(id).await,
            "trust_config" => self.read_trust_config(id).await,
            "certificate_map" => self.read_certificate_map(id).await,
            "certificate_issuance_config" => self.read_certificate_issuance_config(id).await,
            "location" => self.read_location(id).await,
            "certificate_map_entrie" => self.read_certificate_map_entrie(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "dns_authorization" => self.update_dns_authorization(id, input).await,
            "trust_config" => self.update_trust_config(id, input).await,
            "certificate_map" => self.update_certificate_map(id, input).await,
            "certificate_issuance_config" => {
                self.update_certificate_issuance_config(id, input).await
            }
            "location" => self.update_location(id, input).await,
            "certificate_map_entrie" => self.update_certificate_map_entrie(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "dns_authorization" => self.delete_dns_authorization(id).await,
            "trust_config" => self.delete_trust_config(id).await,
            "certificate_map" => self.delete_certificate_map(id).await,
            "certificate_issuance_config" => self.delete_certificate_issuance_config(id).await,
            "location" => self.delete_location(id).await,
            "certificate_map_entrie" => self.delete_certificate_map_entrie(id).await,
    ...
    async fn create_dns_authorization(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a dns_authorization resource
    async fn read_dns_authorization(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_dns_authorization(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_trust_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a trust_config resource
    async fn read_trust_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a trust_config resource
    async fn update_trust_config(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a trust_config resource
    async fn delete_trust_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_certificate_map(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a certificate_map resource
    async fn read_certificate_map(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_certificate_map(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn read_certificate_issuance_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_certificate_issuance_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_certificate_map_entrie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a certificate_map_entrie resource
    async fn read_certificate_map_entrie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_certificate_map_entrie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
