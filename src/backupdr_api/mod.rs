...
impl<'a> Backupdr_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "backup_plan_association" => {
                self.plan_backup_plan_association(current_state, desired_input).await
            }
            "operation" => {
            ...
            "management_server" => {
                self.plan_management_server(current_state, desired_input).await
            }
            "service_config" => {
                self.plan_service_config(current_state, desired_input).await
            }
            "data_source" => {
            ...
            "resource_backup_config" => {
                self.plan_resource_backup_config(current_state, desired_input).await
            }
            "location" => {
                self.plan_location(current_state, desired_input).await
            }
            "data_source_reference" => {
                self.plan_data_source_reference(current_state, desired_input).await
            }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "backup_plan_association" => {
                self.create_backup_plan_association(input).await
            }
            "operation" => {
            ...
            "management_server" => {
                self.create_management_server(input).await
            }
            "service_config" => {
                self.create_service_config(input).await
            }
            "data_source" => {
            ...
            "resource_backup_config" => {
                self.create_resource_backup_config(input).await
            }
            "location" => {
                self.create_location(input).await
            }
            "data_source_reference" => {
                self.create_data_source_reference(input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "backupdr_api",
    ...
    pub async fn read_resource(
        ...
        match resource_name {
            ...
            "backup_plan_association" => {
                self.read_backup_plan_association(id).await
            }
            "operation" => {
            ...
            "management_server" => {
                self.read_management_server(id).await
            }
            "service_config" => {
                self.read_service_config(id).await
            }
            "data_source" => {
            ...
            "resource_backup_config" => {
                self.read_resource_backup_config(id).await
            }
            "location" => {
                self.read_location(id).await
            }
            "data_source_reference" => {
                self.read_data_source_reference(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "backupdr_api",
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "backup_plan_association" => {
                self.update_backup_plan_association(id, input).await
            }
            "operation" => {
            ...
            "management_server" => {
                self.update_management_server(id, input).await
            }
            "service_config" => {
                self.update_service_config(id, input).await
            }
            "data_source" => {
            ...
            "resource_backup_config" => {
                self.update_resource_backup_config(id, input).await
            }
            "location" => {
                self.update_location(id, input).await
            }
            "data_source_reference" => {
                self.update_data_source_reference(id, input).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "backupdr_api",
    ...
    pub async fn delete_resource(
        ...
        match resource_name {
            ...
            "backup_plan_association" => {
                self.delete_backup_plan_association(id).await
            }
            "operation" => {
            ...
            "management_server" => {
                self.delete_management_server(id).await
            }
            "service_config" => {
                self.delete_service_config(id).await
            }
            "data_source" => {
            ...
            "resource_backup_config" => {
                self.delete_resource_backup_config(id).await
            }
            "location" => {
                self.delete_location(id).await
            }
            "data_source_reference" => {
                self.delete_data_source_reference(id).await
            }
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "backupdr_api",
    ...
    async fn read_backup_plan_association(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_management_server(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_resource_backup_config(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_resource_backup_config(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_resource_backup_config(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn create_data_source_reference(
        &self,
        input: ResourceInput,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn read_data_source_reference(
        &self,
        id: &str,
    ) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_data_source_reference(
        &self,
        id: &str,
    ) -> Result<()> {
        // TODO: Implement Gcp SDK calls
