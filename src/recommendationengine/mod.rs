...
//!
//! Auto-generated service module for recommendationengine

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for recommendationengine
pub struct RecommendationengineService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> RecommendationengineService<'a> {
