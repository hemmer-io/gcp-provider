...
impl<'a> Placement<'a> {
    ...
    pub async fn create(&self, labels: Option<HashMap<String, String>>, filter: Option<String>, page_size: Option<i64>, dry_run: Option<bool>, page_token: Option<String>, params: Option<HashMap<String, String>>, user_event: Option<String>, name: String) -> Result<String> {
