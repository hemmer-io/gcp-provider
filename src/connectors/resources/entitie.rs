...
impl<'a> Entitie<'a> {
    ...
    pub async fn create(&self, metadata: Option<HashMap<String, HashMap<String, String>>>, fields: Option<HashMap<String, String>>, name: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, metadata: Option<HashMap<String, HashMap<String, String>>>, fields: Option<HashMap<String, String>>, name: Option<String>) -> Result<()> {
