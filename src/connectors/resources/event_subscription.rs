...
impl<'a> Event_subscription<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, status: Option<String>, subscriber: Option<String>, trigger_config_variables: Option<Vec<String>>, destinations: Option<String>, subscriber_link: Option<String>, name: Option<String>, update_time: Option<String>, event_type_id: Option<String>, jms: Option<String>, parent: String) -> Result<String> {
