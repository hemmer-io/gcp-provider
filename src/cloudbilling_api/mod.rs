...
impl<'a> Cloudbilling_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "sub_account" => self.plan_sub_account(current_state, desired_input).await,
            ...
            "sku" => self.plan_sku(current_state, desired_input).await,
            "service" => self.plan_service(current_state, desired_input).await,
            "price" => self.plan_price(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudbilling_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "sub_account" => self.create_sub_account(input).await,
            ...
            "sku" => self.create_sku(input).await,
            "service" => self.create_service(input).await,
            "price" => self.create_price(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudbilling_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "sub_account" => self.read_sub_account(id).await,
            ...
            "sku" => self.read_sku(id).await,
            "service" => self.read_service(id).await,
            "price" => self.read_price(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudbilling_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "sub_account" => self.update_sub_account(id, input).await,
            ...
            "sku" => self.update_sku(id, input).await,
            "service" => self.update_service(id, input).await,
            "price" => self.update_price(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudbilling_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "sub_account" => self.delete_sub_account(id).await,
            ...
            "sku" => self.delete_sku(id).await,
            "service" => self.delete_service(id).await,
            "price" => self.delete_price(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "cloudbilling_api", resource_name
            ))),
    ...
    async fn create_sub_account(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a sub_account resource
    async fn read_sub_account(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a sub_account resource
    async fn update_sub_account(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a sub_account resource
    async fn delete_sub_account(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_price(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a price resource
    async fn read_price(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a price resource
    async fn update_price(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a price resource
    async fn delete_price(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
