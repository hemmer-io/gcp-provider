...
impl<'a> Assets_export_job<'a> {
    ...
    pub async fn create(&self, labels: Option<HashMap<String, String>>, create_time: Option<String>, show_hidden: Option<bool>, update_time: Option<String>, signed_uri_destination: Option<String>, condition: Option<String>, name: Option<String>, inventory: Option<String>, network_dependencies: Option<String>, performance_data: Option<String>, recent_executions: Option<Vec<String>>, parent: String) -> Result<String> {
