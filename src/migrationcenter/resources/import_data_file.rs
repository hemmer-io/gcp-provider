...
impl<'a> Import_data_file<'a> {
    ...
    pub async fn create(&self, display_name: Option<String>, name: Option<String>, create_time: Option<String>, state: Option<String>, upload_file_info: Option<String>, format: Option<String>, parent: String) -> Result<String> {
