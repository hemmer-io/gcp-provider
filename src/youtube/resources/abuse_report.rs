...
impl<'a> Abuse_report<'a> {
    ...
    pub async fn create(&self, description: Option<String>, subject: Option<String>, abuse_types: Option<Vec<String>>, related_entities: Option<Vec<String>>) -> Result<String> {
