...
impl<'a> Curation<'a> {
    ...
    pub async fn create(&self, name: Option<String>, create_time: Option<String>, last_execution_error_code: Option<String>, last_execution_state: Option<String>, description: Option<String>, update_time: Option<String>, display_name: Option<String>, endpoint: Option<String>, plugin_instance_actions: Option<Vec<String>>, last_execution_error_message: Option<String>, parent: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, name: Option<String>, create_time: Option<String>, last_execution_error_code: Option<String>, last_execution_state: Option<String>, description: Option<String>, update_time: Option<String>, display_name: Option<String>, endpoint: Option<String>, plugin_instance_actions: Option<Vec<String>>, last_execution_error_message: Option<String>) -> Result<()> {
