...
impl<'a> Api_hub_instance<'a> {
    ...
    pub async fn create(&self, create_time: Option<String>, config: Option<String>, name: Option<String>, state_message: Option<String>, state: Option<String>, labels: Option<HashMap<String, String>>, update_time: Option<String>, description: Option<String>, parent: String) -> Result<String> {
