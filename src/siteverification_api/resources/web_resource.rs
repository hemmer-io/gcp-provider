...
impl<'a> Web_resource<'a> {
    ...
    pub async fn create(&self, owners: Option<Vec<String>>, site: Option<String>, id: Option<String>) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, owners: Option<Vec<String>>, site: Option<String>, id: Option<String>) -> Result<()> {
