...
impl<'a> Webproperty_user_link<'a> {
    ...
    pub async fn create(&self, id: Option<String>, permissions: Option<String>, user_ref: Option<String>, entity: Option<String>, self_link: Option<String>, kind: Option<String>, account_id: String, web_property_id: String) -> Result<String> {
