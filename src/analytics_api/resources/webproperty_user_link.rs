...
impl<'a> Webproperty_user_link<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, permissions: Option<String>, user_ref: Option<String>, entity: Option<String>, id: Option<String>, self_link: Option<String>, web_property_id: String, account_id: String) -> Result<String> {
