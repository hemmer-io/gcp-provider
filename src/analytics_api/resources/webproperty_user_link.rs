...
impl<'a> Webproperty_user_link<'a> {
    ...
    pub async fn create(&self, entity: Option<String>, self_link: Option<String>, kind: Option<String>, permissions: Option<String>, user_ref: Option<String>, id: Option<String>, account_id: String, web_property_id: String) -> Result<String> {
