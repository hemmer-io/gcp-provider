...
impl<'a> Account_user_link<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, permissions: Option<String>, user_ref: Option<String>, entity: Option<String>, id: Option<String>, self_link: Option<String>, account_id: String) -> Result<String> {
