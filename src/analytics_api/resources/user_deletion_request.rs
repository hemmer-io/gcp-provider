...
impl<'a> User_deletion_request<'a> {
    ...
    pub async fn create(&self, web_property_id: Option<String>, kind: Option<String>, firebase_project_id: Option<String>, deletion_request_time: Option<String>, id: Option<String>, property_id: Option<String>) -> Result<String> {
