...
impl<'a> User_deletion_request<'a> {
    ...
    pub async fn create(&self, id: Option<String>, firebase_project_id: Option<String>, kind: Option<String>, property_id: Option<String>, deletion_request_time: Option<String>, web_property_id: Option<String>) -> Result<String> {
