...
//!
//! Auto-generated service module for networkmanagement

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for networkmanagement
pub struct NetworkmanagementService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> NetworkmanagementService<'a> {
