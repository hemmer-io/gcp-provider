...
//!
//! Auto-generated service module for adexchangeseller

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for adexchangeseller
pub struct AdexchangesellerService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> AdexchangesellerService<'a> {
    ...
    /// Get preferreddeal resource handler
    pub fn preferreddeal(&self) -> resources::Preferreddeal<'_> {
        resources::Preferreddeal::new(self.provider)
    }
