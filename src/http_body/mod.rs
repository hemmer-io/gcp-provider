//! Http_body service for Gcp provider
//!
//! This module handles all http_body resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Http_body service handler
pub struct Http_bodyService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> Http_bodyService<'a> {
