...
impl<'a> Domainmapping<'a> {
    ...
    pub async fn create(&self, kind: Option<String>, spec: Option<String>, api_version: Option<String>, status: Option<String>, metadata: Option<String>, parent: String) -> Result<String> {
