...
impl<'a> Eventarc_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "enrollment" => self.plan_enrollment(current_state, desired_input).await,
            "channel_connection" => {
                self.plan_channel_connection(current_state, desired_input)
                    .await
            }
            "pipeline" => self.plan_pipeline(current_state, desired_input).await,
            "kafka_source" => self.plan_kafka_source(current_state, desired_input).await,
            ...
            "message_buse" => self.plan_message_buse(current_state, desired_input).await,
            "google_api_source" => {
                self.plan_google_api_source(current_state, desired_input)
                    .await
            }
            "operation" => self.plan_operation(current_state, desired_input).await,
            "trigger" => self.plan_trigger(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "enrollment" => self.create_enrollment(input).await,
            "channel_connection" => self.create_channel_connection(input).await,
            "pipeline" => self.create_pipeline(input).await,
            "kafka_source" => self.create_kafka_source(input).await,
            ...
            "message_buse" => self.create_message_buse(input).await,
            "google_api_source" => self.create_google_api_source(input).await,
            "operation" => self.create_operation(input).await,
            "trigger" => self.create_trigger(input).await,
            "location" => self.create_location(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "enrollment" => self.read_enrollment(id).await,
            "channel_connection" => self.read_channel_connection(id).await,
            "pipeline" => self.read_pipeline(id).await,
            "kafka_source" => self.read_kafka_source(id).await,
            "trigger" => self.read_trigger(id).await,
            "operation" => self.read_operation(id).await,
            "channel" => self.read_channel(id).await,
            "message_buse" => self.read_message_buse(id).await,
            "google_api_source" => self.read_google_api_source(id).await,
            "operation" => self.read_operation(id).await,
            "trigger" => self.read_trigger(id).await,
            "location" => self.read_location(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "enrollment" => self.update_enrollment(id, input).await,
            "channel_connection" => self.update_channel_connection(id, input).await,
            "pipeline" => self.update_pipeline(id, input).await,
            "kafka_source" => self.update_kafka_source(id, input).await,
            ...
            "message_buse" => self.update_message_buse(id, input).await,
            "google_api_source" => self.update_google_api_source(id, input).await,
            "operation" => self.update_operation(id, input).await,
            "trigger" => self.update_trigger(id, input).await,
            "location" => self.update_location(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "enrollment" => self.delete_enrollment(id).await,
            "channel_connection" => self.delete_channel_connection(id).await,
            "pipeline" => self.delete_pipeline(id).await,
            "kafka_source" => self.delete_kafka_source(id).await,
            "trigger" => self.delete_trigger(id).await,
            "operation" => self.delete_operation(id).await,
            "channel" => self.delete_channel(id).await,
            "message_buse" => self.delete_message_buse(id).await,
            "google_api_source" => self.delete_google_api_source(id).await,
            "operation" => self.delete_operation(id).await,
            "trigger" => self.delete_trigger(id).await,
            "location" => self.delete_location(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
    ...
    async fn create_enrollment(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a enrollment resource
    async fn read_enrollment(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a enrollment resource
    async fn update_enrollment(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a enrollment resource
    async fn delete_enrollment(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_channel_connection(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a channel_connection resource
    async fn read_channel_connection(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_channel_connection(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_kafka_source(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a kafka_source resource
    async fn read_kafka_source(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a kafka_source resource
    async fn update_kafka_source(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a kafka_source resource
    async fn delete_kafka_source(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_message_buse(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a message_buse resource
    async fn read_message_buse(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a message_buse resource
    async fn update_message_buse(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a message_buse resource
    async fn delete_message_buse(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_google_api_source(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a google_api_source resource
    async fn read_google_api_source(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_google_api_source(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
