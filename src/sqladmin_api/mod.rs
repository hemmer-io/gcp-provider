...
impl<'a> Sqladmin_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "tier" => self.plan_tier(current_state, desired_input).await,
            "backup_run" => self.plan_backup_run(current_state, desired_input).await,
            "backup" => self.plan_backup(current_state, desired_input).await,
            "ssl_cert" => self.plan_ssl_cert(current_state, desired_input).await,
            "user" => self.plan_user(current_state, desired_input).await,
            "connect" => self.plan_connect(current_state, desired_input).await,
            "flag" => self.plan_flag(current_state, desired_input).await,
            "connect" => self.plan_connect(current_state, desired_input).await,
            "database" => self.plan_database(current_state, desired_input).await,
            "ssl_cert" => self.plan_ssl_cert(current_state, desired_input).await,
            "flag" => self.plan_flag(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "tier" => self.create_tier(input).await,
            "backup_run" => self.create_backup_run(input).await,
            "backup" => self.create_backup(input).await,
            "ssl_cert" => self.create_ssl_cert(input).await,
            "user" => self.create_user(input).await,
            "connect" => self.create_connect(input).await,
            "flag" => self.create_flag(input).await,
            "connect" => self.create_connect(input).await,
            "database" => self.create_database(input).await,
            "ssl_cert" => self.create_ssl_cert(input).await,
            "flag" => self.create_flag(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "tier" => self.read_tier(id).await,
            "backup_run" => self.read_backup_run(id).await,
            "backup" => self.read_backup(id).await,
            "ssl_cert" => self.read_ssl_cert(id).await,
            "user" => self.read_user(id).await,
            "connect" => self.read_connect(id).await,
            "flag" => self.read_flag(id).await,
            "connect" => self.read_connect(id).await,
            "database" => self.read_database(id).await,
            "ssl_cert" => self.read_ssl_cert(id).await,
            "flag" => self.read_flag(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "tier" => self.update_tier(id, input).await,
            "backup_run" => self.update_backup_run(id, input).await,
            "backup" => self.update_backup(id, input).await,
            "ssl_cert" => self.update_ssl_cert(id, input).await,
            "user" => self.update_user(id, input).await,
            "connect" => self.update_connect(id, input).await,
            "flag" => self.update_flag(id, input).await,
            "connect" => self.update_connect(id, input).await,
            "database" => self.update_database(id, input).await,
            "ssl_cert" => self.update_ssl_cert(id, input).await,
            "flag" => self.update_flag(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "tier" => self.delete_tier(id).await,
            "backup_run" => self.delete_backup_run(id).await,
            "backup" => self.delete_backup(id).await,
            "ssl_cert" => self.delete_ssl_cert(id).await,
            "user" => self.delete_user(id).await,
            "connect" => self.delete_connect(id).await,
            "flag" => self.delete_flag(id).await,
            "connect" => self.delete_connect(id).await,
            "database" => self.delete_database(id).await,
            "ssl_cert" => self.delete_ssl_cert(id).await,
            "flag" => self.delete_flag(id).await,
    ...
    async fn create_tier(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a tier resource
    async fn read_tier(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a tier resource
    async fn update_tier(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a tier resource
    async fn delete_tier(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_backup_run(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a backup_run resource
    async fn read_backup_run(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a backup_run resource
    async fn update_backup_run(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a backup_run resource
    async fn delete_backup_run(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_ssl_cert(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a ssl_cert resource
    async fn read_ssl_cert(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a ssl_cert resource
    async fn update_ssl_cert(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a ssl_cert resource
    async fn delete_ssl_cert(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_connect(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a connect resource
    async fn read_connect(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a connect resource
    async fn update_connect(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a connect resource
    async fn delete_connect(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_flag(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a flag resource
    async fn read_flag(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a flag resource
    async fn update_flag(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a flag resource
    async fn delete_flag(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
