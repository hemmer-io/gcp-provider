//! Vpcaccess_api service for Gcp provider
//!
//! This module handles all vpcaccess_api resources and their CRUD operations.

use hemmer_core::Result;
use hemmer_provider::{ResourceInput, ResourceOutput, ResourcePlan};

/// Vpcaccess_api service handler
