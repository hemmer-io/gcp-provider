...
impl<'a> Networkmanagement_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "vpc_flow_logs_config" => {
                self.plan_vpc_flow_logs_config(current_state, desired_input)
                    .await
            }
            "location" => self.plan_location(current_state, desired_input).await,
            "connectivity_test" => {
                self.plan_connectivity_test(current_state, desired_input)
                    .await
            }
            ...
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                ...
                "networkmanagement_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "vpc_flow_logs_config" => self.create_vpc_flow_logs_config(input).await,
            "location" => self.create_location(input).await,
            "connectivity_test" => self.create_connectivity_test(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "vpc_flow_logs_config" => self.read_vpc_flow_logs_config(id).await,
            "location" => self.read_location(id).await,
            "connectivity_test" => self.read_connectivity_test(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "vpc_flow_logs_config" => self.update_vpc_flow_logs_config(id, input).await,
            "location" => self.update_location(id, input).await,
            "connectivity_test" => self.update_connectivity_test(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "vpc_flow_logs_config" => self.delete_vpc_flow_logs_config(id).await,
            "location" => self.delete_location(id).await,
            "connectivity_test" => self.delete_connectivity_test(id).await,
    ...
    async fn create_vpc_flow_logs_config(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a vpc_flow_logs_config resource
    async fn read_vpc_flow_logs_config(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_vpc_flow_logs_config(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_connectivity_test(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a connectivity_test resource
    async fn read_connectivity_test(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_connectivity_test(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
