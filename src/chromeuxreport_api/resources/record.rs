...
impl<'a> Record<'a> {
    ...
    pub async fn create(&self, form_factor: Option<String>, origin: Option<String>, url: Option<String>, metrics: Option<Vec<String>>, collection_period_count: Option<i64>) -> Result<String> {
