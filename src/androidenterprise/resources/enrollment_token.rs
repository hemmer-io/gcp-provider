...
impl<'a> Enrollment_token<'a> {
    ...
    pub async fn create(&self, token: Option<String>, duration: Option<String>, google_authentication_options: Option<String>, enrollment_token_type: Option<String>, enterprise_id: String) -> Result<String> {
