...
impl<'a> Storelayoutcluster<'a> {
    ...
    pub async fn create(&self, product_id: Option<Vec<String>>, name: Option<Vec<String>>, id: Option<String>, order_in_page: Option<String>, page_id: String, enterprise_id: String) -> Result<String> {
    ...
    #[allow(unused_variables)]
    pub async fn update(&self, id: &str, product_id: Option<Vec<String>>, name: Option<Vec<String>>, id: Option<String>, order_in_page: Option<String>) -> Result<()> {
