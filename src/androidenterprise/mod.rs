...
//!
//! Auto-generated service module for androidenterprise

pub mod resources;

use crate::{ProviderError, Result};

/// Service handler for androidenterprise
pub struct AndroidenterpriseService<'a> {
    provider: &'a crate::GcpProvider,
}

impl<'a> AndroidenterpriseService<'a> {
