...
impl<'a> Remotebuildexecution_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            ...
            "remotebuildexecution" => {
                self.plan_remotebuildexecution(current_state, desired_input)
                    .await
            }
            "blob" => self.plan_blob(current_state, desired_input).await,
            "action_result" => self.plan_action_result(current_state, desired_input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "remotebuildexecution_api", resource_name
            ))),
        }
    }
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            ...
            "remotebuildexecution" => self.create_remotebuildexecution(input).await,
            "blob" => self.create_blob(input).await,
            "action_result" => self.create_action_result(input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "remotebuildexecution_api", resource_name
            ))),
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            ...
            "remotebuildexecution" => self.read_remotebuildexecution(id).await,
            "blob" => self.read_blob(id).await,
            "action_result" => self.read_action_result(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "remotebuildexecution_api", resource_name
            ))),
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            ...
            "remotebuildexecution" => self.update_remotebuildexecution(id, input).await,
            "blob" => self.update_blob(id, input).await,
            "action_result" => self.update_action_result(id, input).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "remotebuildexecution_api", resource_name
            ))),
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            ...
            "remotebuildexecution" => self.delete_remotebuildexecution(id).await,
            "blob" => self.delete_blob(id).await,
            "action_result" => self.delete_action_result(id).await,
            _ => Err(hemmer_core::HemmerError::Provider(format!(
                "Unknown resource type: {}.{}",
                "remotebuildexecution_api", resource_name
            ))),
    ...
    async fn create_remotebuildexecution(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a remotebuildexecution resource
    async fn read_remotebuildexecution(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
    ...
    async fn delete_remotebuildexecution(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_action_result(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a action_result resource
    async fn read_action_result(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a action_result resource
    async fn update_action_result(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a action_result resource
    async fn delete_action_result(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
}
