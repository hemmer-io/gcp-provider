...
impl<'a> Action<'a> {
    ...
    pub async fn create(&self, skip_cache_lookup: Option<bool>, results_cache_policy: Option<String>, execution_policy: Option<String>, action_digest: Option<String>, instance_name: String) -> Result<String> {
