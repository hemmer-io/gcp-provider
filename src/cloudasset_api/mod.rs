...
impl<'a> Cloudasset_apiService<'a> {
    ...
    pub async fn plan_resource(
        ...
        match resource_name {
            "effective_iam_policie" => {
                self.plan_effective_iam_policie(current_state, desired_input)
                    .await
            }
            "cloudasset" => self.plan_cloudasset(current_state, desired_input).await,
            "feed" => self.plan_feed(current_state, desired_input).await,
    ...
    pub async fn create_resource(
        ...
        match resource_name {
            "effective_iam_policie" => self.create_effective_iam_policie(input).await,
            "cloudasset" => self.create_cloudasset(input).await,
            "feed" => self.create_feed(input).await,
    ...
    pub async fn read_resource(&self, resource_name: &str, id: &str) -> Result<ResourceOutput> {
        match resource_name {
            "effective_iam_policie" => self.read_effective_iam_policie(id).await,
            "cloudasset" => self.read_cloudasset(id).await,
            "feed" => self.read_feed(id).await,
    ...
    pub async fn update_resource(
        ...
        match resource_name {
            "effective_iam_policie" => self.update_effective_iam_policie(id, input).await,
            "cloudasset" => self.update_cloudasset(id, input).await,
            "feed" => self.update_feed(id, input).await,
    ...
    pub async fn delete_resource(&self, resource_name: &str, id: &str) -> Result<()> {
        match resource_name {
            "effective_iam_policie" => self.delete_effective_iam_policie(id).await,
            "cloudasset" => self.delete_cloudasset(id).await,
            "feed" => self.delete_feed(id).await,
    ...
    async fn create_effective_iam_policie(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a effective_iam_policie resource
    async fn read_effective_iam_policie(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
    ...
    async fn delete_effective_iam_policie(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_cloudasset(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a cloudasset resource
    async fn read_cloudasset(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a cloudasset resource
    async fn update_cloudasset(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Delete a cloudasset resource
    async fn delete_cloudasset(&self, id: &str) -> Result<()> {
        // TODO: Implement Gcp SDK calls
        Ok(())
    }
    ...
    async fn create_feed(&self, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id("placeholder-id"))
    }

    /// Read a feed resource
    async fn read_feed(&self, id: &str) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }

    /// Update a feed resource
    async fn update_feed(&self, id: &str, input: ResourceInput) -> Result<ResourceOutput> {
        // TODO: Implement Gcp SDK calls
        Ok(ResourceOutput::new().with_id(id))
    }
