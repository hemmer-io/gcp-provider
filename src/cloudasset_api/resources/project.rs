...
impl<'a> Project<'a> {
    ...
    pub async fn create(&self, asset_types: Option<Vec<String>>, content_type: Option<String>, read_time: Option<String>, output_config: Option<String>, parent: String) -> Result<String> {
