...
| Output | Type | Description |
|--------|------|-------------|
| `admins` | Vec<String> | A collection of Admins. |
...
admin = provider.mybusinessaccountmanagement_api.Admin {
    parent = "value"  # Required. The resource name of the account this admin is created for. `accounts/{account_id}`.
}
...
location_0 = provider.mybusinessaccountmanagement_api.Location {
    name = "value-0"
}
location_1 = provider.mybusinessaccountmanagement_api.Location {
    name = "value-1"
}
location_2 = provider.mybusinessaccountmanagement_api.Location {
    name = "value-2"
}
```
