...
# Create multiple threat_list resources
threat_list_0 = provider.webrisk_api.Threat_list {
}
threat_list_1 = provider.webrisk_api.Threat_list {
}
threat_list_2 = provider.webrisk_api.Threat_list {
}
```
...
if environment == "production":
    threat_list = provider.webrisk_api.Threat_list {
    }
```
