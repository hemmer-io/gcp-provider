...
# Create multiple mirroring_endpoint_group resources
mirroring_endpoint_group_0 = provider.networksecurity_api.Mirroring_endpoint_group {
    parent = "value-0"
}
mirroring_endpoint_group_1 = provider.networksecurity_api.Mirroring_endpoint_group {
    parent = "value-1"
}
mirroring_endpoint_group_2 = provider.networksecurity_api.Mirroring_endpoint_group {
    parent = "value-2"
}
```
