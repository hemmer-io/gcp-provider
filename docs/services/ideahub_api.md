...
# Create multiple idea resources
idea_0 = provider.ideahub_api.Idea {
}
idea_1 = provider.ideahub_api.Idea {
}
idea_2 = provider.ideahub_api.Idea {
}
```
...
if environment == "production":
    idea = provider.ideahub_api.Idea {
    }
```
