...
# Create multiple hcx_activation_key resources
hcx_activation_key_0 = provider.vmwareengine_api.Hcx_activation_key {
    parent = "value-0"
}
hcx_activation_key_1 = provider.vmwareengine_api.Hcx_activation_key {
    parent = "value-1"
}
hcx_activation_key_2 = provider.vmwareengine_api.Hcx_activation_key {
    parent = "value-2"
}
```
