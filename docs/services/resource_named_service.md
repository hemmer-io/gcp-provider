...
version_0 = provider.resource_named_service.Version {
    apps_id = "value-0"
    services_id = "value-0"
}
version_1 = provider.resource_named_service.Version {
    apps_id = "value-1"
    services_id = "value-1"
}
version_2 = provider.resource_named_service.Version {
    apps_id = "value-2"
    services_id = "value-2"
}
```
