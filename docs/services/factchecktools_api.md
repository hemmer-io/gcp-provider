...
| `results` | Vec<String> | The list of claims and all of their associated information. |
...
page_0 = provider.factchecktools_api.Page {
}
page_1 = provider.factchecktools_api.Page {
}
page_2 = provider.factchecktools_api.Page {
}
```
