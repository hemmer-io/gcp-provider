...
# Create multiple scope resources
scope_0 = provider.observability_api.Scope {
    name = "value-0"
}
scope_1 = provider.observability_api.Scope {
    name = "value-1"
}
scope_2 = provider.observability_api.Scope {
    name = "value-2"
}
```
...
if environment == "production":
    scope = provider.observability_api.Scope {
