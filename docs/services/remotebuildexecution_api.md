...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `digests` | Vec<String> |  | The individual blob digests. |
...
operation_0 = provider.remotebuildexecution_api.Operation {
    name = "value-0"
}
operation_1 = provider.remotebuildexecution_api.Operation {
    name = "value-1"
}
operation_2 = provider.remotebuildexecution_api.Operation {
    name = "value-2"
}
```
