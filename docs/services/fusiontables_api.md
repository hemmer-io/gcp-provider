...
# Create multiple column resources
column_0 = provider.fusiontables_api.Column {
    table_id = "value-0"
}
column_1 = provider.fusiontables_api.Column {
    table_id = "value-1"
}
column_2 = provider.fusiontables_api.Column {
    table_id = "value-2"
}
```
