...
database_0 = provider.oracledatabase_api.Database {
}
database_1 = provider.oracledatabase_api.Database {
}
database_2 = provider.oracledatabase_api.Database {
}
```
...
if environment == "production":
    database = provider.oracledatabase_api.Database {
    }
```
