...
|-------|------|----------|-------------|
| `generation_id` | i64 |  | Required. The generation of the backup to update. |
| `name` | String | ✅ | Required. The resource name for the location for which static IPs should be returned. Must be in the format 'projects/*/locations/*/backupVaults/*/dataSources'. |
...
data_source = provider.backupdr_api.Data_source {
    name = "value"  # Required. The resource name for the location for which static IPs should be returned. Must be in the format 'projects/*/locations/*/backupVaults/*/dataSources'.
}
...
data_source_0 = provider.backupdr_api.Data_source {
    name = "value-0"
}
data_source_1 = provider.backupdr_api.Data_source {
    name = "value-1"
}
data_source_2 = provider.backupdr_api.Data_source {
    name = "value-2"
}
```
