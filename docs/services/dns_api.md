...
# Create multiple response_policy_rule resources
response_policy_rule_0 = provider.dns_api.Response_policy_rule {
    response_policy = "value-0"
    project = "value-0"
}
response_policy_rule_1 = provider.dns_api.Response_policy_rule {
    response_policy = "value-1"
    project = "value-1"
}
response_policy_rule_2 = provider.dns_api.Response_policy_rule {
    response_policy = "value-2"
    project = "value-2"
}
```
...
if environment == "production":
    response_policy_rule = provider.dns_api.Response_policy_rule {
        response_policy = "production-value"
