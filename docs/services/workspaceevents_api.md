...
operation_0 = provider.workspaceevents_api.Operation {
}
operation_1 = provider.workspaceevents_api.Operation {
}
operation_2 = provider.workspaceevents_api.Operation {
}
```
...
if environment == "production":
    operation = provider.workspaceevents_api.Operation {
    }
```
