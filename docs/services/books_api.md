...
|--------|------|-------------|
| `kind` | String | Resource type. |
| `items` | Vec<String> | A list of onboarding categories. |
...
# Create multiple readingposition resources
readingposition_0 = provider.books_api.Readingposition {
    volume_id = "value-0"
}
readingposition_1 = provider.books_api.Readingposition {
    volume_id = "value-1"
}
readingposition_2 = provider.books_api.Readingposition {
    volume_id = "value-2"
}
```
