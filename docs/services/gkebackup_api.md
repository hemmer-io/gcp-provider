...
# Create multiple backup_channel resources
backup_channel_0 = provider.gkebackup_api.Backup_channel {
    parent = "value-0"
}
backup_channel_1 = provider.gkebackup_api.Backup_channel {
    parent = "value-1"
}
backup_channel_2 = provider.gkebackup_api.Backup_channel {
    parent = "value-2"
}
```
