...
# Create multiple project_data_profile resources
project_data_profile_0 = provider.dlp_api.Project_data_profile {
}
project_data_profile_1 = provider.dlp_api.Project_data_profile {
}
project_data_profile_2 = provider.dlp_api.Project_data_profile {
}
```
...
if environment == "production":
    project_data_profile = provider.dlp_api.Project_data_profile {
    }
```
