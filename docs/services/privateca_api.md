...
# Create multiple certificate_authoritie resources
certificate_authoritie_0 = provider.privateca_api.Certificate_authoritie {
    parent = "value-0"
}
certificate_authoritie_1 = provider.privateca_api.Certificate_authoritie {
    parent = "value-1"
}
certificate_authoritie_2 = provider.privateca_api.Certificate_authoritie {
    parent = "value-2"
}
```
