...
# Create multiple posture resources
posture_0 = provider.securityposture_api.Posture {
    parent = "value-0"
}
posture_1 = provider.securityposture_api.Posture {
    parent = "value-1"
}
posture_2 = provider.securityposture_api.Posture {
    parent = "value-2"
}
```
