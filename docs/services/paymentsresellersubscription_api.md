...
promotion_0 = provider.paymentsresellersubscription_api.Promotion {
    parent = "value-0"
}
promotion_1 = provider.paymentsresellersubscription_api.Promotion {
    parent = "value-1"
}
promotion_2 = provider.paymentsresellersubscription_api.Promotion {
    parent = "value-2"
}
```
