...
# Create multiple repositorie resources
repositorie_0 = provider.dataform_api.Repositorie {
    parent = "value-0"
}
repositorie_1 = provider.dataform_api.Repositorie {
    parent = "value-1"
}
repositorie_2 = provider.dataform_api.Repositorie {
    parent = "value-2"
}
```
