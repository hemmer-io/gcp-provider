...
# Create multiple trust_config resources
trust_config_0 = provider.certificatemanager_api.Trust_config {
    parent = "value-0"
}
trust_config_1 = provider.certificatemanager_api.Trust_config {
    parent = "value-1"
}
trust_config_2 = provider.certificatemanager_api.Trust_config {
    parent = "value-2"
}
```
