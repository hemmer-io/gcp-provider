...
| `page_size` | i64 |  | The requested page size. Server might return fewer results than requested. If unspecified, returns at most 100 SKUs. The maximum value is 1000; the server will coerce values above 1000. Optional. |
...
account = provider.cloudchannel_api.Account {
    parent = "value"  # Required. The reseller account's resource name. Parent uses the format: accounts/{account_id}
}
...
# Create multiple customer_repricing_config resources
customer_repricing_config_0 = provider.cloudchannel_api.Customer_repricing_config {
    parent = "value-0"
}
customer_repricing_config_1 = provider.cloudchannel_api.Customer_repricing_config {
    parent = "value-1"
}
customer_repricing_config_2 = provider.cloudchannel_api.Customer_repricing_config {
    parent = "value-2"
}
```
