...
sitemap_0 = provider.webmasters_api.Sitemap {
    site_url = "value-0"
    feedpath = "value-0"
}
sitemap_1 = provider.webmasters_api.Sitemap {
    site_url = "value-1"
    feedpath = "value-1"
}
sitemap_2 = provider.webmasters_api.Sitemap {
    site_url = "value-2"
    feedpath = "value-2"
}
```
...
if environment == "production":
    sitemap = provider.webmasters_api.Sitemap {
