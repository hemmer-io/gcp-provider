...
folder_key_project = folder.key_project
```
...
project_default_key_access_justification_policy = project.default_key_access_justification_policy
...
operation_0 = provider.cloudkms_api.Operation {
}
operation_1 = provider.cloudkms_api.Operation {
}
operation_2 = provider.cloudkms_api.Operation {
}
```
...
if environment == "production":
    operation = provider.cloudkms_api.Operation {
    }
```
