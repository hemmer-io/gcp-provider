...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `user_event_rejoin_scope` | String |  | Required. The type of the catalog rejoin to define the scope and range of the user events to be rejoined with catalog items. |
...
user_event = provider.recommendationengine_api.User_event {
    parent = "value"  # Required. Full resource name of user event, such as `projects/*/locations/*/catalogs/default_catalog/eventStores/default_event_store`.
}
...
operation_0 = provider.recommendationengine_api.Operation {
}
operation_1 = provider.recommendationengine_api.Operation {
}
operation_2 = provider.recommendationengine_api.Operation {
}
```
...
if environment == "production":
    operation = provider.recommendationengine_api.Operation {
    }
```
