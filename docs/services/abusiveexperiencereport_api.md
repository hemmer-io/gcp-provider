...
site_0 = provider.abusiveexperiencereport_api.Site {
}
site_1 = provider.abusiveexperiencereport_api.Site {
}
site_2 = provider.abusiveexperiencereport_api.Site {
}
```
...
if environment == "production":
    site = provider.abusiveexperiencereport_api.Site {
    }
```
