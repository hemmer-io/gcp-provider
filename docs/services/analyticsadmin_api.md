...
# Create multiple reporting_data_annotation resources
reporting_data_annotation_0 = provider.analyticsadmin_api.Reporting_data_annotation {
    parent = "value-0"
}
reporting_data_annotation_1 = provider.analyticsadmin_api.Reporting_data_annotation {
    parent = "value-1"
}
reporting_data_annotation_2 = provider.analyticsadmin_api.Reporting_data_annotation {
    parent = "value-2"
}
```
