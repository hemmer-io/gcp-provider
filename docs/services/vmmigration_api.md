...
# Create multiple image_import_job resources
image_import_job_0 = provider.vmmigration_api.Image_import_job {
    name = "value-0"
}
image_import_job_1 = provider.vmmigration_api.Image_import_job {
    name = "value-1"
}
image_import_job_2 = provider.vmmigration_api.Image_import_job {
    name = "value-2"
}
```
