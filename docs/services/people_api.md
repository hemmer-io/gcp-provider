...
| Output | Type | Description |
|--------|------|-------------|
| `results` | Vec<String> | The results of the request. |
...
other_contact_results = other_contact.results
```
...
# Create multiple contact_group resources
contact_group_0 = provider.people_api.Contact_group {
}
contact_group_1 = provider.people_api.Contact_group {
}
contact_group_2 = provider.people_api.Contact_group {
}
```
