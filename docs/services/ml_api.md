...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `http_body` | String |  |  Required. The prediction request body. Refer to the [request body details section](#request-body-details) for more information on how to structure your request. |
...
# Create multiple trial resources
trial_0 = provider.ml_api.Trial {
    parent = "value-0"
}
trial_1 = provider.ml_api.Trial {
    parent = "value-1"
}
trial_2 = provider.ml_api.Trial {
    parent = "value-2"
}
```
