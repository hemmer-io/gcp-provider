...
# Create multiple ssh_public_key resources
ssh_public_key_0 = provider.oslogin_api.Ssh_public_key {
    parent = "value-0"
}
ssh_public_key_1 = provider.oslogin_api.Ssh_public_key {
    parent = "value-1"
}
ssh_public_key_2 = provider.oslogin_api.Ssh_public_key {
    parent = "value-2"
}
```
