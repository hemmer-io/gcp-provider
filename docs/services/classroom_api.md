...
# Create multiple add_on_attachment resources
add_on_attachment_0 = provider.classroom_api.Add_on_attachment {
    item_id = "value-0"
    course_id = "value-0"
}
add_on_attachment_1 = provider.classroom_api.Add_on_attachment {
    item_id = "value-1"
    course_id = "value-1"
}
add_on_attachment_2 = provider.classroom_api.Add_on_attachment {
    item_id = "value-2"
    course_id = "value-2"
}
```
