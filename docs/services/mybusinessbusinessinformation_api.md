...
| Output | Type | Description |
|--------|------|-------------|
| `categories` | Vec<String> | Categories that match the GConcept ids provided in the request. They will not come in the same order as category ids in the request. |
...
# Create multiple attribute resources
attribute_0 = provider.mybusinessbusinessinformation_api.Attribute {
}
attribute_1 = provider.mybusinessbusinessinformation_api.Attribute {
}
attribute_2 = provider.mybusinessbusinessinformation_api.Attribute {
}
```
...
if environment == "production":
    attribute = provider.mybusinessbusinessinformation_api.Attribute {
    }
```
