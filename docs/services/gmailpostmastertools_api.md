...
# Create multiple traffic_stat resources
traffic_stat_0 = provider.gmailpostmastertools_api.Traffic_stat {
}
traffic_stat_1 = provider.gmailpostmastertools_api.Traffic_stat {
}
traffic_stat_2 = provider.gmailpostmastertools_api.Traffic_stat {
}
```
...
if environment == "production":
    traffic_stat = provider.gmailpostmastertools_api.Traffic_stat {
    }
```
