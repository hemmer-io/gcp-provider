...
folder_service_account = folder.service_account
...
# Create asset
asset = provider.securitycenter_api.Asset {
    parent = "value"  # Required. Name of the organization to groupBy. Its format is "organizations/[organization_id]".
}
...
# Create multiple custom_module resources
custom_module_0 = provider.securitycenter_api.Custom_module {
    parent = "value-0"
}
custom_module_1 = provider.securitycenter_api.Custom_module {
    parent = "value-1"
}
custom_module_2 = provider.securitycenter_api.Custom_module {
    parent = "value-2"
}
```
