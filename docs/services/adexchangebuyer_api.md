...
# Create multiple marketplaceprivateauction resources
marketplaceprivateauction_0 = provider.adexchangebuyer_api.Marketplaceprivateauction {
    private_auction_id = "value-0"
}
marketplaceprivateauction_1 = provider.adexchangebuyer_api.Marketplaceprivateauction {
    private_auction_id = "value-1"
}
marketplaceprivateauction_2 = provider.adexchangebuyer_api.Marketplaceprivateauction {
    private_auction_id = "value-2"
}
```
...
if environment == "production":
    marketplaceprivateauction = provider.adexchangebuyer_api.Marketplaceprivateauction {
        private_auction_id = "production-value"
    }
```
