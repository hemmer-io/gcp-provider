...
| `spark_wrapper_objects` | Vec<String> |  |  |
| `name` | String | ✅ | Required. The fully qualified name of the spark application to write data about in the format "projects/PROJECT_ID/locations/DATAPROC_REGION/batches/BATCH_ID/sparkApplications/APPLICATION_ID" |
...
| Output | Type | Description |
|--------|------|-------------|
| `stages_summary` | String | Summary of a Spark Application Stages |
...
spark_application = provider.dataproc_api.Spark_application {
    name = "value"  # Required. The fully qualified name of the spark application to write data about in the format "projects/PROJECT_ID/locations/DATAPROC_REGION/batches/BATCH_ID/sparkApplications/APPLICATION_ID"
}

# Access spark_application outputs
spark_application_id = spark_application.id
spark_application_stages_summary = spark_application.stages_summary
```
...
# Create job
job = provider.dataproc_api.Job {
    job_id = "value"  # Required. The job ID.
...
# Create multiple node_group resources
node_group_0 = provider.dataproc_api.Node_group {
    parent = "value-0"
}
node_group_1 = provider.dataproc_api.Node_group {
    parent = "value-1"
}
node_group_2 = provider.dataproc_api.Node_group {
    parent = "value-2"
}
```
