...
# Create multiple feedback_thread resources
feedback_thread_0 = provider.datalabeling_api.Feedback_thread {
}
feedback_thread_1 = provider.datalabeling_api.Feedback_thread {
}
feedback_thread_2 = provider.datalabeling_api.Feedback_thread {
}
```
...
if environment == "production":
    feedback_thread = provider.datalabeling_api.Feedback_thread {
    }
```
