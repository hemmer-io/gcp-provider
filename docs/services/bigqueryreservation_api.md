...
location_preferred_tables = location.preferred_tables
...
location_0 = provider.bigqueryreservation_api.Location {
    name = "value-0"
}
location_1 = provider.bigqueryreservation_api.Location {
    name = "value-1"
}
location_2 = provider.bigqueryreservation_api.Location {
    name = "value-2"
}
```
...
if environment == "production":
    location = provider.bigqueryreservation_api.Location {
