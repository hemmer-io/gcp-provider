...
trigger = provider.cloudbuild_api.Trigger {
    project_id = "value"  # Required. ID of the project for which to configure automatic builds.
}
...
build = provider.cloudbuild_api.Build {
    project_id = "value"  # Required. ID of the project.
}
...
# Create multiple cloudbuild resources
cloudbuild_0 = provider.cloudbuild_api.Cloudbuild {
}
cloudbuild_1 = provider.cloudbuild_api.Cloudbuild {
}
cloudbuild_2 = provider.cloudbuild_api.Cloudbuild {
}
```
