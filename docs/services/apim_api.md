...
# Create multiple api_observation resources
api_observation_0 = provider.apim_api.Api_observation {
    parent = "value-0"
}
api_observation_1 = provider.apim_api.Api_observation {
    parent = "value-1"
}
api_observation_2 = provider.apim_api.Api_observation {
    parent = "value-2"
}
```
