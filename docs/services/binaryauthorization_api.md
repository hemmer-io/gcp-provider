...
# Create multiple policy resources
policy_0 = provider.binaryauthorization_api.Policy {
    resource = "value-0"
}
policy_1 = provider.binaryauthorization_api.Policy {
    resource = "value-1"
}
policy_2 = provider.binaryauthorization_api.Policy {
    resource = "value-2"
}
```
