...
# Create multiple metrics_scope resources
metrics_scope_0 = provider.monitoring_api.Metrics_scope {
}
metrics_scope_1 = provider.monitoring_api.Metrics_scope {
}
metrics_scope_2 = provider.monitoring_api.Metrics_scope {
}
```
...
if environment == "production":
    metrics_scope = provider.monitoring_api.Metrics_scope {
    }
```
