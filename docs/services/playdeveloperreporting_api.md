...
# Create multiple issue resources
issue_0 = provider.playdeveloperreporting_api.Issue {
}
issue_1 = provider.playdeveloperreporting_api.Issue {
}
issue_2 = provider.playdeveloperreporting_api.Issue {
}
```
...
if environment == "production":
    issue = provider.playdeveloperreporting_api.Issue {
    }
```
