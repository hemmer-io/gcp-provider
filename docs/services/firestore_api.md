...
document = provider.firestore_api.Document {
    database = "value"  # Required. The database name. In the format: `projects/{project_id}/databases/{database_id}`.
}
...
| `input_uri_prefix` | String |  | Location of the exported files. This must match the output_uri_prefix of an ExportDocumentsResponse from an export that has completed successfully. See: google.firestore.admin.v1beta2.ExportDocumentsResponse.output_uri_prefix. |
...
indexe_0 = provider.firestore_api.Indexe {
    parent = "value-0"
}
indexe_1 = provider.firestore_api.Indexe {
    parent = "value-1"
}
indexe_2 = provider.firestore_api.Indexe {
    parent = "value-2"
}
```
