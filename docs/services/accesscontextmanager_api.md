...
# Create multiple service_perimeter resources
service_perimeter_0 = provider.accesscontextmanager_api.Service_perimeter {
    parent = "value-0"
}
service_perimeter_1 = provider.accesscontextmanager_api.Service_perimeter {
    parent = "value-1"
}
service_perimeter_2 = provider.accesscontextmanager_api.Service_perimeter {
    parent = "value-2"
}
```
