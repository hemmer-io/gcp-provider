...
# Create multiple video_trainability resources
video_trainability_0 = provider.youtube_api.Video_trainability {
}
video_trainability_1 = provider.youtube_api.Video_trainability {
}
video_trainability_2 = provider.youtube_api.Video_trainability {
}
```
...
if environment == "production":
    video_trainability = provider.youtube_api.Video_trainability {
    }
```
